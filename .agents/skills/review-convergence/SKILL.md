...
description: Use this skill to run autonomous adversarial review-fix loops on any file type until convergence to zero findings or max 12 rounds. Use when reviewing config files, agent files, Markdown, YAML, or other non-Typst/non-LaTeX content for internal consistency and logical coherence.
---
