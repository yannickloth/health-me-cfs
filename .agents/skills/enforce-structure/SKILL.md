...
- `structure-auditor` reads `.agents/context/content-structure-convention.md` — ensure this file exists before running. If missing, the audit will fail or produce false negatives.
