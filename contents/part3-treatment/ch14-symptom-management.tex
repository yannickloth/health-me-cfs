...
\begin{itemize}
    \item \textbf{Methylphenidate}: 5--20~mg in divided doses (morning and early afternoon). May improve concentration, processing speed, and alertness. Risk of appetite suppression, insomnia, and cardiovascular effects. Start at 2.5--5~mg to assess tolerability
...
Stimulants and wakefulness-promoting agents improve cognitive \textit{symptoms} but do not address the underlying pathology. They may enable patients to exceed their cognitive energy envelope, risking PEM. Clinicians should counsel patients that improved cognition from medication is not a signal to increase cognitive workload.
\end{limitation}
