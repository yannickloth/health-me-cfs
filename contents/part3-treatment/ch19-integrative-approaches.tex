...
\begin{hypothesis}[Treatment Trial Limits for Severe Patients]
\label{hyp:treatment-trial-limits}
...
\begin{hypothesis}[Phenotype-Guided Treatment Prioritization]
\label{hyp:phenotype-treatment-prioritization}
