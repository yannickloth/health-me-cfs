...
Transcranial direct current stimulation (tDCS) applied to the dorsolateral prefrontal cortex (DLPFC) reduces baseline energy requirements for executive function (Chapter~\ref{sec:selective-dysfunction}, lines 207--228). By decreasing the metabolic cost of Tier 5 cognitive tasks, tDCS may improve sustainable cognitive performance within the energy envelope.
\end{hypothesis}
