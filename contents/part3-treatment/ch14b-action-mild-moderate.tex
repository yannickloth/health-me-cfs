...
Anodal tDCS targeting the DLPFC modulates cortical excitability and has demonstrated improvements in working memory, attention, and executive function in multiple studies~\cite{Li2022tDCS}. Applied to ME/CFS, this neural efficiency gain may reduce the energy cost of Tier 5 cognitive tasks (Chapter~\ref{sec:selective-dysfunction}), thereby improving sustainable cognitive performance within the patient's energy envelope.
\end{hypothesis}
