...
\begin{itemize}
    ...
    \item \textbf{Comorbidity screening}: See Section~\ref{sec:septad-screening}. Treat identified comorbidities concurrently (thyroid dysfunction, vitamin deficiencies, sleep apnea).
    \item \textbf{Immune profiling}: Parallel to this protocol, obtain immune biomarkers to guide longer-term disease-modifying strategy (Section~\ref{subsec:immune-profiling-targeted}).
\end{itemize}
