...
\begin{itemize}
    \item Increases whole-body resting energy expenditure by approximately 7\%---the body burns \textit{more} energy at baseline while on the drug
...
Evidence is very limited. One small lisdexamfetamine trial (n=26, 2013) showed positive results. The NICE recommendation against CNS stimulants applies to amphetamines~\cite{NICE2021mecfs}.
...
\begin{itemize}
    ...
    \item Consider low-dose melatonin as a concurrent intervention (43.3\% net positive in PNAS survey)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Low-dose naltrexone}: 49.4\% net positive; immune modulation via TLR4 and TRPM3 pathways (see Section~\ref{sec:immune-medications})
    \item \textbf{Pyridostigmine}: 41\% net positive; enhances cholinergic autonomic function (see Section~\ref{sec:pyridostigmine})
