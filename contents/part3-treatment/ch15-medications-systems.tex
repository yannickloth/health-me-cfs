...
\begin{itemize}
    ...
    \item Antiviral protocols (valacyclovir, valganciclovir) derive from case series and retrospective analyses; the only randomised trial of valganciclovir in ME/CFS (Montoya 2013, n=30) showed modest improvement that reached significance only for a subset of outcomes.
