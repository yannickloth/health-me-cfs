...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Dual benefit: reflux + mast cell stabilization
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Cetirizine 10 mg
            \item Famotidine 20-40 mg (15-20 min before breakfast)
            \item Quercetin 500-1000 mg (natural mast cell stabilizer, LESS effective than ketotifen)
            \item Vitamin C 1000 mg (DAO enzyme cofactor)
        \end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{CONTRAINDICATIONS}: DO NOT use if you have hypertension, heart failure, kidney disease, or are taking diuretics/ACE inhibitors. Monitor blood pressure daily.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Timing}: Divide doses throughout day with meals. DO NOT take large single doses (>200 mg) on empty stomach - GI irritation.
        \item \textbf{CRITICAL WARNING}: DO NOT supplement potassium if you have kidney disease or are taking potassium-sparing diuretics (spironolactone, amiloride) or ACE inhibitors (lisinopril, etc.) - can cause dangerous hyperkalemia.
    \end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Dose for average adult (60-80 kg)}: 400--600 mg per dose
            \item \textbf{Timing}: Morning: 1 dose (8am with breakfast), Midday: 1 dose (2pm with lunch), Evening: 1 dose (8pm with dinner)
            \item \textbf{First dose can be taken ANY TIME today with food}
            \item \textbf{WARNING}: If using salt loading (Protocol 2), MONITOR kidney function - NSAID + salt can increase renal risk
        \end{itemize}

        \item \textbf{Turmeric/curcumin}: 1000 mg twice daily
        \begin{itemize}
            \item \textbf{Dose for average adult}: 1000 mg per dose
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Dose for average adult}: 500 mg per dose
            ...
            \item \textbf{CRITICAL WARNING}: If taking diabetes medications (metformin, insulin, sulfonylureas), DO NOT use berberine without physician supervision - can cause dangerous hypoglycemia
            \item Antimicrobial, glucose regulation
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Dose for average adult}: 5 g per dose (1 teaspoon powder)
            \item \textbf{Timing}: Morning: 1 dose (empty stomach, 30 min before breakfast), Evening: 1 dose (before bed)
            \item \textbf{First dose can be taken tomorrow morning}
            \item Enterocyte fuel, barrier repair
        \end{itemize}

        \item \textbf{Zinc carnosine}: 75 mg twice daily
        \begin{itemize}
            \item \textbf{Dose for average adult}: 75 mg per dose
            \item \textbf{Timing}: Morning: 1 dose (with breakfast), Evening: 1 dose (with dinner)
            \item \textbf{First dose can be taken with next meal}
            \item Mucosal healing
        \end{itemize}
