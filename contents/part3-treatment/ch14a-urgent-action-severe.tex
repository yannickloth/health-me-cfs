...
The sensitization-prevention protocol targets the documented cascade in which neuroinflammatory priming lowers the threshold for all symptom exacerbations~\cite{hyp:cascade-neuroinflammatory}. By stabilizing this foundation, subsequent treatments for individual systems (immune reconstitution, cognitive rehabilitation, autonomic retraining) have higher probability of efficacy.
