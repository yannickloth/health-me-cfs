...
The astrocyte-neuron lactate shuttle (ANLS) provides 30--50\% of neuronal ATP. Dysfunction in ANLS may cause CNS-specific energy failure while peripheral tissues remain intact (Chapter~\ref{sec:selective-dysfunction}, lines 179--198). Supporting the lactate shuttle may enhance CNS energy availability.
\end{keypoint}
