...
\begin{itemize}
    ...
    \item Cross-condition extrapolation (e.g., FMT efficacy from IBS, VNS from epilepsy, HBOT from wound healing) does not establish efficacy in ME/CFS; the shared-symptom assumption underlying such transfers may be incorrect.
