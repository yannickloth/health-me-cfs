...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{D-ribose} 10--15~g: Ribose is the sugar backbone of ATP; provides direct substrate for ATP resynthesis
        ...
        \item Dissolve ribose and creatine in water or juice; take MCT oil separately or mixed in beverage
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{N-acetylcysteine (NAC)} 1200--1800~mg: Glutathione precursor; scavenges ROS
