...
\textbf{Evidence update (2025):} España-Cueto et al. conducted the first sham-controlled randomised trial of therapeutic plasma exchange in Long COVID ($n = 50$): the plasma exchange arm showed no improvement over sham procedure for the primary composite outcome. This negative result is important context: case reports and uncontrolled series had suggested benefit, but the controlled data do not support plasma exchange as a routine intervention. The authors noted that the trial population was clinically heterogeneous and may not have been pre-selected for autoantibody-positive subgroups, leaving open the possibility of benefit in a more defined patient subset.

Case reports in ME/CFS specifically continue to appear (Kiprov 2022), but the controlled Long COVID data substantially lower confidence in broad application.

\textbf{Evidence Grade}: D---insufficient; sham-controlled trial negative; may warrant further investigation in autoantibody-positive subgroups only
