...
\paragraph{Emergency Use.} For emergency post-exertion PEM prevention, high-dose loading (1000--2000~mg NR or NMN immediately post-exertion, then 500~mg twice daily for 3--5 days) may prevent NAD$^+$ depletion from PARP activation during DNA repair. See Chapter~\ref{ch:emerging-therapies}, \S\ref{subsec:pem-prevention} for complete emergency protocol.
