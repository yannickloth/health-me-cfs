...
\begin{itemize}
    \item Fewer than five supplements discussed here have been tested in randomised placebo-controlled trials specifically in ME/CFS---notably NADH~\cite{Forsyth1999NADH}, CoQ10+NADH~\cite{CastroMarrero2021fatigue}, and acetyl-L-carnitine~\cite{Vermeulen2004carnitine}. Most evidence for other supplements derives from mechanistic reasoning, related-condition trials, or patient surveys with inherent reporting bias.
