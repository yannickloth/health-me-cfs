...
Direct measurement of neuroinflammatory activity in ME/CFS and Long COVID via dual PET-MRI is currently underway, with preliminary pilot data from existing PET studies suggesting elevated microglial activation in multiple brain regions~\cite{Nakatomi2014}, and ongoing work aiming to establish the causal relationship between glial activation and objective cognitive impairment~\cite{VanElzakker2024NeuroinflammationProject}.
