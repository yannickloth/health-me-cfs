...
Emerging research by Wirth and Scheibenbogen (2025) provides a mechanistic framework linking gut dysbiosis to central serotonergic dysfunction through the enterochromaffin-vagal pathway. This pathway offers a novel perspective on serotonin regulation in ME/CFS:
...
\begin{itemize}
    \item Gut dysbiosis with reduced butyrate-producing bacteria is well-documented in ME/CFS~\cite{Shukla2021microbiome}
    \item Enterochromaffin cells require butyrate as a substrate for serotonin synthesis
    \item Vagal tone (measured by HRV) is consistently reduced in ME/CFS patients
