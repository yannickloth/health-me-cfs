...
While tissue hypoxia affects multiple organs, the brain is particularly vulnerable to perfusion deficits during orthostatic challenge. Van Campen et al.\ demonstrated that ME/CFS patients show reduced cerebral blood flow during head-up tilt testing even in the absence of hypotension or tachycardia, suggesting intrinsic cerebrovascular dysregulation beyond simple hemodynamic failure~\cite{VanCampenEtAl2020}. Transcranial Doppler measurements of middle cerebral artery blood flow velocity during tilt reveal reductions of 20--30\% in ME/CFS patients compared to healthy controls.

The cognitive symptoms during orthostatic stress---including brain fog, difficulty concentrating, and word-finding problems---correlate with the degree of cerebral hypoperfusion. Patients often report that cognitive function worsens progressively during prolonged standing and improves rapidly upon assuming a recumbent position. This positional dependence of cognitive symptoms provides clinical evidence for the cerebrovascular contribution to ME/CFS neurological dysfunction.
