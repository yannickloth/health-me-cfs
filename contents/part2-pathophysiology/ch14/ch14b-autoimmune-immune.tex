...
\begin{itemize}
    ...
    \item All treatment trials to date (immunoadsorption n=10, n=20; daratumumab n=10; BC007 case reports) are open-label without placebo control. The 60--70\% response rates cannot be distinguished from placebo effect, regression to the mean, or natural fluctuation without randomised controlled trials.
    \item The BC007 Phase~II trial---the only placebo-controlled study of autoantibody-targeted therapy---failed to show superiority over placebo, directly challenging the therapeutic hypothesis despite positive case reports.
\end{itemize}
\end{limitation}
\revend
