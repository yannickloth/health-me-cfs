...
% NOTE: POTS/dysautonomia is a core component of the Septad framework (Section~\ref{sec:septad}).
% See Chapters~\ref{ch:neurological} and~\ref{ch:cardiovascular} for detailed autonomic
% pathophysiology, and Chapter~\ref{ch:translational-findings} for POTS-MCAS-EDS mechanistic links.
...
% NOTE: MCAS is a core component of the Septad framework (Section~\ref{sec:septad}), which
% organizes seven frequently co-occurring conditions in ME/CFS. See Chapter~\ref{ch:translational-findings}
% for MCAS-dysautonomia-vascular mechanisms, and treatment chapters (ch14a, ch14b) for
...
% NOTE: Autoimmunity is one component of the Septad framework (Section~\ref{sec:septad}).
% See treatment chapters (ch14a, ch14b) for autoimmune screening recommendations in ME/CFS patients.
...
% NOTE: EDS/hypermobility is a core component of the Septad framework (Section~\ref{sec:septad}).
% The hEDS-POTS-MCAS triad is well-recognized clinically. See Chapter~\ref{ch:translational-findings}
% for mechanistic connections (β2-receptor dysfunction, vascular pathology), and treatment
% chapters (ch14a, ch14b) for screening protocols and CCI evaluation criteria.
