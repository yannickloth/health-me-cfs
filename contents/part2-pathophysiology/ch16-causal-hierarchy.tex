...
Once a patient reaches the final common pathway, the amplifier mechanisms described in Section~\ref{sec:amplifiers} engage and lock the disease state. The entry door no longer matters because the amplifiers maintain the disease independently of the triggering mechanism. This is why the triggering event is often years in the past by the time patients seek treatment, yet the disease persists: the locks are self-sustaining.
