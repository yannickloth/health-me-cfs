...
The gut microbiome controls >90\% of tryptophan metabolism, producing serotonin precursors, kynurenine pathway metabolites, and indole derivatives. ME/CFS patients show disrupted tryptophan pathways:
\begin{itemize}
    \item Reduced circulating tryptophan affecting serotonergic neurotransmission
    \item Altered kynurenine pathway metabolites (associated with neuroinflammation)
    \item Disrupted indole derivative production (aryl hydrocarbon receptor ligands)
    \item Potential connection to depression, fatigue, and cognitive dysfunction
\end{itemize}
...
\begin{itemize}
    ...
    \item Bidirectional dysfunction: brain inflammation degrades gut function; gut dysfunction worsens neurological symptoms. The temporal and causal relationships between gut and brain dysfunction in ME/CFS remain unresolved; longitudinal studies are needed to determine which comes first or whether both result from a common upstream cause
\end{itemize}
...
\begin{itemize}
    \item \textbf{Serotonin}: $>$90\% of body's serotonin produced in gut; some studies suggest reduced serotonin metabolism in ME/CFS, though evidence is mixed
...
\begin{itemize}
    ...
    \item \textbf{41\% SIBO-positive}
    \item 45\% SIBO-negative
    \item 14\% equivocal
    \item \textbf{When excluding equivocal results: 48\% positive} (152/316)
...
\begin{itemize}
    ...
    \item \textbf{MCAS} (Section~\ref{sec:septad}): Mast cells in gut mucosa affect motility; SIBO may trigger mast cell activation; mast cell mediators alter intestinal permeability
