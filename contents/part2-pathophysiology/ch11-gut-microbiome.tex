...
\begin{itemize}
    ...
    \item \textbf{Glutathione deficiency}: Shungu et al.~\cite{Shungu2012} demonstrated reduced cortical glutathione in ME/CFS with correlation to physical functioning; pilot NAC supplementation normalized glutathione levels
\end{itemize}
