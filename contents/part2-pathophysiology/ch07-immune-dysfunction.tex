...
Recent work by Wirth and Scheibenbogen (2025)~\cite{WirthScheibenbogen2025Neurotransmitter} on the enterochromaffin-vagal pathway provides novel insights into gut-immune-brain interactions that may influence autoimmune processes in ME/CFS. The full mechanistic evidence chain---butyrate-enterochromaffin serotonin-vagal signalling---is developed in Section~\ref{sec:gut-brain} of Chapter~\ref{ch:gut-microbiome}; here we focus on its immune dysregulation implications:
