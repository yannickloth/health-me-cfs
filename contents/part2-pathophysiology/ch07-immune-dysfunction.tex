...
\begin{hypothesis}[Exhausted Immune Surveillance Phenotype]
\label{hyp:exhausted-surveillance}
...
\begin{hypothesis}[Infection-Induced Irreversible Damage: The Ratchet Model]
\label{hyp:infection-damage-ratchet}
...
Recent work by Wirth and Scheibenbogen (2025)~\cite{WirthScheibenbogen2025Neurotransmitter} on the enterochromaffin-vagal pathway provides novel insights into gut-immune-brain interactions that may influence autoimmune processes in ME/CFS. This pathway connects gut dysbiosis to autonomic dysfunction and potentially to immune dysregulation:

\begin{hypothesis}[Enterochromaffin-Vagal Pathway in ME/CFS Autoimmunity]
\label{hyp:enterochromaffin-autoimmune}
...
\begin{hypothesis}[Autoantibody Inefficiency Hypothesis]
\label{hyp:autoantibody-inefficiency}
...
\begin{itemize}
    \item \textbf{Prevalence}: Estimates range from 25.3\%~\cite{Frioni2024MCAS} to 30--50\%~\cite{Wirth2023} of ME/CFS patients meeting MCAS criteria or exhibiting clinically relevant mast cell activation.

    \item \textbf{Progressive involvement}: Mast cell activation prevalence \textbf{increases over the disease course}~\cite{Frioni2024MCAS}, suggesting that chronic energy deficit may progressively impair mast cell regulation.

    \item \textbf{Orthostatic overlap}: Patients with both MCAS and orthostatic intolerance (particularly POTS) show significantly higher treatment response rates to mast cell-directed therapy compared to OI alone ($p<0.0001$)~\cite{Wirth2023,Frioni2024MCAS}.
...
Links between allergy and ME/CFS~\cite{Wirth2023,Frioni2024MCAS}:
\begin{itemize}
