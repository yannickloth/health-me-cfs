...
Belgium has an official RIZIV/INAMI convention for ME/CVS diagnosis and treatment, running until 2028. The convention provides reimbursement for multidisciplinary diagnosis and cognitive behavioral therapy (CBT).
...
As of 2024, this is the only center in Belgium with an official RIZIV/INAMI convention for ME/CVS. The center provides multidisciplinary diagnostic assessment and, if ME/CVS is confirmed, develops a care trajectory in collaboration with the patient's GP. Referral must come from a GP who suspects ME/CVS.
\end{description}

\begin{remark}[RIZIV/INAMI Convention Details]
