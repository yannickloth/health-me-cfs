...
%===============================================================================
\section{Medication Information Sources}
\label{sec:medication-resources}
%===============================================================================
...
\begin{description}
\item[PubMed] \hfill \url{https://pubmed.ncbi.nlm.nih.gov/}
...
\item[DailyMed] \hfill \url{https://dailymed.nlm.nih.gov/}
...
\item[PubChem] \hfill \url{https://pubchem.ncbi.nlm.nih.gov/}
...
\subsection{Other Recommended Sources}

Not linked per-drug in tooltips, but valuable for independent research:

\begin{itemize}
\item \textbf{DrugBank:} \url{https://go.drugbank.com/} --- Free online database with drug-target interactions, metabolism pathways, and pharmacokinetics. Requires login for full data access.
\item \textbf{Cochrane Library:} \url{https://www.cochranelibrary.com/} --- Independent systematic reviews and meta-analyses of healthcare interventions. Summaries freely accessible in many countries.
\end{itemize}

\subsection{Searching for a Specific Medication}
...
\begin{itemize}
\item \textbf{LDN:} Searched as ``Naltrexone'' (low-dose naltrexone is an off-label regimen of the standard drug)
\item \textbf{IVIG / SCIG:} PubMed searched as ``Immunoglobulins, Intravenous'' (MeSH); no PubChem compound entry (mixture)
\item \textbf{THC:} PubChem as ``Tetrahydrocannabinol,'' PubMed MeSH as ``Dronabinol''
\item \textbf{SkQ1, DCA, DMF:} Experimental compounds; PubChem uses chemical names: ``Dichloroacetic acid,'' ``Dimethyl fumarate''; SkQ1 has no PubChem entry
\end{itemize}
