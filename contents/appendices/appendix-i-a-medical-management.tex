...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item Joint pain (knees/shoulders): \textbf{9/10 --- severe throughout day, from morning onward}
        \begin{itemize}
            \item Patient description: \emph{``joints were really painful, the kind where you just want it gone in any possible way''}
            \item Pain present from morning; worsened during crash window
    ...
    \begin{itemize}
        ...
        \item \textbf{Onset}: Joint pain present from morning; crash occurred midday
        \item \textbf{Severity}: Unable to remain awake; overwhelming exhaustion
        \item \textbf{Joint pain as primary feature}: Extreme intensity suggesting inflammatory/cytokine component
    \end{itemize}
    \item[Observations:]
    \begin{itemize}
