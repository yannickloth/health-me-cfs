...
\begin{description}
    \item[Principal Investigator:] Bhupesh K.\ Prusty (senior), Zhihang Liu (first author)
    \item[Institution:] Multi-centre
    \item[Funder:] Institutional
    \item[Status:] Published February 2026
    \item[Phase:] Observational (in vitro)
    \item[Cohort:] ME/CFS (n=39--40), post-COVID ME/CFS (n=15--16), healthy controls (n=39--41), MS controls (n=11--20), systemic sclerosis (n=21)
    \item[Mechanism/Focus:] Isolated IgG complexes from ME/CFS patient
        ...
        ME/CFS-derived IgG induces mitochondrial fragmentation while maintaining ATP production (stress adaptation rather than energy collapse), triggers IL-1$\beta$ secretion, and produces disease-specific proteomic signatures: post-COVID IgG enriched in hemostasis/clotting pathways, classic ME/CFS in extracellular matrix remodelling pathways.
    \item[Primary Outcomes:] IgG from ME/CFS patients causes mitochondrial fragmentation in endothelial cells; effect predominantly in female patients; maintained spare respiratory capacity with glycolytic compensation
    \item[Estimated Completion:] Published
    \item[Publication Medium:] \textit{Brain, Behavior, and Immunity -- Health}
    \item[Document Relevance:] Ch.~6 (energy metabolism), Ch.~7 (immune
...
epiphenomenal~\cite{Liu2026IgGcomplexes}.  If replicated with purified IgG
