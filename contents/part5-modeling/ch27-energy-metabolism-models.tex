...
Post-exertional malaise (PEM) is the hallmark symptom of ME/CFS: the persistence and accumulation of post-exertion byproducts --- metabolic waste, inflammatory mediators, oxidative damage --- that healthy physiology clears within hours but ME/CFS physiology cannot, producing delayed and disproportionate symptom worsening. The energy metabolism model provides a mechanistic framework for PEM. During exertion, ATP demand increases:
