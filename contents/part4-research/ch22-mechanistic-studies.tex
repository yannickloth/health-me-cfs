...
\begin{itemize}
    \item The study enrolled only 17 post-infectious ME/CFS patients against an original target of 40; recruitment was halted due to COVID-19. At n=17 vs.\ 21 controls, many comparisons are underpowered and findings may not generalise.
    ...
    \item The use of ``effort preference'' to describe grip strength findings generated legitimate scientific controversy; whether the framing reflects unconscious neural computation (as the authors clarified) or introduces psychologising bias into objective data remains unresolved.
