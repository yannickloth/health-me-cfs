...
The research infrastructure proposals in this chapter---the ME/CFS Human Phenome Project, the Recovery Potential Index, the Crash Impact Biomarker panel, and the ME/CFS Digital Twin---are conceptual frameworks, not funded or operational programmes. Key boundaries:
\begin{itemize}
    \item No component of the Recovery Potential Index (epigenetic age acceleration, naïve T cell proportion, telomere length, HSC clonality, HRV, metabolic flexibility) has been validated as a predictor of ME/CFS recovery; the index is a hypothesis about what \emph{might} predict recovery, not an established tool.
