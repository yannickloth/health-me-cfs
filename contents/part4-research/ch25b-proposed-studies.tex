...
The rituximab story illustrates this principle with particular clarity. In the phase~II trial by Fluge and colleagues~\cite{Fluge2011}, 10 of 15 rituximab-treated patients (67\%) showed a clinical response, a B-cell depleting monoclonal antibody, with improvements in function and symptoms. This result motivated a large phase~III trial, RituxME, enrolling 151 unstratified patients.
...
An umbrella trial structures itself inversely: multiple treatments are tested simultaneously within ME/CFS, with patients stratified into matched treatment cohorts according to their biomarker profile. A single master protocol might randomize autoantibody-positive patients to immunoadsorption versus placebo, metabolically-dysregulated (ME-M2/M3 phenotype) patients to mitochondrial-targeted agents versus placebo, and others to immunomodulatory interventions. Each treatment arm targets a distinct biomarker-defined subgroup, maximizing the relevance of comparisons.
...
\begin{enumerate}
    ...
    \item \textbf{Metabolic phenotype}: Using the ME-M classification (ME-M1: preserved mitochondrial respiratory chain; ME-M2: mild dysregulation; ME-M3: severe dysregulation) to assign metabolic interventions to appropriate subgroups
...
This approach directly addresses the rituximab failure: early interim analysis would have identified B-cell seropositivity as a predictor of response, allowing enrichment in phase 2.
...
\begin{enumerate}
    ...
    \item \textbf{Enormous individual variation:} Patients show stark differences in what worsens versus improves symptoms, making population averages less informative than individual response profiles
    \item \textbf{Behavioral and psychosocial sensitivity:} Some interventions (e.g., cognitive exertion, social engagement) benefit from unblinded trials; N-of-1 designs eliminate the need for between-subject comparison
