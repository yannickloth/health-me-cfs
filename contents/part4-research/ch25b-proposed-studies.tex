...
Implementation requires identification of a principal investigator and institutional home with research infrastructure and expertise in neuroimaging, exercise physiology, and ME/CFS patient populations. The full detailed proposal (50+ pages) includes complete methods, statistical analysis plan, regulatory considerations, and appendices, and is available in the project staging area (see \texttt{content-staging/research-proposal-selective-dysfunction.md}).
