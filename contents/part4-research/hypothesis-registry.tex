...
\caption{Cross-document hypothesis and open question registry (59 key entries).
...
Post-Parasitic Kynurenine Shunt: IDO1 as Sustained Neuroinflammatory Driver
(\ref{hyp:parasite-ido1-kynurenine})
&
S & 0.35
&
(a) Serum kynurenine/tryptophan ratio elevated in Bergen cohort ME/CFS vs non-ME/CFS exposed at 5 and 10 years.
(b) H3K4me3 enrichment at \textit{IDO1} promoter in intestinal macrophage biopsies
greater in post-Giardia ME/CFS patients than controls.
(c) IDO1 inhibitors (e.g., epacadostat) reduce kynurenine/tryptophan ratio and improve
cognitive symptoms in post-parasitic ME/CFS.
&
Serum kynurenine/tryptophan measurement; histone modification ChIP-seq in gut
biopsies; IDO1 inhibitor proof-of-concept trial in post-parasitic cohort.
Technically sophisticated; achievable in specialist laboratory.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Molecular Mimicry: Giardia VSPs and Autonomic Receptor Autoimmunity
(\ref{hyp:giardia-molecular-mimicry})
&
S & 0.30
&
(a) Anti-muscarinic and anti-$\beta$2-adrenergic receptor autoantibodies elevated
in Bergen cohort ME/CFS vs non-ME/CFS exposed and unexposed.
(b) VSP structural homology to human GPCR epitopes detectable by computational
proteomics (BLAST, HHpred) at $E$-value $\leq 1 \times 10^{-4}$.
(c) Immunoadsorption produces clinical improvement in post-Giardia ME/CFS patients
with confirmed elevated GPCR autoantibodies.
&
Autoantibody ELISA (muscarinic, $\beta$2-adrenergic receptors); computational
epitope homology screening; immunoadsorption trial in autoantibody-positive subgroup.
Methods available; Bergen cohort data accessible.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Secretory IgA Deficiency as ME/CFS Conversion Risk Factor
(\ref{oq:siga-parasite-mecfs})
&
OQ & ---
&
(a) Selective or partial secretory IgA (sIgA) deficiency more prevalent in
Bergen Giardia exposed who converted to ME/CFS vs non-converters.
(b) Sub-clinical mucosal IgA insufficiency predisposes to prolonged infection
and intense immune priming.
(c) sIgA-restorative interventions (colostrum, targeted probiotics) prevent
ME/CFS development in high-risk exposed individuals.
&
Serum IgA and secretory IgA measurement in Bergen cohort ME/CFS vs non-converters
(low cost); mucosal IgA assessment in biopsies; sIgA-augmentation intervention trial.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Early Parasite Eradication as ME/CFS Prevention
(\ref{oq:parasite-prevention})
&
OQ & ---
&
(a) Proportion of ME/CFS cases in Bergen cohort receiving timely, confirmed
giardia eradication therapy.
(b) Treatment timing correlates with chronic outcome (ME/CFS development vs.\ recovery).
(c) Prospective early-treatment arm shows lower ME/CFS incidence than delayed-treatment arm.
&
Retrospective cohort analysis of Bergen follow-up data stratified by treatment timing;
prospective study tracking ME/CFS development after documented parasitic infection
with early vs.\ delayed treatment arms.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Systematic Parasite Screening in ME/CFS Evaluation
(\ref{oq:parasite-screening})
&
OQ & ---
&
(a) Prevalence of \textit{Blastocystis}, \textit{Dientamoeba fragilis}, and other
intestinal protozoa elevated in ME/CFS vs.\ healthy controls (PCR-based multiplex testing).
(b) Treatment of symptomatic carriers with GI phenotype improves ME/CFS outcomes.
(c) Diagnostic accuracy of PCR-based screening exceeds standard ova and parasite microscopy.
&
Cross-sectional prevalence study using sensitive PCR-based multiplex stool testing
in ME/CFS cohort vs.\ controls; treatment trial in PCR-positive symptomatic carriers;
sensitivity/specificity comparison (PCR vs.\ microscopy).
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Mucosal Checkpoint Failure: GALT NK Depletion Permits Autoreactive Escape
(\ref{spec:galt-checkpoint-failure})
&
S & 0.20
&
(a) GALT NK cell counts (intestinal biopsy) are lower in post-Giardia ME/CFS
patients vs recovered Giardia-exposed controls.
(b) A broader panel of autoantibodies (ANA, anti-thyroid, anti-GPCR) is
elevated in post-Giardia ME/CFS vs post-Giardia non-CFS.
(c) Reconstitution of mucosal NK cell function reduces autoantibody titres
in a relevant animal model.
&
Intestinal biopsy for NK cell quantification; autoantibody ELISA panels
(ANA, anti-thyroid, anti-GPCR receptors); animal model NK reconstitution
trial. Requires specialist intestinal immunophenotyping.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Post-Parasitic Mast Cell Priming as MCAS--ME/CFS Overlap Driver
(\ref{spec:parasite-mcas-priming})
&
S & 0.20
&
(a) Serum tryptase and urinary prostaglandin D$_2$ metabolites are elevated
in post-Giardia ME/CFS patients vs post-Giardia non-CFS and unexposed controls.
(b) The proportion of ME/CFS patients meeting MCAS criteria is higher among
those with post-parasitic onset than among those with post-viral onset.
(c) H1/H2 antihistamine + cromolyn sodium trial produces symptom improvement
specifically in post-parasitic ME/CFS patients with elevated baseline tryptase.
&
Serum tryptase and urinary mast cell mediator measurement; cross-cohort MCAS
prevalence comparison (parasitic vs.\ viral onset); H1/H2 antihistamine +
cromolyn sodium proof-of-concept trial in elevated-tryptase subgroup.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Duodenal Microbiome Disruption as Sustaining Mechanism in Post-Parasitic ME/CFS
(\ref{oq:duodenal-microbiome})
&
OQ & ---
&
(a) Duodenal microbiome composition is persistently altered in post-Giardia
ME/CFS patients vs recovered controls (reduced butyrate-producers, increased
gram-negative bacteria).
(b) Persistent low-grade LPS translocation from small intestine detectable
in blood endotoxaemia assays.
(c) Microbiome restoration via targeted intervention reduces systemic
inflammation and improves ME/CFS outcomes in post-parasitic patients.
&
Duodenal aspirate or proximal jejunal biopsy for 16S/metagenomic sequencing;
endotoxin detection assays; small-bowel microbiome restoration intervention
trial. Requires endoscopic access; methods available in specialist centres.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Bergen Biobank Recontact: Maximising the Natural Experiment
(\ref{oq:bergen-biobank-recontact})
&
OQ & ---
&
(a) GPCR autoantibody panels, duodenal epigenetic profiles, small intestinal
microbiome, serum tryptase, and secretory IgA levels can be measured in
recontacted Bergen cohort survivors.
(b) Recontact biomarker findings correlate with ME/CFS development status
(PI-CFS vs.\ non-CFS exposed controls).
(c) Cross-sectional recontact study simultaneously tests multiple mechanistic
hypotheses at low marginal cost.
&
Biobank recontact study with cross-sectional sampling: serum GPCR autoantibodies,
duodenal biopsy for H3K4me3 ChIP-seq, small-bowel microbiome, serum tryptase,
secretory IgA. Cohort already characterised; recontact logistically feasible.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]

Cryptosporidium Long-Term Cohort Study: Generalising Beyond Giardia
(\ref{oq:cryptosporidium-longitudinal})
&
OQ & ---
&
(a) ME/CFS conversion rate following Cryptosporidium parvum outbreak is
measurable using Bergen-style longitudinal cohort design.
(b) Immunological profile (NK cells, sCD40L, antigen-specific responses)
in post-Cryptosporidium ME/CFS recapitulates or differs from post-Giardia findings.
(c) Results generalise mechanistic hypotheses across two apicomplexan
protozoan species.
&
Prospective cohort following documented Cryptosporidium outbreak for 3--10 years
with formal ME/CFS diagnostic ascertainment, immunophenotyping, and
microbiome analysis. Cryptosporidium outbreaks recurrent in Europe and North
America; opportunistic prospective design feasible.
&
Ch.\,7 \S\ref{sec:parasites-post-infectious} \\[6pt]
...
% ---- New entries added 2026-04-07 ----

\hline
OQ & --- &
\textbf{oq:earthing-autonomic} --- \emph{Earthing and Autonomic Modulation: Does Any Effect Persist Beyond Relaxation?}
If earthing genuinely shifts autonomic tone toward parasympathetic dominance (as claimed), this would be relevant to ME/CFS sympathetic excess. All existing evidence is COI-contaminated; no independent replication; no ME/CFS trial. Requires: sham-controlled crossover HRV study in ME/CFS patients.
&
Sham-controlled crossover sleep study: grounded vs ungrounded mats, continuous HRV monitoring, n$\geq$40 ME/CFS patients.
&
Ch.\,18 \S\ref{sec:earthing-grounding} \\[6pt]

\hline
OQ & --- &
\textbf{oq:smO2-pacing} --- \emph{SmO₂-Guided Pacing: Can Real-Time Muscle Oxygenation Data Improve PEM Prevention?}
Heart-rate pacing is indirect. Real-time SmO₂ (Moxy Monitor or similar) could provide a more direct anaerobic threshold signal for PEM prevention in ME/CFS. NIRS-documented muscle O₂ abnormalities are well-established (McCully 1999, Miller 2015, Colosio 2023) but no SmO₂-pacing trial exists.
&
...
&
Ch.\,18 \S\ref{sec:nirs-moxy-pacing} \\[6pt]

% ---- New entries added 2026-04-10 (vascular pathology integration) ----

\hline
H & 0.40 &
\textbf{hyp:endothelial-senescence-loop} --- \emph{Senescent Endothelial Cell Burden as a Central Maintaining Mechanism}
Virus-induced endothelial senescence and the consequent SASP create a self-perpetuating pathological state. NK cell and T cell dysfunction in ME/CFS prevent senescent cell clearance, establishing a bidirectional amplifying loop between immune dysfunction and endothelial SASP.
Tissue-specific distribution maps to symptom clusters (BBB→brain fog; skeletal muscle→PEM; gut→GI symptoms).
Implies senolytics (dasatinib+quercetin) as rational target; explains prior immunotherapy failures.
Nunes et al.\ Cell Death \& Disease 2026.
&
Skeletal muscle or skin punch biopsy: p21, p16INK4a, SA-$\beta$-galactosidase in capillary endothelial cells.
Plasma SASP markers (GDF-15, PAI-1, syndecan-1) correlating with severity.
Senolytic pilot trial: SASP markers, FMD, EndoPAT, and symptom scores.
NK cytotoxicity restoration associated with reduced circulating SASP markers.
&
Ch.\,7 (Immune Ch.); Ch.\,10 (Cardiovascular Ch.) \\[6pt]

\hline
H & 0.45 &
\textbf{hyp:vascular-primary-mecfs} --- \emph{Vascular Pathology as the Primary Initiating Event in ME/CFS}
Early post-COVID syndrome is dominated by microvascular disturbance; mitochondrial structural damage appears later and selectively in ME/CFS patients. Proposed chain: capillary hypoperfusion → ischaemia/reperfusion → Na+/H+ exchange → Na+ overload → NCX1 reversal → mitochondrial Ca2+ toxicity → structural mitochondrial damage (AIMM). Structural capillary changes (collagen IV deposition), cell-autonomous RBC hypoxia-sensing failure, and interventional evidence (pyridostigmine) all support vascular primacy.
Scheibenbogen \& Wirth 2024; Guo et al.\ 2025; Joseph et al.\ 2022.
&
Prospective biopsy series: vascular markers before mitochondrial changes in early post-COVID.
Vascular-targeted early intervention (sulodexide) reducing ME/CFS incidence in post-COVID cohort.
Targeted fibrinolysis normalising mitochondrial energetics in patients with demonstrable capillary obstruction.
&
Ch.\,6 (Energy Ch.); Ch.\,10 (Cardiovascular Ch.); Ch.\,10 (Cardiovascular Ch.) \\[6pt]

\hline
H & 0.30 &
\textbf{hyp:failed-angiogenesis-mecfs} --- \emph{Failed Angiogenic Compensation as the ME/CFS Transition Mechanism}
Post-COVID serum retains angiogenic tube formation capacity (compensatory vascular repair); ME/CFS serum specifically loses this capacity. Failed angiogenic compensation may be the biological transition point: post-COVID patients who retain vascular repair recover; those who lose it progress to ME/CFS.
Flaskamp et al.\ Cells 2022.
&
Longitudinal angiogenic serum activity before and after ME/CFS development in post-COVID cohort.
Angiogenic capacity correlating inversely with capillary basement membrane thickness on biopsy.
Pro-angiogenic interventions reducing ME/CFS development in at-risk post-COVID patients.
&
Ch.\,10 (Cardiovascular Ch.); Ch.\,10 (Cardiovascular Ch.) \\[6pt]

\hline
H & 0.30 &
\textbf{hyp:glycocalyx-pacing-device} --- \emph{The Glycocalyx as a Molecular Pacing Device}
Glycocalyx mechanosensing via heparan sulphate chains activates eNOS and calibrates local blood flow to metabolic demand. Glycocalyx degradation in ME/CFS (via SASP sheddases) impairs this flow-demand coupling, producing disproportionate post-exertional symptoms at low absolute workloads — not mitochondrial failure but broken blood flow regulation.
&
Intra-exercise flow-mediated dilation (Doppler during ergometry) blunted in ME/CFS.
Syndecan-1 shedding correlating with VE/VCO$_2$ slope on CPET.
Glycocalyx restoration normalising exercise vasodilation response.
&
Ch.\,14k (Speculative Hyp. Ch.) \\[6pt]

\hline
H & 0.30 &
\textbf{hyp:rbc-ps-microclot-nucleation} --- \emph{RBC Phosphatidylserine Externalisation as Microclot Nucleation Signal}
ME/CFS RBCs under oxidative stress externalise phosphatidylserine (PS), directly activating platelets and promoting fibrin polymerisation on the RBC surface, continuously nucleating fibrinaloid microclots. PS externalisation on ME/CFS RBCs has not been directly measured.
&
Annexin-V binding to ME/CFS RBCs correlating with microclot area in same patient sample.
&
Ch.\,14k (Speculative Hyp. Ch.) \\[6pt]

\hline
S & 0.20 &
\textbf{hyp:hypocapnia-microclot-loop} --- \emph{Orthostatic Hypocapnia as a Positive Feedback Loop for Microclot Formation}
Orthostatic hypocapnia (alkalosis) activates coagulation factors and inhibits tPA, reducing fibrinolytic capacity. Each orthostatic episode incrementally adds to microclot burden, progressively worsening capillary obstruction. Over months to years this could explain progressive capillary basement membrane thickening.
&
Tilt-induced pH correlating with post-tilt microclot burden in within-patient comparison.
&
Ch.\,14k (Speculative Hyp. Ch.) \\[6pt]

\hline
S & 0.25 &
\textbf{spec:carotid-body-mecfs} --- \emph{Carotid Body Sensitisation as a Reversible Amplifier of Orthostatic Intolerance}
If Long COVID carotid body sensitisation (El-Medany 2024: HVR 145\% elevated, n=14) extends to ME/CFS, it would amplify orthostatic hypocapnia → CBF reduction → cognitive OI symptoms beyond what cardiac preload failure alone predicts. Gefapixant (P2X3 antagonist) would be the pharmacological test.
&
HVR measurement in ME/CFS cohorts (replicate El-Medany protocol).
HVR correlating with orthostatic PETCO$_2$ fall and OI severity.
Gefapixant attenuating orthostatic hypocapnia in n-of-1 crossover.
&
Ch.\,18 (Emerging Therapies Ch.) \\[6pt]

\hline
OQ & --- &
\textbf{oq:senolytics-mecfs-trial} --- \emph{Senolytics in ME/CFS: Dasatinib + Quercetin Pilot Trial}
Intermittent D+Q (100/1000 mg, 2 days/month, 3 months) targeting senescent endothelial cell burden in post-infectious ME/CFS. Primary endpoint: SASP markers (GDF-15, IL-6, syndecan-1). Secondary: EndoPAT, 6MWT, SF-36 vitality, CPET peak VO$_2$. Feasibility trial that generates mechanistic and safety data.
&
Needs: senolytic pharmacologist collaborator; baseline SASP marker stratification; BCR-ABL inhibitor safety monitoring (CBCs).
&
Ch.\,14k (Speculative Hyp. Ch.) \\[6pt]

\hline
OQ & --- &
\textbf{oq:glycocalyx-prevention-trial} --- \emph{Glycocalyx Restoration as Prevention: Early Post-COVID Sulodexide Intervention}
Enroll COVID-19 patients within 4 weeks of infection with syndecan-1 $>$30 ng/mL. Sulodexide 500 LSU daily for 90 days vs.\ placebo. Primary outcome: ME/CFS incidence at 6 months. Tests vascular-primary causal hypothesis and provides clinical prevention data simultaneously.
&
Feasible with existing infrastructure; sulodexide approved; syndecan-1 as enrichment biomarker is established.
&
Ch.\,14k (Speculative Hyp. Ch.) \\[6pt]
...
The complete document contains approximately \textbf{323 environments} of the
