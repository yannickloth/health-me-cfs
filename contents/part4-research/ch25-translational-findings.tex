...
\midrule
GPCR autoantibodies & 29.5--91\% prevalence~\cite{Scheibenbogen2018immunoadsorption} & $\beta$2-AR, M3 autoantibodies detected \\
...
\begin{enumerate}
    ...
    \item \textbf{Immunoadsorption for GPCR Autoantibodies}: 70\% response rate in a pilot study (n=10) of ME/CFS patients with elevated $\beta$2-adrenergic receptor autoantibodies~\cite{Scheibenbogen2018immunoadsorption}.
