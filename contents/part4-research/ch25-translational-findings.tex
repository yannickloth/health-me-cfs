...
\begin{enumerate}
    ...
    \item \textbf{Autoantibody Screening}: GPCR autoantibodies (β2-AR, M3/M4) documented in 29.5--91\% of ME/CFS patients may also occur in PTLDS if post-infectious autoimmunity is involved.
...
\begin{enumerate}
    ...
    \textbf{ME/CFS Finding}: β2-adrenergic, M3/M4 muscarinic receptor autoantibodies found in 29.5--91\%, correlating with autonomic and cognitive symptoms.
...
\begin{enumerate}
    ...
    \textbf{Established in Neurodegenerative Disease}: Glymphatic system clears amyloid-β and tau during sleep; dysfunction accelerates Alzheimer's pathology.
...
\textbf{Prevalence}:
\begin{itemize}
    \item \textbf{β2-adrenergic receptor}: 29.5--91\% of ME/CFS patients (prevalence varies by assay, cutoff)
    \item \textbf{M3/M4 muscarinic receptors}: Elevated in subset
    \item \textbf{α1-adrenergic receptor}: May contribute to vascular dysfunction
\end{itemize}
...
\textbf{β2-Adrenergic receptor autoantibodies}:
\begin{itemize}
...
\textbf{α1-Adrenergic receptor autoantibodies}:
\begin{itemize}
...
\textbf{POTS}: β2-AR autoantibodies could explain tachycardia, exercise intolerance, and autonomic failure in subset of POTS patients
...
\begin{enumerate}
    \item \textbf{Immunoadsorption}: 70\% response rate in ME/CFS with elevated β2-AR autoantibodies; removes autoantibodies selectively
...
\begin{itemize}
    \item Amyloid-β (accumulates in Alzheimer's disease)
...
\begin{itemize}
    \item Amyloid-β accumulation directly linked to impaired glymphatic clearance
...
\begin{itemize}
    ...
    \item \textbf{Vitamin C}: 1000--2000mg/day (cofactor for dopamine β-hydroxylase)
...
\begin{itemize}
    ...
    \item \textbf{Copper}: 2mg/day (cofactor for dopamine β-hydroxylase; only if deficient)
...
\begin{enumerate}
    ...
    \item \textbf{NF-κB inhibition}: Curcumin, resveratrol
...
\begin{itemize}
    ...
    \item \textbf{Alpha-lipoic acid}: 600mg/day (NF-κB inhibition, crosses BBB)
\end{itemize}
