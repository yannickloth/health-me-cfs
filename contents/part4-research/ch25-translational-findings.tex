...
\begin{enumerate}
    ...
    \item \textbf{Mitochondrial ATP Depletion}: Multiple ME/CFS studies show impaired ATP production, early lactate accumulation, and elevated acylcarnitines indicating impaired fatty acid oxidation~\cite{Naviaux2016metabolomics,Syed2025}.
...
\begin{enumerate}
    ...
    \textbf{ME/CFS Finding}: Oxidative stress markers elevated; peroxynitrite formation damaging cellular components~\cite{Syed2025}.
