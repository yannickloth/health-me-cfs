...
\begin{itemize}
    ...
    \item The framework's reliance on the Heng 2025 7-biomarker panel as validation of multi-system coordination rests on a single study that has not been independently replicated.
\end{itemize}
\end{limitation}
\revend
