...
Fisher et al.\ (2002) documented four adolescents with both CFS and an eating disorder; in all four cases the eating disorder preceded the CFS diagnosis, suggesting that eating disorders may predispose to or unmask ME/CFS in susceptible individuals---or that the chronological sequence of diagnoses reflects diagnostic delay in ME/CFS rather than causal precedence~\cite{Fisher2002cfs-ed}. Comorbid cases require management of both conditions simultaneously, which is particularly challenging because standard eating disorder treatments may be contraindicated in ME/CFS.
