...
\begin{itemize}
    \item GPCR autoantibody panel ($\beta_2$-adrenergic, M3/M4 muscarinic)
...
\begin{itemize}
    \item Heng 7-biomarker panel (AMP, ADP, VWF, fibronectin, TSP-1, PDGF-BB, TGF-$\beta$3) when commercially available
...
\begin{itemize}
    ...
    \item Reduction in VO$_2$max, ventilatory threshold on Day 2 is diagnostic
\end{itemize}
