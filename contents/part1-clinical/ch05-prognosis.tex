...
The dramatic difference between pediatric (54--94\% improve or fully recover) and adult ($\leq$22\% improve) outcomes suggests that biological factors related to developmental plasticity may facilitate recovery in young patients, or that adults face barriers to recovery not present in children.
...
\begin{itemize}
    \item Mean age at death: 52.5--55.9 years
    \item General population mean age at death: 73.5 years
    \item Difference: Approximately 20 years of lost life expectancy
\end{itemize}

These figures must be interpreted with extreme caution due to selection bias in memorial records (deaths are more likely to be reported for severe cases and younger patients). Population-based mortality studies are urgently needed to establish true mortality patterns in ME/CFS.
