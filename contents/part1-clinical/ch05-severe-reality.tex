...
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!75!black,title=Research Finding: Quality of Life Comparison]
\textbf{ME/CFS had the lowest quality of life of all 20 chronic conditions studied}---worse than multiple sclerosis, worse than stroke, worse than cancer.
...
ME/CFS is not merely disabling---it is deadly. A 2016 analysis of mortality patterns found that ME/CFS patients die, on average, \textbf{18 years earlier} than the general population \cite{McManimen2016}:
...
Updated 2025 data confirms these grim statistics, finding a mean age at death of 52.5 years and suicide accounting for 25.4\% of deaths \cite{Sirotiak2025}. The three leading causes of death in ME/CFS are: complications of the disease itself (28.3\%), suicide (25.4\%), and cancer (23.0\%).
