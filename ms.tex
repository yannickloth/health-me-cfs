...
\include{contents/appendices/appendix-k-audit-trail}           % Assertion--source verification audit

% Personal case data — excluded from main publication (kept in patients/yannick/ for private use)
% \include{patients/yannick/00-index}
% \include{patients/yannick/medical-management}
% \include{patients/yannick/case-data/clinical-findings}
% \include{patients/yannick/case-data/personal-symptoms}
% \include{patients/yannick/03-symptom-profile}
% \include{patients/yannick/case-data/case-analysis}
% \include{patients/yannick/case-data/recommendations}
% \include{patients/yannick/case-data/daily-journal}
