...
% Personal case data (patient-specific) - now organized under patients/yannick/
\include{patients/yannick/00-index}        % Case index and overview
\include{patients/yannick/medical-management} % Current medications and treatment history
\include{patients/yannick/case-data/clinical-findings} % Laboratory findings and clinical history
\include{patients/yannick/case-data/personal-symptoms} % Detailed symptom documentation
\include{patients/yannick/03-symptom-profile} % Symptom profile (legacy - may consolidate with personal-symptoms)
\include{patients/yannick/case-data/case-analysis} % Case analysis and clinical reasoning
\include{patients/yannick/case-data/recommendations} % Clinical recommendations summary
\include{patients/yannick/case-data/daily-journal} % Daily symptom log, tracking data
\include{patients/yannick/07-research-hypotheses} % Research hypotheses with testable predictions
