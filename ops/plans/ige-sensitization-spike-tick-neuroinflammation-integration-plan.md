...
- Phase 1: 18 papers added to immune.bib (research_stream=ige-sensitization-spike-tick-neuroinflammation), 18 annotated in appendix-h. Search log: ops/research/search-log-...-2026-06-24.md. Summary: ops/research/literature-summary-...-2026-06-24.md. Verdict: **antigen-specific IgE in ME/CFS = UNSTUDIED**; 2 replicated NULLs (total IgE + allergen-specific IgE normal in ME/CFS: reparramirez2001igelevels, kowal2002prevalence). Verified 18 bib keys lowercase. NOTE: summary doc key-list has typos (oh2024incidental→oh2024incident, omits gimenezorenga2025blood) — bib is ground truth.
- Phase 2: synthesis at (not retained) Decision **PARTIAL** (user-confirmed). Clinical relevance LOW. Contradiction: 1 resolvable (IgE vs non-IgE MC activation — weight to non-IgE/null). Caps: #speculation/#open-question/#limitation only; brainstorm cats 1-2+10-12; WEAK-EVIDENCE flag preemptive.
...
- Phase 4: brainstorm at ops/brainstorms/brainstorm-...-2026-06-24.md, 13 ideas (cats 1,2,10,11,12). Plan table populated with 13 rows.
