# Hypothesis Subtree: PANDAS / PANS

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #15
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic pandas-mecfs` to populate this table.
