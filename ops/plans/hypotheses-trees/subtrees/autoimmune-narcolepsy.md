# Hypothesis Subtree: Narcolepsy Type 1

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #16
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic narcolepsy-mecfs` to populate this table.
