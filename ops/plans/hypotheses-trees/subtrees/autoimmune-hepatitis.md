# Hypothesis Subtree: Autoimmune Hepatitis

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #13
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic autoimmune-hepatitis-mecfs` to populate this table.
