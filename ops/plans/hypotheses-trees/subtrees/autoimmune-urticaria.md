# Hypothesis Subtree: Autoimmune Urticaria

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 2 item #35
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic autoimmune-urticaria-mecfs` to populate this table.
