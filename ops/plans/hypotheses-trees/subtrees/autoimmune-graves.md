# Hypothesis Subtree: Graves' Disease

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #7
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic graves-mecfs` to populate this table.
