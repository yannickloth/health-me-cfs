# Hypothesis Subtree: Sjögren's Syndrome

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #2
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic sjogren-mecfs` to populate this table.
