# Hypothesis Subtree: Hashimoto's Thyroiditis

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #6
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic hashimoto-mecfs` to populate this table.
