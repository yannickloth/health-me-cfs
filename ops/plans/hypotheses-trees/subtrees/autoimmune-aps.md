# Hypothesis Subtree: Antiphospholipid Syndrome (APS)

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #9
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic aps-mecfs` to populate this table.
