# Hypothesis Subtree: Iron Dysregulation and Long COVID

**Origin:** Plan migration from `content-staging/plan-iron-dysregulation-long-covid.md`
...
**Priority:** 🟠  
**ME/CFS links:**
- Iron sequestration (IL-6 → hepcidin → ferroportin degradation) as shared mechanism across post-viral conditions: ME/CFS, Long COVID, post-EBV
- Iron-starved lymphocytes → impaired pathogen clearance → more inflammation → self-sustaining loop
- Iron-deficient reticulocytosis: bone marrow compensates but produces iron-poor red blood cells → functional anemia without flagged labs
- Single-cell maldistribution: monocytes iron-loaded (inflammatory activation), lymphocytes iron-starved (proliferation impaired) — two parallel dysfunctions
- Severity-independent: iron dysregulation present even in mild COVID → mild triggers → chronic disease, directly relevant to ME/CFS argument  
**Target chapters:** ch06-energy-metabolism, ch07-immune-dysfunction, ch14d-cross-disease (Long COVID section), ch16-convergence-mechanisms  
**Pre-identified hypotheses:** Iron sequestration as ME/CFS branch point (certainty ~0.50): if resolved quickly → recovery; if prolonged → self-sustaining metabolic/immune dysfunction persisting after iron normalizes. Falsifiable prediction: ME/CFS patients with post-viral onset should show elevated ferritin:iron ratio and hepcidin even after serum iron normalizes.  
**Research questions:**
1. Is iron sequestration duration (not severity) the critical predictor of chronic fatigue — i.e., can early iron remobilization (hepcidin inhibition, IL-6R blockade) prevent ME/CFS onset?
2. Does chronic ME/CFS show residual iron maldistribution (monocyte iron-loading, lymphocyte starvation) even years after initial viral trigger?

**Key source:** Hanson AL et al. Nature Immunology 2024; DOI 10.1038/s41590-024-01754-8 (n=214, 12-month follow-up, 72% PASC prediction accuracy at day 15–30). Companion editorial: Drakesmith & Smith, Nature Immunology 2024; DOI 10.1038/s41590-024-01759-3.

**Existing iron content:** Audit for existing ferritin/hepcidin/iron mentions before adding — avoid duplication.

**Integration tasks:**
1. Add `Hanson2024iron` to references.bib
2. ch06: iron as contributor to energy metabolism impairment (Fe-S clusters, cytochromes)
3. ch07: hepcidin/iron axis as both consequence and amplifier of inflammation
4. ch14d: iron dysregulation as biomarker; severity-independence; iron remobilization concept
5. ch16: iron dysregulation as convergence mechanism across post-viral conditions
6. Hypothesis environment + registry update

## Execution Detail

> Full plan migrated from `content-staging/plan-iron-dysregulation-long-covid.md`. Status: ⬜ pending.
...
> **Status: stub** — nodes not yet populated. Run Phase 3 of `/integrate-topic iron-dysregulation-long-covid` to populate this table.
