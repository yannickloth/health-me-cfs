...
- Null onset-predisposition finding (Billing-Ross 2016, Venter 2019) **must be stated** wherever predisposition hypothesis appears
- Symptom modulation ≠ predisposition — keep claims separated
- ADHD comorbidity: shared substrate = hypothesis; causal arrow unresolved
- CDR reserve capacity inference must be labelled as inference (Naviaux does not claim mtDNA predisposition)
