# Hypothesis Subtree: Myasthenia Gravis

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #10
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic myasthenia-mecfs` to populate this table.
