# Hypothesis Subtree: Celiac Disease

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #11
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic celiac-mecfs` to populate this table.
