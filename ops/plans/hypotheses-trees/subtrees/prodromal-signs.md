...
**Priority:** 🔴  
**ME/CFS links:**
- Retrospective prodromal signs: subclinical energy deficit presenting as benign symptoms years before diagnosis
- Gradual-onset subtype: overtrained-but-unfit athlete, late-game fader, always-tired high performer, shaky hands, cold extremities, orthostatic symptoms
- Mitochondrial ATP ceiling lower than peers: training effort disproportionate to fitness
- Collin 2018 (ALSPAC): sleep disruption documented 4–7 years before ME/CFS onset (prospective)
- Wirth 2026: ICD fatigue/pain/cognitive codes elevated 5 years before ME/CFS diagnosis in 36,332 children  
**Target chapters:** ch05-onset-patterns (new section "Retrospective Prodromal Recognition"), ch14d-cross-disease (Architecture C cross-reference)  
**Pre-identified hypotheses:** "Retrospective Prodromal Syndrome" speculation (certainty ~0.40) — subclinical metabolic reserve depletion; follow-up topic: chronic sleep insufficiency as causal mechanism (ch15)  
**Research questions:**
1. Does the 5-year pre-diagnostic window of ICD codes represent subclinical metabolic reserve depletion rather than non-specific comorbidity?
...
**Cross-references needed:** @sec:prodromal-recognition (ch05), @sec:architecture-c-metabolic-reserve (ch14d), @sec:ch15-ne-vasomotion (existing glyphatic content)
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic prodromal-signs` to populate this table.
