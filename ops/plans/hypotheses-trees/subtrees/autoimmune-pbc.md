# Hypothesis Subtree: Primary Biliary Cholangitis (PBC)

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #14
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic pbc-mecfs` to populate this table.
