# Hypothesis Subtree: Type 1 Diabetes

**Origin:** `/integrate-topic` — autoimmune diseases plan, Tier 1 item #8
...
> **Status: stub** — nodes not yet populated. Run Phase 3a of `/integrate-topic t1d-mecfs` to populate this table.
