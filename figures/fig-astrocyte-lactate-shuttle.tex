...
\begin{tikzpicture}[
    ...
    capillary/.style={draw=red!60!black, fill=red!5, very thick, rounded corners, minimum width=2cm, minimum height=1.2cm, align=center},
    % Molecule styles
...
\node[font=\scriptsize\bfseries, red!70!black, fill=red!10, rounded corners, inner sep=3pt, align=center] at (1.3, 4.5) {PROPOSED\\DYSFUNCTION};
