...
## EpiSwitch Cross-Condition Network Convergence (Hunter 2026) — Literature Search (2026-09-04)
| Source | Last Scraped | Notes |
|--------|--------------|-------|
| PubMed E-utilities API (esearch/esummary/efetch; 16 query axes + metadata batches) | pubmed/eutils | 2026-09-04 | Phase-1 integrate-topic search for topic `episwitch-crosscondition-hunter2026`. Primary paper (Hunter 2026 J Transl Med, DOI 10.1186/s12967-026-08874-9) read in full from reference PDF (Article-in-Press, not yet PubMed-indexed). 16 query axes: hub-gene mechanism (LAG3, PPARGC1A/PGC-1alpha, RUNX1, T-cell exhaustion), null/contradicting (network convergence chronic fatigue, ME/CFS-LC GWAS shared loci, LAG3 negative), Long-COVID independent support, GWAS sources (Lammi 2025 LC GWAS), competing framing. All candidates deduped vs corpus. Null findings documented: RUNX1 search → only leukemia false positives (no ME/CFS hub validation); LAG3 → melanoma/post-COVID only; PPARGC1A → generic ME/CFS-mito (no hub validation); no independent cross-condition network-convergence study found. Most independent exhaustion/mito support ALREADY in corpus (Iu2024CD8Exhaustion, Shahbaz2026single-cell-immune, VanCampenhout2025EnergyImmune — reused, NOT re-added). 4 NEW papers added to bib/genetics-epigenetics.bib. |

| URL | Source | Scraped | Integrated | Target |
|-----|--------|---------|------------|--------|
| PubMed esearch/esummary/efetch (16 axes; PMIDs 40399555,40519925,41516145,38797051 + screens) | pubmed/eutils | 2026-09-04 | — | ops/research/search-log-episwitch-crosscondition-hunter2026-2026-09-04.md, ops/research/literature-episwitch-crosscondition-hunter2026-2026-09-04.md, bib/genetics-epigenetics.bib (4 new: Hunter2026EpiSwitchCrossCondition, Lammi2025LongCOVIDGWAS, Ueland2025sLAG3postCovid, Dudova2025MECFSBiologicalNetwork), appendix-h (sec:episwitch-crosscondition, 4 annotated entries). Saito 2024 (PMID 38797051) screened but NOT added (redundant with exhaustion corpus). |

## Autism Social Perception & First-Impression Stigma (Sasson 2017 anchor) — Literature Search (2026-09-04)
| Source | Last Scraped | Notes |
|--------|--------------|-------|
| PubMed E-utilities API (esearch/esummary/efetch; 25 query axes + metadata batches) | pubmed/eutils | 2026-09-04 | Phase-1 integrate-topic search for topic `autism-social-perception-stigma`. Anchor Sasson 2017 (PMID 28145411, DOI 10.1038/srep40700) VERIFIED, NOT previously in any bib file. 25 query axes: autism first-impression/thin-slice (Sasson follow-ups, thin slice, willingness to interact, autistic observers in-group, Edey mind-blindness, Faso), mechanism (facial affect, nonverbal behavior, hypomimia, Parkinson facial masking, schizophrenia reduced facial expression, thin-slice clinical context), indirect/ME-CFS (first impression chronic fatigue, clinician impression fatigue = 0 direct, affective flattening CFS = 0, psychomotor CFS), comorbidity (autism AND ME/CFS AND stigma = 0, ME/CFS first impressions = 0), disclosure (diagnosis disclosure stigma = Norris, Parisi). Null findings documented: zero ME/CFS-cohort first-impression study; zero autism+ME/CFS comorbidity-stigma study. 15 papers added to bib/stigma.bib (anchor + 14). Reused NOT re-added: Raymaker/Higgins/Kentrou/Quadt/Ireson (already integrated ND-psych-consequence + long-COVID invisibility streams). |
