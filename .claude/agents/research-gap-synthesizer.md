...
Write output to a staging file (e.g., `.claude/content-staging/research-agenda-[date].md`) and report the path. Do NOT auto-insert into ch25b without user review.