...
description: Audit biomarker claims for sensitivity/specificity reporting, reference ranges, pre-analytical variables, and biomarker vs surrogate endpoint distinction. Use when reviewing ch20 or any biomarker-related content.
model: sonnet
