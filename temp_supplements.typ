...
*Evidence.* High for fatigue reduction, moderate for ME/CFS-specific benefit. A 2022 meta-analysis of 13 RCTs (n=1,126) found CoQ10 significantly reduces fatigue (Hedges' g = -0.398, p = 0.001) with dose-dependent and duration-dependent effects @Tsai2022CoQ10fatigue. ME/CFS-specific data include documented CoQ10 deficiency in 44.8% of patients (plasma below 490 micro g/L) with correlation to fatigue and autonomic symptoms @Maes2009CoQ10, and the largest ME/CFS RCT (Castro-Marrero 2021, n=207) showing benefit when combined with NADH @CastroMarrero2021fatigue. Novel cocrystal ubiquinol formulations show 2.01-3.43x higher bioavailability vs standard ubiquinone @Mei2026UbiquinolBioavailability.

#achievement(title: [Strong Meta-Analysis Evidence Base], body: [
...
*Forms.*
    ...
    - *Ubiquinone:* Oxidized form; must be converted to ubiquinol; standard formulation
    - *Ubiquinol:* Reduced (active) form; better absorbed, especially over age 40; more expensive
    - *Novel cocrystal ubiquinol:* Shows 2.01-3.43x higher bioavailability (Cmax ratio 2.20, AUC0-t ratio 2.01) @Mei2026UbiquinolBioavailability; allows lower doses with equivalent systemic exposure

*Dosing.*

    - *Evidence-based range:* 200–400 mg daily (higher than general population due to ME/CFS baseline deficiency)
    - *Duration:* Minimum 8–12 weeks for meaningful benefit (duration-response from meta-analysis)
    - *Formulation preference:* Novel cocrystal ubiquinol or crystal-modified ubiquinone for enhanced bioavailability
    - *Timing:* Take with fat-containing meal for absorption; split doses if $\>$200 mg
    - *Severe patients:* Consider starting at 100 mg daily and titrating up over 4–6 weeks to assess tolerance

*Response Timeline.* Benefits may take 4–12 weeks to manifest, with dose-duration response favoring longer treatment courses.

*Cautions.* Generally well-tolerated with excellent safety profile (1 adverse event in 602 participants, 0.17% in meta-analysis) @Tsai2022CoQ10fatigue. May reduce warfarin effectiveness (see Section @subsec:mito-combination-guide, drug interactions). Can cause insomnia if taken late in day (clinical observation). No serious adverse events reported in ME/CFS trials.

#speculation(title: [Mitochondrial Reserve Threshold])[
ME/CFS patients have reduced mitochondrial reserve capacity. CoQ10 supplementation may improve fatigue (resting ATP production) but does not improve exercise tolerance because it cannot compensate for reduced reserve capacity during exertion @Deng2025CoQ10ExercisePerformance. This explains why meta-analyses show consistent fatigue reduction but limited exercise performance benefits: CoQ10 supports baseline function but the reserve gap remains. (Certainty: 0.55)
]
