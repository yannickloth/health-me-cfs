...
#warning-box(title: [Devil's Claw Contraindications and Interactions])[
*Contraindications*:
...
#keypoint(title: [Ginkgo for ME/CFS Cognitive Symptoms])[
...
#keypoint(title: [Stimulant Use in ME/CFS: Summary])[
...
*Antivirals alone*:
    ...
    - Directly inhibit viral replication (valacyclovir inhibits HSV/EBV/VZV DNA polymerase)
...
#warning-box(title: [CRITICAL: Unvalidated Hypothetical Protocol])[
...
#warning-box(title: [Dose Range Discrepancy])[
...
#warning-box(title: [Guideline Origin and Extrapolation])[
...
#warning-box(title: [No Formal H2 Up-Dosing Guideline])[
