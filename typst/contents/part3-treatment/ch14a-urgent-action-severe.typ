...
#warning-box(title: [Critical Priority: Life-Threatening Suffering])[
...
For patients with POTS not adequately controlled by medications, transcutaneous vagus nerve stimulation (tVNS) may provide additional benefit. The first sham-controlled RCT demonstrated reduced orthostatic tachycardia with daily auricular tVNS @Teixeira2024POTS. See Chapter @ch:action-mild-moderate (\S@sec:tvns-pots) for detailed protocol. *CAUTION*: Standard tVNS settings may cause crashes in severe ME/CFS @Lugg2024MECFS—requires slower titration and careful monitoring in this population.
...
#keypoint(title: [Sleep Spindle Deficits in ME/CFS])[
...
#keypoint(title: [BBB Vulnerability and CNS Drug Delivery])[
...
#hypothesis-box(title: [Pharmacological Bypass of CNS Motor Coordination Failure])[
...
#keypoint(title: [Experimental: Emergency Post-Exertion Protocol])[
...
See Chapter @ch:emerging-therapies, \S@subsec:pem-prevention for complete protocol details, rationale, and safety considerations.
...
#keypoint(title: [Energy Triage Hierarchy for Severe ME/CFS])[
...
#keypoint(title: [Astrocyte Energy Gate and Lactate Shuttle Support])[
...
#warning-box(title: [CCI Evaluation Is Not for All Severe Patients])[
