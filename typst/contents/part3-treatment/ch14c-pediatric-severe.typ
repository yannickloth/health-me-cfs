...
#protocol-box(title: [Pediatric Mast Cell Management])[
...
#hypothesis-box(title: [Circadian Energy Misallocation in Pediatric ME/CFS])[
...
#keypoint(title: [BBB Vulnerability in Pediatric ME/CFS])[
...
#keypoint(title: [The Pediatric Advantage])[
