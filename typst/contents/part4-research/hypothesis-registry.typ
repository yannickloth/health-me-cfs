...
&
Ch.6 \S@sec:selective-energy-dysfunction;
Ch.25b \S@sec:selective-energy-dysfunction-study \
...
&
Ch.6 \S@sec:mechanistic-implications; Ch.7 \S@sec:viral \
...
&
Ch.7 \S@sec:exhausted-surveillance \
...
&
Ch.7 \S@sec:autoimmune-mechanisms \
...
studies feasible.
&
Ch.8 \S@sec:glymphatic-meningitis \
...
&
Ch.9 \S@sec:postviral-pituitary \
...
&
Ch.17 \S@sec:food-sensitivities-wheat \
...
&
Ch.10 \S@sec:exercise-intolerance \
...
&
Ch.13 \S@subsubsec:long-covid-cycle-dynamics \
...
&
Ch.24 \S@sec:deconditioning-hypothesis \
...
\S@sec:evolutionary-deferred-cost \
...
&
Ch.@ch:lifestyle
\S@sec:comorbidity-exercise-conflict \
...
elevations.
&
Ch.14 \S@subsec:food-mast-cell; Ch.19 \S@subsec:mcas-treatment;
Ch.20 \S@subsec:mast-cell-biomarkers \
