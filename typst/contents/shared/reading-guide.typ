...
/ *Part II: Pathophysiology*: Explores biological mechanisms—known, suspected, and speculative—and concludes with a causal hierarchy analysis that classifies mechanisms as root causes, amplifiers, or consequences. Essential for understanding the multisystem nature of the disease and which mechanisms drive it versus which result from it.
