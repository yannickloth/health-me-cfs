...
Figure @fig:trigger-relationships maps the bidirectional interactions among the four trigger-capable mechanisms, illustrating how co-activation and mutual reinforcement complicate the identification of a single initiating cause.
...
#warning-box(title: [Treatment Priority $eq.not$ Causal Priority])[
