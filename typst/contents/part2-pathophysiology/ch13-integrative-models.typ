...
[Post-exertional malaise (PEM) as cardinal feature (\S@sec:pem)], [Established], [2-day CPET studies; universal patient reports; objective physiological decline on day 2], [Exercise intolerance; delayed crashes; why GET harms], [Pacing; energy management; avoid overexertion], [High (pacing prevents crashes)],



[Autonomic dysfunction (\S@sec:autonomic)], [Established], [Abnormal tilt table tests; HRV abnormalities; POTS prevalence $>$30%], [Orthostatic intolerance; tachycardia; temperature dysregulation; coat hanger pain], [Salt/fluids; compression; fludrocortisone; midodrine; ivabradine], [Moderate–High],



[Sleep architecture abnormalities (\S@sec:sleep)], [Established], [Polysomnography showing reduced slow-wave, fragmented sleep; universal unrefreshing sleep], [Unrefreshing sleep; cognitive dysfunction; fatigue], [Sleep hygiene; low-dose trazodone; address comorbid sleep disorders], [Moderate],
...
[Glymphatic clearance failure (\S@sec:glymphatic)], [Theoretical], [Sleep dys\-function; cognitive symptoms; cranio\-cervical junction issues in subset], [Brain fog; un\-refreshing sleep; position-dependent symptoms], [Address CCI if present; optimize slow-wave sleep], [Unknown],



[Trypto\-phan/\allowbreak kynure\-nine trap (\S@sec:kynurenine-trap)], [Theoretical], [IDO acti\-vation docu\-mented; trypto\-phan pathway abnor\-malities; elevated QUIN:\allowbreak KYNA ratio in some studies], [Depression-like symptoms; neuro\-inflam\-mation; NAD#super[+] depletion], [IDO inhi\-bitors?; shift pathway toward KYNA], [Unknown],
...
#keypoint(title: [Prevention Implications of Cycle Recruitment])[
...
#keypoint(title: [Integration of Selective Dysfunction with Unifying Models])[
...
[Mitochondrial dysfunction], [CoQ10 (ubiquinol); NAD#super[+] precursors; D-ribose; B vitamins; PQQ (\S@sec:mitochondrial-support)], [Low–Moderate], [High], [Widely used; modest benefit for many],
...
[Viral persistence], [Valacyclovir; valganciclovir (\S@sec:antivirals)], [Low], [Moderate], [May help subset with viral markers],
...
[Neutrophil functional exhaustion (\S@hyp:neutrophil-exhaustion)], [Address upstream drivers (autoantibodies, chronic antigens); resolution mediators (resolvins); cautious G-CSF priming], [Theoretical], [Variable], [Neutrophil functional assays needed first],



[Chronic exerkine signaling (\S@hyp:chronic-exerkine)], [Mitochondrial support; tissue oxygenation; FGF-21 as treatment response biomarker], [Theoretical], [High (biomarker monitoring)], [ELISA-based; FGF-21 decline may predict clinical improvement],
...
The vicious cycle framework (Chapter @ch:core-symptoms, \S@sec:pem) provides a mechanistic lens for understanding the Long COVID–ME/CFS relationship: Long COVID may represent ME/CFS at an earlier stage of cycle recruitment.

#hypothesis-box(title: [Long COVID as Stage 1–2 ME/CFS])[
...
*Month 6*: If not resolved, full cycle mapping (Chapter @ch:emerging-therapies, \S@subsec:cycle-gain-measurement)
...
#hypothesis-box(title: [ME/CFS as Critical Transition Phenomenon])[
...
#hypothesis-box(title: [Polygenic Cycle Gain Score])[
...
#warning-box(title: [Confounding in Pediatric vs.\ Adult Recovery Comparisons])[
...
#hypothesis-box(title: [Pediatric Advantage Through Cycle Dynamics Lens])[
