...
// Placeholder labels for Literature hypotheses (ensure references resolve)
<spec:glial-maturation>
<hyp:immune-memory-pruning>
...
#warning-box(title: [Replication Status of Microglial PET Findings])[
...
The glial maturation window may interact synergistically with other proposed pediatric advantages: immune memory pruning (Hypothesis @hyp:immune-memory-pruning, if present), greater HSC regenerative capacity, higher baseline recovery capital (Speculation @spec:recovery-capital), and incomplete epigenetic aging.
...
#warning-box(title: [Interpreting Elevated Brain Lactate])[
...
#warning-box(title: [Vitamin B6 Toxicity])[
...
#warning-box(title: [Tinnitus as PEM Symptom])[
...
#warning-box(title: [Harmful Advice: The “Power of Positive Thinking”])[
...
#warning-box(title: [Stimulant Contraindication and Metabolic Paradox])[
