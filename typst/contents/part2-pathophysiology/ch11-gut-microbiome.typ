...
#warning-box(title: [Replication Status: Not Yet Replicated])[
...
#warning-box(title: [Evidence Limitations: Microbiome–Mast Cell Axis])[
...
#warning-box(title: [SIBO Recurrence])[
...
#warning-box(title: [Prokinetic Limitations])[
