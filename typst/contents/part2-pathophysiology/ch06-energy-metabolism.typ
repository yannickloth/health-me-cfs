...
#keypoint(title: [Compartmental Model Implications])[
...
When Na#super[+]/K#super[+]-ATPase fails to maintain the sodium gradient, the sodium-calcium exchanger (NCX), which normally exports calcium in exchange for importing sodium, reverses direction. Instead of exporting calcium, it imports calcium driven by the collapsed sodium gradient. Calcium accumulates in the cytoplasm and mitochondria, causing mitochondrial damage, further reducing ATP production, amplifying the original problem.

Wirth et al. @WirthScheibenbogen2021muscle documented this cascade in muscle studies using MRI to measure intracellular sodium. They found elevated intracellular sodium inversely correlating with grip strength (a measure of muscle function), supporting the hypothesis that sodium accumulation contributes to weakness. Electron microscopy showed subsarcolemmal mitochondrial damage at sites of calcium influx, consistent with calcium-mediated mitochondrial injury.

Scheibenbogen and Wirth @Scheibenbogen2025muscle expanded this model using proteomic data showing reduced expression of proteins responsible for sodium clearance (Na#super[+]/K#super[+]-ATPase subunits) and increased expression of sodium-sensing proteins (ENaC), indicating a systemic shift toward sodium accumulation and retention. This suggests the dysfunction is not transient but reflects sustained pathological remodeling.
...
The vicious cycle operates as follows:
    ...
    - *NCX reversal*: The sodium-calcium exchanger, driven by the sodium gradient, reverses direction and imports calcium.

    - *Calcium overload*: Excessive cytoplasmic and mitochondrial calcium causes direct mitochondrial damage at subsarcolemmal sites, further impairing ATP production.
