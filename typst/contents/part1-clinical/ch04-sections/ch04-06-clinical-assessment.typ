...
==== Key Questions for Establishing Diagnosis
...
*Abnormal Findings:*
    ...
    - *Postural Orthostatic Tachycardia Syndrome (POTS)*: HR increase $gt.eq 30$ bpm (or $gt.eq 40$ bpm in adolescents) within 10 minutes of standing, without orthostatic hypotension
    - *Orthostatic Hypotension*: Systolic BP decrease $gt.eq 20$ mmHg or diastolic BP decrease $gt.eq 10$ mmHg
...
The paucity of objective findings on standard neurological examination _despite severe symptoms_ is characteristic of ME/CFS. This discordance (severe functional impairment with normal gross exam) historically led to dismissal of ME/CFS as “psychosomatic,” but advanced imaging and functional testing reveal objective abnormalities (cerebral blood flow reduction, autonomic dysfunction, immune activation).
...
30–70% of ME/CFS patients meet criteria for fibromyalgia (widespread pain with tender points). Assessment:
    ...
    - Fibromyalgia: $gt.eq 11$ of 18 sites tender
...
*Inflammation:*
    ...
    - *Note*: ESR/CRP are typically _normal_ in ME/CFS, distinguishing it from autoimmune diseases
...
==== Advanced Biomarker Testing (If Available)
...
*Objective Functional Testing:*
    ...
    - Reduction in VO#sub[2]max, ventilatory threshold on Day 2 is diagnostic
...
These tests are _not required for diagnosis_ but enable Tier 2 biological phenotyping and treatment stratification.
