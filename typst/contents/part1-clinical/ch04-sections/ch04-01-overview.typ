...
$
I subset C subset F #h(1em) "and" #h(1em) I sect O eq.not nothing
$
...
where:
    ...
    - $I sect O eq.not nothing$: ICC and IOM criteria identify overlapping but not identical populations
