...
#warning-star(title: [CRITICAL WARNING: The Point of No Return])[
...
#requirement-box(title: [RED FLAGS: Stop Everything and Implement Emergency Pacing])[
...
#keypoint(title: [Reframing: Pacing Is Not Giving Up])[
...
#warning-star(title: [When to Consider Emergency Disability Application])[
...
#keypoint(title: [Key Takeaways: Preventing the Descent])[
