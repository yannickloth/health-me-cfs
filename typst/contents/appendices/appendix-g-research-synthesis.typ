...
[*Nicotine (low-dose)*], [2–4mg/day (gum, patch)], [Rapid brain fog improvement (hours to days); multiple independent reports], [Alpha-7 nAChR modulation; anti-inflammatory; mitochondrial calcium regulation (ch19 \S@hyp:ach-mito)], [HYPOTHESIS-GENERATING; needs RCT; addiction risk],

[*Methylene blue*], [1–5mg/day (very low dose)], [Smell restoration, brain fog reduction within 1 week], [Enhances electron transport; reduces oxidative stress; indirect benefit despite Complex IV dysfunction (ch19 \S@hyp:mb-mito-enhancement)], [HYPOTHESIS-GENERATING; dose-finding needed],

[*Ketogenic diet*], [Strict keto], [Dramatic improvement in subset; "medication-free" in some cases], [Ketone bodies provide alternative fuel (acetyl-CoA) without glucose; reduces oxidative stress (ch19 \S@spec:patient-interventions)], [ANECDOTAL; subset-specific; needs stratified trial],

[*Pyruvate (prophylactic)*], [1–2g pre-exertion], [Proposed to prevent PEM crashes], [Provides pyruvate directly for TCA cycle; skips glycolysis requirement; used by athletes (ch19 \S@spec:pyruvate-supplement)], [SPECULATIVE; testable in RCT],

[*NAD+ precursors*], [NR 300–1000mg/day; NMN 250–500mg/day], [Proposed for post-exertional recovery], [Boosts lactate dehydrogenase; accelerates lactate clearance; improves mitochondrial NAD+/NADH ratio (ch19 \S@spec:nad-lactate)], [SPECULATIVE; mechanistically sound; testable],
...
[*Lyme Disease (European species)*], [European Lyme serology panel], [Chronic fatigue, PEM-like symptoms; 10-year misdiagnosis reported], [Long-cycle antibiotics "significantly helpful"; requires regional-specific testing (ch19 \S@obs:lyme-mecfs-overlap)],

[*Hypermobile EDS (hEDS)*], [Beighton score; clinical assessment], [Joint hypermobility, easy bruising, fatigue, POTS overlap; "100-fold underdiagnosed"], [Physical therapy adaptations; affects pacing strategies (ch19 \S@hyp:eds-mcas-mecfs)],

[*Mast Cell Activation (MCAS)*], [Tryptase levels; clinical criteria], [Allergic symptoms, flushing, GI issues, fatigue], [H1/H2 blockers, mast cell stabilizers may help; potential mito-immune link (ch19 \S@hyp:mcas-mito-damage)],

[*ADHD + hEDS overlap*], [Clinical assessment], [Shared genetic factors proposed; frequent co-occurrence], [May represent distinct phenotype requiring different management (ch19 \S@hyp:eds-mcas-mecfs)],
...
[*ER stress-WASF3 pathway*], [Viral infection → ER stress → WASF3 upregulation → Complex IV damage], [Proposed pathway integrating viral triggers @hwang2023viral and WASF3 @wang2023wasf3 (ch19 \S@hyp:viral-er-wasf3)], [Validation needed; ER stress markers; intervention trials], [HYPOTHESIS],

[*Metabolic trap (IDO pathway)*], [Tryptophan-kynurenine disruption], [Phair modeling @phair2019ido (ch06 \S@sec:metabolic-trap)], [Replication; causation; therapeutic validation], [HYPOTHESIS],
...
[*"\<5 crashes per year" rule*], [Exceeding energy limits \>5 times/year causes irreversible worsening], [Strict pacing is non-negotiable; crashes have cumulative damage (ch14b \S@sec:energy-envelope)], [OBSERVATIONAL; matches 2-day CPET pathology],
...
[*Sleep apnea masquerading as ME/CFS*], [Years of ME/CFS diagnosis resolved with CPAP in subset], [Polysomnography should be standard workup (ch19 \S@obs:sleep-apnea-misdiagnosis)], [CASE REPORTS; diagnostic importance],

[*EDS/MCAS overlap*], [High comorbidity; "100-fold underdiagnosed"; shared symptoms], [Screen for Beighton score, tryptase, allergic symptoms (ch19 \S@hyp:eds-mcas-mecfs)], [CLINICAL OBSERVATION; needs epidemiological study],

[*Nicotine rapid effect*], [Brain fog improvement within hours to days at 2–4mg], [Suggests cholinergic or anti-inflammatory mechanism; testable in RCT (ch19 \S@hyp:ach-mito)], [ANECDOTAL; multiple independent reports],

[*Ketogenic diet subset response*], [Dramatic improvement in some; no effect or worsening in others], [Heterogeneity suggests metabolic subtypes; stratified trial needed (ch19 \S@spec:patient-interventions)], [ANECDOTAL; subset-specific],

[*GET causes harm*], [Patient deterioration; violates PEM physiology; PACE trial discredited], [Contraindicated; pacing is evidence-based alternative (ch14b \S@warn:get-harmful)], [VALIDATED; consensus],
