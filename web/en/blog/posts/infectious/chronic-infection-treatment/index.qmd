...
**The evidence.** Lerner's open-label cohort studies (from the early 2000s onward) reported 30–40% response in herpesvirus-associated ME/CFS, most notably in the largest cohort (n=142) [@Lerner2010antivirals], and a 36-month blinded follow-up of valacyclovir in the EBV-subset was positive [@Lerner2007valacyclovir] [@Lerner2002valacyclovir]. But these come from a single group, have never been independently replicated, and used cardiac-output or clinical-status endpoints (not PEM or fatigue) as primary measures. The honest evidence grade: **weak and single-group**.
