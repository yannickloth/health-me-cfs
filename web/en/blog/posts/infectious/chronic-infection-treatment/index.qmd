...
**Practical considerations.** Valacyclovir is well tolerated (headache, nausea in ~10%) and requires adequate hydration to prevent crystalluria. Typical doses are 1–1.5 g three to four times daily — high, but necessary because acyclovir has poor oral bioavailability (~20%) and the prodrug compensates. A 3–6 month trial is the minimum to assess response; shorter trials are not informative.
...
If valacyclovir fails and HHV-6 is documented (PCR positive, or ciHHV-6 known), discuss valganciclovir with a specialist. This is a toxic drug — bone-marrow suppression, teratogenicity — requiring regular CBC monitoring. A 3–6 month trial with pre-defined stopping rules and monthly CBC is the responsible approach. **Stop if neutropenia develops or if there is no improvement at 6 months.**
...
- **Valganciclovir is a specialist decision.** The toxicity (bone marrow suppression, teratogenicity) and cost mean it should be managed by a clinician experienced with the drug, with regular CBC monitoring. A 3–6 month trial with pre-defined stopping rules is the responsible approach.
