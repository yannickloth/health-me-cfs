...
Now add the rest of ME/CFS: the PEM, the unrefreshing sleep, the brain fog. About 70% of ME/CFS cases follow an acute infection — EBV mononucleosis, HHV-6 roseola, tick-borne Borrelia, enterovirus, SARS-CoV-2 — and the question that has haunted the field for decades is whether the pathogen is still there, still driving the disease, or whether it lit a fire and walked away [@Blomberg2019HerpesvirusNull].
...
- **~70% of ME/CFS cases follow an acute infection**, and the Big Four are EBV (mononucleosis → 9–11% develop ME/CFS), HHV-6 (roseola → neurotropic, integrates into chromosomes), tick-borne Borrelia (Lyme → 10–20% develop PTLDS), and SARS-CoV-2 (>50% of Long COVID meet ME/CFS criteria).
...
- **Prevalence.** Latent or persistent HHV-6 is found in 46.7% of ME/CFS patients vs 10% of controls.

---

## Tick-borne disease: Lyme, Bartonella, Babesia

**Lyme disease (Borrelia burgdorferi)** causes acute infection treated with 2–4 weeks of antibiotics. In 10–20% of cases, symptoms persist for months to years — post-treatment Lyme disease syndrome (PTLDS). PTLDS shares 26 of 29 core ME/CFS symptoms (fatigue, cognitive dysfunction, musculoskeletal pain, sleep disturbance), making the two conditions nearly clinically indistinguishable in the post-infectious phase.
