...
Only escalate to daratumumab (where available and under specialist supervision) if IVIG and IA have both failed in the AAb-positive post-infectious subgroup — and only within a controlled research protocol, given the early evidence stage and the on-target NK-cell depletion.
