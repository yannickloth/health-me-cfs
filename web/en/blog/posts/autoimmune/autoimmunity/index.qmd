...
- **Passive-transfer evidence from fibromyalgia and Long COVID** shows that injecting patient IgG into mice reproduces pain and small-fibre neuropathy — strong evidence that the antibodies are *sufficient* to reproduce a phenotype (i.e., can be pathogenic, not merely correlative) in those conditions [@Goebel2021passiveTransferFM][@Mignolet2026passiveTransferLC]. No ME/CFS-specific passive-transfer study exists yet.
...
## What the wide prevalence range actually means
