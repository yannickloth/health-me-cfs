...
This pattern has been documented in fibromyalgia research since 1975 [@Moldofsky1975alphaDeltaSleep]. The mechanism is reasonably well understood: abnormal thalamo-cortical excitability causes the oscillation frequency to remain in the alpha range (~10 Hz) instead of transitioning to delta (~1 Hz). The result is sleep that looks adequate by duration but fails at the cellular level — glymphatic clearance doesn't happen, metabolic waste accumulates, the brain wakes exhausted.
