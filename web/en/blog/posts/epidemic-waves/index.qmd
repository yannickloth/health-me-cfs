...
It started at Los Angeles County General Hospital. Between May 1934 and December 1935, 198 hospital employees — 4.5% of personnel, including over 10% of nurses and 5% of physicians — developed a post-infectious illness initially diagnosed as "atypical poliomyelitis." They never recovered normally [@Gilliam1938].

Fourteen years later, an outbreak in Akureyri, Iceland affected 1,090 people in three months — enough to earn it the name "Icelandic disease." The symptoms were the same: crushing fatigue that did not resolve, neurological dysfunction, prolonged disability long after the acute infection had cleared [@Sigurdsson1950].

Then in 1955, the Royal Free Hospital in London saw 292 staff members fall ill over five months, 255 of whom required hospitalization. This outbreak gave the disease its name: Dr. Melvin Ramsay, head of Infectious Diseases, coined "benign myalgic encephalomyelitis." The word "benign" was later dropped once the chronic, disabling nature of the illness became undeniable [@RoyalFree1957; @Ramsay1986].

Three decades on, an outbreak in Incline Village near Lake Tahoe affected 259 patients. The CDC investigated, found elevated Epstein-Barr virus antibodies, and — in one of the most consequential branding decisions in medical history — renamed the disease "chronic fatigue syndrome" in 1988. A name that trivialized it for the next thirty years [@Buchwald1992; @Holmes1988].
...
The RECOVER-Adult Study [@RECOVER2025] found that 4.5% of people infected with SARS-CoV-2 developed ME/CFS meeting formal diagnostic criteria, compared to 0.6% in uninfected controls — a nearly five-fold increase in risk (hazard ratio: 4.93). Among patients classified as "long COVID," 51% meet full ME/CFS diagnostic criteria.

What that translates to in practice: the United States alone went from an estimated 1.5 million ME/CFS patients before the pandemic to somewhere between 5 and 9 million, and the annual economic burden rose from $36–51 billion to $149–362 billion [@Jason2022prevalence].
...
Every previous wave was small enough to dismiss. A few hundred patients at a hospital. A thousand in an Icelandic town. A few hundred near a lake in Nevada. Each time, the medical establishment investigated briefly, failed to isolate a single viral cause, and moved on. Patients were left without a diagnosis or treatment — and after McEvedy and Beard published their infamous 1970 "mass hysteria" reanalysis of the earlier outbreaks [@McEvedy1970], many faced active disbelief from their own doctors. Subsequent mathematical modeling of the outbreak data showed that the epidemiological patterns fit infectious disease models, not psychogenic ones [@Underhill2021] — but by then, the damage to the field's credibility was already done.
...
What researchers found confirmed what the ME/CFS field had been reporting for decades. The NIH's deep phenotyping study [@walitt2024deep] — 75 authors across 15 NIH institutes — demonstrated brain dysfunction, immune exhaustion, and metabolic failure in ME/CFS patients: objective, measurable, biological disease, not "fatigue" or "deconditioning."
