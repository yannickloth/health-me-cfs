---
title: "One Disease, Fourteen Entry Points, One Endpoint"
description: "This is the article everything in this series has been building toward. If you've read the preceding articles on mitochondria, sleep, gut, thyroid, immune activation, hypermobility, infections, depression, and diagnostics — you've seen the pieces...."
author: "Yannick Loth"
date: "2026-07-09"
categories: [Energy Metabolism, Systems Biology, Pathophysiology]
---
...
## The convergence is the disease
...
## The treatment implication: identify and subtract
...
- Mitochondrial: 2-day CPET, organic acids, acylcarnitine profile [[1]](#ref-1)
...
- Autoantibodies → immunoadsorption [[3]](#ref-3) (where available)
...
This predicts that ME/CFS clinical trials will continue to fail until they stratify by mechanism. A rituximab [[2]](#ref-2) trial that enrols all ME/CFS patients will fail on average, even if it cures every patient with a specific autoantibody profile. The signal is real. The trial design buries it.
...
**First:** your disease is real, biological, measurable, and mechanistically explicable [[4]](#ref-4). It is not one thing — it is a convergence of mechanisms — but that does not make it less real. It makes it more complex and harder to treat, which is a property of the disease, not of your psychology.
...
## The landscape is the map

This series [[7]](#ref-7) began with a question: why are you so tired? The answer turned out to be: for fourteen possible reasons, in varying combinations, maintained by feedback loops that resist individual intervention.
...
<span id="ref-1"></span>1. Naviaux RK et al. Metabolic features of chronic fatigue syndrome. *PNAS*. 2016;113(37):E5472-E5480.
<span id="ref-2"></span>2. Fluge Ø et al. B-lymphocyte depletion in myalgic encephalopathy/chronic fatigue syndrome. *PLoS ONE*. 2011;6(10):e26358.
<span id="ref-3"></span>3. Scheibenbogen C et al. Immunoadsorption to remove ß2 adrenergic receptor antibodies in chronic fatigue syndrome. *PLoS ONE*. 2018;13(3):e0193672.
<span id="ref-4"></span>4. IOM. Beyond Myalgic Encephalomyelitis/Chronic Fatigue Syndrome: Redefining an Illness. 2015.
<span id="ref-5"></span>5. Hickie I et al. Post-infective and chronic fatigue syndromes precipitated by viral and non-viral pathogens. *BMC Medicine*. 2006;4:26.
<span id="ref-6"></span>6. Davis HE et al. Long COVID: major findings, mechanisms and recommendations. *Nature Reviews Microbiology*. 2023;21(3):133-146.
<span id="ref-7"></span>7. Loth Y. ME/CFS: Mechanisms, Management, and Research Frontiers. 2026. doi.org/10.5281/zenodo.19627450
