---
title: "The 3-Second Chain Reaction: Why a Nerve Hit Can Make You Pass Out"
description: "Hit a nerve — the inside of an elbow, the underside of a wrist, the corner of a desk against a shin — and for about one second you register a sharp jab. *Oh, I hit myself there.* Then the pain begins to materialize and escalate — not gradually, bu..."
author: "Yannick Loth"
date: "2026-05-26"
categories: [Pain, Autonomic Dysfunction, Neurology]
---
...
## Step 1: The impact — Aδ fibers fire first (0–100 ms)
...
## Step 2: C-fiber recruitment — the delayed wave (200 ms → 2 seconds)
...
## Step 3: The nucleus tractus solitarius — where the reflex hijacks the system (~1–2 seconds)

All that nociceptive (pain) information ascends the spinal cord and brainstem to a structure called the **nucleus tractus solitarius (NTS)** in the medulla oblongata — the lowest part of the brain, right above the spinal cord. The NTS is the central integration hub for **visceral sensation**: it receives input from the heart, lungs, gut, and — critically — from nociceptors [[1]](#ref-1).
...
## Step 4: The dual autonomic cascade — vagal activation + sympathetic withdrawal (~1.5–2.5 seconds)

The NTS sends two simultaneous output signals [[3]](#ref-3):
...
## Step 5: Cerebral hypoperfusion — brain running out of fuel (~2–3 seconds)
...
## Step 6: Syncope — the brain's forced reboot (~2.5–3.5 seconds from impact)

**Syncope** (SIN-co-pee) is the medical term for transient loss of consciousness due to cerebral hypoperfusion [[4]](#ref-4) [[5]](#ref-5). It is not a seizure — it's the brain shutting down non-essential systems to preserve core metabolism, like a laptop entering emergency sleep when the battery hits 1%.
...
## Step 7: Supine reperfusion — blood returns (~3.5–10 seconds from impact)
...
## Step 8: Post-syncopal recovery — the aftermath
...
POTS patients already have a dysregulated autonomic nervous system [[2]](#ref-2) [[8]](#ref-8) [[10]](#ref-10). Their hallmark is an **excessive heart rate increase upon standing** — the sympathetic system overcompensates to maintain cerebral perfusion against blood pooling. But many POTS patients also have **neuropathic POTS** — the sympathetic nerves to the lower-body blood vessels are partially damaged (small-fiber neuropathy [[7]](#ref-7)), meaning vasoconstriction is already impaired.
...
### 3. Pre-existing nerve inflammation (neuritis / neuropathy)
...
### 4. ME/CFS and Long COVID

Autonomic dysfunction is near-universal in ME/CFS and common in Long COVID [[6]](#ref-6). Orthostatic intolerance, POTS, and abnormal heart rate variability are well-documented. Many ME/CFS patients have **reduced baroreflex sensitivity** — the system that detects blood pressure drops and compensates is sluggish.
...
Iron deficiency impairs **tyrosine hydroxylase** — the rate-limiting enzyme for dopamine and norepinephrine synthesis [[9]](#ref-9). Norepinephrine is the primary neurotransmitter of the sympathetic nervous system. Low norepinephrine production means **reduced sympathetic tone** — the baseline vasoconstriction that keeps blood pressure up.
...
### 6. Anxiety and hypervigilance to pain
...
<span id="ref-1"></span>1. Benarroch EE. Nucleus of the solitary tract. In: *The Central Autonomic Network*. Oxford University Press; 2022. [Chapter covering NTS afferent/efferent integration and baroreflex pathways.]

<span id="ref-2"></span>2. Freeman R, Wieling W, Axelrod FB, et al. Consensus statement on the definition of orthostatic hypotension, neurally mediated syncope and the postural tachycardia syndrome. *Clinical Autonomic Research*. 2011;21(2):69–72. PMID: 21431947.

<span id="ref-3"></span>3. Raj SR, Sheldon RS. Syncope: investigation and treatment. *Current Problems in Cardiology*. 2020;45(10):100612.

<span id="ref-4"></span>4. Grubb BP. Neurocardiogenic syncope and related disorders of orthostatic intolerance. *Circulation*. 2005;111(22):2997–3006. PMID: 15939833.

<span id="ref-5"></span>5. Adkisson WO, Benditt DG. Pathophysiology of neurally mediated syncope. *Cardiac Electrophysiology Clinics*. 2017;9(4):575–586.

<span id="ref-6"></span>6. Baschieri F, Cortelli P. Circadian rhythms and autonomic dysfunction in neurodegenerative disorders. *Autonomic Neuroscience*. 2019;217:66–74.

<span id="ref-7"></span>7. Schondorf R, Freeman R. The importance of autonomic testing in POTS and related disorders. *Clinical Autonomic Research*. 2021;31(3):307–316.

<span id="ref-8"></span>8. Sheldon RS, Grubb BP, Olshansky B, et al. 2015 Heart Rhythm Society expert consensus statement on the diagnosis and treatment of postural tachycardia syndrome, inappropriate sinus tachycardia, and vasovagal syncope. *Heart Rhythm*. 2015;12(6):e41–e63. PMID: 25980576.

<span id="ref-9"></span>9. DelRosso LM, Bruni O, Ferri R. Iron deficiency and restless legs syndrome. *Sleep Medicine Clinics*. 2020;15(2):197–207.

<span id="ref-10"></span>10. Garland EM, Celedonio JE, Raj SR. Postural tachycardia syndrome: beyond orthostatic intolerance. *Current Neurology and Neuroscience Reports*. 2015;15(9):60. PMID: 26198889.
