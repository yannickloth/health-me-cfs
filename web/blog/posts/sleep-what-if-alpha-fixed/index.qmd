---
title: "What If We Fixed Alpha-Intrusion? A Thought Experiment in ME/CFS"
description: "Nobody has run this experiment yet. But the question is worth asking anyway."
author: "Yannick Loth"
date: "2026-05-16"
...
Alpha-delta sleep — the intrusion of waking-frequency alpha waves into deep sleep — is one of the most documented objective abnormalities in ME/CFS and fibromyalgia (Moldofsky et al. 1975, *Psychosomatic Medicine* [[1]](#ref-1); Roizenblatt et al. 2001, *Arthritis & Rheumatism* [[2]](#ref-2)). It prevents the brain from entering the slow-wave oscillations that drive overnight restoration. A previous article in this series described the thalamic calcium channel dysfunction hypothesised to cause it (not yet directly tested in ME/CFS patients).
...
Cerebral hypoperfusion continues. ME/CFS patients show reduced cerebral blood flow — 26% reductions documented during orthostatic challenge versus 7% in controls (van Campen et al. 2020, *Clinical Neurophysiology Practice* [[7]](#ref-7)) — driven by autonomic dysfunction, endothelial dysfunction, and reduced blood volume. The brain's oxygen supply is limited regardless of how well it sleeps. Cognitive tasks that demand increased blood flow would still fail at the supply level.
...
Gabapentin and pregabalin are the most commonly prescribed. They bind alpha-2-delta voltage-gated calcium channel subunits, increasing slow-wave sleep and reducing alpha-frequency activity during NREM (Lo et al. 2002, *Epilepsia* [[11]](#ref-11)). Gabapentin (100–600 mg at bedtime) is first-line when pain and sleep disturbance co-occur; pregabalin (25–150 mg) has similar efficacy with more predictable pharmacokinetics. Both improve delta power on polysomnography, but neither fully eliminates alpha intrusion — they shift the ratio rather than resolve the underlying oscillatory dysfunction.
...
The dual orexin receptor antagonists suvorexant and lemborexant target the orexin-driven hyperarousal that may sustain alpha intrusion (López-Amador et al. 2025, *Exploration* [[12]](#ref-12)), and are mechanistically interesting given the documented orexin system dysfunction in ME/CFS — though clinical experience in this population remains limited. Z-drugs (zolpidem, eszopiclone) are effective for sleep initiation but do not address the unrefreshing quality of ME/CFS sleep; zolpidem's suppression of glymphatic-driving norepinephrine oscillations may actively worsen waste accumulation (Hauglund et al. 2025 [[10]](#ref-10)).
...
<span id="ref-1"></span>1. Moldofsky H et al. (1975). Musculoskeletal symptoms and non-REM sleep disturbance in patients with "fibrositis syndrome" and healthy subjects. *Psychosomatic Medicine*, 37(4), 341–351.
<span id="ref-2"></span>2. Roizenblatt S et al. (2001). Alpha sleep characteristics in fibromyalgia. *Arthritis & Rheumatism*, 44(1), 222–230.
<span id="ref-3"></span>3. Xie L et al. (2013). Sleep drives metabolite clearance from the adult brain. *Science*, 342(6156), 373–377.
<span id="ref-4"></span>4. Diekelmann S & Born J (2010). The memory function of sleep. *Nature Reviews Neuroscience*, 11(2), 114–126.
<span id="ref-5"></span>5. Staresina B et al. (2015). Hierarchical nesting of slow oscillations, spindles and ripples in the human hippocampus during sleep. *Nature Neuroscience*, 18(11), 1569–1576.
<span id="ref-6"></span>6. Groven N et al. (2021). Kynurenine metabolites and ratios differ between CFS, fibromyalgia, and healthy controls. *Psychoneuroendocrinology*, 131, 105287.
<span id="ref-7"></span>7. van Campen CLMC et al. (2020). Cerebral blood flow is reduced in ME/CFS during head-up tilt testing. *Clinical Neurophysiology Practice*, 5, 109–117.
<span id="ref-8"></span>8. Porkka-Heiskanen T et al. (1997). Adenosine: a mediator of the sleep-inducing effects of prolonged wakefulness. *Science*, 276(5316), 1265–1268.
<span id="ref-9"></span>9. NICE (2021). Myalgic encephalomyelitis/chronic fatigue syndrome: diagnosis and management. NICE guideline NG206.
<span id="ref-10"></span>10. Hauglund NL et al. (2025). Norepinephrine-mediated slow vasomotion drives glymphatic clearance during sleep. *Cell*, 188(3), 568–583.
<span id="ref-11"></span>11. Lo HS et al. (2002). Gabapentin increases slow-wave sleep in normal adults. *Epilepsia*, 43(Suppl 7), 280.
<span id="ref-12"></span>12. López-Amador N et al. (2025). Orexin system dysfunction in ME/CFS: an integrative review. *Exploration*, doi:10.37349/ent.2025.1004112.
<span id="ref-13"></span>13. Coulter DA et al. (1989). Specific petit mal anticonvulsants reduce calcium currents in thalamic neurons. *Neuroscience Letters*, 98(1), 74–78.
