---
title: "Running on Empty: ME/CFS Patients Are Missing Up to 15% of Their Blood"
description: "The average adult has about 5 liters of blood. Now imagine waking up every morning with 500 to 750 ml less — permanently. No injury, no bleeding, no obvious cause. Just... less blood."
author: "Yannick Loth"
date: "2026-03-13"
categories: [Cardiovascular, Pathophysiology]
---
...
- **Total blood volume**: 10-15% below predicted values [[1]](#ref-1) [[2]](#ref-2)
- **Plasma volume** (the liquid portion): 21% lower in POTS patients — a condition overlapping with ME/CFS in ~60% of cases [[3]](#ref-3); 11 ml/kg below reference in ME/CFS patients [[4]](#ref-4)
- **Red blood cell mass**: reduced in 94% of female and 50% of male ME/CFS patients [[2]](#ref-2)
...
## Blood volume, cardiac output, and the energy chain
...
## A hormonal system that fails to respond
...
Miwa & Fujita [[5]](#ref-5) found that ME/CFS patients had 33% lower aldosterone and 33% lower antidiuretic hormone (ADH) than healthy controls — *despite* documented hypovolemia. The hormonal response was to retain *less* fluid, not more.

Raj et al. [[3]](#ref-3) found the same paradox in POTS patients (a condition overlapping with ME/CFS in about 60% of cases): blood volume was markedly reduced, but plasma renin activity was unchanged and aldosterone was low. The volume-sensing system was broken.
...
## Reduced quantity, compromised quality

Even the blood that remains doesn't work optimally. Red blood cells in ME/CFS patients show reduced deformability [[6]](#ref-6) — they're stiffer and less able to squeeze through capillaries to deliver oxygen. This means that even if you could magically restore blood volume overnight, oxygen delivery would still be impaired at the tissue level.
...
## Managing the deficit — and looking for the cause
...
One leading theory points to autoantibodies — immune proteins that mistakenly target the body's own receptors. ME/CFS patients show elevated autoantibodies against G protein-coupled receptors (GPCRs), including angiotensin II AT1 receptors [[7]](#ref-7) [[8]](#ref-8) [[9]](#ref-9). The AT1 receptor is a key link in the RAAS chain: angiotensin II binds it to trigger aldosterone release. Autoantibodies interfering with this receptor would directly explain why the system fails to correct low blood volume — the signal gets through, but the receptor doesn't respond normally.
...
## A measurable deficit that rarely gets measured
...
<span id="ref-1"></span>1. Newton et al. (2016). Blood volume deficits and reduced cardiac dimensions in ME/CFS measured by dual-isotope dilution and cardiac MRI.

<span id="ref-2"></span>2. Streeten & Bell (1998). Reduced red blood cell mass in ME/CFS patients.

<span id="ref-3"></span>3. Raj et al. (2005). Plasma volume deficits and suppressed renin-aldosterone in POTS. *Circulation*.

<span id="ref-4"></span>4. van Campen et al. (2018). Plasma volume reduction in ME/CFS patients measured by dual-isotope dilution.

<span id="ref-5"></span>5. Miwa & Fujita (2017). Suppressed aldosterone and antidiuretic hormone in hypovolemic ME/CFS patients.

<span id="ref-6"></span>6. Saha et al. (2019). Reduced red blood cell deformability in ME/CFS.

<span id="ref-7"></span>7. Loebel et al. (2016). Elevated GPCR autoantibodies, including AT1 receptor, in ME/CFS.

<span id="ref-8"></span>8. Sotzny et al. (2021). Elevated GPCR autoantibodies, including AT1 receptor, in ME/CFS.

<span id="ref-9"></span>9. Bynke et al. (2020). AT1 receptor autoantibodies in ME/CFS.
