...
- **Total blood volume**: 10-15% below predicted values [@Newton2016] [@Streeten1998blood]
- **Plasma volume** (the liquid portion): 21% lower in POTS patients — a condition overlapping with ME/CFS in ~60% of cases [@Raj2005]; 11 ml/kg below reference in ME/CFS patients [@vanCampen2018plasmaVolume]
- **Red blood cell mass**: reduced in 94% of female and 50% of male ME/CFS patients [@Streeten1998blood]
...
Miwa & Fujita [@Miwa2017] found that ME/CFS patients had 33% lower aldosterone and 33% lower antidiuretic hormone (ADH) than healthy controls — *despite* documented hypovolemia. The hormonal response was to retain *less* fluid, not more.

Raj et al. [@Raj2005] found the same paradox in POTS patients (a condition overlapping with ME/CFS in about 60% of cases): blood volume was markedly reduced, but plasma renin activity was unchanged and aldosterone was low. The volume-sensing system was broken.
...
Even the blood that remains doesn't work optimally. Red blood cells in ME/CFS patients show reduced deformability [@Saha2019] — they're stiffer and less able to squeeze through capillaries to deliver oxygen. This means that even if you could magically restore blood volume overnight, oxygen delivery would still be impaired at the tissue level.
...
One leading theory points to autoantibodies — immune proteins that mistakenly target the body's own receptors. ME/CFS patients show elevated autoantibodies against G protein-coupled receptors (GPCRs), including angiotensin II AT1 receptors [@Loebel2016] [@Sotzny2021] [@Bynke2020]. The AT1 receptor is a key link in the RAAS chain: angiotensin II binds it to trigger aldosterone release. Autoantibodies interfering with this receptor would directly explain why the system fails to correct low blood volume — the signal gets through, but the receptor doesn't respond normally.
