...
Your brain has a waste-clearance system — the glymphatic system [@Xie2013glymphatic] — that operates during slow-wave sleep. Think of it as a pump-and-pipe network: norepinephrine oscillations drive cerebral vasomotion (the pump), which pushes CSF through perivascular spaces surrounded by astrocytic endfeet (the pipes), clearing metabolic waste — tau, amyloid, inflammatory mediators.

Sleep medications like trazodone and DORAs [@Hauglund2025neVasomotion] can restore the pump within days. They increase slow-wave sleep duration, normalize delta power, and consolidate sleep architecture. Measurable on EEG night one.
...
**Week 1:** Sleep architecture normalizes [@Holth2019tauSleep]. You sleep through the night. You wake up still tired. This is expected — the pump is running, the pipes are still wrecked.

**Weeks 2–8:** DTI-ALPS imaging [@NematGorgani2025GlymphaticMECFS] shows glymphatic function improving by maybe 10–15% of the deficit. AQP4 channels are slowly redistributing to endfeet. You feel no different. The brain is paying down its waste debt before the balance sheet shows positive clearance.
...
**Month 6:** Endfeet largely restored. DTI-ALPS [@Ding2025glymphaticAD] approaches ~50–60% of deficit recovery. Significant symptomatic benefit — but still not 100%.
...
This model makes a specific, testable claim: ME/CFS patients with >5 years of non-restorative sleep who achieve objectively normal sleep architecture (delta power, SWS %, spindle density on PSG) after 4 weeks of trazodone + DORA [@Lucey2023SuvorexantTau] will **still** show reduced DTI-ALPS glymphatic index [@NematGorgani2025GlymphaticMECFS] compared to age-matched controls. The same patients treated for >6 months will show progressive DTI-ALPS improvement.
...
4. **Sleep quality matters more than sleep duration.** The pump runs on delta oscillations, not minutes in bed. DORAs and trazodone [@Parhizkar2025LemborexantTau] improve the signal that drives clearance. Z-drugs like zolpidem increase sleep duration but suppress the NE oscillations that drive the pump [@Fultz2019csfOscillations] — and provide zero tau neuroprotection [@Parhizkar2025LemborexantTau]. The medication class matters.
