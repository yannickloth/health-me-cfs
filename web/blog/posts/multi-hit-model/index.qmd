---
title: "Why Only Some People Get ME/CFS After Infection"
description: "In the months following a wave of COVID-19, a fraction of infected individuals develop Long COVID. Of those, a subset — distinguished, so far, only imperfectly from the rest — progress to what meets full ME/CFS criteria. The fraction is not small,..."
author: "Yannick Loth"
date: "2026-04-26"
categories: [Modeling, Epidemiology, Pathophysiology]
---
...
This explains a pattern that has been documented but incompletely understood. ME/CFS onset is most commonly triggered by infections, but only a small fraction of infected individuals develop ME/CFS [[1]](#ref-1)[[2]](#ref-2). Prospective cohort studies — the Dubbo infection studies being the clearest — followed individuals through acute infectious illness and tracked who developed post-infectious fatigue syndromes. The picture is mixed: acute illness severity was the strongest single predictor in Dubbo [[1]](#ref-1), suggesting the infection's intensity also matters, not only the baseline. But risk factors associated with conversion included the prior health state as well: pre-existing fatigue, prior stress events, other vulnerabilities. The multi-hit framework is consistent with both: acute severity determines the size of the perturbation; baseline position determines how much perturbation is needed [Ch. 33 §Multi-Hit Framework — Epidemiological Implication].
...
<span id="ref-1"></span>1. Hickie et al. (2006). *Dubbo infection cohort study*. Prospective cohort study of post-infectious fatigue syndromes; acute illness severity was the strongest single predictor of ME/CFS conversion.

<span id="ref-2"></span>2. Chu et al. (2019). ME/CFS onset after infection.
