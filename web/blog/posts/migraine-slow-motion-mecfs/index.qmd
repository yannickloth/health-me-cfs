...
A Taiwan national cohort study followed **6,902 migraine patients** and **27,608 matched controls** from 2006 to 2010 [@Lau2015migraineCFS]:
...
Migraineurs are not metabolically normal between attacks. Multiple lines of evidence show **chronic mitochondrial impairment** even in the interictal period [@Wang2023migraineMito]:
...
| --- | --- | --- |
| ADHD | Prefrontal hypometabolism + dopaminergic inefficiency [@Zametkin1990] [@Berthier2025cbfadhd] | Static baseline deficit |
| ASD | Systemic mitochondrial ETC dysfunction + low BH4 [@Frye2024ASDmitochondria] [@Fanet2021BH4neuro] | Static baseline deficit |
...
Each condition reduces the brain's metabolic reserve through a different mechanism. The convergent result: less buffer to absorb an immune insult. Neurodivergent traits in childhood predict chronic disabling fatigue in adolescence [@Quadt2024neurodivergentfatigue]. The convergent outcome when a virus arrives: ME/CFS.
