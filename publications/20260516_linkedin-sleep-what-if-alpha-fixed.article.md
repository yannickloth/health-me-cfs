...
Alpha-delta sleep — the intrusion of waking-frequency alpha waves into deep sleep — is one of the most documented objective abnormalities in ME/CFS and fibromyalgia (Moldofsky et al. 1975, *Psychosomatic Medicine*; Roizenblatt et al. 2001, *Arthritis & Rheumatism*). It prevents the brain from entering the slow-wave oscillations that drive overnight restoration. A previous article in this series described the thalamic calcium channel dysfunction hypothesised to cause it (not yet directly tested in ME/CFS patients).
...
Cerebral hypoperfusion continues. ME/CFS patients show reduced cerebral blood flow — 26% reductions documented during orthostatic challenge versus 7% in controls (van Campen et al. 2020, *Clinical Neurophysiology Practice*) — driven by autonomic dysfunction, endothelial dysfunction, and reduced blood volume. The brain's oxygen supply is limited regardless of how well it sleeps. Cognitive tasks that demand increased blood flow would still fail at the supply level.
...
## The partial improvement problem
...
## What not to do — and why standard advice backfires
...
## Current pharmacological approaches to alpha-delta sleep
...
Gabapentin and pregabalin are the most commonly prescribed. They bind alpha-2-delta voltage-gated calcium channel subunits, increasing slow-wave sleep and reducing alpha-frequency activity during NREM (Lo et al. 2002, *Epilepsia*). Gabapentin (100–600 mg at bedtime) is first-line when pain and sleep disturbance co-occur; pregabalin (25–150 mg) has similar efficacy with more predictable pharmacokinetics. Both improve delta power on polysomnography, but neither fully eliminates alpha intrusion — they shift the ratio rather than resolve the underlying oscillatory dysfunction.
...
The dual orexin receptor antagonists suvorexant and lemborexant target the orexin-driven hyperarousal that may sustain alpha intrusion (López-Amador et al. 2025, *Exploration*), and are mechanistically interesting given the documented orexin system dysfunction in ME/CFS — though clinical experience in this population remains limited. Z-drugs (zolpidem, eszopiclone) are effective for sleep initiation but do not address the unrefreshing quality of ME/CFS sleep; zolpidem's suppression of glymphatic-driving norepinephrine oscillations may actively worsen waste accumulation (Hauglund et al. 2025).
...
- Staresina B et al. (2015). Hierarchical nesting of slow oscillations, spindles and ripples in the human hippocampus during sleep. *Nature Neuroscience*, 18(11), 1569–1576.
...
- NICE (2021). Myalgic encephalomyelitis/chronic fatigue syndrome: diagnosis and management. NICE guideline NG206.
- Hauglund NL et al. (2025). Norepinephrine-mediated slow vasomotion drives glymphatic clearance during sleep. *Cell*, 188(3), 568–583.
- Lo HS et al. (2002). Gabapentin increases slow-wave sleep in normal adults. *Epilepsia*, 43(Suppl 7), 280.
- López-Amador N et al. (2025). Orexin system dysfunction in ME/CFS: an integrative review. *Exploration*, doi:10.37349/ent.2025.1004112.
- Coulter DA et al. (1989). Specific petit mal anticonvulsants reduce calcium currents in thalamic neurons. *Neuroscience Letters*, 98(1), 74–78.

---

*Previous article in this series: [Tired But Wired](https://www.linkedin.com/pulse/) — the autonomic betrayal at bedtime.*
...
*#MECFS #MyalgicEncephalomyelitis #ChronicFatigueSyndrome #Sleep #AlphaWaveIntrusion #BrainFog #GlymphaticSystem #DrugDevelopment #MultiMechanism #LongCOVID #PostInfectiousDisease #PatientAdvocacy #MedicalResearch #OpenAccess*
