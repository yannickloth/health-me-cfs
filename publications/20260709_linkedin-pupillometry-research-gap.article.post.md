...
This is not an academic dispute. A patient with a positive autoantibody test faces a real decision: pursue immunomodulatory therapy — IVIG, immunoadsorption, BC007 — expensive, invasive, unproven — or ignore a result that might be telling the truth. Right now, there is no way to know.
...
Nobody has run this study. The last attempt was 1997, with pharmacological methods, n<20. Meanwhile, pupillometry is routine in concussion, diabetes, MS, and post-COVID. The technology exists. The cohorts exist. The budget is a fraction of a typical metabolomics grant.
