...
The characteristic failure to reproduce CPET-1 performance on CPET-2 represents a disease-specific signature that distinguishes ME/CFS from other fatigue conditions and potentially from post-COVID conditions with overlapping symptomatology. (Certainty: 0.50. 0.60→0.50: Mancini/Natelson 2026 NH-funded null replication — equiv powered, independent lab, senior investigator — brings evidence to equipoise. One positive study (Keller 2024, CCC, n=84+71) and one equivalently powered null (Mancini 2026, Fukuda+PEM, n=58+25). Elevated RPE is the consistent replicating finding across ALL studies — but RPE is a subjective self-report measure, not an objective metabolic biomarker. The CPET signature hypothesis now rests on partial evidence and faces genuine uncertainty.)

*Evidence Base.* ME/CFS patients show CPET-2 deterioration across multiple studies @Keller2024CPET @vanCampen2021FemaleCPET @vanCampen2021MaleCPET, whereas ICF patients show CPET-2 improvement similar to healthy controls @vanCampen2021FemaleCPET @vanCampen2021MaleCPET. Long COVID patients with PEM symptoms do NOT show the same 2-day CPET pattern @Gattoni2025LongCOVIDCPET. However, a 2026 null replication by Mancini, Natelson et al.\ (Fukuda criteria, n=58 ME/CFS + 25 sedentary controls) found no significant group-average Day 1→Day 2 decline in VO₂ or VO₂ at VT @Mancini2026CPET, while confirming elevated perceived exertion (Borg RPE) at all workloads — a finding common to all CPET studies. The CPET signature's reliability may depend on patient selection criteria (CCC vs. Fukuda), max-effort enforcement standards, and whether the signal of interest is group-average metabolic decline or individually elevated RPE.
...
The two-day CPET protocol @keller2024cpet provides evidence of _functional_ deterioration (reduced VO#sub[2]max, workload, and ventilatory threshold on Day 2). However, a 2026 null replication by Mancini, Natelson et al.\ (n=58 ME/CFS, Fukuda criteria, n=25 sedentary controls) found no significant Day 1→Day 2 group-average decline in peak VO₂ or VO₂ at VT @Mancini2026CPET. This null result raises critical questions about replicability: the Keller (2024) and Mancini (2026) studies differ on patient criteria (CCC vs. Fukuda), max-effort enforcement, and COI status. Both studies concur that ME/CFS patients have elevated perceived exertion at all workloads and lower maximal HR. The mechanistic hypotheses built upon CPET findings have not been directly tested:
