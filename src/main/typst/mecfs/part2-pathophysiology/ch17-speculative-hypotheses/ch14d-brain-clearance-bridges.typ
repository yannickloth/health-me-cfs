...
=== Brain Clearance Architecture: Cross-Disease Bridges

#speculation(title: [ME/CFS and Alzheimer's Disease: Shared Clearance Failure, Divergent Pathology])[
*Certainty: 0.30.* Yang et al. (2026, now published as Chayama et al.) showed that amyloid pathology (5XFAD mice) causes parenchymal protein retention and border exit obstruction — waste is trapped in the brain @Chayama2026BrainClearance. The neurodegeneration risk speculation (ch15, @spec:ch15-neurodegeneration-risk) already proposes that chronic glymphatic impairment may elevate long-term AD risk in ME/CFS. This bridge formalizes the similarities and differences.
...
#speculation(title: [ME/CFS and Parkinson's Disease: LC-NE Oscillation Impairment as Shared Mechanism])[
*Certainty: 0.30.* Parkinson's disease involves early LC degeneration. SleepFM predicts PD with C-index 0.89 from sleep decoupling patterns @Thapa2026sleepfm. ME/CFS involves LC-NE oscillatory dysfunction (ch15, @sec:ch15-ne-vasomotion) without documented neuronal loss. The Chayama et al.\ nearest-exit principle @Chayama2026BrainClearance predicts that LC degeneration in PD would disproportionately impair dorsal brainstem and basal ganglia clearance (LC-projecting regions), while ME/CFS LC dysfunction (functional, not degenerative) may produce a different regional impairment pattern.
...
#speculation(title: [ME/CFS and Narcolepsy: Orexin Deficiency Spectrum])[
*Certainty: 0.30.* Orexin deficiency is documented in ME/CFS (intermediate levels, approximately 250 pg/mL CSF, Section @sec:ch15-orexin). Narcolepsy type 1 involves severe orexin loss (less than 110 pg/mL CSF). Both conditions involve sleep-wake fragmentation. Chayama et al.\ show that sleep architecture (specifically SWS) powers glymphatic clearance @Chayama2026BrainClearance. This bridge proposes that ME/CFS represents a milder, reversible form of orexin deficiency on the same spectrum — functional (neuroinflammation-mediated suppression) rather than structural (autoimmune neuron destruction as in narcolepsy).
...
#speculation(title: [ME/CFS-Long COVID Clearance Mechanism Divergence])[
*Certainty: 0.35.* H9 (waste trapping vs. reduced generation) proposes divergent mechanisms despite similar symptoms. Both show brain fog and DTI-ALPS reduction. Long COVID may involve reduced neuronal metabolic activity (hibernation-like state with matched generation/clearance), while ME/CFS involves impaired clearance of normal metabolic output (generation exceeds clearance). Chayama et al.\ @Chayama2026BrainClearance show that inflammation reroutes clearance to blood while proteinopathy traps waste — both failure modes could operate differently in each condition.
