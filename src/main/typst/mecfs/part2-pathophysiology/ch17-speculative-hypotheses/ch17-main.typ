...
#landscape[
  #figure(
    table(
      ...
      table.cell(colspan: 7, fill: luma(230))[_*CPET-Derived Hypotheses (Objective Functional Data)*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Core Mechanistic Hypotheses*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Autoimmune/Immune Hypotheses*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Viral/Cellular Hypotheses*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Metabolic Compartmentalization Hypotheses*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Integrated/Multi-System Hypotheses*_],

      [Selective energy dysfunction], [Moderate], [High], [Moderate--High], [Moderate--High], [Preserved autonomous functions (hair, nails), impaired CNS-dependent processes; demand-response failure], [Hair follicle mito assay; CSF lactate; CNS-targeted delivery (Section @sec:selective-dysfunction)],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*Cycle Dynamics Hypotheses*_],
      ...
      table.cell(colspan: 7, fill: luma(230))[_*High-Risk/Counterintuitive Hypotheses*_],
    ...
    kind: table,
    supplement: [Table],
    caption: [Comprehensive ranking of all speculative hypotheses by evidence level, therapeutic potential, and impact on different severity levels],
  ) <tab:all-hypotheses>
]
...
*Understanding evidence levels:*
    ...
    - _Very Low:_ Purely theoretical speculation; interesting for research but no evidence
    - _Low:_ Mechanism makes sense based on other diseases; no ME/CFS-specific data
    - _Low-Moderate:_ Some indirect evidence in ME/CFS; plausible but unproven
    - _Moderate:_ Multiple ME/CFS studies support mechanism; direct intervention untested
    - _Moderate-High:_ Strong mechanistic support; similar interventions show promise
    - _High:_ Direct evidence from ME/CFS trials (rare in this chapter, as these are speculative hypotheses)

*Severity-specific guidance:*

    - _Mild-moderate patients:_ May benefit from metabolomics-guided approaches, autonomic support, circadian optimization
    - _Severe patients:_ Prioritize hypotheses addressing core metabolic function (safe mode, mitochondrial turnover, glymphatic clearance); avoid any interventions requiring exertion
    - _All severities:_ Multi-lock hypothesis suggests combinations may work better than single interventions

=== Qualification and Caveats

#warning-env(title: [Speculative Content])[
