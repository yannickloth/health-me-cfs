...
Multiple mechanisms likely contribute to orthostatic cerebral hypoperfusion in ME/CFS. Evidence strength varies: *(documented)* = directly measured in ME/CFS studies; *(inferred)* = logically derived from observed relationships; *(hypothesized)* = proposed mechanism not yet directly tested.
    ...
    - *Impaired cerebral autoregulation* *(inferred)*: Failure of compensatory vasodilation during reduced perfusion pressure; inferred from near 1:1 CO-CBF relationship where healthy controls show compensatory vasodilation @VanCampenEtAl2024
...
*Certainty: 0.45.* ME/CFS patients paradoxically report both heat and cold intolerance — two symptoms that appear to require opposite vascular states. Heat intolerance requires vasodilation failure (cannot dissipate heat), cold intolerance requires thermogenesis failure (cannot conserve or generate heat). Cambras et al. demonstrated that skin temperature circadian rhythm disruption is associated with elevated endothelin-1 (ET-1), a potent vasoconstrictor @Cambras2023SkinTemperatureEndothelin. This suggests a vasomotor bias toward tonic vasoconstriction: ET-1 elevation locks cutaneous vessels in a chronically constricted state, preventing both heat-induced vasodilation (→ heat intolerance) and cold-induced perfusion for thermogenesis (→ cold intolerance). Normally, cutaneous vessels flip-flop between dilated (heat dissipation) and constricted (heat conservation) states with high dynamic range. In ME/CFS, the vasomotor setpoint is shifted toward constriction, compressing the dynamic range from both sides — vessels cannot dilate enough for cooling, and cannot recruit enough perfusion for warming. This single mechanism elegantly explains the dual-intolerance paradox without requiring separate heat and cold pathways. Falsifiable: laser Doppler flowmetry will show baseline cutaneous perfusion 40% lower in ME/CFS than controls; both heat challenge (43°C) and cold challenge (15°C) will elicit blunted perfusion responses in ME/CFS; ET-1 receptor antagonism will restore perfusion flexibility.
