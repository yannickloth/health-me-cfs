...
*Layer 6: PEM Loop.* Exercise-induced metabolic stress (lactate, succinate accumulation) activates danger signal pathways (Section @sec:ch15-metabolic-danger), triggering TLR4/NF-$kappa$B and NLRP3 inflammasome activation (Section @sec:ch15-cytokine-fatigue). The resulting cytokine surge recapitulates the sickness behavior state (acute, disproportionate, sustained) — post-exertional malaise. Importantly, PEM is not deconditioning; it is the acute re-engagement of the neuroinflammatory cascade triggered by metabolic stress. This is now supported by direct empirical evidence: Charlton et al. (2026) demonstrated that 60 days of strict bed rest in healthy volunteers produces a muscle phenotype qualitatively different from ME/CFS and long COVID at five independent dimensions — glycolytic shift, Type I-selective atrophy, OXPHOS–V̇O₂ₘₐₓ uncoupling, capillary density divergence, and ventilatory patterns — none of which are reproduced by extreme physical inactivity @Charlton2026MuscleBedrest. This explains PEM's delayed onset (24–48h), its disproportionate severity relative to the exertion that triggered it, and its multi-system nature.
