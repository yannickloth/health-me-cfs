...
The characteristic failure to reproduce CPET-1 performance on CPET-2 represents a disease-specific signature that distinguishes ME/CFS from other fatigue conditions and potentially from post-COVID conditions with overlapping symptomatology. (Certainty: 0.55. 0.60→0.55: Mancini/Natelson 2026 null replication of Day 2 group-average decline reduces certainty; incoming evidence certainty 0.60. Framework remains supported by ME/CFS vs ICF discrimination data and elevated RPE across all studies.)
