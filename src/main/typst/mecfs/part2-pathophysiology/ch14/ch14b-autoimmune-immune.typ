...
==== Treatment Trial Evidence
    ...
    Two sham-controlled RCTs of immunoadsorption have been completed as of late 2025—IA-PACS-CFS at Charité Berlin (n=66, NCT05710770, protocol published @Pressler2024IAPACSCFSprotocol) and EXTINCT at Hannover Medical School (n=63, NCT05954325 @EXTINCTtrial2023)—with results pending. These will be the first placebo-controlled tests of immunoadsorption in ME/CFS and are expected to resolve whether the 70% open-label response rate reflects genuine efficacy or non-specific effects of an invasive procedure. The IMPACT trial (NCT07529197 @IMPACTtrial2026) at Charité, recruiting since March 2026, will additionally measure memory B-cell dynamics after IA—addressing the mechanistic question of why some patients relapse (memory B-cell repopulation and re-synthesis of autoantibodies).
