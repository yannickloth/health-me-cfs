...
Defective ECM in hEDS lymph nodes may produce:
    ...
    - *Looser FRC networks:* Altered stromal architecture could change the spatial organisation of T cell zones and B cell follicles, reducing the efficiency of antigen presentation and immune synapse formation.
    ...
    - *Permissive niches for viral persistence:* If the Kol et al.\ FIP model @Kol2026fipv applies to humans, virus-harbouring lymphocytes may find sanctuary in structurally abnormal lymph node regions where immune surveillance is spatially disorganised.
