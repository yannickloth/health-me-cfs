...
Hodgkin lymphoma (HL) has a well-characterised bimodal age distribution with peaks at ~20 and ~55 years. Strikingly, the early HL peak is EBV-associated (~70% of young-adult HL is EBV+ mixed cellularity subtype), while the late peak is EBV-negative (nodular sclerosis subtype). This mirrors the ME/CFS pattern: early peak enriched for EBV/IM triggers, late peak with less infectious trigger predominance. Both diseases may share a common vulnerability mechanism---impaired EBV immune control during young adulthood---but diverge in which cell types are transformed or dysregulated. Family history of HL may be enriched in early-onset ME/CFS families (testable prediction), and genetic variants predisposing to EBV+ HL (HLA-A*01, HLA-B*37) may overlap with early-onset ME/CFS susceptibility. The cross-disease comparison reinforces that bimodal onset can reveal immunologically distinct disease subtypes within a single diagnosis @Grotmol2011HLbimodal.
*Certainty: 0.20* (established HL bimodal epidemiology; mechanistic parallel with ME/CFS is plausible but entirely untested; no direct evidence of shared genetic susceptibility or familial overlap).
...
Type 1 diabetes (T1D) incidence peaks at puberty (ages 10--14), coinciding with pubertal thymic involution and autoimmune susceptibility. T1D is a classical autoimmune disease where autoreactive T cells targeting pancreatic beta cells escape thymic deletion. The parallel with early-onset ME/CFS is mechanistic rather than epidemiological: both may exploit the same window of pubertal thymic insufficiency, but the disease manifestation (T1D vs. ME/CFS) depends on which autoantigens are targeted. This predicts that families with both T1D and ME/CFS will show enrichment for immune-regulatory gene variants affecting thymic selection (AIRE, FOXP3), and that early-onset ME/CFS patients may have higher rates of islet autoantibodies (GAD65, IA-2) than late-onset patients or controls, even without clinical diabetes.
...
The ~80% female ratio in ME/CFS is identical between the early and late onset peaks @McGrath2026bimodalOnset, despite divergent hormonal trajectories (pubertal hormone surge in the early peak, perimenopausal transition in the late peak). If sex hormones were the primary driver of female susceptibility, the ratio should differ between peaks. This paradox points to a non-hormonal mechanism present from birth: X chromosome dosage effects on immune gene expression. The X chromosome carries the highest density of immune-related genes in the genome (TLR7, TLR8, CD40L, FOXP3, CXCR3). X chromosome inactivation (XCI) is incomplete for these immune genes---"escapee" genes produce higher expression in XX individuals regardless of hormonal state (XCI escape in immune genes is well-established; Carrel & Willard 2005). This creates a baseline immune activation (or dysregulation propensity) difference that is constant across age and therefore constant across both peaks, explaining the identical female ratio. The ~80% (not 50%) reflects that only a subset of X-linked immune variants are XCI escapees; the remaining ~20% male cases represent individuals with particularly strong genetic or environmental triggers that overcome the X-dosage advantage. This hypothesis predicts that: (a) XCI escape skewness will be higher in female ME/CFS patients than controls; (b) the magnitude will not differ between early- and late-onset; (c) males with Klinefelter syndrome (XXY) will have elevated ME/CFS risk approaching female rates; (d) females with Turner syndrome (XO) will have reduced risk.
