...
Wound healing — previously listed among preserved processes — has been removed from this framework. Wound healing is a complex, multi-phase, demand-responsive cascade requiring NK cell mobilisation, autonomic vascular regulation, and substantial energy expenditure. No study has measured wound healing in ME/CFS patients. Mechanistic evidence from three independent pathways — NK cell dysfunction @Baraniuk2024NKMeta @Sobecki2021NKWoundHypoxia, sympathetic overactivation @Xue2018ANSWoundHealing, and immune exhaustion @Stanojcic2016ImmuneExhaustionBurns — each based on single studies with substantial caveats, suggests abnormal healing dynamics rather than normal preservation. The assumption of preservation is unsupported, but so is the prediction of impairment — direct measurement is needed (see Chapter @ch:energy-metabolism Section @oq:wound-healing-mecfs for full analysis).
]
...
#key-point(title: [Preserved vs. Impaired Processes])[
...
#definition(title: [CNS-Dependency Index])[
...
#definition(title: [Demand-Responsiveness Index])[
...
#definition(title: [Selective Dysfunction Severity])[
...
#hypothesis(title: [Selective Dysfunction Hypothesis])[
...
#warning-env(title: [Table Values Are Illustrative, Not Independent Validation])[
...
#hypothesis(title: [CNS Energy Triage])[
...
#hypothesis(title: [BBB Compartmentalization])[
...
#hypothesis(title: [Sickness Behavior Stuck On])[
...
#key-point(title: [Treatment Strategy from Selective Dysfunction Model])[
...
#key-point(title: [Model Interpretation])[
...
#hypothesis(title: [Sleep Architecture CNS Coordination Failure])[
...
#hypothesis(title: [Autoantibody-Induced Autonomic Inefficiency])[
...
#hypothesis(title: [Mast Cell Activation Amplifies CNS Energy Deficit])[
...
#hypothesis(title: [Hierarchical Memory Impairment from Energy Triage])[
...
#hypothesis(title: [Parallel Coordination Failure Under Exercise])[
...
#hypothesis(title: [CNS-Primary to Global Subtype Progression])[
