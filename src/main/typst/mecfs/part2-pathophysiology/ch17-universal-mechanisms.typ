...
- *Dendritic cell and monocyte dysfunction.* Reduced conventional and plasmacytoid DCs; altered monocyte metabolic state; impaired antigen presentation capacity. pDC depletion is a conserved post-viral and autoimmune phenomenon (documented across HIV, HCV, HBV, COVID-19, SLE, RA) driven by chemokine-mediated blood→tissue migration (CXCR3/CXCL9-11, CXCR4/CXCL12) rather than absolute cell loss @VanderSluis2022pDCcovid @Li2017pDCdisease. Consequences include systemic DNase1L3 deficiency (impaired NET degradation), reduced systemic type I IFN production, and tissue-localised IFN-α-driven inflammation @GarciaLabroucheColomer2024 @PerezGomez2021pDCpersist.
