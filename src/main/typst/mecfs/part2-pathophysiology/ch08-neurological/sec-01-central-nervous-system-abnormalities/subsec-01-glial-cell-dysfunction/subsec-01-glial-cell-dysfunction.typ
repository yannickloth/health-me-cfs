...
The post-viral CNS reprogramming hypothesis above is framed around neurotropic _viruses_. An emerging literature suggests the mechanism may not be virus-specific: the bacterial tick-borne pathogens implicated in ME/CFS-like illness — principally _Borrelia_, with weaker single-study support for _Bartonella_ (Chapter @ch:immune-dysfunction, @hyp:tickborne-glycolytic-reprogramming) — also drive glycolytic reprogramming of nucleated host cells. (The protozoan _Babesia_ is excluded here: its metabolic effect is transporter-level glucose uptake in anucleate erythrocytes, which cannot undergo transcriptional/epigenetic reprogramming and has no glial analogue.) If _Borrelia_ or _Bartonella_ reprogram glia, the same self-sustaining cycle (metabolic shift $arrow.r$ epigenetic stabilisation $arrow.r$ chronic neuroinflammation) could apply.
...
*Falsifiable prediction.* Microglia or astrocytes exposed to _Borrelia_ or _Bartonella_ antigens in vitro will show a sustained OXPHOS-to-glycolysis shift (elevated LDHA/lactate, downregulated mitochondrial transcripts, H3K4me1/H3K27ac deposition at inflammatory loci) persisting after antigen removal, comparable to the viral glial reprogramming of @Rodrigues2025ViralReprogrammingGlialMetabolism. Falsified if bacterial antigen exposure produces only transient metabolic change with no epigenetic stabilisation in glia.
...
*Consequence:* If tick-borne bacteria (Borrelia, Bartonella) reprogram glia the way viruses appear to, then the "post-viral" framing of chronic neuroinflammation is too narrow — a broader "post-infectious glial reprogramming" model would predict that patients with tick-borne triggers could benefit from the same metabolic/epigenetic-reversal strategies proposed for post-viral ME/CFS, rather than antimicrobials alone; this remains an untested research direction.
