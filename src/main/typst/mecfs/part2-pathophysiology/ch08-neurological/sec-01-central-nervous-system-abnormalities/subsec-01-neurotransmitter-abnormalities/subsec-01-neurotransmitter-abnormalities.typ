...
*Consequence:* This reframes the apathy of postviral illness not as laziness or depression but as a biochemically driven trap — the brain's reward machinery may be receiving a weaker input signal, and the resulting motivational deficit would be a rational response to a biological constraint, not laziness. (Origin: brainstorm.)
...
The treatment implication (Speculation @spec:dopaminergic-augmentation-mecfs, ch24) is that dopamine augmentation — L-DOPA to increase synthesis, MAO-B inhibitors to reduce degradation, or dopamine agonists to bypass terminals — targets the functional deficit directly. However, the structural component (terminal loss) may be irreversible, limiting ceiling effects, and the energetic component warns that augmenting cytosolic dopamine without adequate antioxidant or mitochondrial support could worsen oxidative damage.
