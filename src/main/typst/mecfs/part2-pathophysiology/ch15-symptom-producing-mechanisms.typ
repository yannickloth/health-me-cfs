...
*Unresolved paradox — suppressing already-low orexin.* All of the above agents ultimately converge on reducing pathological tau phosphorylation. However, the Parhizkar et al.\ temporal finding complicates the picture: active-phase dosing (suppressing *high* endogenous orexin) was more effective than inactive-phase dosing. ME/CFS involves partial orexin *suppression* — not elevation. If ME/CFS patients already have reduced orexin→cAMP→PKA signalling, further pharmacological suppression may produce diminishing returns or paradoxical effects. The "tired but wired" phenotype suggests incomplete suppression: residual orexin tone during fragmented sleep may be sufficient to sustain pathological phosphorylation while being insufficient to consolidate sleep. In this scenario, DORAs could provide dual benefit (sleep quality + PKA dampening). But if orexin is truly suppressed below the threshold for pathological PKA activation, DORAs provide no incremental tau benefit and may worsen daytime fatigue. This is the central unresolved question for any ME/CFS application of tau-focused medications: *is endogenous orexin tone in ME/CFS high enough to drive pathological tau phosphorylation, or is it already below that threshold?*
