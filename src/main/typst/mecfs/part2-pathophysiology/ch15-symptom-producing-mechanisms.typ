...
*Certainty: 0.35.* (0.30→0.35: externally validated at general principle level by SleepFM @Thapa2026sleepfm, which demonstrates that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions, supporting the coupling-integrity mechanisms described in this loop) The orexin suppression and glymphatic failure mechanisms described above may form a closed positive feedback loop entirely within the CNS:
...
*Certainty: 0.30.* (0.25→0.30: externally validated at general principle level by SleepFM @Thapa2026sleepfm, which demonstrates that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions, supporting the alpha-delta decoupling mechanism as pathogenic rather than epiphenomenal) The NE infraslow oscillation ($tilde$0.05 Hz) drives vasomotion at a specific frequency @Hauglund2025neVasomotion. Thalamocortical delta oscillations (0.5--4 Hz) nest _within_ these slower NE oscillations --- the two must be phase-locked for optimal glymphatic flow, because the neural slow wave drives blood volume changes that in turn drive CSF pulsation @Fultz2019csfOscillations.
...
*Certainty: 0.30.* (0.25→0.30: externally validated at general principle level by SleepFM @Thapa2026sleepfm, which demonstrates that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions, supporting the glymphatic-coupling mechanism as a pathogenic driver) Physical and cognitive exertion increase neuronal metabolic waste production (extracellular potassium, lactate, adenosine, and potentially tau fragments). In health, the next sleep episode clears this waste via glymphatic flow. In ME/CFS with impaired glymphatic clearance, exercise-generated waste accumulates _additively_ because overnight clearance is insufficient.
...
Arterial pulsatility provides an independent contributor to glymphatic flow. Hablitz and Nedergaard (2021) showed that reduced arterial pulsatility --- from cardiovascular deconditioning, low blood pressure, or reduced cardiac output --- can decrease glymphatic transport by up to 50% @HablitzNedergaard2021glymphatic. ME/CFS patients with orthostatic intolerance (OI) and POTS exhibit precisely this pattern: reduced cerebral perfusion pressure during upright posture and, potentially, reduced nocturnal arterial pulsatility from autonomic dysfunction. The convergence of LC-NE dysfunction, reduced arterial pulsatility, and impaired SWS architecture represents a triple hit on glymphatic clearance. This triple-hit concept is consistent with the SleepFM finding that multimodal physiological decoupling — not any single abnormal signal — carries the strongest disease-predictive weight @Thapa2026sleepfm.
...
*Certainty: 0.30.* (0.25→0.30: externally validated at general principle level by SleepFM @Thapa2026sleepfm, which demonstrates that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions including neurodegenerative diseases (C-index 0.85 for dementia, 0.89 for Parkinson's), supporting glymphatic coupling disruption as a mechanistic pathway to neurodegeneration) ME/CFS patients with chronic impairment of slow-wave sleep quality (alpha-delta intrusion), LC-NE oscillatory dysfunction (Section @sec:ch15-ne-vasomotion), and reduced arterial pulsatility (OI/POTS) may accumulate tau and amyloid-$beta$ at rates exceeding age-matched controls. If sustained over years to decades, this triple-hit on glymphatic clearance could elevate long-term risk of Alzheimer's disease or related tauopathies.
...
*Domain 3: Systems-Level Amplifier Suppression.*
   - *Sleep-glymphatic axis optimization:* Improving slow-wave sleep (SWS) content (not just duration) drives glymphatic clearance. The NE-vasomotion mechanism (Section @sec:ch15-ne-vasomotion) adds an important drug-selection criterion: sleep aids should preferably _not_ suppress the NE oscillations that drive glymphatic flow. SleepFM's large-scale validation that cross-modal physiological decoupling during sleep predicts disease onset @Thapa2026sleepfm provides external support for prioritizing coupling-preserving interventions.
