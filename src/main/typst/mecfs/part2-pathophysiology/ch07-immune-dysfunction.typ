...
Study: (mechanistic inference from Santos Guedes 2026 BBB crossing data + FcRn biology; certainty: 0.30, downgraded from 0.45 after adversarial review because: the quantitative 3--10× amplification factor is extrapolated from blood-placenta and gut barriers, not measured at the BBB; FcRn expression and kinetics at the human BBB are poorly characterised; CNS FcRn may serve protective functions making blockade unpredictable; speculative).
