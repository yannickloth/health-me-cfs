...
#include "../figures/fig-hpa-axis-normal.typ"
...
Multiple studies document a consistent pattern of cortisol abnormalities in ME/CFS patients that differs qualitatively from both healthy individuals and patients with primary adrenal disorders. Baseline cortisol levels tend to be lower, though typically remaining within the broad “normal” laboratory reference range. The diurnal cortisol rhythm shows flattening, with reduced amplitude between morning and evening values. The cortisol awakening response (CAR)—the normal sharp rise in cortisol during the first 30–60 minutes after waking—appears attenuated. Additionally, cortisol responses to physiological and psychological stressors are blunted, despite appropriate ACTH response to exogenous CRH stimulation in some studies @pipper2024steroid.
The NIH deep phenotyping study by Walitt et al.\ identified neuroendocrine abnormalities consistent with HPA axis dysfunction, including altered catecholamine metabolism that affects upstream regulation of the HPA axis @walitt2024deep. The reduced central catecholamines documented in cerebrospinal fluid may contribute to impaired hypothalamic CRH release, providing a mechanistic link between neurological and endocrine dysfunction.

#clinical-finding(title: [CRH Neuron Depletion in ME/CFS Hypothalamus])[
*Certainty: 0.30.* Preliminary autopsy findings from the University of Amsterdam presented at the 2025 IACFS conference indicate dramatic reduction in CRH-producing neurons in the hypothalamus of ME/CFS patients (n=7–10 autopsies) @HealthRising2025. This finding suggests structural loss of CRH neurons rather than purely functional downregulation, providing a potential anatomical substrate for the blunted CRH secretion and HPA axis hypoactivation documented in ME/CFS. If confirmed through peer-reviewed publication, this would represent the first direct evidence of neuroanatomical HPA axis damage in ME/CFS, distinguishing the disorder from functional HPA dysregulation observed in other chronic stress conditions.
Limitations: Secondary source (Health Rising conference report), not peer-reviewed, sample size small (n=7–10), methodological details limited, no control group specified in available reports. Independent replication and full peer-reviewed publication required before certainty can be elevated. The finding requires distinction between: (a) actual neuron loss (cell death), (b) epigenetic silencing of CRH expression in surviving neurons, and (c) methodological artifact or tissue processing issue.
] <cf:crh-neuron-depletion>

Recent sex-stratified analysis by Pipper et al.\ (2024) revealed that cortisol dysregulation patterns differ significantly between male and female ME/CFS patients and vary by disease severity @pipper2024steroid. Female patients with severe ME/CFS demonstrated elevated 11-deoxycortisol (a cortisol precursor) and 17$alpha$-hydroxyprogesterone, suggesting impaired final enzymatic steps in cortisol synthesis. Male patients with mild to moderate disease showed frankly reduced cortisol and corticosterone levels but paradoxically elevated progesterone. These findings indicate that HPA dysfunction may involve enzyme deficiencies in steroidogenesis rather than simple hypothalamic-pituitary signaling deficits.

==== ACTH and CRH Abnormalities
...
==== Stress Response Abnormalities and Post-Exertional Malaise
...
==== Immune System Effects and Chronic Inflammation
...
The cerebral glucose hypometabolism documented by PET imaging studies (Tirelli et al., 1998; Siessmeier et al., 2003) may partly reflect inadequate cortisol support for glucose uptake and utilization @tirelli1998pet @siessmeier2003pet. Additionally, the blunted morning cortisol peak fails to provide the metabolic “boost” needed to transition from fasting metabolism to active daytime metabolism, contributing to severe morning fatigue and the prolonged time required to achieve minimal function after waking.

These metabolic effects connect directly to the mitochondrial dysfunction and energy metabolism deficits discussed in Chapter @ch:energy-metabolism, suggesting that HPA axis abnormalities and cellular metabolic dysfunction represent interconnected rather than independent pathophysiological processes.
...
==== Low Morning Cortisol in Severely Ill Patients.
A comprehensive biomarker examination of severely ill (housebound/bedbound) ME/CFS patients @Komaroff2021severe documented significantly reduced morning salivary cortisol compared to age- and sex-matched healthy controls: median 0.20 mcg/dL in severe ME/CFS vs.\ 0.45 mcg/dL in controls (p = 0.002). To contextualize these values clinically: normal morning salivary cortisol ranges from approximately 0.10 to 0.90 mcg/dL, with 0.20 mcg/dL representing roughly the 15th percentile and 0.45 mcg/dL representing the 50th percentile of the healthy population distribution. Thus, severe ME/CFS patients exhibit cortisol levels that, while not meeting formal diagnostic criteria for adrenal insufficiency ($<$0.10 mcg/dL), fall well below the physiological optimum for barrier maintenance and metabolic function. This 55% reduction in morning cortisol suggests substantial HPA axis dysregulation in the severe patient population. While the mechanisms remain debated, the functional consequence is reduced cortisol availability during periods when barrier repair processes are most active.

==== Cortisol's Role in Intestinal Barrier Function.
...
==== Impaired Barrier Repair in Severe ME/CFS: Mechanistic Hypothesis.
Integrating low cortisol with evidence of baseline gut permeability @GutPermeability2023, severe patients likely exhibit: (1) daily micro-damage from minimal activities (cognitive work, postural changes, meals) triggering transient splanchnic hypoperfusion; (2) insufficient nocturnal cortisol for barrier repair; (3) accumulating baseline permeability; (4) the cytokine-barrier bidirectional cycle (cytokines $arrow.r$ tight junction disruption $arrow.r$ LPS $arrow.r$ cytokine amplification); and (5) nutritional deficits (low albumin in severe patients) limiting epithelial regeneration substrate. This model suggests wheat elimination response may be slower in severe patients due to impaired barrier repair capacity, but nutritional support (protein, micronutrients) and optimization of morning cortisol timing may accelerate recovery.
...
=== Reproductive Health and Gynecological Risk Factors

==== Menstrual Cycle Effects and Hormonal Fluctuations
...
#warning-env(title: [Replication Status: Partially Replicated (Same Group)])[
...
=== Mechanisms of Sex Hormone Influence on ME/CFS
...
==== Immune Modulation by Sex Hormones
...
The sex-specific endocrine and immune patterns reported across studies have important epistemic boundaries:
    ...
    - Hormonal differences between male and female ME/CFS patients do not establish that sex hormones _cause_ the differing immune signatures—shared genetic susceptibility, sex-chromosome immune gene dosage, or other confounders may explain both.
...
=== Evidence for GH/IGF-1 Axis Dysfunction
...
Appetite control in ME/CFS is disrupted through multiple interacting pathways that connect energy sensing, metabolic state, and neuroendocrine signaling. Understanding these mechanisms is clinically important because abnormal appetite patterns can drive body composition changes (see Chapter @ch:additional-symptoms) and complicate medication management.

*AMPK as a Cellular Energy Sensor.*
AMP-activated protein kinase (AMPK) is a master cellular energy sensor that is activated when the cellular ATP:AMP ratio falls—precisely the condition present in ME/CFS due to mitochondrial dysfunction and impaired oxidative phosphorylation. AMPK activation suppresses anabolic processes and drives compensatory responses including hunger signaling (to seek more fuel) and metabolic switching. However, chronic AMPK activation in ME/CFS—reflecting persistent cellular energy deficit—may produce paradoxical downstream effects: while AMPK normally promotes fat oxidation, impaired downstream fatty acid oxidation enzymes (ACAD, CPT; see Chapter @ch:energy-metabolism) prevent this compensation from succeeding @Maya2023fattyacid. The cellular hunger signal is generated but cannot be satisfied by the intended metabolic response.

*Leptin Resistance.*
Leptin is an adipokine secreted by fat cells that signals satiety to the hypothalamus, suppressing appetite and increasing energy expenditure proportional to fat stores. Multiple metabolic abnormalities in ME/CFS converge to impair leptin signaling:

    - Elevated leptin levels have been documented in ME/CFS patients, particularly in the insulin-resistant metabolic subtype, consistent with leptin resistance (where high circulating leptin fails to produce adequate satiety signaling) @Hoel2021metabolicphenotypes
    ...
    - The resulting leptin resistance may drive continued fat accumulation despite elevated leptin levels, contributing to the sarcopenic obesity pattern documented in ME/CFS — a pattern in which standard caloric equations overestimate needs by 15–30%, and positive energy balance paradoxically accelerates muscle loss @Alazzam2023SCI @Biolo2008BedRest
...
#warning-env(title: [Misattribution of Orthostatic Symptoms to Hypoglycemia])[
...
=== Objective Documentation of Circadian Disruption

<obs:circadian-disruption>
Cambras et al.\ (2018) employed rigorous actigraphy monitoring to objectively document circadian rhythm abnormalities in ME/CFS patients @cambras2018circadian. This case-control study of 10 women with ME/CFS and 10 matched controls revealed that daily activity levels were significantly lower in ME/CFS patients, relative amplitude of the activity rhythm (difference between peak and nadir) was reduced, indicating flattened circadian variation, and stability of the activity rhythm across days was decreased, showing less consistent day-to-day patterns. Additionally, distal skin temperature showed lower nocturnal values in winter, suggesting impaired circadian regulation of peripheral blood flow and thermoregulation.

Subsequent work by the same group (Cambras et al., 2023) demonstrated that skin temperature circadian rhythm alterations in ME/CFS are significantly associated with endothelin-1 (ET-1) levels ($p < 0.01$), linking thermoregulatory circadian disruption to vascular tone dysregulation @Cambras2023SkinTemperatureEndothelin. ET-1 is a potent vasoconstrictor peptide; its association with temperature rhythm stability and amplitude suggests that the circadian control of vascular tone — not just central hypothalamic clock output — is disrupted in ME/CFS. Self-reported symptom severity correlated with both ET-1 levels and temperature rhythm disruption, providing a direct link between vascular biomarker, circadian physiology, and patient-experienced symptoms.
...
=== Sleep Architecture Versus Circadian Timing
...
Inflammatory cytokines, particularly IL-1$beta$ and TNF-$alpha$ elevated in ME/CFS (Chapter @ch:immune-dysfunction), directly disrupt clock gene expression and alter circadian rhythms. This creates bidirectional interactions where immune dysfunction disturbs circadian regulation, while circadian disruption impairs proper immune function, perpetuating a self-reinforcing cycle.

=== Melatonin and Its Therapeutic Potential
...
#warning-env(title: [Limitations of Melatonin Supplementation])[
...
The NIH study's documentation of temporal-parietal junction dysfunction and broader brain abnormalities suggests that the neurological impairments in ME/CFS may affect hypothalamic function, disrupting the SCN's ability to maintain circadian organization @walitt2024deep. Inflammatory cytokines directly disrupt clock gene expression, creating a mechanistic link between immune activation and circadian dysfunction. The successful melatonin treatment trial by Castro-Marrero et al.\ (2021) supports the potential for circadian-targeted interventions @castromarrero2021melatonin.

#limitation(title: [Circadian Disruption as Organising Principle: Primacy Not Established])[
While circadian disruption correlates with multiple ME/CFS features, its proposed role as a “central organising principle” has not been distinguished from the alternative that circadian changes are downstream consequences of other primary drivers:
    ...
    - The actigraphy evidence (Cambras 2018, n=10 per group) is too small to generalise. No study has demonstrated that circadian disruption _precedes_ immune or metabolic dysfunction in ME/CFS.
...
#speculation(title: [Hepcidin-Inflammation Axis as Endocrine-Immune Bridge])[
*Certainty: 0.40.* The hepcidin-ferroportin axis, classically viewed as an iron homeostasis regulator, sits at the intersection of endocrine and immune signalling. IL-6 (elevated in ME/CFS, Chapter @ch:immune-dysfunction) drives hepcidin transcription via STAT3, producing functional iron deficiency that impairs: (1) thyroid peroxidase (heme-dependent, needed for T4 synthesis), (2) mitochondrial respiration in steroidogenic tissues (iron-sulfur clusters for CYP11A1, CYP17A1, CYP19A1), and (3) hypothalamic dopamine synthesis (tyrosine hydroxylase requires iron as cofactor). Through these mechanisms, hepcidin-mediated iron redistribution may contribute simultaneously to the Low T3 Syndrome, HPA axis blunting, and dopaminergic dysfunction documented in ME/CFS (Speculation @spec:iron-dysregulation-hepcidin-ferroptosis in Chapter @ch:energy-metabolism).

*Mechanism.* IL-6 → STAT3 → HAMP transcription → hepcidin → ferroportin degradation → iron trapped in macrophages, unavailable to endocrine tissues. Thyroid: TPO (thyroid peroxidase) requires heme-iron for H2O2 generation and iodide oxidation; iron deficiency reduces TPO activity by up to 50% in animal models, producing low T4/T3 despite normal TSH. Adrenal: CYP11A1 (side-chain cleavage, the rate-limiting step in steroidogenesis) and CYP11B1 (11-beta hydroxylase, final cortisol synthesis step) both require iron-sulfur clusters (ferredoxin); tissue iron restriction would limit cortisol output and contribute to the elevated 11-deoxycortisol/cortisol ratio documented in severe ME/CFS (Section @sec:hpa-axis). Hypothalamus: tyrosine hydroxylase (TH, dopamine synthesis rate-limiter) is a non-heme iron-dependent monooxygenase; iron deficiency reduces TH activity by 40–60% in rodent models, consistent with the low CSF dopamine documented in ME/CFS (Section @sec:catecholamine-metabolism). The hepcidin-inflammation axis thus provides a single mechanistic explanation for three endocrine abnormalities that are otherwise treated as independent findings.

*ME/CFS context.* Pipper et al. documented elevated 11-deoxycortisol in severe female ME/CFS (suggesting CYP11B1 impairment) @pipper2024steroid. The NIH study documented low CSF dopamine @walitt2024deep. Low T3 Syndrome is common. All three could arise from a shared hepcidin-mediated iron restriction mechanism.

*Falsifiable predictions.* (1) ME/CFS patients with elevated IL-6 will show elevated hepcidin (serum) and corresponding reductions in serum iron, transferrin saturation, and TPO activity (measured by ultrasound-estimated thyroid volume and echogenicity). *Note (2026-07-26):* Kavyani et al. subsequently reported that hepcidin is decreased by ~50% in ME/CFS @Kavyani2023Hepcidin, partially falsifying prediction (1) — hepcidin is low, not high, in ME/CFS. This does not invalidate the endocrine-iron model; it reinterprets the mechanism. Low hepcidin would allow ferroportin expression, iron export from macrophages, and theoretically normal serum iron — yet serum iron remains low in ME/CFS @Swiatczak2022. The paradox (low hepcidin + low serum iron) suggests downstream ferroportin trafficking defects, IRP/IRE dysregulation, or a distinct ME/CFS hepcidin biology (see @hyp:iron-redox-polarity-diagnostic-bifurcation in Chapter @ch:speculative-hypotheses for full discussion of the ME/CFS vs Long COVID iron polarity). (2) 11-deoxycortisol/cortisol ratio will correlate inversely with serum iron in severe female ME/CFS. (3) CSF dopamine metabolites (HVA) will correlate with serum iron levels in ME/CFS patients. (4) Iron supplementation in ME/CFS patients with functional iron deficiency (ferritin >150 µg/L, TSAT \<20%) may be ineffective or harmful regardless of hepcidin level — if ferroportin trafficking is defective or iron is trapped via hepcidin-independent mechanisms, oral iron will not mobilize trapped iron and may increase oxidative stress and ferroptosis risk.

*Limitations.* Kavyani et al. @Kavyani2023Hepcidin now provides the first and only hepcidin measurement in ME/CFS — hepcidin was decreased by ~50%. This partially validates the hepcidin-inflammation axis (hepcidin is dysregulated, confirming involvement) but partially falsifies the specific prediction of elevated hepcidin. The iron-endocrine connections are supported by general physiology (thyroid peroxidase iron dependence, CYP iron-sulfur cluster requirement) but thyroid, adrenal, and dopamine-specific iron-deficiency data in ME/CFS remain absent. The prediction that oral iron fails without prior modification of iron trafficking is testable but would require a complex clinical trial design.
