...
*Severity applicability:* Unknown — study population not stratified by severity. Severe/bedbound patients who exert minimally may have different satellite cell profiles (disuse atrophy vs disease-specific depletion). Physical activity was not reported in the abstract — satellite cells are mechanosensitive and decline with prolonged disuse in healthy individuals (losses are reported after several weeks of bed rest or immobilisation, particularly in older adults @Dumont2015SCbiology). It is unknown what fraction of the observed SC depletion is disease-specific vs a consequence of reduced activity. The Wüst lab's microvascular study includes a 60-day bed-rest comparator showing disease-specific capillary changes @Charlton2025muscleMicrovasc, but this comparator was for microvasculature only — the bed-rest biopsies have not been reported for satellite cell content.
