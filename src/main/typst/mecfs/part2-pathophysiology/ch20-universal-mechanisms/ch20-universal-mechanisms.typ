...
#include "sec-03-family-3-ion-channel-and-membrane-transp/open-questions/oq-breadth-of-channelopathy-in-me-cfs.typ"
...
- *Heat shock protein (HSP) dysregulation.* Abnormal HSP70 and HSP90 expression in ME/CFS samples; HSPs normally prevent protein misfolding, support immune cell function, and facilitate recovery from stress @nijs2014hsp. Hochecker et al. (2025) demonstrated that HSP70 (HSPA5) can be acutely upregulated (48.33% increase) in ME/CFS PBMCs via whole-body hyperthermia, and that this induction correlates with mitochondrial respiratory improvement — suggesting that HSP deficiency is dynamically modifiable rather than a fixed deficit @Hochecker2025HyperthermiaMECFS. Thermal challenge may additionally recruit TRPV1-mediated autonomic pathways (Section @sec:trpv1-thermal-autonomic-stress-test), providing a secondary, non-mitochondrial mechanism by which controlled hyperthermia could serve as a diagnostic stress test for autonomic recovery capacity @Nelson2021HRVrecoveryMECFS.
...
#include "sec-13-family-13-protein-homeostasis-and-degrad/open-questions/oq-scope-of-proteostasis-failure-in-me-cfs.typ"
...
#include "sec-14-family-14-cell-death-and-senescence/open-questions/oq-senolytic-therapy-potential-in-me-cfs.typ"
...
- *Glycolytic fiber shift.* A published 2026 comparison of ME/CFS and Long COVID muscle biopsies against strict 60-day bed rest controls found both patient groups had significantly more glycolytic (Type IIa/IIx + IIx) fibers and fewer Type I fibers than healthy controls; the same bed rest protocol produced no fiber type change, directly excluding deconditioning as the cause @Charlton2026MuscleBedrest. ME/CFS patients had an even lower Type I proportion than Long COVID patients. This represents adaptive remodelling toward anaerobic metabolism consistent with chronic OXPHOS insufficiency. If satellite cell depletion is confirmed, this shift would also be consistent with metabolic reprogramming in a regeneration-impaired niche (@spec:sc-depletion-glycolytic-shift below).
...
- *Capillary rarefaction and basement membrane thickening.* Fewer capillaries and thicker capillary basement membranes in ME/CFS/Long COVID skeletal muscle (independently replicated across 3 countries); CD169⁺ macrophage infiltration after exercise; endothelial microvacuolization, hypertrophy, and degeneration on EM; lower capillary-to-fiber ratios and capillary density in ME/CFS specifically. The 60-day bed rest comparator in Charlton et al. (2026) @Charlton2026MuscleBedrest showed the opposite pattern — bed rest *increased* capillary density (because atrophy outpaced capillary loss) — confirming the patient phenotype is structurally distinct from simple deconditioning; reduced oxygen delivery capacity at the tissue level @Charlton2025muscleMicrovasc @Aschman2023postcovidCapillary @Agergaard2023LongCOVIDmyopathy.
...
4. *Secondary to disuse/deconditioning* — muscle unloading reduces satellite cell content (countered by the published bed-rest comparator showing distinct structural and metabolic changes in the same patient cohort @Charlton2026MuscleBedrest; however, satellite cell-specific bed-rest data has not been reported from this biobank)
...
] <fhyp:oxphos-vo2max-uncoupling>

#achievement(title: [Sixty-Day Bed Rest Fails to Reproduce the ME/CFS Muscle Phenotype — Deconditioning Is Not the Explanation])[
Charlton, Slaghekke, Appelman, and colleagues at VU Amsterdam and Amsterdam UMC (2026, Nature Communications) @Charlton2026MuscleBedrest compared skeletal muscle biopsies and maximal exercise responses of Long COVID and ME/CFS patients against one of the most extreme deconditioning models available — 60 days of strict head-down tilt bed rest in healthy volunteers. The design posed a straightforward question: if patient muscle looks abnormal, is that just from being inactive?

The answer is no, at multiple independent levels: (1) Bed rest causes generalised atrophy of all fibre types; patients show Type I-selective atrophy (ME/CFS) or no atrophy at all (Long COVID). (2) Bed rest preserves fibre type proportions; both patient groups have a significant shift toward glycolytic Type II fibres. (3) Bed rest preserves the normal correlation between mitochondrial OXPHOS capacity and whole-body V̇O₂ₘₐₓ; patients lose this relationship entirely. (4) Bed rest increases capillary density (atrophy outpaces capillary loss); ME/CFS patients have lower capillary-to-fibre ratios and capillary density. (5) Bed rest alters ventilatory patterns (increased V̇E/V̇CO₂ slope, reduced V̇Eₘₐₓ); patients' ventilatory patterns are largely normal, suggesting a different physiological limitation.

*Consequence:* This quasi-experimental design — using strict bed rest as a natural control for the deconditioning hypothesis — provides the strongest refutation to date of the claim that ME/CFS exercise intolerance is "just deconditioning." The patient phenotype is qualitatively different from disuse, not quantitatively worse. This finding should end the "deconditioning → graded exercise therapy" logic chain and redirect research toward disease-intrinsic mechanisms: mitochondrial complex disruption, microvascular pathology, and central motor output restriction. For patients, this provides an evidence-based answer to the recurring clinical narrative that they "just need to get moving" — even 60 days in bed does not produce what their disease does.
] <ach:charlton2026-bedrest-rebuttal>

#synthesis(title: [The Deconditioning Null — Convergent Evidence That Disuse Is Not the Driver of ME/CFS Skeletal Muscle Pathology])[
Charlton et al. (2026) @Charlton2026MuscleBedrest demonstrated that 60 days of strict bed rest fails to reproduce the ME/CFS muscle phenotype at five independent dimensions: fibre type shift, atrophy pattern, OXPHOS–V̇O₂ₘₐₓ coupling, capillary density direction, and ventilatory response. This converges with earlier work: invasive CPET shows impaired peripheral O₂ extraction despite normal cardiac output (@Joseph2021iCPETmeCFS), plasma proteomics confirms disrupted proteomic–VO₂max associations in PEM (@Germain2025PlasmaProteomePEM), and the bed rest metabolome is now well-characterised at the multi-omics level, establishing the deconditioning phenotype with which patients can be compared (@Eggelbusch2024BedrestMetab). The convergence of three independent methodologies (muscle biopsy respirometry, invasive CPET, plasma proteomics) and two different comparator designs (bed rest control, healthy controls) establishes that the exercise limitation in ME/CFS has a disease-intrinsic component not explained by physical inactivity.

What remains open: whether the limiting factor is mitochondrial (supercomplex disruption, @spec:sc-depletion-glycolytic-shift), microvascular (capillary oxygen diffusion barrier), or central (CNS-mediated motor output restriction, see @fhyp:oxphos-vo2max-uncoupling). These are not mutually exclusive — all could operate simultaneously — but determining which is rate-limiting changes the therapeutic strategy. A mitochondrial defect calls for metabolic support; a microvascular obstruction calls for endothelial-targeted therapies; a central governor calls for neuromodulation.

*Consequence:* The collective evidence from muscle biopsy, invasive CPET, and proteomics — all triangulated against direct bed rest comparators — means that a clinician who tells an ME/CFS patient to "just get moving" is making a claim contradicted by the strongest empirical data in the field. The patient's muscle is not responding to the same stimulus as a deconditioned healthy person's muscle because the muscle itself is different at the molecular level. Research priority: identify what breaks the link between mitochondrial machinery and whole-body performance.
...
#include "sec-18-family-18-transcriptional-and-nuclear-si/hypotheses/hyp-the-three-brake-failure-hypothesis-simul.typ"
...
#include "sec-19-family-19-purinergic-and-danger-signalli/speculations/spec-the-cd73-dual-bottleneck-purinergic-reso.typ"

#include "sec-19-family-19-purinergic-and-danger-signalli/open-questions/oq-cell-danger-response-resolution-in-me-cf.typ"
...
#include "sec-01-misc/subsec-01-the-structural-ratchet-why-me-cfs-rarely/hypotheses/hyp-the-structural-ratchet-hypothesis-irreve.typ"
...
#include "sec-01-misc/subsec-02-cross-family-interaction-structure-and-h/open-questions/oq-which-me-cfs-mechanism-families-are-keys.typ"

=== The Multi-Family Mechanism Score: From Taxonomy to Diagnostic Tool
<sec:mfms>

#include "sec-01-misc/subsec-03-the-multi-family-mechanism-score-from-ta/open-questions/oq-can-a-19-marker-panel-stratify-me-cfs-pa.typ"
...
#include "sec-21-family-20-inflammation-resolution-and-li/speculations/spec-spm-deficiency-as-a-chronicity-switch-in.typ"

#include "sec-21-family-20-inflammation-resolution-and-li/speculations/spec-hmgb1-as-a-candidate-damp-in-neuroinflam.typ"

#include "sec-21-family-20-inflammation-resolution-and-li/speculations/spec-s100a8-a9-calprotectin-as-a-microglial-p.typ"
...
#include "sec-22-synthesis-the-mechanism-landscape-of-me-/achievements/ach-20-family-mechanism-map-constructed-for-.typ"

=== Ceramide-S1P Rheostat Shift as Cross-Family Amplifier
<sec:ceramide-s1p-rheostat>

#include "sec-01-misc/subsec-01-ceramide-s1p-rheostat-shift-as-cross-fam/hypotheses/hyp-ceramide-s1p-rheostat-shift-as-a-cross-f.typ"
