...
*Testable predictions:*
+ ME/CFS patients with documented enteroviral onset (Coxsackie B3 serology or PCR-positive acute illness) will have higher anti-ANT1 titres than ME/CFS patients with EBV onset or non-infectious onset, using recombinant human ANT1 in conformationally correct proteoliposome presentation @ManchadoEtAl2002 (not rat liver ANT2 @MendelHartvig1986, which lacks isoform specificity).
