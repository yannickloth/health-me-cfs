...
*Partially characterised:* GLUT4 trafficking in ME/CFS skeletal muscle has not been directly examined, though Brown et al.\ showed that glucose uptake (a functional GLUT4 output) is impaired in cultured ME/CFS muscle cells, with the defect localised proximal to AMPK @Brown2018AMPK. The malonyl-CoA/CPT1 switch — the molecular gate that controls whether cells preferentially oxidize glucose or fatty acids — has not been characterized in ME/CFS, though Reuter and Evans inferred reduced CPT-I activity from long-chain acylcarnitine deficiency ($n = 44$ CFS vs 49 controls, 30--40% lower C18:1/C18:2, $p < 0.0001$) @Reuter2011. AMPK activators have been tested _in vitro_: metformin and compound 991 rescued both AMPK activation and glucose uptake in ME/CFS muscle cells @Brown2018AMPK. Clinically, the REVIVE-TOGETHER adaptive RCT ($n = 399$) halted its metformin 750 mg BID arm for futility at 60 days while the fluvoxamine arm showed significant fatigue reduction @Reis2026fluvoxamine, and the earlier COVID-OUT trial showed early metformin _prevented_ Long COVID by ~41% but did not treat established fatigue @Reis2023COVIDOUT. No AMPK-activator trial has been conducted in primary ME/CFS.
...
G2 (malonyl-CoA/CPT1 switch) is the highest-priority Step 1 gap: it is the sole gate between carbohydrate and fatty-acid oxidation, tractable via plasma and PBMC assays, and has an immediate therapeutic anchor (metformin). G1 (GLUT4 trafficking) is priority 2 because its measurement requires muscle biopsy — the main barrier is tractability, not impact. G3 (metformin/berberine RCT) is priority 3: Brown 2018 provided in vitro proof-of-concept but the REVIVE-TOGETHER Long COVID RCT found metformin null for established fatigue @Reis2026fluvoxamine, weakening the clinical case. The priority could be upgraded if a positive mechanistic signal emerges from G1 or G2 in ME/CFS specifically.
...
+ *Tissue-selective PDK isoform expression:* PDK4 dominates in skeletal muscle while PDK2 and PDK3 are more highly expressed in brain. The Fluge 2016 PBMC finding (PDK1/2/4 all upregulated @Fluge2016) may map differently onto each tissue. Brain PDK2/3 upregulation could produce resting lactate elevation; muscle PDK4 upregulation may manifest only under exertion when pyruvate flux increases — explaining normal resting muscle metabolites.
...
#figure(
  ...
  table(
    ...
    [G12: Individual β-oxidation enzyme activities (VLCAD/LCAD/MCAD/SCAD)], [Medium — chain-length redundancy but not complete; PASC plasma acylcarnitines are elevated across all chain lengths (Guntur 2022, $n = 29$ PASC vs 30 controls @Guntur2022PASCfattyacid), suggesting proximal FAO impairment or shuttle limitation rather than a single enzyme defect — but direct enzyme activities remain unmeasured], [Up to ~60% of fatty-acid-derived ATP if one enzyme fails], [Hard — muscle biopsy with chain-length-specific assays], [Near-term — riboflavin (MADD precedent)], [Muscle biopsy (chain-length-specific)], [2],
    ...
    [G15: Formal riboflavin RCT], [N/A — intervention gap; no standalone riboflavin trial in ME/CFS or Long COVID exists @Maksoud2021nutraceuticals; a large patient survey ($n = 3{,}925$) provides observational context but not RCT-level evidence @Eckey2025PRO], [Bounded by G12+G13 impact], [Easy — riboflavin 400 mg/day is cheap and well tolerated], [Immediate], [Blood draw (RCT)], [1],
  )
...
#figure(
  ...
  table(
    ...
    [G18: Succinate dehydrogenase / Complex II], [High — sole TCA step 6 and ETC entry point; open for ME/CFS specifically — Long COVID biopsy data show reduced Complex II flux (Colosio 2023 @Colosio2023LongCOVIDNIRS, already cited) but ME/CFS-specific SDH histochemistry has not been formally reported in modern cohorts], [~30% of gated yield], [Moderate — SDH histochemistry is routine], [Near-term — riboflavin], [Muscle biopsy (SDH histochemistry)], [1],
...
+ *ROS sensitivity hierarchy:* KGDHC is inhibited 40--50% by physiological H#sub[2]O#sub[2] concentrations @TretterAdamVizi2005, making it the most oxidant-sensitive TCA enzyme. Its E1 subunit contains 37 cysteine residues @Starkov2004KGDHC, far exceeding PDC's oxidation-susceptible surface.
+ *SIRT4 dual-targeting:* Fluge 2016 documented SIRT4 upregulation in ME/CFS PBMCs @Fluge2016. SIRT4 has demonstrated lipoamidase activity on PDC-E2 and likely acts on KGDHC-E2 by the same mechanism (both share the dihydrolipoamide acetyltransferase architecture, though KGDHC-E2 activity has not been directly tested). The field has discussed only the PDC consequence. If SIRT4 inhibits both complexes simultaneously, KGDHC impairment may be the _larger_ metabolic consequence because KGDHC sits mid-cycle where the substrate ($alpha$-ketoglutarate) is harder to replenish via anaplerosis, whereas PDC has glucose as an effectively unlimited upstream substrate.
...
*Certainty: 0.30.* The Heng 2025 finding — NAD#super[+] _elevated_ in PBMCs while ATP/ADP is _reduced_ @heng2025mecfs — is a potentially important observation that challenges the simple depletion narrative. If confirmed, it suggests the conventional framing (NAD#super[+] is depleted, supplement it) may be wrong in PBMCs, while muscle and neurons may behave differently.
...
+ *Compartment B (skeletal muscle / neurons):* NAD#super[+] is _predicted_ to be depleted by three concurrent consumers: (i) PARP overactivation from exercise-induced DNA damage and oxidative stress, (ii) CD38 upregulation from chronic immune activation, (iii) kynurenine pathway diversion reducing de novo NAD#super[+] synthesis @Naviaux2016metabolomics. This compartment has never been measured in ME/CFS.
...
#figure(
  ...
  table(
    ...
    align: (left, left, left, left, left, left, center),
    table.header([*Gap*], [*Essentiality*], [*Worst-case impact*], [*Tractability*], [*Therapeutic leverage*], [*Measurement*], [*Priority*]),
    [G28: Anti-ANT1 autoantibodies], [High — ANT is the sole ATP export route; no redundancy], [~93% of gated yield (~28/30 ATP, the matrix-produced fraction)], [Easy — human ANT1-specific ELISA; epitopes mapped @ManchadoEtAl2002], [Medium-term — immunoadsorption already piloted in ME/CFS for GPCR autoantibodies @WohlrabEtAl2025], [Blood draw (ANT1-specific ELISA)], [1],
  )
...
The observation that reduced physical activity may impair AMPK-mediated mitophagy does _not_ by itself justify graded exercise therapy (GET). While the PACE GET protocol began at low levels (5 minutes, increasing 1--2 minutes per week), the critical question is whether _any_ structured exercise increment triggers PEM in ME/CFS patients whose exertion threshold is already extremely low. Two-day CPET data document that even modest exertion can provoke sustained metabolic deterioration. Whether a structured protocol could stay below the PEM threshold while providing sufficient AMPK stimulus for mitophagy maintenance is unknown --- this is the "therapeutic window" question, which remains open. The deconditioning loop is a mechanistic observation, not a clinical recommendation for any specific exercise programme.
]
...
+ *PARP hyperactivation (inferred):* The Shankar 2025 MnSOD deficit in lymphocytes @Shankar2025oxidativestress predicts increased mitochondrial superoxide $arrow.r$ oxidative DNA damage $arrow.r$ PARP1 activation $arrow.r$ NAD#super[+] consumption. A single DNA double-strand break can consume hundreds of NAD#super[+] molecules through PARP poly-ADP-ribosylation. PARP activity has not been directly measured in ME/CFS tissue.
...
+ *Kynurenine pathway diversion (documented in plasma):* Tryptophan is the sole substrate for de novo NAD#super[+] synthesis via the kynurenine pathway. IDO1 upregulation by IFN-$gamma$ diverts tryptophan toward quinolinic acid (neurotoxic) rather than completing the synthesis to NAD#super[+] — documented in ME/CFS plasma metabolomics @Naviaux2016metabolomics, though the tissue-specific impact on muscle or neuronal NAD#super[+] pools is unmeasured.

#hypothesis(title: [NAD#super[+]--Sirtuin--Acetylation Hub: Unified Upstream Regulator of G22, G34, and G39])[
*Certainty: 0.35.* NAD#super[+] depletion in energy-intensive tissues (skeletal muscle, neurons — not PBMCs, where Heng et al.\ found NAD#super[+] _elevated_ @heng2025mecfs, consistent with substrate backup rather than depletion) simultaneously inactivates SIRT1, SIRT3, and shifts the SIRT1/SIRT4 balance toward the inhibitory SIRT4 arm @Fluge2016. The downstream consequences propagate through four documented pathways:
...
+ *NRF2 functional suppression* (G34): SIRT1 cannot deacetylate NRF2 $arrow.r$ reduced nuclear retention and ARE binding $arrow.r$ antioxidant target genes (MnSOD, GPX4, NQO1) are under-expressed even if NRF2 protein is present @Shankar2025oxidativestress @Davis2025nrf2lipid (Step 9).
...
*Wound healing is not a preserved autonomous process.* Earlier versions of this framework listed wound healing among spared functions. This classification was biologically incorrect: wound healing is a complex, multi-phase, demand-responsive cascade (haemostasis → inflammation → proliferation → remodelling) requiring NK cell mobilisation, autonomic vascular regulation, fibroblast activation, angiogenesis, and significant mitochondrial ATP. No study has directly measured wound healing in ME/CFS patients, and mechanistic evidence from three independent pathways — each based on single studies — predicts impairment rather than preservation: (1) NK cell cytotoxicity is reduced in ME/CFS (Hedges' $g = 0.96$, 28 studies @Baraniuk2024NKMeta), and NK cells are mechanistically required for wound closure in hypoxic wound models @Sobecki2021NKWoundHypoxia (though whether this requirement extends to normoxic cutaneous wounds is assumed, not demonstrated); (2) sympathetic overactivation — a hallmark of ME/CFS dysautonomia — directly inhibits reepithelialization in a mouse corneal model @Xue2018ANSWoundHealing; (3) the immune exhaustion phenotype in burn patients — a more extreme model than ME/CFS — produces clinically documented wound healing impairment @Stanojcic2016ImmuneExhaustionBurns. Whether ME/CFS patients actually experience delayed wound healing remains an unstudied question, and minor wound repair may remain functionally autonomous even if complex wound healing is impaired. The assumption of preservation is mechanistically unsupported, but direct measurement is needed to resolve the question (see Section @oq:wound-healing-mecfs).
...
No study has directly measured wound healing rate, quality, or complication frequency in ME/CFS patients. Mechanistic evidence from NK cell dysfunction @Baraniuk2024NKMeta @Sobecki2021NKWoundHypoxia, autonomic dysregulation @Xue2018ANSWoundHealing, immune exhaustion @Stanojcic2016ImmuneExhaustionBurns, and chronic TGF-β elevation disrupting NK-MSC wound repair circuits @Petri2017MSCNKTGFb converges on predicting impairment. However, patients and clinicians have not reported wound healing as a prominent clinical complaint, creating an apparent discrepancy between mechanistic prediction and clinical observation.
...
If NK cells are required for wound healing — not as bystanders but as upstream regulators whose IFN-γ and GM-CSF output controls healing rate @Sobecki2021NKWoundHypoxia — and ME/CFS NK cytotoxicity is halved @Baraniuk2024NKMeta, then the repair deficit should extend beyond skin wounds to all NK-dependent tissue maintenance. This would predict impaired mucosal barrier repair (consistent with documented gut permeability in ME/CFS), slower muscle damage repair after exertion (contributing to prolonged PEM duration), and impaired vascular endothelial repair (consistent with endothelial dysfunction in Chapter @ch:cardiovascular). These phenomena are currently treated as separate pathophysiological findings with separate explanations (mast cell activation for gut permeability, metabolic failure for PEM, oxidative stress for endothelial dysfunction); this hypothesis proposes a complementary upstream cause — halved NK repair function — that could contribute to all three. It does not claim to replace the existing explanations but suggests an additional mechanism that may compound them.

*Falsifiable prediction:* Gut mucosal repair rate (measured by serial lactulose-mannitol permeability tests after standardised challenge) should correlate with NK cell cytotoxicity ($r > 0.4$) in ME/CFS patients _after controlling for overall disease severity_ (Bell score). Patients with lower NK function should show slower barrier restoration independent of their general disability level.
...
Xue et al. identified two macrophage populations with opposing wound healing effects: CD64+CCR2+ (β2-adrenergic, SNS-responsive, pro-inflammatory, anti-repair) and CD64+CCR2- (α7-nAChR, PNS-responsive, anti-inflammatory, pro-repair) @Xue2018ANSWoundHealing. ME/CFS is characterised by sympathetic overactivation and parasympathetic withdrawal (Chapter @ch:cardiovascular). This autonomic imbalance would constitutively favour the pro-inflammatory, anti-repair macrophage phenotype across all tissues — not only skin wounds but also brain (neuroinflammation suggested by PET markers @Nakatomi2014neuroinflammation, consistent with M1-biased microglial polarisation though direct polarisation data in ME/CFS is lacking), gut (intestinal macrophage polarisation toward barrier-disrupting), and muscle (impaired satellite cell activation after exertion).
