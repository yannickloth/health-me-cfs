...
@hyp:atg13-circulating-damp documents the downstream consequence of this block: ATG13 accumulates extracellularly and acts as a DAMP, while impaired mitophagy sustains oxidative stress. The convergence of the mTOR/AMPK/ATG13 pathway with the SNS$arrow.r$PKA$arrow.r$AMPK suppression described above and the NAD#super[+]-sirtuin-acetylation hub (Section @sec:nad-sirtuin-acetylation-hub) suggests a hierarchically organised failure: autonomic imbalance suppresses AMPK $arrow.r$ mTORC1 is disinhibited $arrow.r$ ATG13 is phosphorylated $arrow.r$ autophagy and mitophagy are blocked $arrow.r$ damaged mitochondria accumulate $arrow.r$ ROS and mtDNA release activate innate immunity $arrow.r$ inflammation further suppresses AMPK --- closing a self-reinforcing loop.
...
*Certainty: 0.33.* Recent ME/CFS-specific work identifies SMPDL3B (sphingomyelin phosphodiesterase acid-like 3B), a membrane-associated regulator of sphingolipid balance, as a potential biomarker and mechanistic mediator. Altered SMPDL3B may change lipid raft fluidity and receptor organisation, modifying immune responses to inflammatory and antiviral stimuli. @Watton2026unified

Convergent findings in ME/CFS and Long-COVID implicate membrane lipid organisation in immune dysfunction. Lipid rafts function as signalling platforms that regulate receptor clustering and activation thresholds, including Toll-like receptor signalling. The lipid raft framework links commonly observed "omics-level" lipid abnormalities in ME/CFS to cellular immunophenotypes, since raft composition depends on sphingolipid and cholesterol handling and can be remodelled by systemic metabolic cues and chronic inflammatory signalling. @Watton2026unified

A critical theme emerges: lipid biology is not an adjunct topic in ME/CFS but a potential mechanistic substrate linking immune signalling, mitochondrial quality control, redox buffering, and endothelial stability. Lipids provide structure to membranes and substrates for inflammatory mediators; they govern receptor microdomains while regulating mitochondrial dynamics. Consequently, lipid dysregulation could plausibly yield a persistent "mis-set" immune state after infection. The SMPDL3B pathway offers a testable entry point for investigating this lipid-immune-mitochondrial axis. (Certainty: 0.33)

*Falsifiable prediction.* SMPDL3B knockdown or overexpression in primary immune cells will predictably alter (1) lipid raft receptor distribution (TRPM3 surface localisation), (2) ceramide levels in mitochondrial membranes, and (3) mitophagy flux (LC3-II accumulation, PINK1/Parkin recruitment).
] <spec:smpdl3b-lipid-raft-mito>

#speculation(title: [Haptoglobin Proteoforms and PEM-Linked Oxidative Stress])[
*Certainty: 0.45.* Moreau's group identified haptoglobin (Hp) quantity and proteoform structure as relevant to core ME/CFS symptoms including PEM and cognitive dysfunction. Hp scavenges free haemoglobin released during haemolysis and thus buffers against haem-mediated oxidative stress and endothelial injury. Reduced functional Hp capacity permits exaggerated oxidative and vascular stress during or after exertion, with downstream effects on microvascular regulation and symptom relapse. @Watton2026unified
...
*Certainty: 0.35. Probability of clinically meaningful efficacy in ME/CFS: 0.08.* CDR involves redox dysregulation. NAC replenishes glutathione, modulates redox-sensitive signalling (NF-$kappa$B, Nrf2), and may facilitate CDR resolution by restoring thiol redox balance. NAC's glutathione-replenishing effects are well-established clinically; no ME/CFS-specific trial data. The probability is higher than most nutraceuticals because NAC has demonstrated objective efficacy in related conditions (COPD, psychiatric disorders) via glutathione restoration. Falsifiable: NAC treatment will increase GSH/GSSG ratio in ME/CFS PBMCs, shift Nrf2-dependent gene expression, and reduce inflammatory cytokine production.
] <spec:nac-cdr-redox>
