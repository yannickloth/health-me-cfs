...
*Pattern:* Muscle creatine loading alone does not resolve fatigue in either CFS (GAA trial) or fibromyalgia (creatine RCT). The Godlewska signal is brain-specific — brain creatine correlated with cognitive improvement, not muscle creatine with fatigue resolution. A future ME/CFS creatine RCT should therefore be designed with brain MRS as the primary mechanistic outcome and should measure brain-specific endpoints (cognition, brain fog) alongside whole-body fatigue.
...
#figure(
  ...
  table(
    ...
    [G32: Placebo-controlled creatine RCT with brain MRS], [N/A — confirmatory intervention; muscle loading per se does not resolve fatigue @Ostojic2016GAA @Alves2013creatineFM], [Determines whether the _brain-specific_ Godlewska signal is real; Long COVID RCTs encouraging @DosSantos2026creatineCovid], [Easy — RCT design is simple; brain MRS adds cost but is essential for mechanism], [Immediate — creatine is OTC], [1],
  )
) <tab:step8-gap-priorities>

G32 remains priority 1 but the landscape has shifted. A creatine-precursor RCT in CFS proper (Ostojic 2016, GAA, $n = 21$) successfully loaded muscle creatine but did *not* reduce fatigue @Ostojic2016GAA; a fibromyalgia creatine RCT similarly improved muscle strength without affecting fatigue or cognition @Alves2013creatineFM. Long COVID creatine RCTs show promise ($n = 58$ completers, fatigue $p = 0.005$ @DosSantos2026creatineCovid), but the Godlewska signal is brain-specific: _brain_ creatine correlated with _cognitive_ improvement. A future ME/CFS RCT should be designed with brain MRS as the primary mechanistic outcome — the muscle-loading question is arguably answered (loading works but does not resolve fatigue). Step 8 is not individually essential to ATP production (creatine shuttles are kinetic buffers) but its failure mode is _exactly_ the demand-response failure pattern observed in PEM, making it a candidate mechanism for the selective-dysfunction hypothesis (@hyp:selective-energy).
