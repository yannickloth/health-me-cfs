...
*Certainty: 0.30.* Coxsackie B3 is one of the best-documented enteroviral triggers of ME/CFS, and independently, Coxsackie B3 viral myocarditis is the exact model system in which Schulze et al.\ (1999) demonstrated anti-ANT autoantibody generation with 56% cytosolic ATP/ADP reduction @SchulzeEtAl1999. The bridge hypothesis: Coxsackie B3 infection in ME/CFS patients generates anti-ANT autoantibodies via molecular mimicry between viral capsid or protease epitopes and ANT1 C-terminal/M2--M3 loop epitopes (mapped by Manchado et al.\ 2002 @ManchadoEtAl2002), producing a chronic energy deficit that persists long after viral clearance.
...
*Testable predictions:*
+ ME/CFS patients with documented enteroviral onset (Coxsackie B3 serology or PCR-positive acute illness) will have higher anti-ANT1 titres than ME/CFS patients with EBV onset or non-infectious onset, using recombinant human ANT1 in conformationally correct proteoliposome presentation @ManchadoEtAl2002 (not rat liver ANT @MendelHartvig1986, which lacks human isoform specificity).
...
*Certainty: 0.45.*
Post-exertional malaise may represent a two-phase ISR cycle rather than a single failure state @CostaMattioli2020ISRReview @Le2025ATF4Mitochondria @Gotz2025ISRLifespan. *Phase 1 (0--24 h post-exertion):* acute eIF2α phosphorylation --- adaptive, protective mitochondrial elongation (Baron/Wiseman mechanism @Baron2025ISRMitochondria), translational pause. Symptom correlate: immediate fatigue. *Phase 2 (24--72 h):* ATF4-driven transcriptional reprogramming --- suppresses OXPHOS subunit synthesis, induces amino acid stress genes, activates CHOP @Le2025ATF4Mitochondria. When chronic, this phase becomes net-harmful @Gotz2025ISRLifespan. Symptom correlate: delayed crash, cognitive symptoms, PEM peak. *Phase 3 (recovery):* GADD34/PP1-mediated eIF2α dephosphorylation; if impaired, no full recovery and symptoms persist @CostaMattioli2020ISRReview.
...
*Certainty: 0.40.*
Persistent low-grade ATF4 activity creates a "metabolic ceiling" that PEM cannot exceed @Gotz2025ISRLifespan @CostaMattioli2020ISRReview. ATF4, the master ISR transcription factor induced downstream of all four eIF2α kinases, represses mitochondrial OXPHOS subunit translation and activates amino acid metabolism genes (aminoacyl-tRNA synthetases, one-carbon/serine pathway flux), diverting resources away from energy production toward stress tolerance. In the Götz Drosophila model, this chronic ATF4 activity reduced lifespan and suppressed proteostasis and DNA repair @Gotz2025ISRLifespan; in the Le 2025 cell model, the acute eIF2α--ATF4 axis is required for mitochondrial maintenance, but chronic activation becomes maladaptive @Le2025ATF4Mitochondria.
...
*Limitation:* Direct ISR measurement in ME/CFS is limited to PERK elevation in muscle (n=14, single study) @wang2023wasf3. Peripheral blood stress biomarkers showed no difference between long COVID and controls in one controlled study (n=48) @Omdal2026LCFatigueStress, suggesting ISR signatures may be tissue-confined rather than circulating. GDF15 has other causes including cardiac and inflammatory conditions. The connection between ISR kinetics and PEM timing remains mechanistic reasoning without direct empirical support.
] <spec:pem-isr>
