...
Plasma F#sub[2]-isoprostanes are significantly elevated in ME/CFS: Kennedy et al.\ ($n = 47$ vs 34 controls) found elevated 8-iso-PGF#sub[2\u03b1] correlating with PEM severity ($p = 0.027$) @Kennedy2005isoprostanes, and Robinson et al.\ ($n = 33$ vs 33) confirmed elevation at rest persisting 24 hours post-exercise @Robinson2010isoprostanes.
...
The preceding sections treat NAD#super[+] depletion (G22, Step 6), NRF2 pathway dysfunction (G34, Step 9), and PGC-1$alpha$ hyperacetylation (G39, Step 10) as separate research gaps. They are mechanistically linked through a single upstream regulator: NAD#super[+]-dependent sirtuin activity. This convergence rests on well-established enzymology (the sirtuin-substrate relationships are documented in non-ME/CFS biology), though the specific claim that these connections are operative in ME/CFS tissue remains a hypothesis.

SIRT1 deacetylates PGC-1$alpha$ at multiple lysine residues, converting it from an inactive hyperacetylated form to the active transcription factor that drives mitochondrial biogenesis @MorrisMaes2014mitochondria. SIRT1 also directly deacetylates NRF2, promoting its nuclear retention and transcriptional activity on antioxidant response elements. SIRT3, a mitochondrial matrix sirtuin, deacetylates and activates isocitrate dehydrogenase 2 (IDH2), MnSOD, and components of Complex I — the last of which directly affects electron transport chain flux. All three sirtuins require NAD#super[+] as a co-substrate (not merely a cofactor — NAD#super[+] is consumed stoichiometrically, one molecule per deacetylation event, producing nicotinamide and O-acetyl-ADP-ribose).
