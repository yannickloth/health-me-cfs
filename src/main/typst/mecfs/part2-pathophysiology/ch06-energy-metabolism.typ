...
+ *ROS sensitivity hierarchy:* KGDHC is inhibited 40--50% by physiological H#sub[2]O#sub[2] concentrations @TretterAdamVizi2005, making it the most oxidant-sensitive TCA enzyme. Its E1 subunit contains 37 cysteine residues (Starkov et al.\ 2012, _Free Radic Biol Med_), far exceeding PDC's oxidation-susceptible surface.
...
*Wound healing is not a preserved autonomous process.* Earlier versions of this framework listed wound healing among spared functions. This classification was biologically incorrect: wound healing is a complex, multi-phase, demand-responsive cascade (haemostasis → inflammation → proliferation → remodelling) requiring NK cell mobilisation, autonomic vascular regulation, fibroblast activation, angiogenesis, and significant mitochondrial ATP. No study has directly measured wound healing in ME/CFS patients, and mechanistic evidence from three independent pathways predicts impairment rather than preservation: (1) NK cell cytotoxicity is halved in ME/CFS @Baraniuk2024NKMeta, and NK cells are mechanistically required for wound closure @Sobecki2021NKWoundHypoxia; (2) sympathetic overactivation — a hallmark of ME/CFS dysautonomia — directly inhibits reepithelialization @Xue2018ANSWoundHealing; (3) the immune exhaustion phenotype shared by ME/CFS produces clinically documented wound healing impairment in burn patients @Stanojcic2016ImmuneExhaustionBurns. Whether ME/CFS patients actually experience delayed wound healing remains an unstudied question, but the assumption of preservation is unsupported and mechanistically implausible.
