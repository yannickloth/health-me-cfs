...
#figure([], kind: table, supplement: [Table], caption: [Comprehensive ranking of all speculative hypotheses — table conversion pending]) <tab:all-hypotheses>

/* TODO: landscape, fix table
#table(
