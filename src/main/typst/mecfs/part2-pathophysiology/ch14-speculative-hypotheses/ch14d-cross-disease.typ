...
#figure(
  ...
  #table(
    ...
    [],
    [*Confounders (C):* Shared genetic susceptibility (immune dysregulation loci, HLA variants; ADHD--ASD genetic correlation $r_"g" = 0.32$--$0.41$ ) acts as a common cause of both ME/CFS trigger-susceptibility and elevated baseline risk for ADHD/ASD/depression, creating non-causal association even if Architecture B is false.],
  )
]
