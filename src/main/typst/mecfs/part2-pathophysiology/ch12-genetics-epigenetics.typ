...
First, tissue enrichment across 30 tissue types found significant enrichment exclusively in 14 brain regions and pituitary, with no peripheral tissue reaching significance. This replicates and extends the DecodeME brain enrichment finding (Achievement @ach:decodeme-brain-enrichment) and argues against a primary peripheral genetic origin. Second, gene-set analysis replicated neuronal and synaptic gene sets, with glutamatergic synapses emerging as the most specific replicated signal---converging with the DecodeME identification of _SHISA6_ and _UNC13C_ (Section @sec:decodeme-genes). Third, cell-type enrichment identified independent replicated signals in distinct neuronal populations of subcortical and cerebellar regions, providing the first regional neuronal enrichment of ME/CFS genetic architecture. Fourth, a secondary signal in dopaminergic midbrain (ventral tegmental area/substantia nigra) was identified, with convergent support from both common (GWAS) and rare (WGS) variant data---rare variant analysis independently implicating synaptic genes @Birch2025rare.
...
#warning-env(title: [Single-Anchoring Risk and Methodological Limitations])[
...
#speculation(title: [PTPRN2 Hypomethylation as Epigenetic Anchor of Cognitive Subtype])[
  If _PTPRN2_ hypomethylation alters neuroendocrine vesicle biogenesis in hippocampal and hypothalamic neurons, it could produce a stable reduction in monoaminergic signaling capacity manifesting as the cognitive and autonomic phenotype observed in a subset of ME/CFS patients. This model predicts that _PTPRN2_ methylation status defines a biological subtype with preferentially cognitive and neuroendocrine features, distinct from subtypes where immune or metabolic mechanisms dominate.

  Testable predictions: (1) ME/CFS patients with _PTPRN2_ hypomethylation should show measurably worse delayed recall and working memory compared to patients without the modification; (2) _PTPRN2_ mRNA or protein expression should differ between the two epigenetic subgroups; (3) pharmacological enhancement of monoaminergic signaling should preferentially benefit the hypomethylated subgroup. No longitudinal or interventional data yet test these predictions.
