...
*Clinical implication:* Until the directionality question is resolved by longitudinal methylation data, therapeutic strategies that promote demethylation (HDAC inhibitors, TET pathway activation, 5-azacitidine) carry theoretical risk of worsening the disease by further eroding methylation at already-hypomethylated loci. Conversely, methyl-donor support (SAMe, methyl-folate, methyl-B12, betaine) is mechanistically conservative---it supports both methylation maintenance (preventing further loss) and de novo remethylation (restoring lost marks) regardless of which directionality the dominant pathology takes. This makes methyl donor support the safer default strategy pending resolution of the directionality question, though efficacy for ME/CFS symptoms remains unproven.

*Limitations:* The consolidation-as-loss framing is a hypothesis, not an established mechanism. Existing ME/CFS methylation studies used mixed cell populations (PBMCs, saliva) and cross-sectional designs; cell-type-specific and longitudinal data are absent. Cancer epigenetics shows global hypomethylation + focal hypermethylation---the same bidirectional pattern observed in ME/CFS (@DeCecco2019LINE1)---and the distinction between "gain-dominant" and "loss-dominant" consolidation in a given tissue or cell type may be quantitative rather than categorical. The ICF syndrome parallel is illustrative but ICF is a severe Mendelian condition; ME/CFS methylation changes are subtler and may operate through different mechanisms.
