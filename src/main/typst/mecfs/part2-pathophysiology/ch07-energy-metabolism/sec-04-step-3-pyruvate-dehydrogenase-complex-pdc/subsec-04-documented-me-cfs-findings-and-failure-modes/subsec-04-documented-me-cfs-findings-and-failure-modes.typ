...
*Testable predictions:* (1) Exercise-provoked muscle #super[31]P-MRS or venous lactate will show dramatically exaggerated PDK-signature (high lactate, slow PCr recovery) compared to the mild resting abnormality; a paired brain MRS + exercise muscle MRS study would demonstrate the divergence. Consistent with this prediction's premise, dynamic 31P-MRS under an exercise/recovery protocol has already shown reduced muscle oxidative capacity (prolonged recovery time-constant and reduced maximal flux) in COVID-19 and multiple sclerosis patients versus controls @Naegel2023MuscleMetabolism, while resting muscle 31P-MRS PCr/ATP does not differ between ME/CFS, long COVID, and controls @Godlewska2025MRS — indicating the deficit is load-gated/extrinsic rather than resting. (2) A muscle biopsy finding only PDK4 elevated (not PDK1/2) would implicate inflammation-driven JNK→PDK4 mechanisms @ParkJeoung2016PDK4 rather than cell-autonomous reprogramming.
