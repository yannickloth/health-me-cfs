...
*Competing explanation (equal weight):* The deficiency may instead arise from impaired CoQ10 biosynthesis — primary genetic CoQ deficiencies from COQ-pathway mutations produce a static, non-consumption-driven low state @Laredj2014CoQBiosynth — or from generalized downregulation of mitochondrial biogenesis, statin use, or gastrointestinal malabsorption. These are not mutually exclusive with oxidative consumption and have never been tested against it in the same ME/CFS cohort. This uncertainty is stated explicitly in Open Question @oq:coq10-consumption-vs-biosynthesis.
...
*Consequence:* If it works, a single blood test measuring the *ratio* of CoQ10's two forms (rather than just how much is present) could tell a clinician whether a patient's low CoQ10 comes from an infection burning through it or from the body making too little — pointing to different treatments — but this is a research proposal, not a validated test.
