...
Three 2024–2026 sources deepen the Bartonella–cognition link beyond the single chronic-fatigue culture study cited above @BartonellaCFS2025, and they contribute different kinds of evidence. A comprehensive *review* synthesizes _Bartonella_ as an established neurotropic genus producing cognitive impairment, neuropsychiatric symptoms, neuropathy, and movement disorders, proposing "neurobartonelloses" as a clinical entity @Bush2024Neurobartonelloses (synthesis, not new primary data); a national retrospective *cohort* of _B. henselae_ encephalitis establishes CNS neurotropism and documents persistent cognitive sequelae, though from acute brain infection rather than chronic ME/CFS-like illness @Yakubovsky2026CatScratchCNS; and a small *pilot* directly relevant to chronic cognition detected _Bartonella_ DNA at higher rates in mild-cognitive-impairment patients than controls @Guirguis2024BartonellaMCI, though it was too small (n\=16 vs 30) to resolve the unanswered question of _Bartonella_ DNA prevalence in healthy populations.
...
#limitation(title: [Babesia Remains the Least-Studied of the Three in ME/CFS])[
A targeted 2024–2026 search returned no new studies linking _Babesia_ infection to chronic fatigue, cognitive, or autonomic symptom domains in an ME/CFS context. The _Babesia_ relevance described above rests on co-infection severity data @Krause1996babesia and mechanistic inference (chronic hemolysis, cytokine activation), not on direct ME/CFS-specific evidence. *Certainty: n/a* (documents an evidence gap, not a claim).
