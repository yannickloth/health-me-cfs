...
=== Postpartum Rebound and Postpartum Onset
...
#limitation(title: [Postpartum ME/CFS Evidence Is Limited to Unreplicated Signals])[
The postpartum vulnerability claim rests on the Schacterle observation (postpartum rebound patterns), the Slack synthesis (3–6 month relapse timing), and review-level descriptions of postpartum onset @Schacterle2004pregnancy @Slack2023pregnancyReview @Thomas2022sexDifferences. There is no large prospective cohort quantifying postpartum relapse or onset risk in ME/CFS, no controlled comparison of postpartum-onset ME/CFS against other postpartum syndromes, and no severity-stratified data.
...
#prediction(title: [The Postpartum 3–6 Month Window Is an Ideal Prospective Onset-Cohort Target])[
The postpartum window is a defined, time-bounded event with an identifiable trigger state — the collapse of the pregnancy hormonal and immune milieu — making it a cleaner natural experiment than general post-infectious onset for testing the immune-reconstitution hypothesis (@hyp:fra-postpartum-immune-reconstitution). The decisive study would recruit primiparous women at elevated risk (prior mild/remitted ME/CFS, family history, recent EBV) before or during pregnancy and follow them through the 3–6 month postpartum window with scheduled biobanking (Treg, NK, EBV/HHV-6 titres, allopregnanolone, estradiol/progesterone). Because onset in this window is defined and trigger-linked, it captures the transition from well to unwell prospectively rather than retrospectively — directly closing the gap flagged in @lim:fra-postpartum-evidence.

*Certainty:* 0.45 — as a feasible, high-value research design. The underlying onset signal is real (see @warn:fra-postpartum-planning) but its immune mechanism is unproven.
