...
=== The Null Sympathetic Result and What It Narrows
...
#open-question(title: [Is the Luteal-Phase Orthostatic Effect Real? — An Unresolved Contradiction])[
A study of ten women with POTS found that the menstrual cycle did not affect presyncope incidence, baroreflex sensitivity, or muscle sympathetic nerve activity (MSNA), although it did modulate blood pressure and vasoconstriction during tilt @Stickford2015menstrualCyclePOTS. This directly conflicts with the earlier report of luteal-phase orthostatic protection, which found a higher presyncope rate in the early follicular phase @Fu2010menstrualCyclePOTS. The two studies measure the *same outcome* (orthostatic tolerance / presyncope) on the *same variable* with *opposite results* — Fu found a luteal benefit, Stickford found none. They are not complementary; they are an unresolved contradiction.
...
#limitation(title: [Menstrual-Cycle Symptom Cyclicity in ME/CFS Lacks a Direct Prospective Cohort])[
No direct prospective study has yet tracked cycle-phase symptom variation in a diagnosed ME/CFS cohort against hormonal confirmation of phase. The ME/CFS symptom-cyclicity claim rests on (a) the sex-differences review synthesis @Thomas2022sexDifferences, (b) the existing chronobiology observations in this document @sec:sex-hormones, and (c) physiological inference from POTS populations @Fu2010menstrualCyclePOTS @Stickford2015menstrualCyclePOTS. The physiological base is solid but the patient-facing, ME/CFS-specific evidence is preliminary and not severity-stratified.
...
#speculation(title: [Cyclic Luteal→Menstrual Allopregnanolone Withdrawal as a Monthly PEM Amplifier])[
Allopregnanolone, a progesterone metabolite with GABA-A-positive-modulating, anxiolytic, sleep-supporting, and autonomic-dampening actions, rises across the luteal phase and crashes at the luteal→menstrual transition. The chapter treats the *postpartum* version of this withdrawal — the single large crash after pregnancy — as a vulnerability window (@hyp:fra-postpartum-immune-reconstitution). The monthly version is unexamined: each cycle's premenstrual allopregnanolone drop could be a *recurring amplifier of post-exertional malaise and autonomic instability*, unmasking the same GABAergic-autonomic vulnerability on a monthly basis rather than once after pregnancy.

If real, this predicts that PEM episodes cluster at the luteal→menstrual boundary beyond the hormonal vascular effects already covered in this chapter (@hyp:luteal-orthostatic-protection), and suggests a testable intervention: luteal-phase micronized progesterone (which preserves allopregnanolone) as a repeatable, non-pregnancy probe of the GABAergic-autonomic axis. (Origin: brainstorm.)
