...
=== Menopause Transition and Symptom Acceleration
...
#clinical-finding(title: [Menopause Symptoms Are Highly Prevalent in Post-COVID Clinical Populations])[
In a cross-sectional study of 122 patients attending post-COVID clinics, menopause-related symptoms were highly prevalent, and the menopausal status of women shaped the clinical picture @Stewart2024menopausePostCOVID. This is a post-infectious (Long-COVID) population rather than a diagnosed ME/CFS cohort, so it informs ME/CFS only by the mechanistic overlap between post-infectious syndromes — but it supports the clinical observation that the menopausal transition intersects with post-infectious illness in ways that affect symptom presentation and management.
...
#speculation(title: [The Menopause Transition Compounds the ME/CFS Energy and Autonomic Burden])[
The menopause transition withdraws the hormonal support that — on the account developed in this chapter — partially sustains volume, vascular, and immune regulation. The loss of estradiol's vascular and metabolic actions, combined with the sleep disruption, hot flushes, and autonomic instability that characterise the transition, plausibly compounds the energy, orthostatic, and sleep burden of ME/CFS in a subgroup of women @Stewart2024menopausePostCOVID @Gkouvi2026fibromyalgiaMenopause. Fibromyalgia — a condition sharing features with ME/CFS — shows menopause-associated symptom worsening, providing a cross-condition precedent @Gkouvi2026fibromyalgiaMenopause.
...
*Consequence:* If the menopause transition does accelerate ME/CFS symptoms, then this is a predictable and potentially modifiable worsening — and it makes assessing menopause status and considering HRT (see @sec:fra-hrt) a legitimate part of managing ME/CFS in this age group, rather than treating a menopausal flare as irreversible disease progression.
] <spec:fra-menopause-transition-compounding>

#limitation(title: [No Direct ME/CFS-Specific Menopause-Transition Cohort Exists])[
The symptom-acceleration-at-menopause claim for ME/CFS specifically lacks a direct longitudinal cohort. The best available evidence is (a) the post-COVID clinic prevalence data @Stewart2024menopausePostCOVID, (b) fibromyalgia-menopause overlap studies @Gkouvi2026fibromyalgiaMenopause, and (c) the early-menopause association @boneva2015menopause. None of these directly demonstrates menopause-transition symptom acceleration in a diagnosed ME/CFS cohort.
...
#speculation(title: [Menopause as an Iron-Accumulation / Ferroptosis Transition — the Reverse of Deficiency])[
...
*Certainty:* 0.20 — novel and mechanistically coherent (iron overload → ferroptosis → mitochondrial failure), but entirely unexamined in ME/CFS; the menopause-transition evidence base itself is indirect (@lim:fra-menopause-transition-no-cohort).
