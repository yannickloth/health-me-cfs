...
Microglia, the resident immune cells of the central nervous system, have emerged as key players in ME/CFS neuroinflammation. Evidence for microglial activation includes elevated markers in CSF (soluble CD14, chitotriosidase), PET imaging showing increased translocator protein (TSPO) binding in specific brain regions @Nakatomi2014neuroinflammation, correlation between neuroinflammatory markers and symptom severity, and persistence of microglial activation years after initial infection. While the viral-triggered microglial activation literature dominates the ME/CFS neuroinflammation discourse, parallel evidence from bacterial pathogens has been underdiscussed: _Borrelia burgdorferi_ directly activates human microglia through TLR1/TLR2 pathways, induces M1 polarisation, and non-viable bacterial debris suffices to sustain this activation — and PET imaging confirms glial activation persists years after antibiotic treatment in PTLDS patients (detailed in Section @sec:tick-borne, @spec:microglial-mitochondrial-borrelia) @Myers2009Microglia @Parthasarathy2015MicrogliaTLR @CassianiIngoni2006MicrogliaTLR @Coughlin2018PTLDSglialPET @Parthasarathy2022NonviableBb. Microglial activation is thus a convergent neuroimmunological endpoint for both viral and bacterial post-infectious triggers of ME/CFS-like illness — the viral arm is well-covered in this section; the bacterial arm should be read alongside it.
