...
The CSF catecholamine data derive primarily from two NIH Clinical Center analyses of overlapping cohorts: Walitt 2024 (n=17 PI-ME/CFS) and Aregawi 2026 (n=16 PI-ME/CFS, n=34 PASC, n=32 Parkinson's disease, n=40 healthy volunteers) @Walitt2024NIH @Aregawi2026Noradrenergic. Aregawi et al. extended the 2024 findings by constructing novel composite pathway indices (NE + DHPG + MHPG for noradrenergic; DA + DOPAC + HVA for dopaminergic), adding PASC and Parkinson's disease comparator groups, and reporting CSF MHPG levels for the first time in PI-ME/CFS or PASC. Key epistemic boundaries:
    ...
    - The direction of causality is unestablished: low central norepinephrine may _result from_ reduced physical activity, sleep disruption, or chronic illness rather than _causing_ ME/CFS symptoms.
...
A direct test of this model was inadvertently provided by Sulheim et al. (2014), who conducted an RCT of clonidine --- a central α2-adrenergic agonist that suppresses sympathetic outflow --- in adolescent CFS (n=120) @Sulheim2014clonidine. Clonidine failed to improve symptoms, a result consistent with the mismatch model: if peripheral sympathetic overactivity is _compensatory_ for central noradrenergic deficiency, suppressing it pharmacologically removes the compensation without addressing the underlying deficiency, producing no net benefit. The study's null result is informative precisely because the alternative hypothesis (sympathetic overactivity as primary pathology) would have predicted improvement.
