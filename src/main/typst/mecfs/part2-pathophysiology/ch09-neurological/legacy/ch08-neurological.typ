...
The regional hypometabolism pattern in ME/CFS converges with a recently proposed brain energy disorder framework for autism spectrum disorder (ASD), in which astrocytic glucose metabolism dysfunction --- impaired glucose uptake, glycogen storage failure, and disrupted astrocyte-neuron lactate shuttling --- preferentially impairs prefrontal cortex and association network function due to their disproportionately high metabolic demands @BlagojevicStokic2026brainenergy. The ASD model posits an energy-saving adaptation: the brain economizes by deprioritizing higher-order cognitive processes (social communication, cognitive flexibility, sensory integration) to preserve ATP for survival functions. ME/CFS independently exhibits the core biochemical features of this model: regional brain glucose hypometabolism on FDG-PET, elevated ventricular lactate on MRS (Natelson et al., 2017, n=34, indicating cerebral glycolytic shift) @Natelson2017Lactate, and astrocyte dysfunction implicated in central fatigue pathways (Morris & Maes, 2015) @Morris2015CentralPathways. A recent review synthesized FDG-PET, MRS, and mitochondrial evidence into a convergent cerebral metabolic signature for ME/CFS @Zhu2025MetabolicNeuroimaging. An independently developed energy conservation model for ME/CFS fatigue (Lacourt et al., 2018) @Lacourt2018InflammationEnergy is structurally identical to the ASD brain energy model --- inflammation → reduced cellular energy availability → non-adaptive energy conservation --- despite being developed without reference to the ASD literature. For detailed treatment of this convergence and its clinical implications, see Chapter @ch:energy-metabolism, Section @sec:brain-energy-cross-disease.
...
*Caveat:* Dietary tryptophan intake — the dominant determinant of systemic tryptophan and serotonin availability — has never been controlled in any ME/CFS tryptophan or serotonin study. Reductions in circulating tryptophan and serotonin may reflect reduced dietary intake (due to restricted eating, nausea, or altered food choices in ME/CFS) rather than pathway-level metabolic diversion alone. The IDO-driven tryptophan diversion model assumes equivalent dietary tryptophan intake between patients and controls — an assumption that has never been tested.
...
*Certainty: 0.45.* (0.40→0.45: externally supported by analogy — Wong et al. 2023 documented enterochromaffin cell damage as a serotonin depletion mechanism in post-infectious illness (Long COVID, @wong2023serotonin), and Che et al. 2025 confirmed innate immune-driven tryptophan diversion in ME/CFS specifically (@che2025innate). The EC-cell damage evidence is from Long COVID, not ME/CFS; the bump reflects cross-condition analogous support, not direct ME/CFS validation.) The enterochromaffin-vagal pathway may represent a critical gut-brain communication axis disrupted in ME/CFS. Enterochromaffin cells in the gut epithelium synthesize and release serotonin in response to mechanical stimulation and short-chain fatty acids (particularly butyrate). This serotonin activates 5-HT3 receptors on vagal afferent neurons, providing tonic input to the brainstem. In ME/CFS, gut dysbiosis and reduced butyrate production may impair enterochromaffin serotonin synthesis, leading to reduced vagal afferent signaling and downstream autonomic dysfunction.
...
*Supporting evidence:*
    ...
    - Entherochromaffin cell damage has been directly documented in post-infectious illness (@wong2023serotonin, three converging depletion mechanisms including EC cell damage)
    - Innate immune-driven tryptophan diversion away from serotonin synthesis confirmed in ME/CFS specifically (@che2025innate)
...
*Limitations:*
    ...
    - EC cell damage evidence is from Long COVID, not ME/CFS directly
...
*Certainty: 0.20.* (Downgraded from 0.30: the Lee et al. 2024 mouse model is a chronic fluoxetine toxicity model, not an ME/CFS model. The central hyperserotonergia component adds no explanatory power beyond peripheral depletion — the POTS SSRI harm signal is already explained by peripheral serotonin deficiency alone. The POTS platelet serotonin data (Gunning et al. 2016, @gunning2016pots; Mar et al. 2014, @mar2014ssripots) provides convergent human evidence for peripheral depletion, not for central hyperactivity.) The coexistence of evidence for serotonin depletion (tryptophan diversion via kynurenine pathway) and serotonin excess (5-HT1A desensitisation in a mouse fluoxetine model, @Lee2024serotonin) raises the possibility of compartmentalised dysregulation. However, the central hyperactivity evidence derives from a single mouse study using chronic high-dose fluoxetine — not a model of ME/CFS, and potentially irrelevant to patients not on SSRIs. Different compartments or brain regions may experience opposite perturbations, which could explain heterogeneous responses to serotonergic medications, but direct measurement of regional serotonergic tone in ME/CFS patients has not been performed. The POTS SSRI harm signal (worsened hemodynamics, @mar2014ssripots) is consistent with peripheral serotonin deficiency but does not provide evidence for central serotonin excess. (Origin: literature-derived)
...
==== Synaptic Homeostasis Failure: When Sleep Cannot Reset the Brain

*Clinical note:* This section describes a speculative mechanism (certainty 0.30) with zero ME/CFS-specific data. No clinical action follows — current management of unrefreshing sleep (sleep hygiene, circadian optimization, pacing, glymphatic positioning) is unchanged. The mechanism is presented for completeness: it identifies a testable prediction that, if confirmed, would mechanistically distinguish true sleep non-restoration from subjective sleep perception. Until SV2A PET is measured in ME/CFS cohorts, this remains basic-science contextual material.

#speculation(title: [Alpha-Delta Sleep May Impair Synaptic Downscaling — Speculative; No Clinical Action Follows])[
*Certainty: 0.30.* (General-population human evidence for synaptic homeostasis from Elmenhorst 2026 @Elmenhorst2026SV2Asleep; no ME/CFS-specific SV2A or synaptic density data exists. All claims below are mechanistic inference from healthy-human and animal data applied to an ME/CFS sleep phenotype that itself rests on a small evidence base: alpha-delta sleep is documented in 2 CFS studies — Guilleminault 2006 cert 0.75, Van Hoof 2007 cert 0.55 — and a fibromyalgia model @Horne1991alphaEEGfibromyalgia.)

The synaptic homeostasis hypothesis (SHY) proposes that wakefulness produces net synaptic strengthening — a structural consequence of learning and neural activity — while sleep, particularly NREM slow-wave sleep, downscales synapses to restore cellular homeostasis and energy balance @Tononi2003SHY @Tononi2014SHYneuron. The first direct in vivo human evidence for this mechanism was provided by Elmenhorst et al. (2026, PLOS Biology, n=40 healthy adults), demonstrating that a single night of sleep deprivation increased synaptic vesicle glycoprotein 2A (SV2A) binding — a PET proxy for synaptic density — in the thalamus (+4.6%), hippocampus (+5.6%), and parietal cortex (+3.2%), while normal sleep controls showed no change @Elmenhorst2026SV2Asleep. The SV2A increase correlated with elevated slow-wave activity during recovery sleep, directly linking sleep pressure to synaptic accumulation.

The ultrastructural basis was established by de Vivo et al. (2017, Science), showing ~18% reduction in synapse density after sleep vs. wake in mouse cortex via serial block-face electron microscopy @DeVivo2017SHYultrastructural. The molecular machinery was identified by Diering et al. (2017, Science): the protein Homer1a drives AMPA receptor removal from synapses during sleep @Diering2017Homer1aSHY. Together, these establish a framework: sleep is required for physical and functional downscaling of synapses.

If this framework applies to ME/CFS, the alpha-delta sleep anomaly — where alpha (wake-like) EEG activity intrudes into NREM delta sleep — may prevent the synaptic downscaling that normal slow-wave sleep provides. *Critical caveat:* the inference that alpha-frequency contamination during NREM blocks the molecular machinery of synaptic downscaling (Homer1a expression, AMPA receptor internalization) has zero direct evidence in any species. The Elmenhorst 2026 finding is about *total* sleep deprivation (zero sleep), not partial NREM disruption, and alpha-delta sleep still contains significant delta activity whose sufficiency for triggering downscaling is unknown. The chain healthy-sleep-deprivation → SV2A-increase → sleep-normally-resets-synapses → alpha-delta-disrupts-deep-sleep → ME/CFS-synaptic-reset-fails → unrefreshing-sleep is a six-link inferential chain in which only the first two links have direct human evidence and none has been tested under ME/CFS-relevant conditions. Each night, the ME/CFS brain may partially fail to reset its synaptic landscape, accumulating the day's synaptic burden; or chronic adaptation (sustained inactivity, reduced cognitive engagement as use-dependent drivers of synaptic pruning) may produce *reduced* synaptic density — the opposite prediction. Both alternatives are empirically testable via SV2A PET but neither is currently constrained by data.

*Energy implications.* Alpha oscillations (8--12 Hz) reflect active thalamocortical processing that involves substantially more neuronal firing than the slow oscillations of delta sleep (0.5--4 Hz), which have been associated with approximately 40% lower cerebral metabolic rate in PET studies @Maquet1990cerebralSleep versus wakeful rest; a shift toward delta-dominant NREM is the brain's primary energy-conservation state. Alpha intrusion during NREM sleep thus places the brain closer to a waking metabolic state when it should be in a low-energy deep-sleep state. Combined with the possibility that unpruned synapses continue consuming maintenance energy (though the ATP cost of a silent synapse relative to an active one remains unquantified), the overnight energy expenditure in ME/CFS could exceed that of a healthy sleeper. This is a qualitative, directional inference — the magnitude of any excess energy cost is unknown and could range from trivial to clinically significant. No direct measurement of overnight cerebral metabolic rate in ME/CFS exists.

*Relationship to other mechanisms.* This hypothesis is framed here as complementary to the glymphatic clearance hypothesis (Section @sec:ch15-glymphatic) and the nocturnal autophagy failure hypothesis (@spec:nocturnal-autophagy-sleep): glymphatic clearance addresses extracellular waste, autophagy addresses intracellular clearance, and synaptic downscaling would address structural synaptic reset. However, these are not established as independent mechanisms — all three may be downstream consequences of a shared cause (brain energy deficit during sleep) rather than parallel independent failures. A negative SV2A PET finding would refute the synaptic mechanism while leaving glymphatic and autophagy explanations intact. This is simultaneously a strength (falsifiable) and a limitation: the "unrefreshing sleep as impaired deep-sleep maintenance" framework survives refutation of any single constituent mechanism.

*Sensory hypersensitivity.* Failed synaptic downscaling in thalamocortical circuits provides a mechanistic bridge to sensory hypersensitivities (photophobia, hyperacusis, allodynia) common in ME/CFS. Excess AMPA receptors at thalamic relay synapses lower the threshold for sensory signal propagation — the same mechanism underlying central sensitization in fibromyalgia. If each night of alpha-delta sleep leaves more synapses potentiated rather than pruned, sensory inputs that are normally filtered as irrelevant gain cortical access, producing the feeling that "everything is too loud, too bright, too much." (Origin: brainstorm.)

*T-type calcium channel convergence.* Thalamic T-type calcium channels (CaV3.1) — the proposed gatekeepers of alpha-delta sleep (Section @sec:thalamic-calcium-sleep) — have been hypothesised to also gate the synaptic downscaling cascade via the chain Ca#super[2+]#sub[V3.1] → CaMKII → Homer1a → AMPA removal. This is a speculative pathway assembly: each individual arrow (CaV3.1 → Ca#super[2+] influx, Ca#super[2+] → CaMKII activation, CaMKII → transcriptional regulation, Homer1a → AMPA internalization) is supported by separate literatures, but the assembled chain has not been demonstrated as a single causal cascade, and CaMKII is activated by many calcium sources beyond CaV3.1. If valid, this would make T-type calcium channels a dual-integrator: their dysfunction would impair both the *generation* of deep sleep rhythms and the *downstream* structural reset that deep sleep normally triggers. This convergence also illustrates a parsimony point: if brain energy deficit underlies both CaV3.1 dysfunction and impaired ATP-dependent processes (AMPA internalization via endocytosis, glymphatic AQP4-driven flow, autophagic lysosomal acidification), then synaptic, glymphatic, and autophagy failures may all be downstream consequences of a single energetic cause — not three independent mechanisms selected by evolution. (Origin: brainstorm.)


*Falsifiable predictions.* (a) SV2A PET in ME/CFS patients scanned after a night of sleep will show elevated synaptic density compared to matched healthy controls — specifically in thalamus and hippocampus, mirroring the Elmenhorst sleep-deprivation finding. (b) The alpha-delta sleep index (ratio of alpha to delta power during NREM) will correlate positively with SV2A binding (r > 0.5). (c) Interventions that objectively increase NREM delta power and reduce alpha intrusion — such as T-type calcium channel modulation, slow-paced breathing before sleep, or temperature optimization — should reduce next-day sensory hypersensitivity and cognitive dysfunction, and over weeks should improve unrefreshing sleep scores. (d) The Homer1a-dependent AMPA receptor internalization pathway (Diering 2017) should show reduced activity in ME/CFS — measurable via CSF Homer1a concentration or, if accessible, synaptic proteomics. (e) Thalamic SV2A binding should correlate positively with quantitative sensory testing thresholds (pressure pain threshold, auditory discomfort threshold), controlling for total sleep time — providing a direct link between synaptic density and the sensory hypersensitivity clinical phenotype. (f) Evening Homer1a protein levels in CSF (or cortical lysate in animal models) should be lower after sleep with alpha-frequency thalamic stimulation vs. normal NREM.

*Alternative possibilities.* The SV2A PET signal reflects synaptic vesicle glycoprotein 2A density, which varies with vesicle trafficking state and recycling pool size in addition to synapse count @Mikkelsen2023SV2Apostmortem. Elmenhorst's observed SV2A increase may partially reflect activity-dependent vesicle loading rather than new synapse formation — the finding still supports synaptic *potentiation* during wakefulness but the magnitude of structural change may be smaller than headline percentages suggest. Furthermore, the synaptic homeostasis hypothesis is not universal — Durkin & Aton (2016) demonstrated sleep-dependent synaptic *potentiation* (not downscaling) in mouse visual cortex, challenging the generality of SHY @Durkin2016SHYcounter. Whether SHY holds in thalamus and hippocampus (Elmenhorst's key regions) under alpha-delta sleep conditions is unknown. Separately, ME/CFS involves sustained inactivity and reduced cognitive engagement (use-dependent drivers of synaptic pruning); chronic adaptation over months to years could produce homeostatic *downregulation* rather than accumulation, producing the opposite of the predicted PET finding. Third, adenosine accumulation — well-documented by the same lab as the SV2A finding @Elmenhorst2007A1adenosine @Elmenhorst2017recoveryA1 — provides a purely neurochemical mechanism for unrefreshing sleep that does not require synaptic structural change. The adenosine pathway is neurochemically upstream of sleep pressure and could explain the same clinical phenotype without invoking Homer1a, AMPA receptors, or synaptic density at all. All alternatives are empirically testable. (Origin: brainstorm + Durkin 2016, Mikkelsen 2023, and Elmenhorst adenosine evidence.)

*Consequence:* If alpha-delta sleep prevents the brain's nightly synaptic reset, this would explain unrefreshing sleep at the synaptic level — patients wake with yesterday's neural connections still fully loaded. This would reframe sleep quality interventions (T-type calcium modulation, glymphatic positioning, circadian optimization) as not merely comfort measures but as strategies to prevent cumulative synaptic and energetic overload. However, the complete absence of ME/CFS-specific SV2A data means this remains a mechanistic inference — zero clinical action follows until direct evidence is obtained.

(Origin: literature-derived — Elmenhorst 2026 evidence applied to established ME/CFS sleep phenotype.)
] <spec:ch08-synaptic-downscaling-failure>

#open-question(title: [Does ME/CFS Involve Elevated Synaptic Density?])[
The Elmenhorst et al. (2026, PLOS Biology, n=40) finding that sleep deprivation increases SV2A binding in healthy humans provides a tool to test whether ME/CFS sleep pathology produces the same synaptic accumulation @Elmenhorst2026SV2Asleep. SV2A PET imaging with [#super[18]F]SynVesT-1 could directly measure whether ME/CFS patients have elevated synaptic density after sleep compared to healthy controls, and whether the alpha-delta sleep index predicts SV2A binding regionally (thalamus, hippocampus). This would be the first direct test of whether unrefreshing sleep in ME/CFS reflects failed synaptic homeostasis.

Key questions: (a) Is whole-brain SV2A binding elevated in ME/CFS vs. matched controls after a night of sleep? (b) Does SV2A binding correlate with alpha-delta sleep severity on PSG? (c) Does SV2A binding correlate with subjective unrefreshing sleep scores and cognitive dysfunction? (d) Does improved NREM quality (via T-type calcium modulation, temperature optimization, or orexin-targeted interventions) reduce SV2A binding over time?

A negative finding (normal SV2A despite severe unrefreshing sleep) would refute the synaptic accumulation mechanism and redirect attention to glymphatic or energetic explanations. A positive finding would connect ME/CFS sleep pathology to a measurable, quantifiable brain imaging biomarker.

*Consequence:* SV2A PET could provide the first objective imaging biomarker of unrefreshing sleep in ME/CFS — distinguishing true sleep non-restoration from subjective sleep perception. This would guide which patients benefit most from sleep-targeted interventions and which need alternative approaches. However, SV2A PET is expensive and involves radiation exposure — practical deployment as a routine biomarker is unlikely; the primary value is as a research tool to validate the synaptic homeostasis mechanism.

(Origin: literature-derived.)
] <oq:ch08-sv2a-pet-me-cfs>

#open-question(title: [CSF Synaptic Protein Panel as a Low-Cost SV2A PET Alternative])[
If synaptic accumulation contributes to ME/CFS unrefreshing sleep, fragments of synaptic proteins (SV2A, AMPA receptor subunits GluA1/GluA2, Homer1a, PSD-95) may be detectable in cerebrospinal fluid as proteins or extracellular vesicles, providing a lower-cost alternative to PET imaging. ME/CFS lumbar puncture samples already collected in existing cohorts (NIH deep phenotyping, UK ME/CFS Biobank) could be analyzed for these markers via ELISA or mass spectrometry.

Key predictions: (a) ME/CFS subjects will have elevated CSF SV2A fragments (>0.5 SD vs controls). (b) SF-36 vitality score will correlate negatively with CSF SV2A. (c) Patients with documented alpha-delta sleep will have higher CSF synaptic protein levels than those with normal sleep architecture.

*Consequence:* A spinal tap could become the first molecular test for whether unrefreshing sleep has a synaptic basis — far cheaper than PET scans and scalable to multi-center studies. However, CSF reflects whole-brain extracellular fluid, not regional synaptic density; signal-to-noise and specificity to synaptic vs. neuronal injury must be established.

(Origin: brainstorm.)
] <oq:ch08-csf-synaptic-panel>

#open-question(title: [Optogenetic Causal Test of Alpha Intrusion and Synaptic Downscaling])[
The hypothesis that alpha-frequency thalamocortical activity during NREM prevents synaptic downscaling is testable via optogenetic manipulation in mice — a design that provides causal evidence rather than EEG-symptom correlation. Transgenic mice expressing channelrhodopsin in thalamocortical projection neurons (e.g., VGLUT2-ChR2) can receive 8--12 Hz optical stimulation during naturally occurring NREM episodes. If alpha intrusion is causal: (a) alpha-stimulated sleep should produce SV2A levels elevated by >20% vs unstimulated sleep (p < 0.01), similar to total sleep deprivation; (b) Homer1a protein levels should be reduced; (c) AMPA receptor surface expression should increase; (d) synapse counts by serial block-face EM should show less overnight reduction than control sleep. This is among the highest-mechanistic-value studies available — it addresses the direction of causality and tests the molecular cascade CaV3.1→Ca#super[2+]→CaMKII→Homer1a→AMPA removal that is currently purely inferential.

*Consequence:* Would provide the first causal evidence in any species that abnormal EEG activity during sleep directly impairs synaptic reset — transforming alpha-delta sleep from a correlational EEG curiosity to a proven pathophysiological mechanism. Negative result would redirect toward glymphatic or energetic explanations.

(Origin: brainstorm.)
] <oq:ch08-optogenetic-alpha-sleep>
...
Microglia, the resident immune cells of the central nervous system, have emerged as key players in ME/CFS neuroinflammation. Evidence for microglial activation includes elevated markers in CSF (soluble CD14, chitotriosidase), PET imaging showing increased translocator protein (TSPO) binding in specific brain regions @Nakatomi2014neuroinflammation, correlation between neuroinflammatory markers and symptom severity, and the suggestion — though replication remains incomplete — that microglial activation may persist years after the inciting trigger. _Borrelia burgdorferi_ also directly activates human microglia through TLR1/TLR2 pathways, induces a pro-inflammatory phenotype (M1-like, as characterised using HMC3 microglial cells; the M1/M2 binary is a simplification of human microglial heterogeneity @Akinlusi2025MicrogliaPolar), and non-viable bacterial debris suffices to sustain this activation — with in vivo human PET imaging providing evidence consistent with persistent glial activation years after antibiotic treatment in PTLDS patients, though TSPO-PET specificity limitations (discussed below) constrain this interpretation (detailed in Section @sec:tick-borne, @spec:microglial-mitochondrial-borrelia) @Myers2009Microglia @Parthasarathy2015MicrogliaTLR @CassianiIngoni2006MicrogliaTLR @Coughlin2018PTLDSglialPET @Parthasarathy2022NonviableBb. Microglial activation is thus a convergent neuroimmunological endpoint for both viral and bacterial post-infectious triggers of ME/CFS-like illness — the viral arm is well-covered in this section; the bacterial arm should be read alongside it.
...
*Limitations.* No study has measured glial glycolytic reprogramming for any tick-borne pathogen; all evidence is from peripheral macrophages/monocytes or non-CNS tissue, and no ME/CFS glial data exist. Whether these pathogens reprogram glia specifically — as opposed to peripheral immune cells — is untested. This is a lower-certainty extension (0.30) of the already-speculative post-viral hypothesis (0.40).
...
#speculation(title: [Brainstem Autonomic Loop: Neuroinflammation as Both Cause and Consequence of Vascular-Immune Failure])[
...
The brainstem (medulla, pons) contains autonomic centers---nucleus tractus solitarius, dorsal motor nucleus of vagus, rostral ventrolateral medulla---that regulate heart rate, blood pressure, and cerebral blood flow. Neuroinflammation in the brainstem _could_ impair autonomic output, reducing vagal tone and the cholinergic anti-inflammatory pathway. Simultaneously, reduced autonomic output could produce hypovolemia and hypoperfusion, causing cerebral ischemia and metabolic stress that further drives neuroinflammation. However, the NII study shows _widespread_ white matter changes, not brainstem-localized neuroinflammation; the Faro connectivity changes could reflect compensatory activation, disinhibition, or analysis artifact rather than autonomic failure; and the Bragee CSF evidence has no control group. Each of these three evidence pillars is weak individually, and treating them as measurements of three nodes in the same cycle in the same patients is an ecological fallacy.
...
*Testable predictions:*
    ...
    + A shared upstream cause model predicts that all three nodes will correlate with a single third variable (e.g., overall disease severity); the cycle model predicts that each node predicts the others after controlling for severity
...
Stimulants (amphetamines, methylphenidate, modafinil) are generally *contraindicated* in ME/CFS despite their effectiveness in other fatigue conditions. While they may temporarily mask fatigue by artificially boosting alertness and motivation, they do not address the underlying energy deficit and may enable activity levels that exceed the patient's true physiological capacity. This can precipitate post-exertional malaise (PEM) and potentially cause permanent deterioration (see Warning @warn:amphetamine-permanent-risk). The neurological model presented here explains why: stimulants affect perceived effort and motivation (downstream of the TPJ dysfunction) without correcting the fundamental mismatch between the brain's effort calculations and actual metabolic capacity. Patients may feel capable of activity that their bodies cannot sustain, leading to crashes. This differs fundamentally from stimulant use in conditions like ADHD or narcolepsy, where the underlying metabolic machinery is intact.
...
#speculation(title: [ADHD and ME/CFS: Dopamine-NRF2-NLRP3 Axis as Mechanistic Overlap])[
*Certainty: 0.35.* ADHD is overrepresented in ME/CFS populations, and stimulants are contraindicated in ME/CFS (Section @sec:neuro-summary, Warning @warn:ch08-stimulant-paradox), suggesting a shared dopaminergic dysfunction that paradoxically diverges in treatment response. A proposed mechanistic bridge: chronic low-grade dopamine oxidation produces dopamine-quinones that deplete glutathione and impair NRF2-mediated antioxidant defence, disinhibiting the NLRP3 inflammasome in microglia and immune cells @SeguraAguilar2018dopaminequinone @Sies2017NRF2.

*Mechanism.* Dopamine is normally stored in synaptic vesicles. Excessive cytosolic dopamine — from impaired vesicular packaging (VMAT2 dysfunction), reduced dopamine transporter (DAT) expression, or mitochondrial ROS impairing vesicular integrity — undergoes auto-oxidation to dopamine-quinones. These quinones: (1) covalently modify cysteine residues on KEAP1, preventing NRF2 nuclear translocation and reducing antioxidant response element (ARE) transcription; (2) deplete glutathione (GSH) directly through conjugation; (3) activate NLRP3 via mitochondrial ROS and lysosomal damage pathways. Unrestrained NLRP3 drives IL-1beta production, which amplifies neuroinflammation and impairs dopamine neuron function, creating a self-reinforcing dopaminergic-inflammatory loop.
...
*Limitations.* Dopamine-quinone formation has not been measured in any ME/CFS sample. The ADHD-ME/CFS co-occurrence rate is not precisely known (estimates vary from 5% to 25% depending on assessment method). Stimulant-induced IL-1beta increases in ME/CFS are untested. The NRF2-NLRP3 connection is well-established in other neuroinflammatory contexts (Parkinson's, multiple sclerosis) but not in ME/CFS.
] <spec:adhd-dopamine-nrf2-nlrp3>

#speculation(title: [Brainstem Neuroinflammation at Dorsolateral Inferior Medulla as a Shared CNS Substrate for POTS, ME/CFS, and Long COVID])[
*Certainty: 0.40.* Blitshteyn (2025) has proposed that the dorsolateral inferior medulla — containing nucleus tractus solitarius (NTS), rostral ventrolateral medulla (RVLM), and dorsal motor nucleus of the vagus (DMV) — represents a shared CNS localization for autonomic dysfunction across POTS, ME/CFS, and Long COVID @Blitshteyn2025Neuroinflammation @Wagoner2019MedullaInflammation. This region integrates baroreflex afferents, controls sympathetic outflow, and receives humoral signals via the adjacent area postrema (a circumventricular organ with a leaky BBB). Chronic neuroinflammation at this site could produce the autonomic signatures common across all three conditions: sympathetic predominance, baroreflex impairment, and vagal withdrawal.

*Evidence.* (1) TSPO-PET studies in Long COVID show neuroinflammation in medullary regions, though not specifically resolved to dorsolateral medulla @VanElzakker2024NeuroinflammationPASC @Moen2025NeuroimmuneLongCOVID. (2) Wagoner (2019) documented brainstem inflammation in pediatric autoimmune neuropsychiatric disorders, providing precedent for medullary neuroinflammation as a pathogenic mechanism. (3) Post-mortem ME/CFS studies show brainstem glial activation, though sampling has not focused on dorsolateral medulla. (4) Area postrema lacks a functional BBB, allowing circulating autoantibodies and inflammatory mediators direct access to NTS neurons — providing a mechanistic route from systemic autoimmunity to brainstem dysfunction.
...
#speculation(title: [GPCR Autoantibody-Mediated Baroreflex Gain Resetting at NTS via Area Postrema Access and Receptor Internalization])[
*Certainty: 0.35.* Circulating α1-adrenergic and M2/M4 muscarinic autoantibodies may cross the area postrema (circumventricular organ with leaky BBB) and bind their cognate receptors on NTS baroreflex neurons @Blitshteyn2026Neuroimmune @Sunami2024GPCRPOTS @Gunning2019GPCRPOTS. Chronic low-level agonism triggers GPCR internalization via β-arrestin-mediated endocytosis, reducing the density of functional adrenergic and muscarinic receptors on second-order baroreflex neurons. This shifts the baroreflex operating point rightward — the brainstem reads mean arterial pressure as lower than actual because fewer receptors transduce the afferent signal — resulting in inappropriate compensatory sympathetic activation despite normal or elevated MAP, exactly the pattern seen in hyperadrenergic POTS.
...
*Evidence.* (1) α1-AR and M2 autoantibodies are documented in POTS and ME/CFS @Fedorowski2017Antiadrenergic @Gunning2019GPCRPOTS. (2) GPCR autoantibodies from POTS patients show functional activity in cell-based assays (CHO cell cAMP/Ca2+ flux) @Fedorowski2017Antiadrenergic @Kharraziha2020GPCRseverity. (3) Area postrema is adjacent to NTS and lacks BBB — autoantibodies have direct anatomical access. (4) GPCR internalization via β-arrestin in response to chronic agonism is a well-established pharmacological phenomenon.
...
#speculation(title: [Germinal Center-Like B Cell Aggregates in Dorsolateral Medulla Driving Intrathecal GPCR Autoantibody Synthesis])[
*Certainty: 0.30.* If the dorsolateral medulla harbors persistent antigen — viral remnants, neo-epitopes from oxidative damage, or misfolded proteins — meningeal B cell aggregates or perivascular cuffs could form, creating local autoantibody production that sustains a feed-forward neuroimmune loop @Blitshteyn2025Neuroinflammation @Moen2025NeuroimmuneLongCOVID @VanElzakker2024NeuroinflammationPASC. The NTS/RVLM/DMV region is adjacent to the fourth ventricle choroid plexus, a known immune surveillance site. Chronic neuroinflammation could recruit B cells via CXCL13/CXCR5, establish tertiary lymphoid structures, and drive intrathecal GPCR autoantibody synthesis independent of peripheral B cell activity.

*Evidence.* (1) B cell aggregates and tertiary lymphoid structures occur in other neuroinflammatory diseases (MS meningeal B cell follicles, NMDA receptor encephalitis perivascular cuffs). (2) CXCL13 is elevated in CSF during neuroinflammation and predicts intrathecal B cell recruitment. (3) GPCR autoantibodies are found in CSF as well as serum in ME/CFS @Bynke2020, consistent with at least some CNS production.
...
=== Retinal and Corneal Imaging as CNS Windows
...
#speculation(title: [Retinal and Corneal Imaging May Detect CNS Pathology Invisible to Blood Tests in ME/CFS])[
...
*Retinal Aβ pathology from viral exposure.* Miller et al. (2025, *Science Advances*) demonstrated that SARS-CoV-2 induces Alzheimer's disease-related amyloid-β (Aβ) pathology in ex vivo human retinal explants and iPSC-derived retinal organoids @Miller2025RetinalAmyloid. The Aβ accumulation was reversible with an NRP1 inhibitor (not clinically available). While this was an ex vivo study (not in living patients), it establishes that SARS-CoV-2 exposure can directly trigger amyloid pathology in CNS tissue — and that the retina is a visible readout. Baraniuk found amyloid products in ME/CFS as early as 2010, and Pretorius has documented fibrin amyloid microclots, suggesting amyloid pathology may be convergent across compartments.

*Retinal microcirculation correlates with fatigue.* Schlick et al. (2022, n=40) used optical coherence tomography angiography (OCT-A) to demonstrate that retinal microcirculation impairment correlates with chronic fatigue severity in post-COVID syndrome @Schlick2022RetinalMicrocirc. Reduced retinal vessel density and increased foveal avascular zone area — markers of microvascular dysfunction — distinguished fatigued from non-fatigued patients, independent of systemic inflammatory markers.

*Corneal nerve fiber loss as neuroinflammation marker.* Cañadas et al. (2023, n=50) used corneal confocal microscopy to demonstrate reduced corneal small nerve fiber density and increased immune cell (Langerhans cell) infiltration in Long COVID patients two years post-infection @Cañadas2023CornealConfocal. Corneal nerve fiber loss is a validated marker of small fiber neuropathy, and the presence of immune cells suggests ongoing local neuroinflammation at a CNS-adjacent site.

*Relevance to ME/CFS:* Small fiber neuropathy is documented in approximately 30% of ME/CFS patients. Retinal and corneal imaging could provide: (a) a non-invasive window into CNS neuroinflammation (retinal microglia are CNS microglia), (b) an objective correlate of the brain fog and cognitive dysfunction reported by patients, and (c) a longitudinal biomarker that can be repeated without radiation (unlike PET) or lumbar puncture. No retinal or corneal imaging study has been performed in ME/CFS.
