...
==== Potential Causes of SFN in ME/CFS
    ...
    - A proposed serological subtype defined by anti-TS-HDS (IgM) and anti-FGFR3 (IgG) antibodies — *reported in general cryptogenic SFN but NOT validated in ME/CFS* (@oq:autoimmune-sfn-serological-subtype)
...
#open-question(title: [Is There a Distinct Autoimmune Serological SFN Subtype (Anti-TS-HDS / Anti-FGFR3) in ME/CFS?])[
A proposed autoimmune SFN subtype is defined by serum anti-TS-HDS (IgM, trisulfated heparin disaccharide) and anti-FGFR3 (IgG, fibroblast growth factor receptor 3) antibodies, which several groups report in cryptogenic and non-length-dependent SFN and sensory neuronopathy, associated with DRG-predominant involvement and acute-onset presentation @Antoine2015FGFR3 @Levine2020TSHDSFGFR3 @Tholance2020FGFR3 @Murin2024SFNsero. Preclinical work suggests FGFR3 antibodies can bind DRG neurons and induce mechanical hypersensitivity in mice @Salih2026FGFR3Pathogenic.

This serological claim is contested and is NOT established. Independent real-world data show anti-TS-HDS has limited disease specificity — 34% of seropositive patients in one consecutive cohort had no objective neuropathy on skin biopsy or autonomic testing, and immunotherapy benefit did not exceed that in seronegative patients @Chompoopong2023TSHDS; antibodies are present irrespective of whether small-fiber damage is objectively demonstrable @Trevino2021TSHDSFGFR3 @Murin2024SFNsero; and the anti-FGFR3 assay lacks inter-laboratory standardisation, with lab-specific cut-offs @Appeltshauser2025FGFR3assay. In fibromyalgia — the closest overlapping population to ME/CFS — anti-TS-HDS is either not elevated over controls @Malik2019TSHDSfibromyalgia or is *lower* than controls @Nissan2023TSHDSfibromyalgia, the opposite of the expected direction. Independent reviews find the pathogenic role and clinical-phenotype correlation unresolved @Morelli2024antibodyReview. Notably, the supportive reports share a common assay and testing lineage and overlapping interests, whereas the challenge data above come from independent centres — an asymmetry that further undercuts confidence in the positive reports. No ME/CFS-cohort study of these antibodies exists; their relevance to ME/CFS is inferential only.

Most importantly, controlled immunomodulation trials are negative: a double-blind placebo-controlled pilot found no benefit of IVIG over placebo in antibody-positive SFN @Gibbons2023IVIGpilot, a Class I RCT found no benefit in painful idiopathic SFN @Geerts2021IVIG, and a systematic review rates the evidence low-to-very-low @Ng2026IVIGsystrev. Uncontrolled open-label IVIG reports showing IENFD improvement @Zeidman2022IVIG conflict with these blinded data, and an independent editorial describes the antibody-guided IVIG efficacy signal as "fading" @Katzberg2023IVIGsignal.

*Research question:* Does a prospectively phenotyped ME/CFS cohort contain a seropositive autoimmune-SFN subgroup distinguishable from seronegative patients on skin-biopsy IENFD, sudomotor testing, and symptom profile — and does any such subgroup respond to immunomodulation in an adequately powered, antibody-stratified trial? Absent that evidence, anti-TS-HDS/anti-FGFR3 serology should not be used to diagnose an autoimmune SFN subtype in ME/CFS or to select patients for IVIG.

*Consequence:* A patient who tests positive on these commercial antibody panels might be told they have a "treatable autoimmune small fiber neuropathy" and be offered IVIG — yet the evidence does not support that the test reliably distinguishes disease or that IVIG helps. Knowing the test is unvalidated and the trials are negative protects patients from over-testing and from unproven, expensive, and not risk-free immunotherapy, while clarifying that the real need is a proper ME/CFS-cohort study.
] <oq:autoimmune-sfn-serological-subtype>

#limitation(title: [Anti-TS-HDS / Anti-FGFR3 Serology Is Not a Validated Diagnostic or IVIG-Selection Tool in ME/CFS])[
The anti-TS-HDS and anti-FGFR3 antibodies are commercially testable but are not validated as diagnostic markers or as predictors of immunotherapy response in ME/CFS. Key evidence gaps: no ME/CFS-cohort study of these antibodies exists; the closest overlapping population (fibromyalgia) shows no elevation or the reverse direction @Malik2019TSHDSfibromyalgia @Nissan2023TSHDSfibromyalgia; real-world data find limited disease specificity and no response prediction @Chompoopong2023TSHDS; the assay is not standardised across laboratories @Appeltshauser2025FGFR3assay; and both controlled IVIG trials are negative @Gibbons2023IVIGpilot @Geerts2021IVIG. Positive open-label IVIG reports @Zeidman2022IVIG derive from uncontrolled, responder-selective cohorts. (Severity applicability: unknown — none of these studies stratified by severity. This limitation is distinct from the IgG-DRG passive-transfer axis @hyp:drg-sfn-igg-mecfs, which has direct experimental support in post-infectious cohorts and is a separate claim.)
