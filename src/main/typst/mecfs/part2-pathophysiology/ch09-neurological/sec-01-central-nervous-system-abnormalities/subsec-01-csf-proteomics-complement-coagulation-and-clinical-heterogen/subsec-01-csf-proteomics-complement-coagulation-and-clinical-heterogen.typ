...
This pattern indicates that fatigue in ME/CFS originates centrally rather than peripherally @walitt2024deep. The motor cortex continues to “try harder” even as actual force production declines, suggesting a breakdown in the feedback mechanisms that normally calibrate effort to output. A complementary multimodal study (Bedard 2026) found that ME/CFS patients fail to up-regulate motor output (cortical and subcortical) under sustained effort despite equal maximum force @Bedard2026centralFatigability; the resulting central motor-drive failure and its differential-diagnostic drug probes are traced in Section @sec:central-motor-drive-cascade.
