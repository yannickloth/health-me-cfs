...
#clinical-finding(title: [In Vivo CNS ATP and Phosphocreatine Reduction in Long COVID])[
Weber-Fahr et al. (2026) used whole-brain phosphorus magnetic resonance spectroscopy (#super[31]P-MRSI) to measure high-energy phosphates directly in living patients, comparing 27 post-COVID participants with 23 recovered controls @WeberFahr2026ATPphosphocreatine. Long COVID participants showed reduced ATP-to-phosphocreatine (ATP/PCr) ratios centred on the cingulate cortex, with lower anterior-cingulate ATP/PCr correlating with poorer cognition. The Long COVID subgroup meeting ME/CFS diagnostic criteria showed the same brain-energy alteration. This is among the first direct in-vivo human evidence that brain ATP and its phosphagen reserve are measurably reduced in post-infectious fatigue---complementing the PET hypometabolism and neuroinflammation findings above with a molecular energy readout rather than an indirect perfusion or metabolic proxy. (Evidence type: observational case-control; raw certainty 0.72, from a Long-COVID cohort with an ME/CFS subgroup --- discounted to 0.61 for the cross-cohort transfer. Correlational, not causal.) (Severity applicability: unknown --- the study did not stratify by ME/CFS severity.)

Reading this as a core ME/CFS energy lesion is premature: the deficit may be specific to the Long-COVID trajectory rather than general ME/CFS, could be a downstream correlate of reduced cognitive activity or depressive/medication state rather than an upstream energy-generating failure, and the ATP/PCr-cognition link is correlational and potentially reverse-causal @WeberFahr2026ATPphosphocreatine. Until it replicates in non-COVID ME/CFS and survives control for cognitive effort and mood, it is best treated as a candidate biomarker of the central-fatigue phenotype, not proof of a primary brain energy-generating defect.

*Consequence:* If confirmed in broader ME/CFS cohorts, direct in-vivo brain-energy measurement would give researchers a molecularly specific readout of the CNS energy deficit this model predicts --- currently inferred only from perfusion and metabolism proxies.
] <clin:weberfahr-cns-atp>
