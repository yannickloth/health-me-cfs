...
Emotional suppression in ME/CFS has been documented experimentally: patients show blunted electrodermal activity during emotion suppression tasks — a physiological flattening — paired with _higher_ subjective distress @Rimes2016EmotionSuppression. The body cannot produce the normal physiological response, but the subjective experience remains intact. The patient feels everything; they simply cannot show it. This dissociation between internal experience and external expression is profoundly isolating: others perceive a flat, unresponsive person and infer absence of feeling, while the patient experiences the full range of human emotion but cannot produce the motor output to express it.

#speculation(title: [Emotional Synchrony Failure as Prefrontal Mismatch Cost])[
*Certainty: 0.40 (Tier 2, resting on convergent cross-domain evidence).*

The inability to match others' emotional tempo — emotional synchrony — may represent a distinct and underrecognized metabolic cost in ME/CFS. Neuroimaging evidence in healthy populations shows that when two people are emotionally congruent (both happy, both calm), the medial orbitofrontal cortex and ventromedial prefrontal cortex activate — regions linked to reward — making synchrony metabolically efficient because it requires no conflict resolution @Kuhn2011emotionalSynchrony. However, when emotional states are _incongruent_ — the room is animated and the patient is depleted, someone directs cheerfulness at a person who feels nothing — the dorsolateral prefrontal cortex (DLPFC) activates to process the conflict between internal state and external expectation @Kuhn2011emotionalSynchrony. The DLPFC is the brain's most metabolically expensive region.

For the person with ME/CFS, most social situations represent a _continuous_ state of emotional mismatch. The room operates at a tempo the patient cannot match. The affect the patient can produce — flat, quiet, minimal — is incongruent with the affect the room expects. The DLPFC runs continuously, burning energy the patient does not have, trying to bridge a gap that cannot be bridged.

Facial mimicry — the automatic tendency to mirror others' expressions — depends on intact medial prefrontal cortex. TMS experiments demonstrate this causally: activating the medial prefrontal cortex enhances facial mimicry; inhibiting it impairs it @Balconi2013rTMSMimicry; @Balconi2011MPFCmimicry. The neural hardware that produces the smile expected in return for another's warmth is the same frontal circuitry that is hypometabolic and hypoperfused in ME/CFS.

Fatigue directly impairs emotional contagion. Partial sleep deprivation in healthy subjects reduces emotional contagion — people feel less happiness observing happy faces, and their brains show reduced activation to emotional stimuli — even when facial muscle mimicry persists @Tamm2020sleepContagion. Total sleep deprivation reduces emotional empathy across multiple domains @Guadagni2014sleepEmpathy. In real-world settings, sleep-deprived physicians show measurably reduced empathy and prescribe fewer analgesics to patients in pain @ChoshenHillel2022sleepEmpathy. If one night of poor sleep degrades emotional synchrony in healthy people, years of metabolic brain dysfunction — reduced cerebral glucose metabolism, impaired prefrontal function, depleted catecholamines — produce a brain operating in a state analogous to continuous partial sleep deprivation.
...
#speculation(title: [Thin-Slice Misreading of Flat Affect: An Experimental Basis for Observer Misattribution])[
*Certainty: 0.42 (Tier 2, mechanism transfer by analogy — no ME/CFS-cohort first-impression study exists).*

The observer-side misattribution described above — flat affect read as disinterest, disengagement, or "not caring" — has a plausible experimental parallel in the autism thin-slice literature, though that literature measures a *related but not identical* judgment. Across three studies, observers formed less favorable first impressions of autistic adults and children from thin slices (seconds) of real behavior, judged them more socially awkward and less likeable, and reported reduced willingness to engage; the effect was robust within seconds, stable over repeated exposure, and present across child and adult ages (η² 0.47–0.55) @Sasson2017ThinSlice. The bias disappeared when impressions were based only on the written transcript of what a person said — evidence that negative first impressions track presentational *style* (facial affect, expressivity, movement), not conversational *substance* @Sasson2017ThinSlice. A meta-analysis (21 articles, 221 effects) replicates the modality-specific pattern @Wanigasekera2025FirstImpressionsMeta. The specific presentational signal implicated is facial affect: reduced facial expressivity in autistic adults is directly linked to less favorable first impressions @Foster2025FacialAffectFirstImpressions. (Severity applicability: unknown — these studies did not stratify by the ME/CFS severity axis.)

*Important scope note:* the autism studies measured reduced *favorability* toward targets judged socially awkward or less competent — not an inference that the target holds *contempt or animus* toward the observer. The present chapter's clinical observation that ME/CFS flat affect is sometimes read as disdain or superiority is a separate, ME/CFS-specific clinical claim; the autism literature supports the general principle that low-affect presentation reduces first-impression favorability and engagement, but does not by itself establish that an ME/CFS patient's flat affect is specifically read as contempt. Whether ME/CFS patients' presentation produces the same effect — and with what attributed meaning — in real observers is untested.

If reduced presentational expressivity drives less favorable first impressions independently of conversational substance, then an ME/CFS patient's metabolic flat affect — a documented symptom of neurometabolic energy failure, not a mood or attitude — may lower an observer's first-impression favorability and willingness to engage before the patient has spoken. Two caveats bound the claim. First, the flat affect is the patient's genuine symptom (energy conservation), not a behavioral choice. Second, the specific *meaning* an observer attaches to the presentation (disinterest, illness, low energy, or contempt) is not established by the cross-condition evidence, which measured overall favorability rather than the attributed cause. This gives the chapter's clinical-observation claim a plausible cross-condition mechanism, developed in full for the clinician-dismissal setting in the healthcare-systems chapter (@spec:thin-slice-mecfs-dismissal, Chapter @ch:healthcare-systems-policy), but it is a mechanism hypothesis, not a validated ME/CFS finding.

*Falsifiable:* in a thin-slice design, observers rating matched verbal content from ME/CFS patients versus controls will form less favorable first impressions when presented with audio-visual clips than when presented with the transcript alone.

*Consequence:* If patients and clinicians recognize flat affect as a metabolic symptom likely to be misread as a first-impression signal, then clinicians and caregivers can be primed to weight the patient's reported substance over their presentational style when forming judgments. (Origin: /integrate-topic autism-social-perception-stigma.)
]
...
==== The Defensive Shift: When Energy Depletion Produces Criticality
...
In ME/CFS, under stress and fatigue, attention narrows to central, focal stimuli and peripheral awareness degrades. This is the Easterbrook effect: as arousal or load increases, the range of cues an organism can process shrinks @Easterbrook1959cueUtilization. Applied to social situations, this means the depleted person misses peripheral social information — subtle shifts in expression, changes in tone, body language that signals a shift in conversation. They are processing less of the social environment, not because they are not paying attention, but because their attentional bandwidth has contracted. This narrowing has cumulative social consequences: the person who misses peripheral cues responds less appropriately, misreads situations more often, and appears socially clumsy or disconnected.

#include "subsubsec-07-neurodivergent-psychological-consequences.typ"

==== Neurobiological Basis

The social and emotional impairments described above are explained by the documented neurological abnormalities:

    - *Catecholamine depletion*: Low dopamine and norepinephrine impair both reward processing (making social interaction unrewarding) and the motivation to engage socially @walitt2024deep. BH4 depletion compromises tyrosine hydroxylase activity, directly limiting catecholamine synthesis capacity @Williams2025GCH1BH4.
    - *Prefrontal hypometabolism*: Reduced energy availability in prefrontal regions impairs the executive functions required for social cognition @siessmeier2003pet. Self-regulation — emotional control, impulse inhibition, careful word choice — draws on the same limited prefrontal metabolic resources that are compromised in ME/CFS. Experimental studies in healthy populations demonstrate that acts of self-control measurably reduce blood glucose and impair subsequent self-regulation, establishing that social comportment depends on a depletable metabolic resource @Gailliot2007glucoseSelfControl; @Baumeister1998egoDepletion.
    - *Effort-reward miscalculation*: Reduced dopaminergic tone biases basal ganglia computation toward effort aversion — social interaction is computed as high-cost, low-reward activity rather than the inherently reinforcing experience it is for healthy individuals @Miller2014dopamine; @Treadway2012effortbaseddecisionmaking; @Salamone2012dopamine. This is reinforced by predictive processing models in which fatigue increases the brain's prior expectation of effort cost, making engagement feel prohibitively expensive before it begins @GreenhouseTucknott2022.
    ...
    - *ATP depletion*: Fundamental energy insufficiency makes any sustained cognitive activity painful. Cognitive exertion increases brain ATP demand by 10–20% above baseline, and the brain has minimal energy reserves @Jamadar2025metabolic.
...
The evolutionary framework of sickness behaviour provides the biological context: across species, the coordinated suite of fatigue, social withdrawal, anhedonia, hyperalgesia, and irritability that accompanies infection serves to redirect energy away from social interaction and toward immune function @Morris2013mecfsSickness. When an animal is sick, it withdraws from the group, stops grooming, stops responding to social signals, becomes less tolerant of approach, and may become aggressive if pushed — each behaviour conserving energy for immune defence by eliminating non-essential expenditure. In acute infection this programme runs for days and then switches off. In ME/CFS, chronic inflammatory signalling keeps it engaged far beyond any acute trigger @VollmerConna2004. The patient is not choosing withdrawal; the patient's brain is running an evolutionarily conserved energy-conservation programme that never receives the shutoff signal.
...
Beyond withdrawal and irritability, energy depletion produces a broader psychosocial syndrome for which converging evidence exists across multiple research domains. Sleep loss in healthy populations — a well-characterized model of acute energy deficit — reduces willingness to help others, deactivates the brain's social-cognition network (medial prefrontal cortex, temporoparietal junction, inferior frontal gyrus), and at population scale produces measurable drops in charitable giving @BenSimon2022sleepHelping. While the specific mechanisms of energy deficit differ between acute sleep deprivation and chronic ME/CFS, the neural circuitry affected — social-cognition and prefrontal networks — overlaps substantially with the regions showing hypometabolism and reduced activation in ME/CFS. Post-infectious fatigue reduces reward sensitivity — the brain assigns lower motivational priority to activities that would normally feel worth the effort, independent of effort cost @Scholing2025fatigueReward. The conservation-withdrawal framework from psychosomatic medicine describes a behavioural state in which the self withdraws from engagement, narrows its circle of trust, intensifies self-concern, and redirects all remaining resources toward self-protection @Ironside1980conservationWithdrawal. Under fatigue, perceptual narrowing — the Easterbrook effect — reduces the range of social cues a person can process, degrading peripheral awareness of subtle expressions, tone shifts, and body language @Easterbrook1959cueUtilization. Taken together, the convergent evidence predicts that the person with ME/CFS becomes less generous, more withdrawn, less motivated by reward, more self-focused, and processes a narrower slice of the social world — not because of who they are, but because their brain has been forced into energy-conservation mode.
...
Without a biological explanation, the brain does what brains do with unexplained distress: it looks for causes in the environment. _These people are draining me. That friend is too demanding. That group is too stressful. I must be an introvert. I must not like these people anymore. Maybe I am depressed._ The interpretations that emerge from energy depletion — threat scanning, negativity bias, defensive posture — become the story the person tells themselves about why they are withdrawing.
