...
== GLP-1 Receptor Agonists: Central Nervous System Research Directions
<sec:glp1-cns-research>

The genetic pathway enrichment findings (Chapter @ch:genetics-epigenetics, Section @sec:glp1-genetics) and the orexin-GLP-1 reciprocal dysregulation hypothesis @Ruhrländer2026orexinGLP1 together motivate CNS-directed research on GLP-1 receptor agonists in ME/CFS. All considerations below are research-stage; no clinical data exist.

#open-question-unnumbered(title: [Postprandial GLP-1 Secretion Dynamics in ME/CFS])[
...
#speculation(title: [Central GLP-1 Resistance as a Driver of Brain Fog])[
  *Certainty: 0.25.* (0.20→0.25: convergence with Central NE Deficiency — GLP-1 incretin resistance and catecholamine deficiency both predict cerebral energy homeostasis failure via complementary pathways from different physiological systems.)
  ...
  GLP-1 receptors on neurons and glia regulate cerebral glucose uptake, mitochondrial biogenesis, and insulin sensitivity. If ME/CFS involves central GLP-1 resistance — analogous to the well-documented central insulin resistance in Alzheimer's disease ("Type 3 diabetes") — neurons would be metabolically starved despite normal or elevated blood glucose. This could explain the reduced cerebral glucose metabolism observed in some ME/CFS PET studies and the subjective experience of "brain fog" as "brain not getting enough fuel." GLP-1 RAs at supraphysiological doses might overcome resistance, improving neuronal energy availability independent of peripheral effects @Athauda2026GLP1neurodegenerative.
...
#speculation(title: [GLP-1 RA-Mediated Glycocalyx Stabilisation and PEM Reduction])[
...
#speculation(title: [GLP-1 RA Effects on NK Cell Cytotoxicity — First Ex Vivo Human Data])[
  *Certainty: 0.35.* (0.30→0.35: convergence — GLP-1 RA NK enhancement from T2D pharmacology and clinical evidence of corticosteroid NK suppression both indicate NK function is pharmacologically modifiable, via complementary evidence from different domains.)
  ...
  NK cell dysfunction is one of the most replicated immune findings in ME/CFS (Chapter @ch:immune-dysfunction). GLP-1 receptors are expressed on NK cells and their activation enhances cytotoxicity in T2D @Deng2025GLP1immune. No study has examined GLP-1 RA effects on ME/CFS NK cells. Ex vivo exposure of ME/CFS PBMCs to GLP-1 RA (liraglutide, semaglutide) would provide the first human ME/CFS-specific mechanistic data with zero patient drug exposure.
...
#include "open-questions/oq-glp1-cns-research-priorities.typ"
