...
=== Research Priorities and Cross-Disease Bridges

#open-question-unnumbered(title: [CNS-Targeted GLP-1 Delivery (Intranasal Route)])[
...
#open-question-unnumbered(title: [FDG-PET as a CNS GLP-1 Sensitivity Biomarker])[
...
#open-question-unnumbered(title: [Glucose-Independent GLP-1 RA Efficacy Prediction from Protective Allele Overlap])[
  Gardner 2026 reports protective ME/CFS alleles overlap with T2D protection. This creates a testable prediction: GLP-1 RA effects in ME/CFS may occur through the same pathways that protect against T2D, which are distinct from glucose lowering — specifically, anti-inflammatory (NF-kB, CRP), endothelial (eNOS, glycocalyx), and mitochondrial (PGC-1α, biogenesis) effects @Ren2025GLP1inflammatory @Athauda2026GLP1neurodegenerative. If true, GLP-1 RAs could benefit normal-weight, normoglycaemic ME/CFS patients as much as pre-diabetic ones, and baseline HbA1c would not predict symptom response. This would substantially expand the eligible population for any future trial.
...
#open-question-unnumbered(title: [Postprandial GLP-1 AUC as Trial Enrichment Biomarker])[
...
#open-question-unnumbered(title: [DPP-4 Activity as Drug-Selection Biomarker])[
...
#open-question-unnumbered(title: [Auricular tVNS to Enhance Vagal GLP-1 Sensitivity])[
...
#open-question-unnumbered(title: [Gut L-Cell → Vagus → Brain Axis as Drug-Free GLP-1 Target])[
  Endogenous GLP-1 is released from intestinal L-cells in response to nutrients. L-cells express mechanosensors (PIEZO2, TRPA1) and chemosensors (FFAR2/3 for SCFAs). The gut → vagus → NTS → hypothalamus circuit is the major physiological route for GLP-1 signalling, independent of BBB penetration. In ME/CFS, dysbiosis (reduced SCFAs, altered bile acids), slow gut motility, and vagal dysfunction may collectively suppress endogenous GLP-1 release, creating a vicious cycle: low GLP-1 → reduced vagal tone → gut dysmotility → further GLP-1 suppression. This cycle could be interrupted by prokinetics, prebiotics, or vagal nerve stimulation — entirely without pharmacological GLP-1 RAs. The orexin-GLP-1 reciprocal regulatory cycle described by Ruhrländer 2026 is positioned within this broader gut-brain axis @Ruhrländer2026orexinGLP1.
...
#open-question-unnumbered(title: [Retrospective Classifier Validation in Non-ME/CFS Cohorts])[
...
#open-question-unnumbered(title: [PEM Provocation Substudy — Does GLP-1 RA Blunt Delayed Worsening?])[
...
#open-question-unnumbered(title: [Bismuth Subsalicylate as GLP-1 Secretagogue via H2S Chelation])[
  Qi et al. 2024 (Nature Metabolism) demonstrated that _Desulfovibrio_-produced H2S suppresses GLP-1 secretion from L cells by inhibiting mitochondrial function @Qi2024DesulfovibrioGLP1. Bismuth subsalicylate chelates luminal H2S, rescuing GLP-1 production in mice. ME/CFS patients have altered gut microbiota including potential increases in H2S producers. BSS is an OTC, cheap, well-tolerated, oral medication with >50 years of safety data. This provides a mechanism to increase endogenous GLP-1 without injected drugs.
...
#open-question-unnumbered(title: [PEA as PPAR-α Agonist Enhancing CNS GLP-1 Sensitivity])[
...
#open-question-unnumbered(title: [Severe-ME/CFS-Adapted GLP-1 Strategy])[
...
#open-question-unnumbered(title: [Post-Viral ME/CFS as GLP-1 Deficiency Syndrome — Cross-Disease Models])[
...
#open-question-unnumbered(title: [Urinary GLP-1 Fragments as Non-Invasive Monitoring])[
