...
#speculation(title: [Aluminium-Adjuvant NLRP3/IL-1$beta$ Chronic Immune Stimulation as an Unproven ME/CFS Contributor])[
*(Certainty: 0.33 — discounted for single-mechanism, in-vitro/animal provenance and absent ME/CFS-specific data; raised from 0.28 on Phase 7 convergence with the HS-NLRP3 bridge and IL-11 inflammaging on the shared NLRP3→IL-1$beta$→neuroinflammation→fatigue endpoint; this is the mechanism strand of the aluminium-adjuvant/MMF subgroup speculation in Chapter @ch:speculative-hypotheses, Section @spec:aluminum-adjuvant-mmfs-subgroup.)* Caution: NLRP3→IL-1$beta$ is a highly non-specific final common pathway, activated by many non-alum stimuli (damage signals, urate, cholesterol, infection); its co-occurrence in these conditions therefore confers only weak alum-specificity on this mechanism and does not by itself strengthen the aluminium-adjuvant case. Chronic immune stimulation is a documented ME/CFS theme, and aluminium oxyhydroxide adjuvants activate the NLRP3 (Nalp3) inflammasome to drive IL-1$beta$ secretion — the molecular basis of alum immunostimulation @Eisenbarth2008nalp3. Aluminium-adjuvant particles also biopersist in phagocytes and can translocate to brain (animal) @Gherardi2015biopersist, and MMF patient phagocytes show specific inflammatory, autophagic, and mitochondrial responses in vitro @Masson2024phagocytes. The speculation is that, in a minority of vaccine-adjuvant-exposed people, sustained low-grade NLRP3/IL-1$beta$ signalling constitutes a chronic immune-stimulation vector that could contribute to ME/CFS-like fatigue. This is the *mechanism* strand only: it does not assert that aluminium adjuvants cause ME/CFS at the population level, a claim that a nationwide registry already counts against (adjuvanted vaccine HR 0.97; see Chapter @ch:speculative-hypotheses, Section @sec:cross-disease) @Magnus2015influenza.

*Severity applicability:* Unknown — the MMF cohort was not stratified by severity; applicability may be confined to an MMF-diagnosed subset.

*Falsifiable prediction:* A prospective immune-phenotyping study comparing MMF biopsy-positive against MMF biopsy-negative vaccine-exposed controls would find MMF-positive patients do *not* show higher NLRP3/IL-1$beta$ activation over baseline once age, sex, and cumulative adjuvant dose are matched. Falsified if MMF-positive patients show no excess NLRP3/IL-1$beta$ activity independent of those confounders, or if NLRP3/IL-1$beta$ activity does not associate with fatigue in an incident vaccine-exposed cohort.

*Consequence:* If sustained adjuvant-driven NLRP3/IL-1$beta$ signalling contributes to ME/CFS-like symptoms in a subset, it would argue for stratifying patients by vaccine-adjuvant exposure history and deltoid-biopsy MMF status in immune phenotyping studies — but current evidence does not justify any diagnostic or treatment change.
] <spec:aluminum-adjuvant-nlrp3-immune-stimulation>
