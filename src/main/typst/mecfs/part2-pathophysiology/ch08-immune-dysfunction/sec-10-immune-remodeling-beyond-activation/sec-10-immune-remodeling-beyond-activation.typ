...
This observation coexists with the chapter's "Paradox of Invisible Immunity" (Section @oq:invisible-immunity), which documents that the broadest profiling studies (391 patients, 7,542 autoantibody interactions, 64 cytokines) have found nothing systematically different. The tension between specific heterogeneous findings in small cohorts and null findings in large cohorts remains unresolved. A related activation-versus-depletion tension arises with the BioMapAI AI model's finding of heightened IFN-gamma/granzyme-A activity in MAIT and gamma-delta T cells (@hyp:biomapai-dysbiotic-crosstalk-benzoate-hippurate, @oq:mait-gamadelta-activation-vs-depletion, @ch:integrative-models) — reconcilable as an activation-then-exhaustion trajectory, but the direction is unresolved.
...
#include "subsec-10-galectin-9-tim-3-a-novel-mechanism-for-tissue-resident-cell/subsec-10-galectin-9-tim-3-a-novel-mechanism-for-tissue-resident-cell.typ"

#include "subsec-10-complement-genetics-and-the-inflammatory-subgroup/subsec-10-complement-genetics-and-the-inflammatory-subgroup.typ"

#include "subsec-10-extracellular-vesicles-as-inter-compartment-signaling-vector/subsec-10-extracellular-vesicles-as-inter-compartment-signaling-vector.typ"
