...
The Hammarlund primate model provided direct experimental confirmation @Hammarlund2017PlasmaCell: bone marrow LLPCs survived for more than a decade after sustained depletion of memory B cells. BrdU pulse-chase experiments detected plasma cells labelled at the time of vaccination still alive 10 years later without any evidence of cell division. The LLPC pool alone — without memory B cell input and without antigenic stimulation — was sufficient to maintain stable serum antibody titres.

A critical structural determinant of antibody longevity is the physical form of the antigen that drove the original response @Slifka2019Multivalency @Chackerian2020LLPC. Highly multivalent, repetitive antigen arrays — such as viral capsids and envelope glycoprotein lattices — cross-link B cell receptors with high avidity, lowering the activation threshold and preferentially driving LLPC differentiation. Herpesviruses present precisely this type of antigen: icosahedral capsids with repeating structural subunits, dense glycoprotein arrays on the viral envelope, and tegument proteins packaged at high copy number. They are structurally optimised to generate exceptionally durable antibody responses.

Robinson et al. demonstrated that LLPCs accumulate in bone marrow at a rate of approximately one cell per hour after immunisation, and that the final number scales with the duration of the germinal centre reaction @Robinson2022LLPC. This implies that the magnitude of the initial infection — the antigen load and the duration of the germinal centre response — determines long-term antibody levels, not the frequency of subsequent reactivation events.

===== What This Means for Herpesvirus Serology
...
This does not mean herpesvirus reactivation does not occur in ME/CFS — the dUTPase, ALR, and poly-herpesvirus co-reactivation evidence is discussed below (Sections @sec:abortive-lytic, @sec:poly-herpesvirus). It means that antibody titre alone — particularly against structural viral antigens (VCA, gB) and latency proteins (EBNA-1, which is not a structural antigen but is functionally in the same interpretive category because it is constitutively expressed during latency) — cannot distinguish between:
...
===== What IS a Signal of Active Viral Activity (and What Isn't)

| Antibody target | What it indicates |
|-----------------|-------------------|
| VCA IgG, EBNA-1 IgG, CMV gB IgG, VZV gE IgG | LLPC output (may reflect infection that occurred decades ago) |
| EA-D IgG (EBV early antigen diffuse) | Lytic cycle entry — but early antigen antibodies can persist for years after resolved reactivation |
| VCA IgM | Genuine herpesvirus reactivation OR recent primary infection OR nonspecific polyclonal B cell activation OR rheumatoid factor interference — cannot distinguish between these without clinical context and confirmatory testing |
| Anti-dUTPase IgG (BLLF3, U45, ORF8) | Evidence of abortive lytic replication — dUTPase is an early lytic gene product; antibody presence signals recent expression of lytic genes, not necessarily productive replication |
| Viral DNA in plasma (quantitative PCR) | Presence of cell-free virions — indicates productive lytic replication; however, may be negative during abortive lytic replication (ALR, Section @sec:abortive-lytic) where no infectious virions are produced. A negative qPCR does not exclude ALR. |
| Viral mRNA (EBER, BLLF1) in tissue | Active viral gene expression at the tissue site |

The critical interpretive principle: the bottom three rows of this table provide the strongest evidence of ongoing viral activity, but each has caveats — qPCR may be negative during ALR, viral mRNA requires tissue biopsy, and dUTPase antibodies come from a single research group without independent replication. The top rows are dominated by the LLPC baseline: isolated elevation of structural antigen or latency protein IgG, without corroborating evidence from viral DNA, viral mRNA, or lytic-cycle antibodies, is insufficient to diagnose active reactivation. Clinicians and researchers should not diagnose "active EBV" or "chronic herpesvirus reactivation" on the basis of structural antigen IgG alone.

When confirmatory testing (qPCR, EA-D, dUTPase serology) is negative or unavailable — a common clinical scenario — a time-limited valacyclovir trial with predefined stopping rules and symptom tracking remains a reasonable shared-decision option for the post-infectious subset with clinical suspicion of herpesvirus-driven pathology. This is expert opinion, supported by the two controlled positive antiviral trials (Lerner 2007, Montoya 2013) that enrolled on elevated antibody titres rather than confirmed viral replication, and is not a universal recommendation. The goal is to avoid reflexive chronic antiviral prescribing triggered by an isolated VCA IgG result, while preserving access to a therapeutic trial when the clinical picture warrants it.

===== Evidence in ME/CFS: Is Antibody Elevation Real?
...
*Evidence of elevation:*
    - Palomo et al. (n=40 ME/CFS, 16 controls): elevated anti-dUTPase IgG to EBV, HHV-6, VZV; 72.5% co-expression of multiple herpesvirus antibodies vs 31% controls @Palomo2026dUTPase
    - Apostolou et al. (n=95 ME/CFS, 110 controls): elevated salivary EBNA-1 IgG and EBV-VCA IgG in ME/CFS — detected locally in saliva, not systemically in plasma @Apostolou2022Saliva
    - Loebel et al. (n=92 CFS, 50 controls): EBNA-6 repeat region IgG enhanced in CFS, though overall EBV IgG pattern "quite similar" between groups @Loebel2017EBVsero

*Evidence of no elevation:*
    - Cliff et al. (n=251 ME/CFS, 107 controls): UK ME/CFS Biobank — no differences in seroprevalence for six herpesviruses between ME/CFS and controls @Cliff2019Cellular
    - Blomberg et al. (Swedish cohort, Canada criteria): suspension multiplex immunoassay for HHV-1-7 — overall IgG anti-herpes-viral reactivities did NOT show significant differences between ME/CFS and blood donor controls @Blomberg2019HerpesvirusNull

#open-question(title: [Is Herpesvirus Antibody Elevation a Universal Feature of ME/CFS?])[
...
#limitation(title: [Methodological Weaknesses in the Herpesvirus Serology Literature])[
...
#limitation(title: [Herpesvirus Antibody Titres Cannot Be Interpreted as Evidence of Active Infection])[
Total IgG against structural herpesvirus antigens (VCA, CMV gB, VZV gE) and latency proteins (EBNA-1) has a substantial antigen-independent component maintained by long-lived plasma cells established at primary infection — not a pure readout of the current state of the virus. LLPCs maintain antibody titres for decades without antigenic stimulation (@Amanna2007Duration, half-life >200 yr for EBV; @Hammarlund2017PlasmaCell, LLPC survival >10 yr without memory B cells). However, structural antigen IgG CAN be boosted by clinical reactivation (e.g., VZV IgG rises during shingles), so elevated titres against a high LLPC baseline are ambiguous. An elevated titre may indicate: (a) greater LLPC numbers from a more intense primary infection; (b) individual variation in bone marrow niche capacity; (c) ongoing antigenic stimulation from viral reactivation; or (d) intrinsic B cell dysregulation driving excess plasma cell differentiation (@Sun2024Immunometabolic, preliminary, n=4). The critical distinction is between detectable antibodies (universal in seropositive adults, expected from LLPCs) and significantly elevated titres above age/sex-matched norms (could reflect any of a–d). Without viral DNA (qPCR), viral mRNA (in situ hybridisation), or lytic-cycle antibody data, herpesvirus IgG titre alone is uninformative about viral activity — but when confirmatory testing is negative or unavailable, a time-limited antiviral trial with defined stopping rules remains a defensible clinical option for the post-infectious subset. This principle applies to all herpesviruses (EBV, HHV-6, CMV, VZV, HSV-1/2) and is not specific to ME/CFS — it is a general constraint on serological interpretation.
...
#synthesis(title: [Rethinking Herpesvirus Serology in ME/CFS])[

The evidence collectively argues that herpesvirus serology in ME/CFS has been systematically misinterpreted: the large antigen-independent LLPC baseline means that isolated structural-antigen or latency-protein IgG elevation is insufficient to diagnose active viral reactivation, while the contradictory literature on antibody elevation has not been resolved by any study to date — the evidence is too methodologically heterogeneous on both sides to support a definitive conclusion (@oq:herpesvirus-antibody-universal, @lim:herpesvirus-serology-methods). The strongest practical implication is that clinical decisions should not rest on structural antigen IgG alone (@lim:herpesvirus-antibody-interpretation) — but neither should the absence of accessible confirmatory testing preclude a time-limited therapeutic trial in appropriate patients. The dUTPase, ALR, and poly-herpesvirus evidence (Sections @sec:abortive-lytic, @sec:poly-herpesvirus) establishes that viral reactivation occurs in a subset of ME/CFS patients; what remains unresolved is how to identify that subset with available tests.
...
==== What Antiviral Response Reveals About the Elevated LSR
...
#open-question(title: [What Does a Discordant Pattern Mean — LSR Elevated but Valacyclovir Succeeds?])[
