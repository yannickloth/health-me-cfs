...
The precedent from multiple sclerosis is instructive: EBNA-1 antibodies cross-react with GlialCAM specifically in MS patients, not in seropositive healthy controls @Lanz2022Nature. The pathogenic feature is the qualitative shift in antibody fine specificity — the same principle may apply in ME/CFS, where cross-reactive antibodies could target autonomic neurons, skeletal muscle, or mitochondrial antigens. The elevated titre is a byproduct of autoimmune drift, not the primary pathology.
