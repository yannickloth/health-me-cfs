...
*Rash-Less VZV Disease (Zoster Sine Herpete)*

VZV reactivation does not always produce the diagnostic shingles rash. The virus can reactivate within nerve clusters and travel internally to blood vessels and organs without announcing its presence cutaneously, producing zoster sine herpete ("internal shingles")---severe, often one-sided burning pain or systemic disease with normal imaging and no rash @Bubak2026VZVInfection. Reactivated VZV can drive arterial inflammation (VZV vasculopathy) and ischemic stroke even in the absence of a rash: in the prospective VIPS II childhood-stroke cohort, asymptomatic VZV reactivation was detected in 9.8% of children with arterial ischemic stroke versus 3.1% of controls, concentrated in focal cerebral arteriopathy @Fullerton2025VIPSII; and VZV is reported to account for up to one-third of arterial ischemic strokes in children @Bubak2026VZVInfection @Livieratos2025VZVstroke. In older adults, even classic shingles carries an elevated long-term risk of stroke, cardiovascular events, and dementia @Bubak2026VZVInfection. Because rash-less presentations require specialized blood or CSF testing and are easily missed, the diagnosis is frequently delayed or untreated @Bubak2026VZVInfection.

#speculation(title: [Rash-Less VZV Reactivation as an Underrecognized Neurovascular Mode within the Poly-Herpesvirus Pattern])[

*Certainty: 0.30.* VZV is the third member of the documented poly-herpesvirus co-reactivation serologic pattern in ME/CFS (72.5% co-express EBV, HHV-6, and VZV antibodies @Palomo2026herpesvirus; anti-VZV dUTPase elevation reported @Halpin2017VZVdUTPase). The concept that VZV can cause systemic and neurovascular disease *without a rash* is well established in the general population @Bubak2026VZVInfection @Fullerton2025VIPSII and mechanistically parallels the paper's abortive-lytic-replication (ALR) theme---immune activation and tissue consequences occurring without a detectable, classical productive infection. However, no empirical cohort links rash-less VZV reactivation to ME/CFS symptom flares, and static VZV serology does not discriminate ME/CFS from controls: in a UK Biobank re-analysis including VZV IgG among six herpesviruses, herpesvirus IgG poorly distinguished ME/CFS subgroups @Domingues2023HerpesIgG. The certainty of 0.30 reflects that the rash-less VZV *mechanism* is high-certainty but its *application to ME/CFS* is hypothesis-level, supported only by a conceptual proposal linking VZV peripheral-ganglion involvement to chronic fatigue symptoms @Shapiro2009VZVgangliaCFS. *Origin: not brainstorm---literature-derived from Phase 1.*

*Falsifiable prediction:* If rash-less VZV reactivation is a meaningful contributor in a ME/CFS subset, then longitudinal sampling timed to PEM/symptom flares (VZV PCR in saliva or blood, or paired anti-VZV dUTPase IgG) will detect transient VZV reactivation events that correlate temporally with symptom exacerbation, analogous to the HSV PEM-probe framework (Section @spec:hsv-pem-probe). This is falsified if VZV reactivation markers show no temporal clustering around flares beyond the poly-herpesvirus co-reactivation baseline. The prediction requires a prospective design because cross-sectional herpesvirus serology---including VZV IgG in the UK Biobank panel---has already been shown to be non-discriminative @Domingues2023HerpesIgG; the HSV-family nulls @Koelle2002TwinsHSV @Buchwald1996ViralSerologies likewise leave the temporal-reactivation question open.

*Consequence:* If confirmed, this would identify rash-less VZV reactivation---potentially antiviral-responsive, like the already-documented EBV/HHV-6 members---as a treatable contributor in a subset of ME/CFS patients whose symptoms are currently attributed to "unexplained" one-sided or neurovascular presentations. This is a hypothesis about ME/CFS, not an established clinical instruction. The clinical heuristic that VZV (including zoster sine herpete) should be considered in puzzling one-sided neurological presentations is established in general neurology @Bubak2026VZVInfection, but it has no validated ME/CFS-specific basis: static VZV serology is non-discriminative in ME/CFS @Domingues2023HerpesIgG, no ME/CFS cohort supports invasive VZV testing (CSF sampling) or empiric antivirals, and this remains a differential-diagnosis note rather than a recommendation for such testing. This is early-stage and may prove to be a minor pathway rather than a driver.

*Severity applicability: unknown---none of the cited studies stratify ME/CFS by severity.* *Evidence source: general-population/long-COVID mechanism (Bubak 2026, Fullerton 2025) + ME/CFS poly-herpesvirus serology (Halpin 2017, Palomo 2026).* *Translation gap: general population $arrow.r$ ME/CFS; no ME/CFS-validated VZV vasculopathy demonstration.* *Competing explanations: poly-herpesvirus co-reactivation as a single surveillance failure (VZV is one member, not necessarily independent); static serology nulls; consequence-of-immunedysfunction framing rather than causal trigger @Li2026PostCOVIDVZVthreshold.*
] <spec:rashless-vzv-mecfs>
...
The pathway linking exertion to HSV reactivation is mechanistically coherent at several steps, though critically none has been prospectively tested in ME/CFS:
  ...
  - Catecholamine-mediated stress shows a significant but weak association with HSV recurrence in the general population. A meta-analysis of 11 prospective studies found a positive association between psychosocial stress and symptomatic HSV recurrence ($r$ = 0.083, 95% CI 0.025--0.141, $p$ = 0.005), explaining less than 1% of variance, with some indication of publication bias @Chida2009StressHSVMetaAnalysis. Notably, psychological *distress* was more strongly associated than stress *stimuli* per se --- and PEM is primarily a physiological stimulus --- meaning the meta-analysis's strongest finding is not the one most relevant to PEM.
  ...
  - HSV-1/2 latency--reactivation kinetics are among the best-characterized in virology. Reactivation follows a predictable cascade: immediate-early gene expression $arrow.r$ early gene expression $arrow.r$ viral DNA replication $arrow.r$ virion assembly and anterograde transport $arrow.r$ visible lesion. Only productive (not abortive) replication produces visible lesions; subclinical shedding is more common and is detected only by PCR.
  - The complete pathway, with exertion as the temporal anchor: exertion exceeding the anaerobic threshold $arrow.r$ sympathetic activation $arrow.r$ catecholamine surge $arrow.r$ Treg-mediated CD8+ T cell suppression at ganglia $arrow.r$ HSV exit from latency $arrow.r$ anterograde transport (1--3 days) $arrow.r$ viral replication in epithelium (1--2 days) $arrow.r$ visible cold sore. The cold sore provides information beyond what the patient's symptoms or autonomic monitoring already convey because it is an independent biological readout: productive viral replication at a ganglion anatomically distant from the sites generating PEM symptoms (muscle, vasculature, brain), and the cold sore is not a PEM criterion symptom. If catecholamines drive PEM symptoms AND HSV reactivation but the two are mechanistically unlinked, the cold sore adds timing precision and biological specificity that HRV/norepinephrine cannot provide, because it confirms that catecholamine levels reached a threshold sufficient to reactivate dormant virus at a distant anatomical site.

*Known Triggers and Base Rates*

HSV-1 global prevalence is approximately 67% in adults under 50 years (~57% in the US), with 20--40% of seropositive individuals experiencing recurrent outbreaks @Gopinath2023HerpesLabialis. This means approximately 33--43% of adults are seronegative and excluded from the probe, and among the seropositive, only a minority experience regular recurrences. Known triggers --- UV radiation, psychological stress, fever, menstruation, physical trauma, sleep disruption --- are all established in the general population but have never been prospectively tracked against PEM episodes in ME/CFS. A patient seropositive for HSV-1 who experiences 2--3 outbreaks per year is in the normal range; a patient whose outbreaks cluster temporally with PEM episodes provides a different signal @Gopinath2023HerpesLabialis. Whether the seropositive probe-eligible subset differs clinically from the excluded seronegative subset is unknown; probe findings will not generalize to approximately 33--43% of patients.
