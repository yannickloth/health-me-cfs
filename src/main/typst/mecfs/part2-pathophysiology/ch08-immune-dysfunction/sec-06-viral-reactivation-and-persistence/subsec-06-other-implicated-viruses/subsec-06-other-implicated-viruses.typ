...
#limitation(title: [No Productive Viral Infection Detected by Nucleic-Acid Surveillance of Non-Tissue Compartments in ME/CFS])[
A multicenter case--control study by Briese et al. @Briese2023MulticenterVirome screened blood, feces, and saliva of ME/CFS patients using polymerase chain reaction and high-throughput sequencing (391 ME/CFS patients, 292 controls). The study found no consistent group-specific differences in viral nucleic acid between cases and healthy controls. Its one significant finding was a lower prevalence of anelloviruses in cases (30.5% vs 54.1%, $p < 0.001$; see @spec:anellovirus-hyperimmune). The authors recommend that future investigations into viral infection in ME/CFS focus on adaptive immune responses rather than surveillance for viral gene products --- a recommendation, not a measured outcome.

This null result constrains the productive-replication arm of the viral-persistence model *for the non-tissue compartments sampled* (blood, feces, saliva): it argues against an ongoing, actively replicating, nucleic-acid-detectable viral infection in the periphery as the proximate driver of ME/CFS. It does **not** bear on tissue-resident virus (gut lamina propria, CNS, dorsal root ganglia) or on abortive lytic replication --- both of which the paper addresses elsewhere (Section @sec:abortive-lytic; Peluso et al.\ detected spike RNA in gut tissue by biopsy, not blood surveillance). It is consistent with the PASC finding that persistent immune activation can occur independently of ongoing peripheral viral replication (Section above).
...
#speculation(title: [Anellovirus Burden as an Immune-State Signature Rather Than a Viral Cause in ME/CFS])[
*Certainty: 0.25.*

Two studies (one read at abstract level) are jointly compatible with --- but do not establish --- the interpretation that anellovirus burden reflects immune-dysregulation state rather than productive viral infection in ME/CFS and its post-infectious relatives. Briese et al. @Briese2023MulticenterVirome found a *lower* prevalence of anelloviruses in ME/CFS cases than healthy controls (30.5% vs 54.1%, $p < 0.001$). Maguire et al. @Maguire2026ViralReactivation (IMPACC, $n=1154$) found elevated Anelloviridae transcript reads in the long-COVID physical-disability patient-reported-outcome group---characterized by fatigue, cognitive dysfunction, and post-exertional malaise overlapping ME/CFS symptoms---after controlling for age, sex, and acute COVID-19 severity, and noted that Anelloviridae had previously been linked to chronic fatigue syndrome and multiple sclerosis.
...
*Directional reading from the existing sibling hypothesis:* The document already interprets the identical Briese depletion directionally (Section @spec:anellovirus-hyperimmune): constitutive innate-immune hyperactivation clearing commensal viruses would predict *low* TTV, whereas adaptive-immune exhaustion would predict *high* TTV. This directional map (innate-hyperactivation-dominant $arrow.r$ low; adaptive-exhaustion-dominant $arrow.r$ high) is the testable form of the hypothesis; the present environment holds the non-directional form and defers to @spec:anellovirus-hyperimmune for the mechanistic commitment.
...
*Cross-reference:* See @spec:anellovirus-hyperimmune for the directional (innate-hyperactivation) reading of the Briese depletion; the present synthesis holds the weaker, non-directional form.
