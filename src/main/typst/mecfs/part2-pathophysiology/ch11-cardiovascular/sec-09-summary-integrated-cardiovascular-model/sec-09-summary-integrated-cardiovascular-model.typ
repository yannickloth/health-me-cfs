...
The recognition that cardiovascular abnormalities are objective and measurable helps counter misconceptions that ME/CFS exercise intolerance reflects psychological factors or simple deconditioning. Charlton et al.\ (2026) formalized this argument in the _British Journal of Sports Medicine_, concluding that post-exertional malaise cannot be explained by cardiac deconditioning and calling for a fundamental rethinking of exercise pathophysiology in post-viral illness @Charlton2026pem. Their primary research paper @Charlton2026MuscleBedrest published concurrently in _Nature Communications_ provides the empirical backbone: a direct comparison of 60-day strict bed rest against Long COVID and ME/CFS muscle biopsies showing that the patient phenotype (glycolytic shift, Type I atrophy, OXPHOS–V̇O₂ₘₐₓ uncoupling) is qualitatively different from deconditioning — not just a more severe version of it.

*Measurement note — the resting-normal / provocation-abnormal pattern:* The cardiovascular abnormalities documented above illustrate a broader phenomenon formalized in Section @sec:subjective-measurable-discrepancy: many ME/CFS pathologies are provocation-dependent, detectable only under orthostatic or exercise stress but absent at rest. van Campen et al.\ demonstrated that cerebral blood flow decline during tilt testing occurs regardless of resting hemodynamics or deconditioning severity @vanCampen2021Deconditioning. Novak et al.\ found zero correlation between subjective autonomic symptom questionnaires (COMPASS-31, SAS) and objective autonomic testing (QASAT, CASS) across 2,627 patients @Novak2024DysautonomiaMismatch. Friedberg et al.\ showed that lower HRV — an objective autonomic measure — was associated with patient-reported nonimprovement at 6-month follow-up, while self-reported activity patterns (push-crash, limiting, pacing) did NOT discriminate improvers from non-improvers @Friedberg2022Nonimprovement. The implication for cardiovascular assessment: normal resting ECG, blood pressure, and HR do not rule out orthostatic pathology — and a patient whose resting vitals are normal but whose orthostatic symptoms are severe is consistent with the expected clinical pattern of provocation-dependent autonomic dysfunction. Provocation testing (tilt table or active stand test) can reveal cardiovascular abnormalities that resting measurements systematically miss and should be considered when results would change management. *Safety note:* 2-day CPET is the gold-standard provocation for PEM documentation but carries non-trivial PEM risk and should be severity-gated and patient-discussed; tilt table and active stand test are lower-risk alternatives for orthostatic assessment. Bedbound very-severe patients may not tolerate any form of provocation testing, and the resting-normal/provocation-abnormal framework may not apply in this subgroup where resting abnormalities may be profound.
