...
The hypotheses presented in this chapter are speculative extrapolations intended to stimulate new research directions. They share several features:
    ...
    - Each is grounded in established biochemistry and physiology
    - Each attempts to explain the characteristic features of ME/CFS
    - Each generates testable predictions
    - None requires invoking unknown biology—only novel combinations of known mechanisms
