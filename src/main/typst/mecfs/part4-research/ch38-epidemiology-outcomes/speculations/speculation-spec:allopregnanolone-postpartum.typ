...
*Mechanism.* Allopregnanolone maintains autonomic stability and reduces HPA reactivity via GABA-A potentiation. The biphasic concentration-response curve @Andreen2009allopregnanoloneBiphasic documents paradoxical anxiety at low concentrations (1--5 nM) versus anxiolysis at higher concentrations (>10 nM), consistent with the general hormesis principle @Calabrese2010hormesisCentral. The brexanolone (synthetic allopregnanolone analog) mechanism in postpartum depression provides proof-of-concept that postpartum allopregnanolone withdrawal can drive neurological and affective dysfunction. ME/CFS features autonomic dysregulation, HPA axis abnormalities, and sleep disruption—all of which allopregnanolone suppresses in physiological doses.
