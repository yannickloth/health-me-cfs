...
*EpiSwitch 3D chromatin conformation:* Hunter et al.\ (2025) applied a different epigenetic modality — 3D chromatin conformation — to ME/CFS patients (n=47) versus healthy controls (n=61), achieving 92%/98% sensitivity/specificity in the discovery cohort @Hunter2025. This convergent finding from an entirely different epigenetic measurement approach strengthens the case for biologically distinct patient subgroups. Two caveats apply: the cohort was severely affected (housebound) patients, and the reported specificity is against healthy controls only — the test has not been assessed against fibromyalgia, depression, or long-COVID fatigue, so it is not yet shown to be specific to ME/CFS as opposed to other fatiguing conditions.
