...
The severe-care factsheet's most actionable organisational claim — that a single point of contact (specialist nurse) outperforms a multidisciplinary team for housebound/bedbound patients — has never been tested (@cf:single-point-of-contact-severe). A cluster-randomised pragmatic trial would randomise care teams or geographic units (individual randomisation is infeasible for housebound patients) to either a single-coordinator model or a multidisciplinary roster, with endpoints of care-triggered PEM episodes, hospitalisation, caregiver strain, and functional deterioration over 12 months. The null (care architecture does not change outcomes once severity and environmental control are held constant) is plausible and itself informative; the alternative would justify reorganising severe-ME/CFS services. The nurse-delivery prototype exists in FINE @Wearden2010FINETrial and the harm-monitoring gap in current centres is documented @McPhee2019TreatmentHarm. Feasibility certainty: 0.30 — cluster designs are standard but severe-ME/CFS-specific outcome measures and recruitment of housebound patients are substantial barriers. (Origin: brainstorm)
