...
#speculation(title: [The HIV/AIDS Food Assistance Template: Structural Analogy for ME/CFS])[
...
In HIV, food insecurity independently predicts incomplete viral suppression, CD4+ T-cell decline, metabolic complications, and mortality @weiser2011foodinsecurityhiv. Food assistance interventions improve CD4+ counts, medication adherence, and some clinical outcomes, though effect sizes on purely biological endpoints (viral suppression independent of adherence) are mixed across studies @palar2015foodassistancehiv @palar2018mtmhiv. The HIV SDoH literature is approximately 15 years ahead of ME/CFS on this dimension.

*Applicability to ME/CFS.*
The structural parallels are documented: chronic disease → employment loss (Bowden 2026: 18.3% ME/CFS employment vs. 83.8% general population @bowden2026mecfslabourmarket) → income reduction → food insecurity → hypothesised nutritional deficiency. Lin 2025 (aOR 1.73 for FI→Long COVID @lin2025longcovidfoodinsecurity) and Datta 2025 (1–11 percentage-point FI increase across income strata @datta2025longcovidfinancial) support the same directional association for post-infectious chronic illness. The SNAP attenuation interaction (p=0.04, uncorrected for multiple comparisons) is a single finding that could reflect residual confounding between SNAP recipients and non-recipients.

*Limitations — biological disanalogy.*
Without an ME/CFS disease-activity biomarker analogous to CD4+ counts, HIV-style food assistance programs cannot demonstrate disease-modifying efficacy even if it exists — they can only demonstrate quality-of-life improvement, which can be justified without appealing to disease modification. The HIV template is a structural analogy with unvalidated biological applicability. MTM programs are resource-intensive. Zero ME/CFS food assistance intervention studies exist. Effect-size estimates (40–60% FI reduction) are borrowed from HIV, where measured populations differ in FI baseline, welfare infrastructure, and disease profile.

*Falsifiable prediction.*
If HIV-style food assistance integration is implemented in ME/CFS clinics, FI prevalence among attendees will decline by ≥20% within 12 months (reduced from HIV 40–60% to reflect ME/CFS access barriers). Falsified if food access improves without SF-36 improvement, or if FI prevalence remains within measurement error of baseline.
