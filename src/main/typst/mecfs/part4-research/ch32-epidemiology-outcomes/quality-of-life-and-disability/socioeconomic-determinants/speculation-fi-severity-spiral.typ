...
#speculation(title: [FI↔ME/CFS Severity Spiral: Positive Feedback Loop Hypothesis])[
...
Four pathways connect food insecurity to worsened ME/CFS:
...
*Evidence link.*
FI→dysbiosis pathway established in general population. Gut dysbiosis in ME/CFS well-documented (Guo 2023). Intestinal permeability in ME/CFS documented (Martin 2023). Employment loss→FI chain supported by Bowden 2026, Datta 2025, Lin 2025. Bidirectional loop is a logical extension of established unidirectional associations — not directly observed.

*Falsifiable prediction.*
12-month prospective study: incident food insecurity (USDA HFSS) will predict ≥10-point decline in SF-36 PCS after controlling for baseline severity, age, and comorbidity. PEM duration will increase over time in FI+ patients but remain stable in food-secure controls. PBMC spare respiratory capacity will decline in FI+ patients relative to matched controls.

*Limitations.*
The bidirectional hypothesis is a logical assembly of unidirectional links — no study has measured all four pathway components simultaneously in ME/CFS. The effect size of FI on ME/CFS outcomes is unknown. Disease-internal factors (malabsorption, appetite loss, MCAS-related dietary restrictions) could produce nutritional deficiency independent of economic food access.

*Consequence:* If this spiral is real, preventing or interrupting food insecurity in ME/CFS patients would directly modify disease trajectory — not just help with finances, but actually slow functional decline. A downward spiral, if confirmed, also means it could be reversed upward with adequate food assistance.
