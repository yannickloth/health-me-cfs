...
#figure(
  table(
    columns: (auto, auto),
    [*Model*], [*Description*],
    [Wirth, Löhn (2023) model], [Orthostatic stress $arrow.r$ $beta$2-receptor desensitization $arrow.r$ mast cell degranulation $arrow.r$ mast cell mediators (histamine, PAF) $arrow.r$ vascular dysfunction $arrow.r$ worse orthostatic stress.],
  ),
  kind: table,
  supplement: [Table],
  caption: [
