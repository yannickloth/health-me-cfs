...
The absence of sustained benefit is not confined to the PACE/GETSET trials. The FINE trial (n=296 primary-care CFS/ME) found that nurse-led pragmatic rehabilitation produced only a transient fatigue improvement at 20 weeks that was no longer significant at 70 weeks, with supportive listening ineffective @Wearden2010FINETrial. These replicated "no sustained benefit" findings across independent trials underpin the position that rehabilitation-based approaches have no place in management @S4ME2026ManagementSevereVerySevere.
