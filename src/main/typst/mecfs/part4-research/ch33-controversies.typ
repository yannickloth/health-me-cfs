...
The psychologization harm framework and much of the supporting evidence rest on cross-sectional designs (Büchner 2025, Pantelic 2022, Clutterbuck 2024) and qualitative studies (Ireson 2022, Hammer 2025). These establish association but not causation. The temporal direction could be partially reversed: patients with more severe ME/CFS see more clinicians, have more "medically unexplained" symptoms, and thereby accumulate more psychologization encounters — making psychologization exposure partially a marker of disease severity rather than a cause of deterioration. No prospective cohort study has measured psychologization exposure at baseline and tracked functional decline over time while controlling for objectively measured severity (CPET, actigraphy, biomarker panels). The Schomerus essay itself is a position paper with 37 citations, not a systematic review — it synthesizes existing evidence without PRISMA methodology, risk-of-bias assessment, or explicit inclusion criteria. Its primary value is framing and normative argument, not new empirical data.

The monitoring-gap claim is illustrative: the specific statistic that 8 of 11 LC psychotherapy studies lacked adverse effect information is reported by Schomerus et al.\ as a secondary citation whose underlying reference could not be independently verified during Phase 1 literature search. While the general pattern of inadequate harm monitoring in ME/CFS psychosocial trials is independently supported (Kindlon 2011 @Kindlon2011GET, Cooper 2025 @Cooper2025PacingVsGET), the precise 8/11 figure should be treated with appropriate caution pending a dedicated systematic review of adverse event reporting in published LC psychotherapy trials.
