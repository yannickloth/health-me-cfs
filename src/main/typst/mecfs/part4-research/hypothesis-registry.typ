...
#table(
  ...
  [hyp fibromyalgia-cns-shared-genetic-vulnerability], [Hypothesis: fibromyalgia is a central-nervous-system (nociplastic) disorder with brain-enriched genetic architecture, and its 20--70% co-occurrence with ME/CFS reflects a partially shared central genetic vulnerability. The largest fibromyalgia GWAS (Kerrebijn 2026, _Nature Medicine_, 2.56M individuals, 54,629 cases) identified 26 risk loci (strongest: coding variant in _HTT_, plus _GPR52_, _DCC_, _DRD2/NCAM1_, _MDGA2_, _CELF4_) and showed heritability exclusively enriched in brain tissues and neural cell types, with no immune/glial enrichment @Kerrebijn2026FibromyalgiaGWAS. This mirrors the brain-enriched architecture independently established for ME/CFS by DecodeME @DecodeME2025 and the Maccallini meta-GWAS @Maccallini2026metaGWAS, with shared risk regions (_OLFM4_, _RABGAP1L_, _GPR52_). *Falsifiability:* a cross-trait GWAS/PRS analysis between fibromyalgia and ME/CFS will show significant genetic correlation and shared brain-enriched heritability; fibromyalgia PRS will be elevated in ME/CFS patients with comorbid fibromyalgia; falsified if the two conditions show near-zero genetic correlation or divergent enrichment patterns. *Consequence:* if the comorbidity reflects shared central genetic vulnerability, centrally-targeted approaches generalize across the two conditions and the overlap is a shared-mechanism signal, informing differential diagnosis. (ch14 @ach:kerrebijn-fibromyalgia-gwas @hyp:fibromyalgia-cns-shared-genetic-vulnerability; cert 0.60; severity unknown — GWAS not stratified by severity; origin: literature integration.)],[Phase 2 / 0.60],

  [hyp shared-transdiagnostic-cns-genetic-factor], [Hypothesis: chronic overlapping pain conditions (fibromyalgia, IBS, low back pain) and comorbid psychiatric traits share a transdiagnostic central-nervous-system genetic factor. Fibromyalgia showed rg > 0.7 with low back pain, PTSD, and IBS, and pervasive positive genetic correlation with depression, somatoform/dissociative disorders, and migraine @Kerrebijn2026FibromyalgiaGWAS; independent GenomicSEM analyses establish a shared nociplastic-pain heritable factor @Johnston2025NociplasticPain and a shared CNS/synaptic genetic factor across fibromyalgia-psychiatric traits @Lin2026FibromyalgiaPsychiatric. ME/CFS already shows high genetic correlation with IBS (rg 0.75) and depression (rg 0.60) @DecodeME2025. *Falsifiability:* a transdiagnostic genomic-SEM factor across these conditions will show significant heritability and shared neural cell-type enrichment, and nociplastic-pain PRS will predict severity across ME/CFS, fibromyalgia, and IBS cohorts; falsified if the shared factor explains negligible variance or enrichment is condition-specific. *Consequence:* supports transdiagnostic (centrally-acting) treatment strategies and explains the high comorbidity burden in ME/CFS; genetic correlation is association, not proof of shared causal biology. (ch14 @hyp:shared-transdiagnostic-cns-genetic-factor; cert 0.55; severity unknown; origin: literature integration.)],[Phase 2 / 0.55],

  [hyp shared-central-genetic-architecture-fibro-mecfs], [Hypothesis: the ME/CFS-fibromyalgia comorbidity is underlain by a shared central (brain/neural) genetic architecture. Both conditions independently show exclusive brain/neural-cell-type heritability enrichment (fibromyalgia: @Kerrebijn2026FibromyalgiaGWAS; ME/CFS: @DecodeME2025 @Maccallini2026metaGWAS), and neither shows peripheral immune/metabolic enrichment. *Falsifiability:* a direct cross-trait genetic-correlation analysis of fibromyalgia and ME/CFS will be significantly positive, and fibromyalgia PRS will be elevated in ME/CFS patients with comorbid fibromyalgia; falsified if the two conditions show near-zero genetic correlation despite clinical overlap. *Consequence:* a shared central genetic basis argues for centrally-targeted comorbidity management and reframes the 20--70% overlap as shared-mechanism rather than coincidence. (ch04 @hyp:shared-central-genetic-architecture-fibro-mecfs @sec:kerrebijn-fibromyalgia-gwas; cert 0.55; severity unknown; origin: literature integration.)],[Phase 2 / 0.55],

  [hyp fibromyalgia-autoimmune-reconciliation], [Hypothesis: fibromyalgia autoimmunity exists as an antibody subset within a non-HLA-linked genetic architecture. The Kerrebijn 2026 GWAS found no MHC signal and no immune/glial heritability enrichment (genetic evidence against a primarily autoimmune/HLA-linked architecture) @Kerrebijn2026FibromyalgiaGWAS, yet passive-transfer evidence shows fibromyalgia/long-COVID IgG reproduces symptoms in mice (acquired humoral autoimmunity) @Goebel2021passiveTransferFM. These are reconcilable: genetic architecture (germline) and acquired antibodies are different layers — fibromyalgia may carry a non-HLA-linked central-sensitization vulnerability while a subset develops acquired pathogenic antibodies as a downstream/amplifying mechanism. *Falsifiability:* fibromyalgia patients responding to immunomodulation will cluster in an autoantibody-positive subset without enrichment for the 26 GWAS loci; falsified if the GWAS loci and the autoantibody subset fully overlap (arguing for a unified HLA-linked mechanism). *Consequence:* reframes the "fibromyalgia is/isn't autoimmune" debate as a two-layer model (central-sensitization genetics + acquired antibody subset) that could explain differential immunomodulation response. (ch14 @hyp:fibromyalgia-autoimmune-reconciliation; cert 0.40; severity unknown; origin: literature integration + brainstorm.)],[Phase 2 / 0.40],
)
