...
#table(
  ...
  [cf prolactin-buspirone-exaggerated], [Clinical finding: ME/CFS patients mount a markedly exaggerated prolactin response to an oral buspirone challenge despite normal baseline prolactin, replicated by multiple independent groups (Bakheit 1992 @Bakheit1992Buspirone; Sharpe 1996 @Sharpe1996Buspirone) and in the opposite direction to depression (lowest in depression, highest in CFS, healthy intermediate — Cleare 1995 @Cleare1995DepressionCFS). The effect is probe-specific (null fenfluramine results @Yatham1995Fenfluramine @Bearn1995Fenfluramine localize it to the dopamine-D2/buspirone pathway). Small studies (n=11-20/arm), all pre-2010, line abandoned and never re-tested with modern criteria; replication needed. *Falsifiability:* a modern pre-registered buspirone challenge in IOM-criteria ME/CFS vs depression vs healthy shows no prolactin-AUC difference, or the historical effect is an artifact of pre-Fukuda criteria/uncontrolled confounders; falsified if ME/CFS no longer differs from depression. *Consequence:* if replicated, a single controlled buspirone challenge could give clinicians a biological test that helps tell ME/CFS apart from depression. (ch10 @cf:prolactin-buspirone-exaggerated; cert 0.62; severity unknown — not stratified; origin: literature integration.)],[Phase 3 / 0.62],

  [oq prolactin-buspirone-mechanism], [Open question: what explains the exaggerated prolactin response is unresolved. Competing candidates: (a) reduced dopaminergic inhibitory tone (dopamine-D2 brake on lactotroph @BenJonathan2001ProlactinDopamine @Fitzgerald2008ProlactinDopamine @QiLytle2023TIDA) — supported by probe-specificity (null fenfluramine @Yatham1995Fenfluramine @Bearn1995Fenfluramine) and by ME/CFS dopaminergic dysfunction (basal-ganglia reward deficits; OSU6162 trial @Haghighi2021OSU6162); (b) serotonergic 5-HT1A hypersensitivity — constrained by null growth-hormone response @Sharpe1996Buspirone; (c) estradiol modulation — links to ~80% female predominance but no direct ME/CFS prolactin-by-sex study exists. Not mutually exclusive; decisive test is a modern study with both ME/CFS and depression arms, sex/menstrual-phase stratification, and cortisol measurement (cortisol modulates the response @Dinan2001Buspirone). *Falsifiability:* each mechanism makes a distinct, testable prediction about whether the exaggerated response is dopamine-, serotonin-, or estradiol-dependent. *Consequence:* which mechanism is correct determines whether this peripheral test reflects a central dopamine deficit, a serotonergic or estradiol effect — a prerequisite for using the challenge as a meaningful biomarker. (ch10 @oq:prolactin-buspirone-mechanism; cert 0.50; severity unknown; origin: literature integration.)],[Phase 3 / 0.50],
  ...
  [spec prolactin-dopamine-window], [Speculation: the peripheral prolactin response to a D2-brake-lifting challenge acts as an indirect read-out of hypothalamic dopaminergic tone, because prolactin is tonically inhibited by dopamine at the lactotroph D2 receptor @BenJonathan2001ProlactinDopamine @Fitzgerald2008ProlactinDopamine. If the exaggerated buspirone→prolactin response reflects reduced dopaminergic inhibitory tone, this blood test is effectively a non-invasive window on a deep-brain dopamine signal that would otherwise need PET or CSF — making the dopamine hypothesis of ME/CFS fatigue/reward-processing far more testable. *Falsifiability:* if the exaggerated response tracks a hypothalamic dopamine deficit, it should correlate with other dopamine-function markers (anhedonia/motivation, DAT/VMAT2) and be reproduced by a pure D2-antagonist challenge; falsified if abolished by 5-HT1A blockade or uncorrelated with dopamine-linked symptoms. *Consequence:* a simple blood test could give researchers a cheap, non-invasive view of a deep-brain dopamine signal, making a central hypothesis testable without imaging. (ch10 @spec:prolactin-dopamine-window; cert 0.45; severity unknown; origin: brainstorm idea 1.2.)],[Phase 5 / 0.45],

  [spec prolactin-msn-link], [Speculation: the exaggerated prolactin response and dopamine-related motor/reward symptoms in ME/CFS could share a common reduced dopaminergic tone that affects both the lactotroph (pituitary) and the dopamine-regulated medium spiny neurons of the basal ganglia. A convergence hypothesis — not a claim that the pituitary finding causes the striatal symptoms, but that a shared dopamine-tone deficit could explain both a peripheral endocrine read-out and central reward/motor dysfunction. Connects to nigrostriatal dopaminergic findings in Long COVID (@spec:long-covid-dopamine-bridge). *Falsifiability:* the exaggerated prolactin response should correlate with striatal-dopamine or dopamine-linked measures (anhedonia, effort cost, motor fatigue); falsified if unrelated to all such measures. *Consequence:* if confirmed, a peripheral test could proxy for a central dopamine deficit otherwise requiring brain imaging. (ch10 @spec:prolactin-msn-link; cert 0.30; severity unknown; origin: brainstorm idea 1.3.)],[Phase 5 / 0.30],
  ...
  [spec long-covid-dopamine-bridge], [Speculation: the dopaminergic interpretation of the prolactin finding converges with independent dopaminergic evidence from Long COVID — VMAT2-PET striatal dopamine-terminal loss (see ch09 neurological) and dopamine-modulator (OSU6162) trials in ME/CFS @Haghighi2021OSU6162. If reduced dopaminergic tone underlies both the exaggerated prolactin response and Long COVID striatal dopamine loss, the two lines mutually reinforce a shared dopamine-deficit account of post-infectious fatigue states, though they measure different nodes (lactotroph vs striatal terminal) of the same system. *Falsifiability:* comorbid post-infectious ME/CFS/Long COVID patients with exaggerated prolactin responses should also show dopaminergic changes (DAT/VMAT2, dopamine-linked symptoms); falsified if prolactin response and striatal dopamine measures are independent. *Consequence:* if the lines converge, dopamine dysregulation would be a shared, targetable feature of post-infectious ME/CFS and Long COVID, and the low-cost prolactin challenge could screen for that subgroup. (ch10 @spec:long-covid-dopamine-bridge; cert 0.40; severity unknown; origin: brainstorm idea 8.1.)],[Phase 5 / 0.40],
)
