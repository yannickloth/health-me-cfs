...
#table(
  ...
  [oq adult-onset-adhd-mix-status], [Open question: whether the "adult-onset ADHD is a distinct syndrome" reading (from the Dunedin birth cohort @Moffitt2015adhdadult) still holds. Current evidence says no — the field moved to a mix: comprehensive repeated assessments of a comparison group from ages 10 to 25 excluded roughly 95% of apparent late-onset ADHD on careful assessment, with the remainder adolescent-onset or explained by substance use or comorbidity @Sibley2018lateonsetADHD; a dedicated review concluded most late-onset cases develop between ages 12--16, rarely without childhood precursors @Asherson2019lateonsetADHD; and retrospective recall of childhood ADHD symptoms is unreliable (accuracy about 55%) @Breda2020adhdrecall. This narrows the acquired-catecholamine interpretation: much apparent adult onset is adolescent-onset or missed childhood ADHD, not a clearly distinct adult-onset syndrome — though a subset of genuine non-childhood onset cannot be fully excluded. *Falsifiability:* a prospective cohort with repeated childhood assessments that confirmed a substantial de novo (no childhood precursors, no substance use) adult-onset ADHD group would partially revive the distinct-syndrome reading; current MTA-derived data contradict it. *Consequence:* for the ADHD–ME/CFS framing, ADHD is better treated as a largely childhood/adolescent-onset predisposing trait than an acquired post-infectious adult-onset phenomenon, so the shared-metabolic-reserve hypothesis applies most strongly to childhood/adolescent-onset ADHD. (ch14d @sec:architecture-c-metabolic-reserve; cert 0.47; severity unknown; origin: literature integration.)],[Phase 2 / 0.47],

  [hyp adhd-nrf2-pathway-measured], [Hypothesis (updated claim): NRF2 pathway activity in ADHD has now been measured once — a 2026 cross-sectional study of 60 adults with ADHD versus 60 controls found serum NRF2 and HO-1 protein significantly reduced in ADHD and negatively correlated with symptom severity (all p $<$ 0.001; ROC AUC 0.756 for NRF2, 0.797 for HO-1) @Gurbuzer2026nrf2adhd. This replaces the earlier "no study has measured NRF2 in ADHD" claim and is consistent with — but does not prove — the dopamine-NRF2-NLRP3 axis: it measured circulating serum protein, not NRF2 nuclear translocation or NQO1 target-gene expression, and covers adult ADHD only in a single unreplicated study. *Falsifiability:* an ADHD PBMC study showing no difference in NRF2 nuclear translocation or NQO1 expression between ADHD and controls would weaken the axis claim; replication of reduced NRF2 in a second independent ADHD cohort would strengthen it. *Consequence:* a measurable NRF2 deficit in ADHD now has direct (if preliminary) human evidence, supporting the plausibility that the ADHD–ME/CFS dopamine-NRF2-NLRP3 axis operates through a real antioxidant-defense deficit, and giving NRF2-activating interventions (sulforaphane, DMF) a concrete biomarker target to test. (ch14d sec:x1-adhd-nrf2-nlrp3: @spec:adhd-dopamine-nrf2-nlrp3-xdisease; cert 0.41; adult-only, severity unknown; origin: literature integration.)],[Phase 3 / 0.41],
)
