...
#table(
  ...
  [oq ldn-metformin-phenotype-triage], [Open question (ch47 @oq:ldn-metformin-phenotype-triage): could LDN vs metformin ever become a phenotype-guided first-line choice (LDN for neuroimmune/TRPM3-dominant, metformin for immunometabolic)? No evidence supports it as a triage rule today — no head-to-head, no validated response predictor for either drug, and the strongest metformin signal is timing, not phenotype: benefit was confined to acute-phase initiation in COVID-OUT (LC incidence 6.3% vs 10.4% at day 300 @Reis2023COVIDOUT) while both randomized trials in established disease were negative (REVIVE metformin arm futility @Reis2026fluvoxamine; PASC recovery RCT no benefit @Lim2026MetforminPASC). TRPM3 NK-cell dysfunction is reproducible and restored in vitro by naltrexone @Sasso2026trpm3 @Sasso2025LDNtrpm3LC, but restoration has never predicted clinical response. Metformin immunometabolic reach (Th17/Treg, B-cell biology, SLE/RA flare modulation) is real but modest and inconsistent @Ursini2018MetforminAutoimmunity @Sun2020MetforminSLE @Gharib2021MetforminRA. *Falsifiable prediction:* a trial stratifying established ME/CFS by (a) functional TRPM3 NK-cell assay and (b) insulin-resistance phenotype (HOMA-IR), randomizing within strata to LDN vs metformin, would show a phenotype x drug interaction (LDN better in TRPM3-abnormal/insulin-sensitive; metformin better in TRPM3-normal/insulin-resistant); falsified if response is independent of both markers — the likely outcome absent any validated predictor. *Consequence:* neither drug can be selected by biomarker today; the honest default is mechanism-based reasoning plus individual dose-response probing, and metformin must NOT be imported into established ME/CFS on the strength of its acute-phase prevention signal. Complementary framing preserved: the two drugs act on different branches of the same process (@hyp:metabolic-immune-ldn). (ch47 @oq:ldn-metformin-phenotype-triage; cert n/a — research question; severity unknown; origin: /integrate-topic ldn-metformin-bifurcation-triage.)],[Phase 3 / n/a],

  [compat note], [Compatibility (Phase 7): oq:ldn-metformin-phenotype-triage is INDEPENDENT of (does not modify) the concurrent-adjunct framing @hyp:metabolic-immune-ldn (metformin added to preserve LDN benefit in prediabetics — an either/or triage question is a different axis, so no conflict). It is COMPLEMENTARY to the ch33 LDN pharmacodiagnostic differential (@sec:low-dose-naltrexone-ldn LDN TLR4/TRPM3 dose-window content) and consistent with the ch06 endotype/subgroup framework. No certainty bump applies (cert n/a — research question; Active Caps forbid bumping above 0.45). The metformin established-disease negative trials (REVIVE futility, Lim2026 PASC) do not conflict with any existing positive metformin claim because the paper's metformin content is prevention/timing-scoped, not established-disease benefit. Compat audit at tmp/compat-audit-ldn-metformin-bifurcation-2026-09-09.md.],[Phase 7 / n/a],
)
