...
#table(
  ...
  [spec:hormetic-inversion-point-battery-hip-b], [A 6-drug within-patient crossover trial (LDN, sulforaphane, duloxetine, modafinil, rapamycin, allopregnanolone — each at 4 dose levels, n=20, ~48 weeks) could validate or falsify the hormetic reserve hypothesis across all four mechanistic clusters. Generates a 6×6 inversion-point correlation matrix. If ≥50% of patients show measurable inversion points and mean pairwise r ≥ 0.4, hormetic reserve is supported. Falsified if under 30% show inversions or all pairwise r under 0.2. If 30--50% show inversions, the hormetic-reserve effect size is too small to reject confounding at n=20; requires n ≥ 80 replication. Estimated cost: USD 600,000--800,000. No pharmaceutical company will fund (all 6 drugs generic). @Samuel2019Nof1Hypertension @Samuel2023Nof1RCT],[Phase 4 / n/a],
