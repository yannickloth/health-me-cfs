...
#registry-entry(
  ...
  chapter-ref: [ch07:@lim:seronegative-chronic-lyme-cfs],
...
= Entries added 2026-07-26f: LDN Hormetic Dose-Response

#table(
  columns: (1fr, 2fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [@spec:ldn-hormetic-window], [LDN shows non-monotonic dose-response within the clinical 0.5--4.5 mg range because TLR4 partial antagonism triggers Nrf2-mediated compensatory anti-inflammatory priming (M1 to M2 microglial phenotype shift, glycolysis to OXPHOS metabolic switch) at lower doses; higher doses within the LDN range remove the basal TLR4 tone needed to sustain this compensatory response. Four distinct mechanisms (TLR4, TRPM3, opioid receptors, orexin) have non-overlapping dose optima -- the "right dose" varies per patient depending on which mechanism is dominant. Evidence: microglial dose-dependent M1 to M2 switch in vitro @Kucic2021LDNmicroglia (cert 0.63), Nrf2 hormesis framework @Calabrese2021Nrf2 (cert 0.72), naltrexone inverted-U behavioural model @Hammerslag2020 (cert 0.68), opioid receptor feedback disruption @Boyadjieva2004 (cert 0.68), FM dose-response ED50 3.88 mg with wide interindividual variation @BruunPlesner2020LDN (cert 0.48). No within-range dose-response trial in any condition. Falsifiable prediction: prospective four-arm crossover trial (0.5/1.5/3.0/4.5 mg, n at least 30) must show non-monotonic individual response curves in more than 50% of participants AND group-averaged curve shows a decline from mid-dose to high-dose in at least 1 outcome. Falsified if all individual curves are monotonic OR group-average is strictly monotonic-increasing across full dose range.],[Phase 3 / 0.30],

  [@hyp:multi-target-dose-optimum-divergence], [LDN's four mechanisms have distinct concentration-response curves with potentially non-overlapping optima: TLR4 hormetic priming peaking at 0.5--1.5 mg, endorphin compensatory upregulation plateauing at 1.5--3.0 mg (set by endogenous opioid precursor expression), TRPM3 restoration possibly requiring 3.0--4.5 mg, and orexin disinhibition tracking TLR4 microglial effects in hypothalamus. A patient's optimal dose reveals which mechanism is dominant -- dose-finding becomes a diagnostic tool. Prediction: patients with TRPM3 dysfunction (measurable via NK cell calcium flux assay) should respond to higher LDN doses (3.0--4.5 mg) while patients with inflammation-driven symptoms (high ESR) should respond to lower doses (0.5--1.5 mg). Falsified if there is no correlation between baseline TRPM3 function, inflammatory markers, and individual optimal LDN dose (r less than 0.3 for both).],[Phase 3 / 0.25],

  [@spec:hormesis-multi-drug-principle], [Non-monotonic dose-response is a recurring pattern across ME/CFS pharmacotherapy: LDN (TLR4 hormetic window, 0.5--4.5 mg), LDA (microglial D2 stabilization, 0.2--2 mg), lithium (NCS-1/IP3R1 vs IMPase vs GSK-3beta dose optima, 2--45 mg), melatonin (sleep benefit 0.5 mg, worsening 3+ mg), sulforaphane (Nrf2 hormetic window, theoretical). The hormesis framework -- low-dose stress triggers compensatory adaptive upregulation -- unifies these observations. Falsifiable prediction: in a cohort of ME/CFS patients trialed on 2 or more drugs with documented inverted-U dose-responses, individual inversion-point position should correlate across drugs (patients with narrow LDN window also have narrow LDA window, r greater than 0.4). Falsified if inversion-point correlation across drugs is r less than 0.2 -- then each drug's dose-response is independent of the underlying hormetic machinery, and there is no "hormetic reserve" trait.],[Phase 3 / 0.30],
