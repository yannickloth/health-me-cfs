...
#figure(
  table(
    ...
    [S], [0.35],
    [KGDHC is more ROS-sensitive than PDC (40--50% inhibition at oxidative-stress-range H2O2; multiple redox-sensitive cysteine residues). SIRT4 dual-targets both PDC and KGDHC E2. Mid-cycle trap: no overflow valve (unlike PDC→lactate). Paired PDC + KGDHC measurement should show KGDHC reduction exceeding PDC.],
