...
#figure(
  table(
    ...
    [Ch.6b @hyp:pgc1alpha-suppression],
    ...
    [Ch.6b @spec:cardiolipin-peroxidation],
  ...
  kind: table, supplement: [Table], caption: [Ch06b energy metabolism failure cartography entries added 2026-04-11: one hypothesis (PGC-1α suppression, H, certainty 0.40); five speculations (PDC cofactor depletion, PDK upregulation as protective, PEM timing as ISR kinetics, riboflavin FAD master rate-limiter, cardiolipin peroxidation convergence); seven open questions (ANT autoantibodies, ISCU dysfunction, KGDHC cofactor failure, CPT1/malonyl-CoA regulation, NRF2 pathway suppression, PRDX3/thioredoxin system, UCP2/UCP3 upregulation) — thirteen entries total. Motivated by @Fluge2016, @Shankar2025oxidativestress, @Maksoud2021nutraceuticals, @MorrisMaes2014mitochondria, @Molnar2024LCmitochondria.],
