...
#registry-entry(
  [MZ Twin Discordant Striatal VMAT2/D2-D3 Imaging in ME/CFS],
  type: "H",
  certainty: "0.35",
  evidence: [Monozygotic twin discordant design eliminates genetic and shared-environment confounds: the unaffected co-twin provides the optimal control — identical germline DNA, rearing environment, parental SES, childhood diet @Buchwald1997twinsCFS @Koelle2002TwinsHSV. DecodeME cell-type enrichment converges on striatal MSNs as the top cell-type hit (Human Brain Atlas pipeline), replicated in Dropviz @Maccallini2026metaGWAS @DecodeME2025. Liu 2026 demonstrated 16--20% VMAT2 binding reduction in long COVID striatum across ventral striatum, dorsal putamen, and dorsal caudate (P=4×10⁻⁵), reductions comparable to mild-moderate Parkinson's @Liu2026VMAT2longcovid. COVID-recovered controls had normal VMAT2, confirming specificity to persistent illness. Zero VMAT2 PET data exist in ME/CFS. Prior twin studies in ME/CFS used blood biomarkers only (CPET, platelet mitochondrial proteomics, HSV serology), no striatal imaging @Giloteaux2016Twins @Ciregia2017mitoTwin. Genetically-controlled twin design isolates acquired striatal pathology from shared genetic predisposition.],
  citations: [@DecodeME2025 @Maccallini2026metaGWAS @Liu2026VMAT2longcovid @Buchwald1997twinsCFS @Koelle2002TwinsHSV @Giloteaux2016Twins @Ciregia2017mitoTwin @Braga2023neuroCOVID @Braga2025astrogliosis @Treadway2012effortD2],
  mechanism: [ME/CFS genetic risk operates through striatal circuits (MSN enrichment) → environmental trigger (infection, stress) activates this vulnerability → acquired striatal dopaminergic terminal pathology → VMAT2 binding reduction in affected twin vs unaffected co-twin carrying identical genetic vulnerability but lacking illness. D2/D3 availability pattern discriminates presynaptic terminal loss (VMAT2↓ + D2/D3↑) from combined pre- and postsynaptic pathology (VMAT2↓ + D2/D3↓). The unaffected co-twin serves as the ultimate within-subject genetic control — any difference is attributable to the illness or its trigger, not to shared predisposition.],
  chapter-ref: [ch46:@sec:mz-twin-discordant-striatal-microbiome-lsr, @hyp:mz-twin-discordant-striatal-microbiome-lsr],
  prediction: [In MZ twin pairs discordant for ME/CFS, the affected twin shows ≥10% reduction in striatal VMAT2 BP_ND vs unaffected co-twin in at least one subregion (Cohen's d_z ≥ 0.5, FDR q < 0.05). Unaffected co-twin VMAT2 binding remains within 1 SD of healthy reference pair mean. D2/D3 SBR pattern discriminates pre- from postsynaptic pathology. Falsified if: no significant within-pair difference in VMAT2 binding (all P ≥ 0.05), OR D2/D3 null — demonstrating long COVID VMAT2 finding does not generalise to ME/CFS and DecodeME brain enrichment reflects genetic vulnerability without acquired striatal pathology.],
...
#registry-entry(
  ...
  type: "S",
  certainty: "0.20",
  evidence: [Microbiome composition predicts fatigue severity in ME/CFS @NagySzakal2017microbiomeME. The striatum is a primary target of gut-derived inflammatory signals via the gut-brain axis @Cryan2019gutbrain. Kynurenine pathway links gut microbiome to striatal dopaminergic function: microbial metabolites modulate tryptophan metabolism → kynurenine/tryptophan ratio → quinolinic acid production → striatal microglial activation. Microbial SCFAs (butyrate, propionate) cross BBB and influence dopaminergic gene expression in striatum. The twin design controls for the largest confounds in microbiome research (diet, genetics, early environment, childhood antibiotic exposure), isolating the illness-specific microbiome signal. The gut-microbiome-striatal axis has never been tested with simultaneous measurement of both endpoints in any population.],
  citations: [@NagySzakal2017microbiomeME @Cryan2019gutbrain @DecodeME2025 @Liu2026VMAT2longcovid],
  ...
  chapter-ref: [ch46:@sec:mz-twin-discordant-striatal-microbiome-lsr],
