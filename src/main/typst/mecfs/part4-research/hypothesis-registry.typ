...
#registry-entry(
  ...
  chapter-ref: [ch25: dopaminergic augmentation mecfs],
...
#registry-entry(
  ...
  chapter-ref: [ch47: mz twin discordant striatal microbiome lsr, mz twin discordant striatal microbiome lsr],
...
#registry-entry(
  ...
  chapter-ref: [ch47: mz twin discordant striatal microbiome lsr],
...
#registry-entry(
  ...
  chapter-ref: [ch34 sec-08 innate-immune-hyperactivation-cascade (@sec:innate-immune-hyperactivation-cascade); ch08 @sec:innate-immunity @sec:immune-activation; ch18 @hyp:tlr4-nfkb-pem-amplifier; ch17 @sec:multi-lock-trap],
...
#registry-entry(
  ...
  chapter-ref: [ch07: lsr valacyclovir response; ch31: lsr cascade interpretation],
...
#registry-entry(
  ...
  chapter-ref: [ch39: lsr diagnostic biomarker; ch40: lsr biomarker validation study],
...
#registry-entry(
  ...
  chapter-ref: [ch47: mz twin discordant striatal microbiome lsr, ch07: lytic structural igg ratio],
...
#registry-entry(
  ...
  chapter-ref: [ch30: pupillometry biomarker, ch30: pupillometry pem, ch30: plr gpcr bioassay],
...
#registry-entry(
  ...
  chapter-ref: [ch30: pupillometry pem],
...
#registry-entry(
  ...
  chapter-ref: [ch30: plr gpcr bioassay],
...
#registry-entry(
  ...
  chapter-ref: [ch34: negative control class; ch34: negative control principle; ch34: negative control taxonomy; ch34: negative control ladder; ch34: negative control decision heuristic; ch34: negative control asymmetric evidence],
...
#registry-entry(
  ...
  chapter-ref: [ch15: trpv1 thermal autonomic stress test; ch47: trpv1 thermal autonomic stress test],
...
#registry-entry(
  ...
  chapter-ref: [ch27: resolution failure pem],
...
#registry-entry(
  ...
  chapter-ref: [ch27: recovery network collapse],
...
#registry-entry(
  ...
  chapter-ref: [ch27: antihistamine pem blockade],
...
#registry-entry(
  ...
  chapter-ref: [ch27: thermal exercise mimetic],
...
#registry-entry(
  ...
  chapter-ref: [ch47: deconditioned-matched CPET separation; ch38 + ch42 effort-preference controversy; ch17 @sec:cpet-hypotheses],
...
#registry-entry(
  ...
  chapter-ref: [ch27: dxa standard assessment],
...
#registry-entry(
  ...
  chapter-ref: [ch27: overfeeding paradox],
...
#registry-entry(
  ...
  chapter-ref: [ch27: metabolic adaptation amplification],
...
#registry-entry(
  ...
  type: "P",
  certainty: "0.55",
  evidence: [Ratio of measured REE to predicted REE defines hypometabolic index; values less than 0.80 indicate clinically significant hypometabolism. Analogous to Metabolic Reserve Score (ch30) but simpler.],
  ...
  chapter-ref: [ch27: hypometabolic index],
...
#registry-entry(
  ...
  chapter-ref: [ch27: pocus bedside composition],
...
#registry-entry(
  ...
  chapter-ref: [ch27: ree equation mecfs],
...
#registry-entry(
  ...
  chapter-ref: [ch27: rq substrate inflexibility],
...
#registry-entry(
  ...
  chapter-ref: [ch27: positional feeding],
...
#registry-entry(
  ...
  type: "S",
  certainty: "0.45",
  evidence: [Metformin proposed for ME/CFS (Fineberg 2025). XR has better GI tolerability than IR. AMPK activation may improve fat oxidation. NOTE: no positive ME/CFS symptom benefit demonstrated; in established post-viral disease two RCTs were unsupportive (one completed negative @Lim2026MetforminPASC; one stopped for futility @Reis2026fluvoxamine); the only positive RCT-level signal is acute-phase prevention (COVID-OUT @Reis2023COVIDOUT).],
  citations: [@Fineberg2025Metformin @Lim2026MetforminPASC @Reis2026fluvoxamine @Reis2023COVIDOUT],
  ...
  chapter-ref: [ch27: metformin metabolic platform],
  prediction: [Metformin XR improves fasting RQ (toward fat oxidation) and reduces CRP vs placebo over 12 weeks.],
  treatment: [Already available, inexpensive, weight-neutral — but NOT recommended for established ME/CFS outside a registered trial (research hypothesis only; see @oq:ldn-metformin-phenotype-triage).],
  limitation: [Complex I inhibition risk in population with pre-existing Complex I impairment; renal impairment contraindication (eGFR $< 30$; not initiated 30--44); no established-disease symptom benefit demonstrated.],
)
...
#registry-entry(
  ...
  chapter-ref: [ch27: severity tiered protocol],
...
#registry-entry(
  ...
  chapter-ref: [ch27: creatine metabolic],
...
#registry-entry(
  ...
  chapter-ref: [ch27: pacing meal timing],
...
#registry-entry(
  ...
  chapter-ref: [ch27: hypometabolic caloric recalibration],
...
#registry-entry(
  ...
  chapter-ref: [ch27: mct fat oxidation bypass],
...
#registry-entry(
  ...
  chapter-ref: [ch27: carnitine cpt bypass],
...
#registry-entry(
  ...
  chapter-ref: [ch27: omega3 anabolic sensitivity],
...
#registry-entry(
  ...
  chapter-ref: [ch27: leptin ampk driver],
...
#registry-entry(
  ...
  chapter-ref: [ch27: admf muscle preservation],
...
#registry-entry(
  ...
  chapter-ref: [ch28: tvns dissociation mechanisms],
...
#registry-entry(
  ...
  chapter-ref: [ch27: microbiome weight trajectory],
...
#registry-entry(
  ...
  chapter-ref: [ch27: psmf severe obesity],
...
#registry-entry(
  ...
  type: "S",
  certainty: "0.30",
  evidence: [All three components documented as GLP-1 modulators (ch27). Combination may produce synergistic endogenous GLP-1 stimulation.],
  citations: [—],
  ...
  chapter-ref: [ch27: glp1 pathway stack],
...
#registry-entry(
  ...
  type: "S",
  certainty: "0.30",
  evidence: [Berberine activates AMPK (same target affected in ME/CFS). Timing before largest meal may maximize effect (ch27).],
  citations: [—],
  ...
  chapter-ref: [ch27: berberine dose timing],
...
#registry-entry(
  ...
  chapter-ref: [ch27: cachexia pem phenotype],
...
#registry-entry(
  ...
  chapter-ref: [ch27: slow cachexia phenotype],
...
#registry-entry(
  ...
  chapter-ref: [ch27: glp1 actriib combo],
...
#registry-entry(
  ...
  chapter-ref: [ch27: urolithin mitophagy],
...
#registry-entry(
  ...
  chapter-ref: [ch27: cachexia drugs repurposed],
...
#registry-entry(
  ...
  chapter-ref: [ch28: tvns pcc systematic review; ch14d: tvns sham superior paradox; ch27: tvns pcc null evidence],
...
#registry-entry(
  ...
  chapter-ref: [ch27: vagal tone appetite],
...
#registry-entry(
  ...
  chapter-ref: [ch27: trh t3 augmentation],
...
#registry-entry(
  ...
  chapter-ref: [ch27: cold thermogenesis],
...
#registry-entry(
  ...
  certainty: "ch27:@spec:brown-fat-activation",
...
#registry-entry(
  ...
  chapter-ref: [ch28: tvns dissociation mechanisms; ch14d: tvns sham superior paradox],
...
#registry-entry(
  ...
  chapter-ref: [ch27: ree mecfs severity],
  prediction: [—],
...
#registry-entry(
  ...
  chapter-ref: [ch27: weight loss symptom improvement],
  prediction: [—],
...
=== Aluminum-Adjuvant MMF Post-Exposure

#registry-entry(
  [Aluminium-Adjuvant Biopersistence and Myofasciitis as a Rare Post-Vaccination Subgroup of ME/CFS],
  type: "S",
  certainty: "0.30",
  evidence: [Single-site Henri-Mondor/AP-HP (INSERM U955, Gherardi + Authier) proposal that intramuscular aluminium-adjuvant particles biopersist in deltoid-muscle macrophages (macrophagic myofasciitis, MMF) and, in a minority, drive chronic NLRP3/IL-1β signalling producing a fatiguing, arthromyalgic, cognitively impaired syndrome overlapping ME/CFS @Gherardi2019myalgia @Rigolet2014clinical @VanDerGucht2015spect @VanDerGucht2017fdg @AounSebaiti2018cogn. Animal: selective low-dose aluminium-adjuvant neurotoxicity and brain translocation @Crepeaux2017dose @Gherardi2015biopersist; in vitro MMF phagocyte autophagic/mitochondrial dysfunction @Masson2024phagocytes. Alum activates the NLRP3 inflammasome → IL-1β @Eisenbarth2008nalp3. All MMF clinical/mechanistic papers derive from one referral cohort — NOT independent replication; no formal diagnostic-criteria (Fukuda/CCC/ICC/IOM) study of MMF patients. Origin: literature — single-group.],
  citations: [@Gherardi2019myalgia @Rigolet2014clinical @VanDerGucht2015spect @VanDerGucht2017fdg @AounSebaiti2018cogn @Gherardi2015biopersist @Crepeaux2017dose @Masson2024phagocytes @Eisenbarth2008nalp3 @Mitkus2011aluminum @Principi2018aluminum @Magnus2015influenza],
  mechanism: [Aluminium oxyhydroxide activates NLRP3 → IL-1β (adjuvant mechanism); biopersistence in phagocytes + low-dose long-term neurotoxicity (animal); phagocyte autophagic flux impairment, pain chemokines, mitochondrial dysfunction (in vitro MMF cells); proposed chronic dispersal → systemic fatigue/arthromyalgia. Translation from local muscle lesion to CNS disease not established.],
  chapter-ref: [ch14d: aluminum-adjuvant macrophages myofasciitis subgroup],
  prediction: [Independent multicenter study applying IOM (2015) criteria to biopsy-confirmed MMF patients shows no excess ME/CFS vs matched controls, or an excess confined to the referral population not reproduced in an incident population cohort. Falsified if criteria-based MMF cohorts and incident cohorts show no excess ME/CFS (the expectation given @Magnus2015influenza HR 0.97).],
  treatment: [None — no treatment implication beyond speculation; the proposal is a post-exposure subgroup hypothesis, not a therapeutic target.],
  limitation: [Single-site, single referral cohort re-analysed across papers. Population-level counter-evidence strong: Norwegian nationwide registry found adjuvanted vaccine did not raise CFS/ME risk (HR 0.97) while infection did (HR 2.04) @Magnus2015influenza; regulatory assessments find no toxic aluminium body burden @Mitkus2011aluminum @Principi2018aluminum. Animal/in vitro evidence not translated to human CNS. Severity applicability unknown.],
)

#registry-entry(
  [Aluminum-Adjuvant MMF Single-Site Cohort and Registry Counter-Evidence],
  type: "OQ",
  certainty: "n/a",
  evidence: [The MMF→ME/CFS hypothesis is advanced by one group (Henri-Mondor), a single referral cohort sliced across papers; the strongest independent vaccine-adjuvant evidence is negative (Magnus 2015 nationwide HR 0.97; no toxic body burden @Mitkus2011aluminum). Open question: does any independent, criteria-based (IOM 2015) MMF cohort show an excess of ME/CFS, or is the association a referral artifact? Origin: literature — counter-evidence synthesised with existing corpus @Magnus2015influenza.],
  citations: [@Magnus2015influenza @Mitkus2011aluminum @Principi2018aluminum @Gherardi2019myalgia],
  mechanism: [Documents the epistemic structure: single-group positive association vs population-registry null; the registry null governs the general vaccine→ME/CFS claim, confining MMF to a speculative niche subgroup.],
  chapter-ref: [ch14d: aluminum-adjuvant mmf limitation],
  prediction: [A prospective, criteria-based, independent MMF cohort study showing no ME/CFS excess would resolve the referral-artifact question; a positive independent finding would reopen it.],
  treatment: [N/A — methodological/epistemic audit, not a treatment claim.],
  limitation: [No independent MMF cohort study exists to test the resolution either way.],
)

= Entries added 2026-09-01: aluminum-adjuvant-mmf

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec aluminum-adjuvant-nlrp3-immune-stimulation], [Speculation (mechanism strand, ch08): chronic immune stimulation is a documented ME/CFS theme, and aluminium oxyhydroxide adjuvants activate the NLRP3 (Nalp3) inflammasome to drive IL-1β @Eisenbarth2008nalp3; aluminium-adjuvant particles biopersist in phagocytes and may reach brain (animal) @Gherardi2015biopersist, and MMF patient phagocytes show specific inflammatory, autophagic, and mitochondrial responses in vitro @Masson2024phagocytes. The speculation is that, in a minority of vaccine-adjuvant-exposed people, sustained low-grade NLRP3/IL-1β signalling could contribute to ME/CFS-like fatigue. Mechanism strand only — does not assert population-level causation, which a nationwide registry already counts against (adjuvanted vaccine HR 0.97 @Magnus2015influenza). Certainty 0.33 (discounted: in-vitro/animal provenance, no ME/CFS-specific data; 0.28→0.33: convergence with HS-NLRP3 bridge and IL-11 inflammaging on the shared NLRP3→IL-1β→neuroinflammation→fatigue endpoint via distinct triggers/labs). Severity applicability unknown — MMF cohort not severity-stratified. Consequence: if true, stratify immune phenotyping by adjuvant-exposure history and deltoid-biopsy MMF status; no diagnostic or treatment change currently. (ch08 @spec:aluminum-adjuvant-nlrp3-immune-stimulation; origin: literature — mechanism strand of aluminum-adjuvant-mmf.)],[Phase 7 / 0.33],

  [oq mmf-deltoid-biopsy-significance], [Open question (biomarker strand, ch36): whether the deltoid-biopsy MMF finding is a genuine ME/CFS-relevant biomarker or a referral-selection artifact is unresolved. MMF is a validated histopathological entity (aluminium-particle biopersistence in deltoid macrophages), and the single Henri-Mondor group describes an ME/CFS-like presentation @Gherardi2019myalgia @Rigolet2014clinical @VanDerGucht2015spect @VanDerGucht2017fdg @AounSebaiti2018cogn — but no study applies formal diagnostic criteria (Fukuda/CCC/ICC/IOM), all literature derives from one cohort (not independent replication), and the strongest independent population evidence is negative (adjuvanted vaccine HR 0.97 @Magnus2015influenza). Severity applicability unknown — MMF cohort not severity-stratified. Falsifiable resolution: an independent criteria-based (IOM 2015) multicenter deltoid-biopsy MMF study. Consequence: until such data, a positive MMF deltoid biopsy should not diagnose ME/CFS or select treatment; it is a documented finding in a small referral-biased subgroup, not a validated ME/CFS biomarker. (ch36 @oq:mmf-deltoid-biopsy-significance; origin: literature — biomarker strand of aluminum-adjuvant-mmf.)],[Phase 3 / n/a],
)

= Entries added 2026-09-01: aluminum-adjuvant-mmf (Phase 5 brainstorm)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec aluminum-adjuvant-amplifier-modulator], [Speculation (mechanism strand, ch14d, H1): a sequential model reconciles the registry observations — the adjuvanted vaccine did not raise CFS/ME risk (HR 0.97) while infection did (HR 2.04) @Magnus2015influenza. Aluminium-adjuvant particles biopersist and continuously gate NLRP3 priming (alum→NLRP3→IL-1β @Eisenbarth2008nalp3), so alum sets a low-level NLRP3 "gain"; a later independent viral trigger tips IL-1β over threshold into symptom generation. Alum is an amplifier, not an independent cause. Operationalisation = R3: prospective post-infectious cohorts record pre-infection alum-adjuvant history and stratify by exposure. Falsifiable prediction: in a vaccine-exposed cohort, ME/CFS incidence after infection will be higher with a long vaccine-to-infection interval. Certainty 0.20 (mechanisms real; sequencing interaction unstudied in humans). Severity applicability unknown. Consequence: reframes the question from "does a vaccine cause ME/CFS?" to "does prior vaccine exposure change how strongly a later infection affects you?". (ch14d @spec:aluminum-adjuvant-amplifier-modulator; origin: brainstorm H1/R3.)],[Phase 5 / 0.20],

  [oq aluminum-adjuvant-dose-response], [Open question (research direction, ch14d, R2): the population null (HR 0.97) tested only any adjuvanted vaccine; a graded dose-response re-analysis of the registry data (number of adjuvanted doses, total aluminium dose, booster timing against IOM-coded incident ME/CFS) would sharply constrain the causal claim. Falsifiable prediction: cumulative aluminium-adjuvant dose shows no monotonic increase in ME/CFS incidence (flat HR ~1.0 across dose quartiles); a positive monotonic trend would contradict @Magnus2015influenza. Certainty of resolution if run 0.38 (registry data exist; dose-stratification straightforward). Severity applicability unknown. Consequence: could resolve cheaply and within a few years whether aluminium dose is truly irrelevant. (ch14d @oq:aluminum-adjuvant-dose-response; origin: brainstorm R2.)],[Phase 5 / 0.38],

  [oq aluminum-vs-nonalum-immune-state], [Open question (research direction, ch14d, R4): the registry compared vaccinated vs unvaccinated and cannot exclude a non-aluminium vaccine component; alum specifically activates NLRP3 @Eisenbarth2008nalp3 whereas other adjuvants engage different pathways, and MMF phagocytes show in-vitro mitochondrial/autophagic changes @Masson2024phagocytes. Compare long-term circulating immune state (IL-1β, IL-18, monocyte phenotype, mitochondrial-reserve markers) in alum- vs non-alum-vaccine recipients, matched for age/sex/indication. Falsifiable prediction: no durable ≥6-month difference in IL-1β/IL-18 or mitochondrial-reserve markers between alum and non-alum recipients; any alum signature transient and below the ME/CFS range. Certainty of resolution if run 0.30. Severity applicability unknown. Consequence: isolates the aluminium ingredient's lasting immune trace from the general vaccination response. (ch14d @oq:aluminum-vs-nonalum-immune-state; origin: brainstorm R4.)],[Phase 5 / 0.30],

  [oq aluminum-postvaccination-onset-distinction], [Open question (case-definition, ch14d, NUL1): even if the null holds (aluminium adjuvants do not cause ME/CFS), MMF remains a real local histopathological entity but a bystander reaction, not an etiologic lesion. "Post-vaccination onset" (real, temporally associated) is not evidence of "aluminium-caused onset"; the temporally overlapping infection (HR 2.04 @Magnus2015influenza) is a better-supported explanation, or a non-aluminium vaccine component. Falsifiable prediction: under the null, ME/CFS-after-vaccination cases are attributable to the coincident infection and show no aluminium dose-dependence or deltoid-lesion correlation with severity. Confidence in the null interpretation 0.70 (reflects strong independent registry counter-evidence; this is counter-evidence confidence, not a positive causal claim — no positive mechanistic certainty crosses the 0.45 PARTIAL cap). Severity applicability unknown. Consequence: a patient developing ME/CFS shortly after a vaccine should not be told the aluminium caused it. (ch14d @oq:aluminum-postvaccination-onset-distinction; origin: brainstorm NUL1.)],[Phase 5 / 0.70 counter],

  [lim aluminum-adjuvant-confounding], [Limitation (epistemic, ch14d, E3): vaccination is not randomly assigned; vaccinated vs non-recipients differ in health-seeking, chronic-illness avoidance, occupational exposure — a spurious vaccine association can arise. Reverse causation: MMF is diagnosed in symptomatic people who recall vaccine history, inflating perceived causality. The @Magnus2015influenza registry mitigates confounding for the population null but not the referral MMF cohort, whose association is compatible with confounding alone. Severity applicability unknown. Consequence: additional caution beyond single-site/referral concerns before treating any vaccine–ME/CFS association as causal. (ch14d @lim:aluminum-adjuvant-confounding; origin: brainstorm E3.)],[Phase 5 / n/a],

  [lim aluminum-adjuvant-measurement-validity], [Limitation (epistemic, ch14d, E4): validity of exposure and outcome uncertain. (a) MMF is a single-site biopsy; a negative deltoid biopsy does not exclude alum-laden macrophages elsewhere, and population frequency unknown. (b) Aluminium "body burden" rests on pharmacokinetic modelling not directly measured in humans @Mitkus2011aluminum; circulating/urinary aluminium is a poor tissue-store proxy. (c) In-vitro findings use patient cells without a population comparator @Masson2024phagocytes, so in-vivo effect size unknown. Consequence: widens confidence interval on any MMF→ME/CFS association; argues for direct tissue-aluminium quantitation (ICP-MS) correlated with histology/symptoms in a multicentre sample. Severity applicability unknown. (ch14d @lim:aluminum-adjuvant-measurement-validity; origin: brainstorm E4.)],[Phase 5 / n/a],
)
...
#table(
  ...
  [spec:hormesis-multi-drug-principle], [Non-monotonic dose-response is a recurring pattern across ME/CFS pharmacotherapy spanning 18+ medications (LDN, LDA, lithium, melatonin, sulforaphane, corticosteroids, DORAs, duloxetine, beta-blockers, modafinil, guanfacine, gabapentinoids, H1 antihistamines, rapamycin, allopregnanolone, NAC, ketotifen, quercetin; taVNS is a hypothesis-stage candidate without a confirmed dose window). The hormesis framework unifies these observations via Nrf2-mediated compensatory upregulation (Calabrese corpus), catecholamine inverted-U at prefrontal D1/α2A receptors (Arnsten, Cools), mTORC1/mTORC2 dose selectivity (Sarbassov, Lamming), and biphasic concentration-response at GABA-A (Andreen). Falsifiable prediction: individual inversion-point position (standardised dose at which symptom improvement turns to worsening) should correlate across drugs within each patient if a hormetic reserve trait exists; mean pairwise r ≥ 0.4 expected, with ≥60% of all 153 pairwise comparisons reaching r ≥ 0.3. Falsified if mean pairwise r < 0.2 and fewer than 20% of pairs reach r ≥ 0.3. Indeterminate if mean r falls in 0.2--0.4 range or 20--60% of pairs are above threshold — then hormetic reserve signal is too weak/noisy for a single-trait model and would require mechanistic-clustering decomposition. @Calabrese2002hormesisHistory @CalabreseBaldwin2003toxicologyRethinks @Calabrese2010hormesisCentral @Sun2020yinYangHormesis @Arnsten2011catecholaminePFC @Cools2011invertedU @Sarbassov2006rapamycin @Lamming2012rapamycin @Andreen2009allopregnanoloneBiphasic],[Phase 3 / 0.35],
...
#registry-entry(
  ...
  chapter-ref: [ch32: lyme paradigm],
...
#registry-entry(
  ...
  chapter-ref: [ch32: duration caveats],
...
#registry-entry(
  ...
  chapter-ref: [ch32: duration critique research],
...
#registry-entry(
  ...
  chapter-ref: [ch34: nomenclature controversy],
...
#registry-entry(
  ...
  chapter-ref: [ch34: nomenclature section],
...
#registry-entry(
  ...
  chapter-ref: [ch33: null subtyping — absent vs blocked vs overwhelmed],
...
#registry-entry(
  ...
  chapter-ref: [ch34 sec-10 subsec-07: endogenous probes — menstrual cycle pharmacodiagnostic],
...
#registry-entry(
  ...
  chapter-ref: [ch34: @sec:contraindication-ladder],
...
#registry-entry(
  ...
  chapter-ref: [ch34: @sec:diurnal-response-window],
...
#registry-entry(
  ...
  citations: [Existing ch34 references; no dedicated ME/CFS latency studies],
  ...
  chapter-ref: [ch34: subsec-04 subsubsec-03 response onset latency],
...
#registry-entry(
  ...
  chapter-ref: [ch34: @sec:sequential-ordering-principle],
...
#registry-entry(
  ...
  citations: [Existing ch34 references; no dedicated stopping-rule literature],
  ...
  chapter-ref: [ch34: @sec:do-not-disturb-rule],
...
#registry-entry(
  ...
  chapter-ref: [ch14d cross-disease: @spec:methylene-mecfs-longcovid-distinguish; ch19: @spec:methylation-loss-consolidation; ch56: @oq:consolidation-directionality],
...
#registry-entry(
  ...
  chapter-ref: [ch34 sec-12 Daratumumab (Anti-CD38); ch19: @hyp:plasma-cell-sanctuary; ch33 sec-02h origin-elimination],
...
#registry-entry(
  ...
  type: "H",
  certainty: "0.26",
  evidence: [Healthy 3D biofabricated skeletal muscle exposed in vitro to ME/CFS and Long COVID patient sera shows up-regulated glycolysis, mitochondrial hyperfusion, elevated oxygen consumption early, then contractile weakness and toroidal mitochondrial fragmentation by 96--144 h @Mughal20253dMuscleSera. The serum-transfer phenomenon has prior support across models @Schreiner2020HHV6MitoME @Appelman2024MusclePEM; anti-mitochondrial antibodies are excluded as the mediator @Nilsson2020NoMitoAb. Note: the Fluge monolayer-myoblast layer (myoblasts exposed to ME/CFS serum) failed a large pre-registered replication that found no difference in maximal respiratory capacity across >1,700 Seahorse tests @Ryback2026myoblastNull; the null is scoped to the monolayer assay and does not extend to the structurally intact 3D biofabricated model or in-tissue/activity-dependent models @Fluge2016PDH @Ryback2026myoblastNull. Raw 0.65, discounted 0.26 by in-vitro population weight 0.40.],
  citations: [@Mughal20253dMuscleSera @Fluge2016PDH @Schreiner2020HHV6MitoME @Appelman2024MusclePEM @Nilsson2020NoMitoAb @Ryback2026myoblastNull],
...
#registry-entry(
  ...
  type: "S",
  certainty: "0.30",
  evidence: [Biofabricated 3D skeletal muscle exposed to patient serum shows up-regulated glycolysis and mitochondrial hyperfusion at 48 h, then toroidal fragmentation and contractile failure at 96--144 h @Mughal20253dMuscleSera; patient sera were also reported to drive PDH-related myoblast metabolic shift @Fluge2016PDH, though this monolayer-myoblast serum effect failed a large pre-registered replication @Ryback2026myoblastNull. The phase decomposition is an interpretation reconciling short-exposure hypermetabolic and long-exposure hypometabolic findings; raw 0.30, discounted from in-vitro weight.],
  citations: [@Mughal20253dMuscleSera @Fluge2016PDH @Ryback2026myoblastNull],
...
#registry-entry(
  ...
  citations: [@Mughal20253dMuscleSera @Fluge2016PDH @Schreiner2020HHV6MitoME @Nilsson2020NoMitoAb @Ryback2026myoblastNull],
  mechanism: [Fractionating serum and applying each fraction to biofabricated muscle with quantitative readouts (lactate efflux, PDK mRNA, mitochondrial morphology, contractile force) identifies which molecular class transmits the metabolic pathology; a parallel blinded ME/CFS vs LC vs healthy comparison tests whether the assay discriminates conditions. The fractionation rationale rests on the 3D biofabricated model and Schreiner cell-transfer findings; the monolayer-myoblast serum layer failed a large pre-registered replication @Ryback2026myoblastNull, so the fractionation target is the 3D-model phenotype rather than the refuted monolayer readout.],
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:medical-education-reform],
  ...
  limitation: [No prospective intervention data in ME/CFS; severity applicable across all levels. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @hyp:diagnostic-delay-harm],
  ...
  limitation: [Cross-sectional survey evidence; no prospective study; severity applicability all, greatest for those progressing to severe. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:specialist-clinic-evidence; ch40 BHC care-delivery example],
  ...
  limitation: [Evidence gap identification, not a factual claim; severity most critical for severe/very-severe. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @spec:coproduction],
  prediction: [Co-produced ME/CFS services should show higher retention/satisfaction than non-co-designed services.],
  limitation: [n=8 qualitative; not ME/CFS-validated; severity most important for severe/very-severe. CONFLICT-TENSION: the S4ME (2026) severe-care factsheet argues multidisciplinary teams are "likely counterproductive" for housebound/bedbound patients and recommends a single point of contact instead (@cf:single-point-of-contact-severe); the preference for multidisciplinary teams may be severity-stratified (ambulatory vs housebound), untested. (ch40, prior cycle + severe-mecfs-management cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:universal-access-null],
  ...
  limitation: [Descriptive/qualitative health-services evidence; no care-model comparative studies. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @hyp:diagnostic-desert],
  ...
  limitation: [Geographic variation documented; the trap mechanism is novel/untested; severity most relevant for severe/very-severe. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @spec:guideline-cascade-duration],
  ...
  limitation: [Implementation-science support is general; contested-illness amplification novel; NICE-2021 cascade unobserved; all severity. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @spec:invalidation-pem-trap],
  ...
  limitation: [Both mechanisms individually documented; synergy inferred not directly observed; severity most critical for long-duration severe patients. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:nice-natural-experiment],
  ...
  limitation: [Feasibility high (standard method, data exist); the study has not yet been run. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:specialist-clinic-quasiexperiment],
  ...
  limitation: [Feasibility reasonable (UK data exist; US richer on claims, poorer on function); un-run. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:education-pilot-trial],
  prediction: [Education arm shows higher ME/CFS diagnosis rate; absence implies structural (not educational) barrier.],
  limitation: [18-month follow-up may be too short (delay averages 5+ years); feasible but un-run. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch40: @oq:pem-proof-trial],
  prediction: [PEM-avoiding arm shows better SF-36 physical function / fewer PEM episodes at 12 months than standard care.],
  limitation: [Blinding to delivery channel impossible (actigraphy as objective check); feasible but un-run. (ch40, prior cycle.)],
)
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-01 menstrual cyclicity: @hyp:luteal-orthostatic-protection, @oq:fra-cyclicity-null-sympathetic],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-02 pregnancy & postpartum: @hyp:fra-postpartum-immune-reconstitution],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-04 HRT: @hyp:fra-estrogen-mastcell-axis],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-05 endometriosis & PCOS: @ach:fra-endometriosis, @hyp:fra-endometriosis-shared-axis],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-05 endometriosis & PCOS: @oq:fra-pcos],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-01 menstrual cyclicity: @spec:fra-allopregnanolone-monthly],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-03 menopause transition: @spec:fra-menopause-iron-ferroptosis],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-04 HRT: @pred:fra-mastcell-stabilizer-stratify],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-02 postpartum: @pred:fra-postpartum-cohort],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-03 early menopause: @pred:fra-amh-slope],
...
#registry-entry(
  ...
  chapter-ref: [ch21 sec-02 pregnancy tripartite: @pred:fra-pregnancy-probe],
...
= Entries added 2026-08-15: Neurogenic vs Muscular Cramp Origin in ME/CFS

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq neurogenic-vs-muscular-cramp], [Open question: whether spontaneous, exertion-independent cramps in ME/CFS are fully explained by the muscular (sarcolemmal Na⁺/K⁺-ATPase depolarization) mechanism — the prior-favored account, being the only published ME/CFS-specific explanation and consistent with documented muscle sodium overload and subsarcolemmal mitochondrial pathology (@WirthSteinacker2025fasciculations @Petter2022sodium @Bizjak2024muscleMito) — or whether a small neurogenic (motor-nerve-terminal hyperexcitability; HCN channel, spinal reflex — @Czesnik2015HCN @Maughan2019MuscleCramping) contribution exists in addition. The neurogenic mechanism is the general-population default for cramps but has no direct ME/CFS-specific support. *Falsifiability:* EMG/nerve-conduction showing ectopic discharges or raised HCN inward rectification would establish a neurogenic route; normal nerve function with sarcolemmal abnormality would support the muscular mechanism being complete; no ME/CFS study has yet performed this discrimination. *Consequence:* the muscular mechanism should be treated as the working default and no current treatment change is indicated; whether a neurogenic contribution exists is an unanswered, testable question. (ch04 sec-03: @oq:neurogenic-vs-muscular-cramp; evidence Czesnik 2015 0.70/Wirth 2025 0.35; severity unknown; origin: literature integration.)],[Phase 3 / n/a],

  [spec motor-nerve-hyperexcitability-cramp], [Hypothesis: ME/CFS spontaneous cramps partly reflect motor-nerve-terminal hyperexcitability (ion-channel driven: HCN) rather than only the energy-deficit model; small-fiber neuropathy present in ME/CFS could excite intramuscular nerves. *Falsifiability:* threshold-tracking axonal excitability showing elevated HCN-driven inward rectification in cramp ME/CFS patients vs cramp-free controls; falsified if axonal excitability is normal or purely sarcolemmal. *Consequence:* if replicated, cramps could become a treatable nerve-excitability problem — but the mechanism has no direct ME/CFS-specific support and should not change practice. (ch04 sec-03: @spec:motor-nerve-hyperexcitability-cramp; evidence Czesnik 2015 cert 0.70, transferability-discounted to 0.30; severity unknown; origin: brainstorm.)],[Phase 3 / 0.30],

  [spec single-pump-failure-cramp-unification], [Hypothesis: the Na⁺/K⁺-ATPase maintains resting membrane potential in both muscle fibres and motor-nerve terminals, so the muscular and neurogenic cramp mechanisms may be ONE pump failure expressed in two compartments, dissolving the dichotomy. *Falsifiability:* paired sarcolemmal + motor-axonal excitability in the same limb showing correlated abnormalities; falsified if one is normal while the other is abnormal. *Consequence:* if true, clinicians need not choose between two rival explanations — a single energy/ion defect causes both. (ch04 sec-03: @spec:single-pump-failure-cramp-unification; cert 0.15; severity unknown; origin: brainstorm.)],[Phase 5 / 0.15],
)

= Entries added 2026-08-17: Leptin Circadian Entrainment (Fleury 2026)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec metabolic-circadian-entrainment], [Speculation: the metabolic hormone leptin can influence the speed of circadian re-entrainment to an external schedule, complementing light and melatonin as circadian levers. Molecular substrate: DMH LepR neurons project to the SCN and shift clock phase (@Tang2023LeptinDMHSCN @Faber2021LeptinDMHDiurnal); the clock reciprocally gates leptin signalling (@OsorioMendoza2025LeptinCircadianGating). An encapsulated-cell therapy delivering constitutively-produced (non-phasic) leptin accelerated re-entrainment to phase advances and delays in mice and cynomolgus macaques without impairing sleep (@Fleury2026LeptinCircadian). *Falsifiability:* selective ablation of DMH LepR neurons or SCN LepR innervation abolishes the entrainment-accelerating effect of systemic leptin elevation in an animal model; in humans, a timed metabolic challenge against a light pulse measurably alters phase-shift magnitude. *Consequence:* if the coupling holds in humans, it expands the toolbox for re-stabilising ME/CFS sleep-wake timing beyond light and melatonin — but it is a single unreplicated preclinical lead, the lever is non-phasic, and it is untested in the ME/CFS circadian system. (ch10 sec-06: @spec:metabolic-circadian-entrainment; evidence animal-model, raw cert 0.55–0.75 discounted to 0.28–0.38, set at 0.30; translation gap animal→human; severity unknown; origin: literature integration.)],[Phase 3 / 0.30],

  [oq leptin-therapeutic-direction], [Open question: whether raising leptin could ever aid ME/CFS circadian disruption, or whether that direction is wrong. ME/CFS-specific data caution against it: circulating leptin is elevated in ME/CFS (@Domingo2024BiomarkersMECFSLC) or unremarkable (@Cleare2001PlasmaLeptinCFS), light rather than metabolic signalling is the dominant circadian lever (@Cambras2026LightExposureMECFS), and even direct circadian interventions (melatonin, phototherapy) produced no CFS symptom benefit (@williams2002therapy). *Consequence:* treat the metabolic-circadian coupling as a research/diagnostic direction, not a treatment target — the existing data point toward light and scheduling, and away from elevating an already-elevated or normal hormone. (ch10 sec-06: @oq:leptin-therapeutic-direction; severity unknown; origin: literature integration.)],[Phase 3 / n/a],

  [oq leptin-timing-amplitude], [Open question: whether ME/CFS leptin is altered in circadian timing/amplitude rather than amount — a reconciliation of the Cleare (@Cleare2001PlasmaLeptinCFS) and Domingo (@Domingo2024BiomarkersMECFSLC) readings, which point numerically the same way (higher in CFS) and are single-timepoint snapshots of a circadian hormone. A 24-hour serial profile (phase-referenced to DLMO) would reveal phase-shift/flattening even where spot means are indistinguishable. *Falsifiability:* serial profiling shows a normal rhythm within a pre-specified effect-size margin (amplitude ratio ≥1.5-fold or phase offset ≥2 h) — falsifies timing hypothesis; confirms flattening/phase-shift beyond the threshold — supports it. *Consequence:* if confirmed, the relevant ME/CFS variable may be when-not-how-much, giving a feasible measurement protocol — but it is a research hypothesis with no current clinical application. (ch10 sec-06: @oq:leptin-timing-amplitude; severity unknown; origin: brainstorm.)],[Phase 5 / 0.15],
)

= Entries added 2026-08-17: Brain Microstructure & Neurochemicals in Long COVID / Recovered COVID (Thapaliya 2025)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq t1w-t2w-myelin-substrate], [Open question: whether the elevated T1w/T2w myelin-signal seen in long COVID and recovered-COVID brains reflects remyelination, neuroinflammatory gliosis, or iron/water content changes. A multimodal MRI study (n=47: 19 long COVID, 12 COVID-recovered, 16 never-infected) found altered T1w/T2w signal across all three group comparisons (long COVID > controls in precentral/middle temporal gyrus; recovered > long COVID in pons/midbrain/cerebellar tonsil/SLF; recovered > controls in precentral/posterior cingulate), correlating with physical (r=0.56) and cognitive (r=-0.64) function @Thapaliya2025BrainMRI; the authors read it as possible remyelination but concede it "may also indicate inflammation or gliosis." *Falsifiability:* a study combining T1w/T2w with myelin-water-fraction or quantitative-susceptibility mapping in the same cohort resolves whether the signal tracks myelin, gliosis, or iron. *Consequence:* whether the scan reflects healing (remyelination) or ongoing damage (inflammation/gliosis) changes what the finding means clinically — but the substrate is currently unresolved. (ch09 sec-01: @oq:t1w-t2w-myelin-substrate; evidence Thapaliya 2025, cert n/a; severity unknown; origin: literature integration.)],[Phase 3 / n/a],

  [spec multimodal-mri-biomarker], [Hypothesis: a multimodal MRI panel (T1w/T2w myelin-signal + DTI microstructure + MRS neurochemistry) is a candidate research-stage biomarker for post-infectious brain involvement, discriminating long COVID / recovered COVID / never-infected and correlating with physical and cognitive function @Thapaliya2025BrainMRI, supported by independent-lab microstructural findings in ME/CFS and post-COVID (cingulum FA at 85% diagnostic accuracy @Wu2026Cingulum; diffusion-NII edema/infiltration in ME/CFS @Yu2026diffusion-neuroinflammation; post-COVID DWI review @Jahanshahi2026). *Falsifiability:* multi-site harmonised replication failing to reproduce a stable multimodal signature, or the signal tracking non-specific factors (age, deconditioning, mood) as strongly as post-infectious status, falsifies the claim. *Consequence:* if validated, it gives an objective non-invasive way to detect and track brain involvement — but it is a research tool, not a clinical test today. (ch36 sec: @spec:multimodal-mri-biomarker; evidence Thapaliya 2025 0.47 discounted→0.40 + Wu 0.70 + Yu 0.65; severity unknown; origin: literature integration.)],[Phase 3 / 0.40],

  [spec postinfectious-bidirectional-microstructure], [Hypothesis: two cross-disease observations from post-infectious neuroimaging cohere — (1) a shared brainstem–cerebellar–thalamic–cingulate limbic-cortical vulnerability circuit (recurring regions: pons, midbrain, cerebellar tonsil, SLF, cingulum @Thapaliya2025BrainMRI @Thapaliya2021DTI @Wu2026Cingulum), and (2) a bidirectional diffusion-microstructure signature (elevated FA/restricted diffusion = remyelination/repair; reduced FA/elevated diffusivity = demyelination/edema/injury) that reframes the "inconsistent findings" complaint as a predictable damage-to-repair continuum @Maksoud2020Neuro @Yu2026diffusion-neuroinflammation @Lu2020Micro. *Falsifiability:* circuit-specificity fails if alteration is no stronger in this circuit than control tracts; bidirectional synthesis fails if diffusion direction is random with respect to recovery state. *Consequence:* focuses imaging on a shared circuit and on measuring the damage-vs-repair balance rather than arguing over direction — a research-direction change, not clinical. (ch14d: @spec:postinfectious-bidirectional-microstructure; cert 0.28; severity unknown; origin: brainstorm.)],[Phase 5 / 0.28],
)

= Entries added 2026-08-18: LDN Fibromyalgia — Secondary-Outcome Responder Evidence & Meta-Analysis Divergence

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq ldn-fm-pain-meta-divergence], [Open question: whether low-dose naltrexone improves pain in fibromyalgia, given divergent meta-analyses — a 2025 meta-analysis found no between-group superiority vs placebo (@Ologunowa2025LDNFMMeta) while a 2024 meta-analysis reported significant pain reduction (MD −0.86) and higher pressure pain threshold (@Vatvani2024LDNFMMetaTSA); the discrepancy reflects differing trial sets and methods, the positive analysis carries an erratum, and the certainty difference (0.56 vs 0.52 discounted) is within measurement uncertainty so neither is weighted. Secondary-outcome 30%-responder analysis of the FINAL trial was null on all six non-pain outcomes @Nielsen2026LDNFMResponder, leaning toward the null meta-analysis, but the pain-specific question remains open. *Falsifiability:* a pre-registered pooled responder analysis of LDN in fibromyalgia demonstrating a significant ≥30% pain-responder advantage over placebo would resolve the conflict toward the positive meta-analysis; conversely, a pooled responder analysis finding no ≥30% advantage (or equivalence) would resolve it toward the null meta-analysis. *Consequence:* clinicians cannot rely on a consistent evidence verdict for LDN in fibromyalgia pain, so expectations should be modest and uncertain. (ch31: @oq:ldn-fm-pain-meta-divergence; severity unknown; origin: literature integration.)],[Phase 3 / n/a],

  [spec ldn-tlr4-occupancy-gap], [Speculation: the null fibromyalgia LDN responder results may be mechanistically *expected* because clinical-dose LDN never reaches meaningful TLR4 occupancy. (+)-naltrexone is a weak TLR4 antagonist; the optimized derivative CIAC101 required ~6200× potency gain to reach nanomolar TLR4 antagonism (@Gao2025CIAC101TLR4). Clinical LDN is racemic at 4.5–6 mg, so the TLR4-blocking species may need concentrations orders of magnitude above achieved levels — a dose-to-target translation failure, meaning the TLR4 rationale was never actually tested at clinical dose. Consistent with the alternative OGFr/enkephalin-rebound mechanism (@Zagon2018OGFrBlockade) that may require longer duration or a fatigue-specific subtype @Nielsen2026LDNFMResponder. *Falsifiability:* a dose-occupancy study showing clinical-dose LDN achieves below 10% TLR4 occupancy (no downstream NF-κB suppression) in patient PBMCs supports the below-threshold reading; measurable TLR4 antagonism at these doses falsifies it. *Consequence:* the FM null does not disprove the TLR4/microglial rationale — it may mean the dose never reached the target, shifting research from "does the mechanism work" to "was it ever tested at an engaging dose." (ch31: @spec:ldn-tlr4-occupancy-gap; cert 0.30; severity unknown; origin: brainstorm.)],[Phase 5 / 0.30],
)

= Entries added 2026-08-19: Gastroparesis and Delayed Gastric Emptying in ME/CFS

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [cf gastroparesis-delayed-emptying-mecfs], [Clinical finding: delayed gastric emptying is a documented, measurable feature of chronic fatigue syndrome — a controlled radionuclide study found delayed liquid emptying in 23/32 (72%) and delayed solid emptying in 12/32 (38%) with the delay significantly correlated with symptom severity (p $<$ 0.001) @Burnet2004GastricEmptyingCFS. Direct ME/CFS evidence (raw certainty 0.60, no population discount); not yet replicated in a modern-IOM/ICC-criteria cohort. *Falsifiability:* a modern-criteria ME/CFS cohort showing no difference in scintigraphic gastric emptying versus matched controls would weaken this finding; replication of the delay would confirm it. *Consequence:* stomach emptying delay is a real, testable problem in ME/CFS, so it can be assessed with a standard gastric-emptying test rather than dismissed as a vague symptom. (ch04: @cf:gastroparesis-delayed-emptying-mecfs; cert 0.60; severity not stratified; origin: literature integration.)],[Phase 3 / 0.60],

  [oq gastroparesis-enteric-icc-loss-mecfs], [Open question: whether ME/CFS gastroparesis shares the structural enteric-neuron and interstitial-cell-of-Cajal (pacemaker-cell) loss documented in diabetic and idiopathic gastroparesis. Human antral tissue shows ICC and enteric-nerve loss in diabetic/idiopathic gastroparesis @Grover2011CellularChangesGastroparesis, and an animal model confirms cell/nerve loss accompanies slowed emptying @Wang2009ICCLossDiabetes; no ME/CFS gastric histology exists, so the ME/CFS form could be functional vagal failure, autoimmune ganglionic blockade, or structural degeneration. *Falsifiability:* normal ICC and enteric-nerve density in ME/CFS gastric specimens with documented gastroparesis would falsify the structural-shared-pathology reading; evidence of cell/nerve loss would support it. *Consequence:* if ME/CFS gastroparesis involves structural pacemaker-cell loss, prokinetics that stimulate surviving nerves would have limits and treatment would need to target cell-loss prevention or replacement. (ch04: @oq:gastroparesis-enteric-icc-loss-mecfs; cert 0.40; severity unknown; origin: literature integration.)],[Phase 3 / 0.40],

  [spec gastroparesis-autoimmune-ganglionic-blockade], [Speculation: a subset of ME/CFS gastroparesis could reflect autoimmune ganglionic (α3 nicotinic acetylcholine-receptor) blockade — modeled on a post-SARS-CoV-2 autoimmune GI dysmotility case that responded to immunotherapy @Montalvo2022LongCovidGIDysmotility — a potentially reversible mechanism distinct from structural nerve loss. Speculative for ME/CFS: no ME/CFS cohort has been screened for ganglionic AChR antibodies; the autoimmune GI dysmotility literature in ME/CFS is a single post-viral case. *Falsifiability:* measuring ganglionic AChR antibodies in ME/CFS patients with documented gastroparesis — a meaningful antibody-positive subset whose emptying improves with immunotherapy would support the claim; titers that do not track emptying delay or immunotherapy response would falsify it. *Consequence:* a reversible autoimmune subset of ME/CFS gastroparesis would have a real immunotherapy treatment path, testable with an existing blood antibody panel. (ch04: @spec:gastroparesis-autoimmune-ganglionic-blockade; cert 0.30; severity unknown; origin: brainstorm.)],[Phase 5 / 0.30],

  [lim gastroparesis-evidence-anchor-and-alternatives], [Limitation: the direct ME/CFS gastroparesis evidence rests on a single 2004 cohort (n=32) predating modern diagnostic criteria @Burnet2004GastricEmptyingCFS with one n=1 null @Corrado1998NormalGastricEmptying and no modern-IOM/ICC replication; non-specific alternatives (medication side-effects, functional dyspepsia/visceral hypersensitivity @Debourdeau2024GastricVolumetry, deconditioning, reporting bias) could produce the same pattern without a distinct ME/CFS lesion, and cross-disease histology @Grover2011CellularChangesGastroparesis @Wang2009ICCLossDiabetes is population-discounted. *Consequence:* clinicians should exclude the common non-specific causes (drug effects, dyspepsia) with objective testing before attributing symptoms to a ME/CFS-specific emptying defect. (ch04: @lim:gastroparesis-evidence-anchor-and-alternatives; severity across all; origin: literature integration.)],[Phase 5 / n/a],
)

= Entries added 2026-08-19: Adult-Onset ADHD — Consensus Update Past Moffitt 2015

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq adult-onset-adhd-mix-status], [Open question: whether the "adult-onset ADHD is a distinct syndrome" reading (from the Dunedin birth cohort @Moffitt2015adhdadult) still holds. Evidence to date favors a mix, but the question remains open: repeated comprehensive assessments of an MTA comparison cohort (n=239, ages 10 to 25) excluded roughly 95% of those who screened positive on careful assessment, with the remainder adolescent-onset or explained by substance use or comorbidity @Sibley2018lateonsetADHD; a dedicated review concluded most late-onset cases develop between ages 12--16, rarely without childhood precursors, while cautioning the data cannot yet clarify whether early and late onset share underlying neural mechanisms @Asherson2019lateonsetADHD; and retrospective recall of childhood ADHD symptoms is unreliable (accuracy about 55%) @Breda2020adhdrecall. The strongest reading is that much apparent adult onset is adolescent-onset or missed childhood ADHD, so the acquired-catecholamine interpretation applies, if at all, to a narrow residual subset — but the evidence base is a small US comparison cohort plus a self-referential research cluster, not settled consensus, so the question is open. *Falsifiability:* a prospective cohort with repeated childhood assessments that confirmed a substantial de novo (no childhood precursors, no substance use) adult-onset ADHD group would partially revive the distinct-syndrome reading; current MTA-derived evidence weighs against it but does not settle it. *Consequence:* for the ADHD–ME/CFS framing, ADHD is best treated as a largely childhood/adolescent-onset predisposing trait; the shared-metabolic-reserve hypothesis applies most strongly to childhood/adolescent-onset ADHD. (ch14d @sec:architecture-c-metabolic-reserve; cert 0.47 — discounted from Sibley2018 0.65, Asherson2019 0.62, Breda2020 0.58 each ×0.75 cross-disease weight; severity unknown; origin: literature integration.)],[Phase 2 / 0.47],

  [hyp adhd-nrf2-pathway-measured], [Hypothesis (updated claim): NRF2 pathway activity in ADHD has now been measured once — a 2026 cross-sectional study of 60 adults with ADHD versus 60 controls found serum NRF2 and HO-1 protein significantly reduced in ADHD and negatively correlated with symptom severity (all p $<$ 0.001; ROC AUC 0.756 for NRF2, 0.797 for HO-1) @Gurbuzer2026nrf2adhd. This replaces the earlier "no study has measured NRF2 in ADHD" claim and is consistent with — but does not prove — the dopamine-NRF2-NLRP3 axis: it measured circulating serum protein, not NRF2 nuclear translocation or NQO1 target-gene expression, and covers adult ADHD only in a single unreplicated study. *Falsifiability:* an ADHD PBMC study showing no difference in NRF2 nuclear translocation or NQO1 expression between ADHD and controls would weaken the axis claim; replication of reduced NRF2 in a second independent ADHD cohort would strengthen it. *Consequence:* a measurable (if preliminary) NRF2 deficit in ADHD adds plausibility to the dopamine-NRF2-NLRP3 axis, and suggests serum NRF2/HO-1 as a candidate exploratory biomarker — but because the measurement was serum protein, not NRF2 nuclear translocation or NQO1 expression, it does not yet establish which NRF2-dependent endpoint an intervention should target. (ch14d sec:x1-adhd-nrf2-nlrp3: @spec:adhd-dopamine-nrf2-nlrp3-xdisease; cert 0.41; adult-only, severity unknown; origin: literature integration.)],[Phase 3 / 0.41],
)

= Entries added 2026-08-20: Long Covid–AD(H)D Neuroimmune Framework (Spanoghe 2026)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq lc-adhd-acquired-causal], [Open question: whether SARS-CoV-2 infection acquires new-onset AD(H)D or merely reveals preexisting neurodivergence. A translational viewpoint proposes a bidirectional Long Covid–AD(H)D link via convergent neuroimmune dysfunction (frontal-striatal-hippocampal circuits, catecholamine neuroimmune dysregulation, tryptophan-kynurenine overactivation, mitochondrial bioenergetic defects) and an acquired, infection-triggered neuroimmune-mediated dopaminergic/noradrenergic dysfunction @Spanoghe2026LongCovidADHD. The causal claim is unresolved: post-COVID ADHD symptom onset is reported and stimulant prescribing rose post-COVID @Koonce2024LongCovidStimulant @Gimbach2024ADHDMedicationEurope, with AD(H)D as a risk factor for Long Covid @Merzon2022LongCovidADHDYouth; but a 20-year national cohort found no independent COVID effect on AD(H)D diagnosis/treatment rates @Zemer2024COVIDADHD20Year, and the prescribing rise is consistent with catch-up diagnosis @Gimbach2024ADHDMedicationEurope. Because the certainty gap between the strongest null (0.70 raw) and the positive epidemiology is ≤0.15, both sides are presented without weighting. *Falsifiability:* a prospective post-infectious cohort with validated AD(H)D scales plus an executive/immune-biomarker profile at enrollment and longitudinally would distinguish de novo onset from unmasking of preexisting traits; reliance on retrospective diagnosis or prescription records cannot settle it. *Consequence:* determines whether post-viral attention difficulties are interpreted as newly acquired brain dysfunction requiring investigation or as unmasked preexisting neurodivergence — changing clinical interpretation and management while not altering the need to address the symptoms. (ch14d @spec:lc-adhd-neuroimmune-shared-substrate; cert 0.40; severity unknown; origin: literature integration.)],[Phase 2 / 0.40],

  [hyp lc-adhd-neuroimmune-shared-substrate], [Hypothesis: a shared neuroimmune substrate links Long Covid, AD(H)D, and ME/CFS executive dysfunction — specifically kynurenine-pathway overactivation disrupting dopamine/noradrenaline transmission and intersecting mitochondrial bioenergetics @Spanoghe2026LongCovidADHD. Direct human evidence: kynurenine-pathway activation correlates with post-acute COVID cognitive impairment @Cysique2023KynureninePASC; kynurenic acid lowers striatal dopamine at nanomolar concentrations in animals @Rassoulpour2005KynurenicAcid; kynurenine intersects mitochondrial function @Tanaka2022MitoKynurenine and mitochondrial complex suppression accompanies COVID cognitive decline @Xu2025MitoComplexesADHD; dopamine is immunomodulatory @Sarkar2010DopamineImmunoreg @Feng2021DopamineImmunomodulatory. Precision-immunopsychiatry (immune/neurocognitive endophenotype stratification) and off-label AD(H)D-targeted pharmacotherapy in Long Covid are proposed, with autonomic dysregulation and PEM as limiting factors @Krishnan2022BrainFogMultidisciplinary @FesharakiZadeh2023Guanfacine @Spanoghe2026LongCovidADHD. *Falsifiability:* in ME/CFS patients with executive dysfunction, plasma KYN/TRP ratio will correlate positively with objective executive deficit and negatively with a dopaminergic-function proxy, persisting after controlling for fatigue severity; falsified if KYN/TRP does not track executive dysfunction independent of overall fatigue. *Consequence:* provides a mechanism-specific target (kynurenine-to-dopamine signaling) and a caution that AD(H)D-type medication for cognitive symptoms is observational only, not a validated ME/CFS treatment. (ch14d @spec:lc-adhd-neuroimmune-shared-substrate; cert 0.35; severity unknown; origin: literature integration.)],[Phase 2 / 0.35],

  [hyp mito-kynurenine-nad-sink], [Hypothesis: the kynurenine and mitochondrial arms of the LC-AD(H)D framework converge on a single prefrontal bioenergetic bottleneck — chronic kynurenine-pathway activation draws down the NAD#super[+] pool that mitochondria require, so the energetically expensive prefrontal cortex shows the first ATP deficit, producing the shared executive/inattentive phenotype. Kynurenine-pathway overactivation diverts tryptophan toward the kynurenine-NAD#super[+] catabolic arm @Cysique2023KynureninePASC; mitochondrial complex suppression accompanies COVID cognitive decline @Xu2025MitoComplexesADHD; the kynurenine pathway intersects mitochondrial function @Tanaka2022MitoKynurenine. Unifies mechanisms (3) and (4) of the Spanoghe framework into one molecular mechanism @Spanoghe2026LongCovidADHD. *Falsifiability:* in ME/CFS patients with executive dysfunction, prefrontal ATP/phosphocreatine (MRS) will correlate inversely with kynurenine-pathway load and executive-deficit severity, independent of general fatigue; falsified if prefrontal bioenergetic markers do not track kynurenine-pathway load after controlling for fatigue. *Consequence:* gives a single druggable target (kynurenine-to-NAD#super[+] balance) behind the separate kynurenine and mitochondrial hypotheses, and suggests shifting the pathway away from the NAD#super[+]-consuming arm might preserve prefrontal energetics. (ch14d @spec:mito-kynurenine-nad-sink; cert 0.40; severity unknown; origin: brainstorm idea 1.4.)],[Phase 2 / 0.40],
)

= Entries added 2026-08-21: Depression–Adult Hippocampal Neurogenesis

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq depression-neurogenesis-stall-mechanism], [Open question: whether adult human hippocampal neurogenesis stalls in major depressive disorder. A single-cell + spatial + proteomic atlas of ~500,000 hippocampal nuclei reported a stalled neurogenic lineage in MDD (more quiescent neural stem cells, fewer neuroblasts, reduced DCX/BDNF, elevated interferon and stress signaling) and argued for molecular reclassification of depression @Peng2026NeurogenesisNatureMed. The premise that adult human hippocampal neurogenesis persists at a measureable level is directly contested: one group reports persistence into the ninth decade @Boldrini2018NeurogenesisAging @Boldrini2019ResilienceDentate, building on the foundational BrdU demonstration @Eriksson1998Neurogenesis; the opposing group concludes very few, if any, new neurons are born in the adult human hippocampus @Sorrells2018NeurogenesisDrops @Sorrells2021PositiveControls. The certainty gap between the strongest positive (0.80) and strongest null (0.68) is ~0.12, within the ±0.10 band — both sides are presented without weighting. *Falsifiability:* a pre-registered multi-method (single-nucleus RNA + multiple antibody markers) post-mortem study in independent cohorts that either reproduces the MDD neurogenesis stall or demonstrates undetectable neurogenesis at any adult age would settle the controversy; agreement between methods is required to exclude fixation/antibody artifacts. *Consequence:* determines whether stalled hippocampal neurogenesis can serve as a molecular feature of primary depression at all — if the underlying process is not reproducibly measureable in adults, it cannot be used to distinguish depression from ME/CFS or to guide any intervention. (ch04 @oq:is-molecular-depression-distinct; ch16 @spec:molecular-reclassification-depression-mecfs-boundary; cert 0.40 — controversy unresolved, both sides discounted; severity unknown; origin: literature integration.)],[Phase 2 / 0.40],

  [spec postinfectious-neurogenesis-suppression-mecfs], [Speculation: a post-infectious or HPA-axis process could suppress adult hippocampal neurogenesis in ME/CFS, paralleling the depression-axis finding. Mechanism bridges are indirect: (a) HPA-axis dysfunction is documented in CFS @Papadopoulos2011HPAaxis and adult hippocampal neurogenesis buffers stress/HPA negative feedback in animal models @Snyder2011BuffersStress; (b) mild SARS-CoV-2 infection suppresses hippocampal neurogenesis and oligodendrogenesis via microglial reactivity and elevated CCL11, linked to cognitive symptoms in long COVID @FernandezCastaneda2022MildCOVID. There are zero direct studies of adult hippocampal neurogenesis in ME/CFS — the extrapolation is unsupported by direct data and additionally contingent on the unresolved adult-human-neurogenesis controversy @Sorrells2018NeurogenesisDrops @Sorrells2021PositiveControls. *Falsifiability:* direct measurement of dentate-gyrus neurogenic markers (DCX, nestin, Ki67) in ME/CFS post-mortem or surgical hippocampal tissue showing density comparable to controls would falsify suppression; a replicated reduction below matched controls would support it — but no such ME/CFS tissue study exists. *Consequence:* if replicated, a neurogenesis deficit could link the post-infectious onset of ME/CFS to a measurable hippocampal consequence and eventually offer a target — but current evidence is too thin for any clinical or diagnostic use. (ch16 @spec:molecular-reclassification-depression-mecfs-boundary; cert 0.30 — indirect links only, zero direct ME/CFS data; severity unknown; origin: literature integration.)],[Phase 3 / 0.30],
)

= Entries added 2026-08-22: Angelman Syndrome (UBE3A) Cross-Disease Speculation

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec angelman-ube3a-cross-disease], [Speculation: Angelman syndrome (UBE3A/E6AP E3 ubiquitin-ligase loss) may model ME/CFS-relevant bioenergetic and GABAergic vulnerability. Ube3a loss impairs mitochondrial oxidative phosphorylation and lowers neuronal ATP in a mouse model @Su2011UBE3Amitochondria; in silico work links UBE3A-dependent mitochondrial transcripts to energy metabolism @Panov2020Ube3aMito; AS models show elevated reactive-oxygen species @Simchi2023ROS and reduced tonic GABAergic (GABA-A) inhibition @Watanabe2026TonicInhibition, alongside fragmented sleep @Qu2024SleepAS — each domain independently proposed in ME/CFS @Le2025ATF4Mitochondria @Shankar2025oxidativestress @Davis2025nrf2lipid @WirthScheibenbogen2026glutamate @Liu2025geneticFatigueActigraphy. No direct AS–ME/CFS co-occurrence or mechanistic link exists (0 PubMed hits), so this is hypothesis-generating, not established shared pathophysiology, and two structural disanalogies limit extrapolation: AS is congenital/monogenic/neurodevelopmental while ME/CFS is adult-onset/polygenic, and UBE3A dosage sensitivity (loss and duplication both yield overlapping outcomes) limits specificity @Kurmashev2026UBE3Adosage. *Falsifiability:* if the analogy holds, ME/CFS should show impaired mitochondrial oxidative phosphorylation/ATP and reduced tonic GABA-A inhibition consistent with the AS-like phenotype regardless of acquired-vs-genetic origin; UBE3A-pathway variant enrichment is an optional corroborating (not falsifying) test, since an acquired deficit would show pathway pathology without genetic enrichment. Where such carriers are identified, iPSC-derived neurons should recapitulate the reduced tonic inhibition and lower ATP seen in AS models, though an iPSC null is non-decisive given technical recapitulation limits. *Consequence:* a research hypothesis only — no current clinical or diagnostic application; if it holds, it points toward UBE3A/ubiquitin-pathway and GABAergic tonic-inhibition circuits as a shared vulnerability underlying energy and brain-fog symptoms, giving a concrete biochemical test. (ch14d @spec:angelman-ube3a-cross-disease; cert 0.20 — cross-disease analogy, animal/in-silico/overview evidence discounted for non-ME/CFS population and developmental stage; severity unknown; origin: literature integration.)],[Phase 5 / 0.20],
)

= Entries added 2026-08-22: Guanfacine + NAC Inter-Cluster Bridge

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec guanfacine-nac-bridge], [Speculation: low-dose guanfacine (PFC-selective α2A-adrenoceptor agonism) plus N-acetylcysteine (Nrf2 antioxidant) as an inter-cluster bridge spanning the ch15 catecholamine cluster and Nrf2 cluster — a deliberate fixed combination, distinct from either single agent. Reported as open-label intervention for cognitive deficits in Long COVID @FesharakiZadeh2023Guanfacine and TBI @Khasnavis2024GuanfacineNACTBI @FesharakiZadeh2025GuanfacineNACDonepezil. Mechanistic rationale is parallel non-overlapping targets (PFC α2A signaling + glutathione/Nrf2 redox support @Cherneva2025NACCNS); no direct α2A→Nrf2 molecular cross-talk is established (0 PubMed hits). Zero ME/CFS data; open-label case series only. *Falsifiability:* in ME/CFS with documented oxidative stress and PFC-dependent cognitive deficits, guanfacine+NAC improves n-back/Stroop more than either alone at 8 weeks; falsified if no added benefit over monotherapy, or if augmentation is oxidative-burden-independent, or if orthostatic intolerance exceeds guanfacine monotherapy @Okamoto2024GuanfacineHyperPOTS. *Consequence:* hypothesis-generating — if confirmed, gives a tolerability-favorable combination targeting both the prefrontal noradrenergic deficit and oxidative stress implicated in ME/CFS brain fog; not a current treatment. (ch15 @spec:guanfacine-nac-bridge @clinical-finding:guanfacine-nac-postinfectious; cert 0.30; severity unknown; origin: literature integration + user-directed.)],[Phase 2 / 0.30],
)

= Entries added 2026-08-22: Saffron (Crocus sativus) — Unproven Serotonergic-Kynurenine Modulator

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec saffron-serotonergic-kynurenine-modulator], [Speculation: saffron bioactives (crocin, safranal, crocetin) inhibit SERT at the fluoxetine binding site (human ex vivo @Wauquier2022SaffronSERT; animal @Mohammadi2023SaffronSERT) and inhibit MAO-A/B (in vitro @DeMonte2014SafranalMAO), reduce serum kynurenine and raise melatonin (rodent @DeLaFuenteMunoz2023AffronKynurenine), downregulate neurotoxic kynurenine components (murine @MonchauxDeOliveira2026SaffronBioactives), and shift gut-microbial tryptophan toward tryptamine and indole-acetic acid (ex vivo @Horvath2026SaffronMicrobiomeTryptophan). Zero primary-ME/CFS trials; a null RCT on fatigue in healthy subclinical-depression adults @Amadieu2025SaffronNullMood; fatigue RCTs are only comorbid-secondary (COPD @Dastan2025SaffronCFS; sarcoidosis @MoghimiDehkordi2026SaffronSarcoidosis) or cross-disease (Parkinson's @Hajhashemy2026SaffronPD). Combined SERT + MAO inhibition carries serotonin-syndrome risk with SSRIs/SNRIs/MAOIs @Cauus2026HerbalSafety, directly relevant to the SSRI-paradox (hyper-serotonergic) model in which serotonergic agents may worsen ME/CFS. High-dose saffron has uterine-stimulation risk in pregnancy @Alshdefat2026SaffronPregnancy. *Falsifiability:* if the hyper-serotonergic model holds, saffron worsens fatigue in ME/CFS (reverse of its reported comorbid-fatigue benefit) and should be avoided with serotonergic antidepressants; falsified if saffron improves ME/CFS fatigue in a primary-ME/CFS RCT despite SERT inhibition. *Consequence:* do not recommend saffron for ME/CFS fatigue or mood; treat it as an unproven, potentially-worsening serotonergic agent that also touches the kynurenine and gut-tryptophan axes. (ch18 @spec:saffron-serotonergic-kynurenine-modulator; cert 0.20; severity unknown; origin: literature integration — external-contact proposal.)],[Phase 2 / 0.20],
)

= Entries added 2026-08-22: AhR-Tryptophan-Gut-Microbiome Axis

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [hyp ahr-gut-microbiome-axis], [Hypothesis: the aryl-hydrocarbon receptor (AhR), a ligand-activated transcription factor sensing gut-microbial tryptophan and indole metabolites (indole-3-acetic acid, indole-3-propionic acid, indole-3-aldehyde, tryptamine) and kynurenine-pathway metabolites, is an altered gut-microbiome–immune axis in ME/CFS. AhR activation drives IL-22-producing ILC3 and gamma-delta T cells and reinforces the intestinal barrier while restraining Th17 inflammation @Rothhammer2019AhRImmunity @Thirugnanam2026DietaryIndolesAhR. Direct ME/CFS evidence found altered stool AhR-agonist activity that was elevated specifically in the neurocognitive-symptom subgroup rather than uniformly @Esteban2026AhRGutMicrobiome, with supporting comorbid IBS+CFS urinary tryptophan-metabolite data @Chojnacki2025IBSCFSTryptophan. The mechanism extends (not replaces) the already-integrated kynurenine pathway, since kynurenine metabolites are themselves AhR ligands @TorrelliDiljohn2026TryptophanSignaling. *Falsifiability:* ME/CFS patients with neurocognitive symptoms should show elevated stool/plasma AhR-agonist activity and altered indole metabolites vs cognitively-unaffected ME/CFS and healthy controls, correlating with cognitive performance and barrier markers; falsified if the association does not track the neurocognitive subgroup or fails to correlate with barrier/immune readouts. *Consequence:* if confirmed, gut-microbial tryptophan metabolism and AhR signaling become a shared upstream mechanism linking intestinal and cognitive features of ME/CFS, pointing toward dietary/microbial restoration of a neuroprotective (transient) AhR ligand balance — no intervention established for ME/CFS today. (ch12 @hyp:ahr-gut-microbiome-axis @ach:esteban2026-ahr-neurocognitive @lim:ahr-evidence-subgroup-specific; cert 0.40; severity unknown — anchor not stratified; origin: literature integration — external-contact proposal, pre-identified gap.)],[Phase 2 / 0.40],
)

= Entries added 2026-08-22: Fibromyalgia Genetics (Kerrebijn 2026 GWAS)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [hyp fibromyalgia-cns-shared-genetic-vulnerability], [Hypothesis: fibromyalgia shows brain/neural-enriched genetic architecture, and its co-occurrence with ME/CFS may reflect a partially shared central genetic vulnerability. The largest fibromyalgia GWAS (Kerrebijn 2026, _Nature Medicine_, 2.56M individuals, 54,629 cases) identified 26 risk loci (strongest: coding variant in _HTT_, plus _GPR52_, _DCC_, _DRD2/NCAM1_, _MDGA2_, _CELF4_) and found heritability exclusively enriched in brain tissues and neural cell types, with no immune/glial enrichment — consistent with, not proof of, a central-nervous-system (nociplastic) role @Kerrebijn2026FibromyalgiaGWAS. This parallels the brain-enriched architecture independently established for ME/CFS by DecodeME @DecodeME2025 and the Maccallini meta-GWAS @Maccallini2026metaGWAS. Confirmed shared risk regions are _OLFM4_ and _RABGAP1L_ (_DCC_ in the earlier overlap); _GPR52_/_HTT_ are fibromyalgia-risk genes whose presence in ME/CFS is untested. *Falsifiability:* a cross-trait GWAS/PRS analysis between fibromyalgia and ME/CFS will show significant genetic correlation and shared brain-enriched heritability; fibromyalgia PRS will be elevated in ME/CFS patients with comorbid fibromyalgia; whether _HTT_/_GPR52_ appear in ME/CFS GWAS is a testable prerequisite; falsified if the two conditions show near-zero genetic correlation or divergent enrichment patterns. *Consequence:* if confirmed, a shared central genetic vulnerability would make central-sensitization mechanisms a research priority to test across both conditions — but the direct genetic correlation remains to be measured, so no clinical change follows from the genetics alone. (ch14 @ach:kerrebijn-fibromyalgia-gwas @hyp:fibromyalgia-cns-shared-genetic-vulnerability; cert 0.55; severity unknown — GWAS not stratified by severity; origin: literature integration.)],[Phase 2 / 0.55],

  [hyp shared-transdiagnostic-cns-genetic-factor], [Hypothesis: fibromyalgia shares substantial genetic variance with chronic pain and psychiatric/somatic traits, and ME/CFS shows overlapping genetic correlations (the transdiagnostic CNS-factor interpretation is one candidate formalization, not established). Fibromyalgia showed rg > 0.7 with low back pain, PTSD, and IBS, and pervasive positive genetic correlation with depression, somatoform/dissociative disorders, and migraine @Kerrebijn2026FibromyalgiaGWAS; GenomicSEM analyses report a shared nociplastic-pain heritable factor @Johnston2025NociplasticPain and a shared latent genetic liability across fibromyalgia-psychiatric traits @Lin2026FibromyalgiaPsychiatric. ME/CFS already shows high genetic correlation with IBS (rg 0.75) and depression (rg 0.60) @DecodeME2025. *Falsifiability:* a transdiagnostic genomic-SEM factor across these conditions will show significant heritability and shared neural cell-type enrichment, and nociplastic-pain PRS will predict severity across ME/CFS, fibromyalgia, and IBS cohorts; falsified if the shared factor explains negligible variance, if enrichment is condition-specific, or if correlations are attributable to population structure. *Consequence:* high pairwise genetic correlation across fibromyalgia, ME/CFS, IBS, and chronic pain is a real finding that argues for shared genetic underpinnings, but a single central-sensitization mechanism is unproven and transdiagnostic treatment strategies remain a hypothesis to test. (ch14 @hyp:shared-transdiagnostic-cns-genetic-factor; cert 0.42; severity unknown; origin: literature integration.)],[Phase 2 / 0.42],

  [hyp shared-central-genetic-architecture-fibro-mecfs], [Hypothesis: the ME/CFS-fibromyalgia comorbidity may be underlain by a shared central (brain/neural) genetic architecture. Both conditions independently show brain/neural-cell-type heritability enrichment (fibromyalgia: @Kerrebijn2026FibromyalgiaGWAS; ME/CFS: @DecodeME2025 @Maccallini2026metaGWAS), consistent with — but not proof of — a shared central vulnerability; the co-occurrence figure is inflated by overlapping diagnostic criteria (Wolfe 2016) and the decisive direct fibromyalgia × ME/CFS genetic correlation is untested. This is a cross-reference to the detailed ch14 analysis, not an independent claim. *Falsifiability:* a direct cross-trait genetic-correlation analysis of fibromyalgia and ME/CFS will be significantly positive, and fibromyalgia PRS will be elevated in ME/CFS patients with comorbid fibromyalgia; falsified if the two conditions show near-zero genetic correlation despite clinical overlap. *Consequence:* if confirmed, a shared central genetic basis would make central-sensitization mechanisms a research priority to test across both conditions — but genetic architecture does not by itself determine effective treatment, so this is a research direction, not a current management change. (ch04 @hyp:shared-central-genetic-architecture-fibro-mecfs @sec:kerrebijn-fibromyalgia-gwas; cert 0.52; severity unknown; origin: literature integration.)],[Phase 2 / 0.52],

  [hyp fibromyalgia-autoimmune-reconciliation], [Hypothesis: the no-MHC GWAS finding and the passive-IgG autoantibody evidence in fibromyalgia are not contradictory because germline genetic architecture and acquired antibodies are independent layers. The Kerrebijn 2026 GWAS found no MHC signal and no immune/glial heritability enrichment (genetic evidence against a primarily autoimmune/HLA-linked architecture) @Kerrebijn2026FibromyalgiaGWAS, yet passive-transfer evidence shows fibromyalgia/long-COVID IgG reproduces symptoms in mice (acquired humoral autoimmunity) @Goebel2021passiveTransferFM. An absence of HLA-linked germline risk does not rule out acquired pathogenic antibodies; whether a fibromyalgia antibody subset maps onto the non-HLA-linked central-sensitization architecture is a framing device, not an independently tested hypothesis. *Falsifiability:* fibromyalgia patients responding to immunomodulation will cluster in an autoantibody-positive subset without enrichment for the 26 GWAS loci; falsified if the GWAS loci and the autoantibody subset fully overlap (arguing for a unified HLA-linked mechanism). *Consequence:* fibromyalgia need not be forced into an "is/isn't autoimmune" binary — the no-MHC finding and the passive-IgG evidence can both be true because germline genetics and acquired antibodies are separate layers. (ch14 @hyp:fibromyalgia-autoimmune-reconciliation; cert 0.30; severity unknown; origin: literature integration + brainstorm.)],[Phase 2 / 0.30],
)

= Entries added 2026-08-26: Davis 2023 Long COVID Landmark Review

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq lc-trajectory-chronicity], [Open question: post-infectious syndromes (Long COVID) can become self-sustaining rather than resolving — 85% of those symptomatic at 2 months remained symptomatic at 1 year, and cognitive-impairment prevalence *increased* from 16% (2 mo) to 26% (12 mo), with neurological symptoms often delayed in onset and parosmia showing ~3-month onset @Davis2023LongCOVIDmajorfindings. The increasing cognitive trajectory argues that at least a subset of Long COVID converges on an ME/CFS-like chronic state (ME/CFS is generally considered lifelong). This temporal evidence is integrated into ch14d as a counterfactual-validity argument for post-infectious chronicity. *Consequence:* if post-infectious syndromes commonly become self-sustaining or worsen over the first year, this argues for early mechanism-targeted intervention before chronicity locks in — relevant to both Long COVID and post-infectious ME/CFS onset. (ch14d @oq:lc-trajectory-chronicity; cert 0.60; severity unknown; origin: literature integration.)],[Phase 3 / 0.60],

  [oq lc-vaccine-heterogeneity], [Open question: vaccination has heterogeneous effects on established Long COVID symptoms — 16.7% relief, 21.4% worsening, remainder unchanged @Tsuchida2022vaccineLC @Davis2023LongCOVIDmajorfindings, even though vaccination reduces the *risk* of new Long COVID (~15-41% partial protection). The heterogeneous response indicates Long COVID (and by extension ME/CFS) is not a single uniform process; the same intervention can improve or worsen depending on underlying mechanism. *Consequence:* a treatment that helps some post-infectious patients and harms others signals mechanistic heterogeneity, arguing for individualised titration and mechanism-based stratification rather than uniform protocols. (ch14d @oq:lc-vaccine-heterogeneity; cert 0.45; severity unknown; origin: literature integration.)],[Phase 3 / 0.45],

  [oq insufficient-early-antibody-chronicity], [Open question: a low/absent acute SARS-CoV-2 antibody response predicts Long COVID at 6-7 months in both hospitalized and non-hospitalized patients @GarciaAbellan2021antibodyLC @Augustin2021postcovid @Davis2023LongCOVIDmajorfindings, suggesting an *insufficient* adaptive response (not only an overactive one) can gate post-infectious chronicity. Causal direction unestablished — low antibody could be a marker of viral persistence, a severity confound, or genuine immunocompromise. *Consequence:* if a weak early antibody response helps predict who develops a chronic post-infectious illness, it could support early immune-supportive intervention in the acute-to-subacute window, relevant to both Long COVID and post-infectious ME/CFS. (ch08 @oq:insufficient-early-antibody-chronicity; cert 0.55; severity unknown; origin: literature integration.)],[Phase 3 / 0.55],

  [lim seroreversion-control-bias], [Limitation: a substantial proportion of SARS-CoV-2-infected patients never seroconvert or serorevert within months (more commonly in women, children, mild infections) @VanElslande2021seroreversion @Davis2023LongCOVIDmajorfindings, so serology-based control classification misassigns seroreverted symptomatic patients into control groups, biasing comparisons toward null and under-ascertaining post-infectious illness. The same testing-bias risk applies to ME/CFS research whenever serology defines infection exposure. *Consequence:* researchers should not rely on serology alone to assign infection-exposure status; symptom-based and clinically-diagnosed cohorts strengthen validity — a methodological correction transferable to post-infectious ME/CFS study design. (ch08 @lim:seroreversion-control-bias; cert 0.55; severity unknown; origin: literature integration.)],[Phase 3 / 0.55],

  [lim lc-extrapolation-limits], [Limitation: extrapolating Long COVID findings to ME/CFS carries limits that temper the confidence of the overlap argument — (1) the Davis 2023 review is a narrative (not systematic) synthesis with some preprint/small-cohort findings @Davis2023LongCOVIDmajorfindings; (2) Long COVID is mostly studied in the first 1-2 years (acute-to-chronic extrapolation) while ME/CFS is lifelong, and many Long COVID symptoms resolve while ME/CFS persists; (3) the ~50% criteria overlap may partly reflect self-referential symptom criteria rather than shared biology, and the 2-day CPET divergence argues against full mechanistic equivalence; (4) several Long COVID findings derive from overlapping cohorts, inflating apparent certainty. *Consequence:* Long COVID evidence is a strong suggestive bridge and hypothesis source for ME/CFS, not proof of mechanistic identity — direct head-to-head mechanistic and longitudinal studies are still required. (ch14d @lim:lc-extrapolation-limits; cert 0.55; severity unknown; origin: brainstorm critical category.)],[Phase 5 / 0.55],
)
...
#table(
  ...
  [hyp central-motor-drive-cascade], [Hypothesis: the earlier fatigability in ME/CFS reflects a failure to up-regulate central motor drive under sustained effort — a ≥4-step neurophysiological cascade (cortical motor output → corticospinal drive → spinal motoneuron recruitment → neuromuscular transmission → muscle-fiber recruitment → afferent feedback) rather than peripheral muscle exhaustion @Bedard2026centralFatigability. Multimodal neuroimaging (grip force + EMG + EEG + fMRI + corticomuscular coherence) in n=15 ME/CFS vs n=19 controls showed equal maximum voluntary force but earlier fatigue onset, with healthy controls steadily increasing muscle (Dimitrov index) and brain (EEG power, BOLD) activity until fatigue then declining slowly, whereas ME/CFS showed minimal fluctuation — an absent up-regulation of motor-cortical and subcortical output. This is an *association*, not established causation (the authors explicitly disclaim a causal link; only TMS or a drug-intervention study could establish direction). The differential-diagnostic value lies in which central-acting interception drug restores motor-drive up-regulation: dopaminergic/effort-node probes (modafinil/armodafinil @Minzenberg2008modafinil, methylphenidate, amphetamines, bromocriptine/rotigotine) and glutamatergic (amantadine) agents, each targeting a distinct cascade node (see Section @sec:central-motor-drive-cascade). *Falsifiability:* if central motor drive is the bottleneck, ME/CFS patients whose motor-drive up-regulation is restored by a central-acting agent should show later fatigue onset and a normalized Dimitrov-index/EEG/BOLD trajectory on the same grip-force protocol, while peripheral ergogenic aids should not; falsified if a peripheral intervention alone restores performance, or if no central-acting agent alters the motor-drive trajectory. *Consequence:* reframing ME/CFS fatigability as a brain-level failure to drive muscle — rather than a purely peripheral muscle problem — directs research and treatment toward the central nervous system (dopaminergic/effort circuits) and gives a testable drug-response framework, though no drug is recommended on this evidence alone. (ch03 @clf:central-fatigability; ch34 @sec:central-motor-drive-cascade; cert 0.45 — the 0.60 association discounted for its associational (non-causal) design and single small sample; severity unknown — NIH intramural cohort not stratified; origin: literature integration — gap-fill of prior fatigue-cycle ch30-tier NONE.)],[Phase 3 / 0.45],
)

= Entries added 2026-08-29: Quinine Sulfate / Skeletal-Muscle Sodium-Channel Cramp Link

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec muscle-nav14-cramp-mecfs], [Speculation: skeletal-muscle sodium-channel (Nav1.4, _SCN4A_) or potassium-channel (Kv7/KCNQ) dysfunction may contribute to the cramps and myalgia reported in ME/CFS, overlapping the muscle-ion-channel arm of the energy-ratchet model. Primary Nav1.4 dysfunction directly produces painful cramps and myotonic discharges in a channelopathy family @Torbergsen2015Nav14Myotonia, and quinine's anti-cramp action is *proposed* to involve membrane stabilization of skeletal-muscle sodium (Nav1.4) and potassium (Kv7/KCNQ) channels — a pharmacologic attribution of low confidence (the Kv7/KCNQ component is uncited in the cited reviews) @ElTawil2010CochraneCramps. The link to ME/CFS is indirect and low-certainty — the channel evidence is a primary channelopathy, not ME/CFS, and zero studies of skeletal-muscle excitability in ME/CFS exist. Quinine itself is *not* a safe probe for this hypothesis: FDA-boxed-warned (2006) and restricted (2010) against off-label leg-cramp use because serious adverse events (immune thrombocytopenia, drug-induced thrombotic microangiopathy @Liles2016QuinineAdverse, QT prolongation @Haeusler2018QuinolineCardiotoxicity, hemolysis in G6PD deficiency) outweigh its marginal, publication-bias-inflated efficacy @ElTawil2010CochraneCramps @ManSonHing1998QuinineCramps. *Falsifiability:* if muscle ion-channel/membrane-excitability disturbance contributes to ME/CFS cramps, ME/CFS patients should show altered skeletal-muscle excitability on electromyography or nerve-excitability testing, and cramps should respond to safer sodium-channel modulation (e.g. mexiletine/carbamazepine in specialist myotonia care @Spillane2025DrugMyotonia) rather than to quinine; falsified if ME/CFS cramps are absent, are purely centrally mediated, or respond to no ion-channel modulator. *Consequence:* if confirmed, leg cramps and muscle pain in ME/CFS would point to a measurable muscle-membrane-excitability disturbance and toward safer ion-channel treatments — but today this is only a hypothesis, and quinine is not the way to test it. (ch34 @spec:muscle-nav14-cramp-mecfs; cert 0.25; severity unknown — no ME/CFS studies; origin: literature integration — off-label treatment caution.)],[Phase 3 / 0.25],

  [spec mecfs-cramp-metabolic-substrate], [Speculation: ME/CFS cramps may be driven primarily by an energetic/post-exertional state rather than a fixed channelopathy. Magnesium (@Garrison2020MagnesiumCramps) and non-drug therapies (@Hawke2021CrampsNonDrug) fail to show solid benefit for cramps, and quinine's benefit is marginal and publication-bias-inflated (@ElTawil2010CochraneCramps); sodium-channel blockers reduce *myotonia* (a distinct condition) per Cochrane but are not validated as a cramp probe @Spillane2025DrugMyotonia. If the cramp substrate were a fixed ion-channel hyperexcitability, one might expect at least one channel modulator to show a signal; the uniformly weak response across classes *raises the possibility* (without proving it — trial failures can reflect small effect sizes, heterogeneous causes, or design) of an energetic driver (depleted ATP, altered calcium handling in fatigued muscle). This competes with the Nav1.4 channel speculation (`spec:muscle-nav14-cramp-mecfs`) as an alternate interpretation. *Falsifiability:* if ME/CFS cramps are primarily metabolic/post-exertional, cramp frequency should correlate with PEM severity and cluster in the post-exertional window, and should not respond to any channel-active drug, while pacing and post-exertional recovery should help; falsified if cramps are independent of exertion and respond to a channel modulator. *Consequence:* if cramps in ME/CFS are a symptom of exertion-related energy failure rather than a treatable muscle-electrical problem, pacing and recovery matter more than any cramp medication — consistent with the observation that no cramp drug works well for ME/CFS patients. (ch34 @spec:mecfs-cramp-metabolic-substrate; cert 0.25; severity unknown — no ME/CFS studies; origin: brainstorm idea 1.3.)],[Phase 5 / 0.25],
)

= Entries added 2026-08-29: Osteoporosis and Bone Health Risk in ME/CFS

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec deconditioning-osteoporosis], [Speculation: sustained reduced mobility in moderate-to-severe ME/CFS raises osteoporosis risk via disuse bone loss. Mechanical unloading reduces osteocyte mechanosensing, raising sclerostin and shifting the RANKL/OPG balance toward resorption, producing bone loss in immobilization and bed rest @Rolvien2022DisuseOsteoporosis; muscle contraction opposes this via muscle–bone RANKL/OPG coupling @Qin2013MuscleBone, and chronic deconditioning degrades muscle and bone together @Hart2021Deconditioning. Moderate–severe ME/CFS involves sustained activity reduction and, in the most affected, prolonged recumbency, so patients face the same unloading stimulus that causes disuse bone loss in immobilization, bed rest, and spinal-cord injury. No direct ME/CFS osteoporosis or BMD study exists (research gap). *Falsifiability:* in ME/CFS stratified by mobility, hip/lumbar BMD (DXA) will be lower in more immobile strata after adjusting for age, sex, menopause, vitamin D, and calcium; falsified if BMD does not track mobility. *Consequence:* bone health is worth monitoring in moderate–severe ME/CFS even absent ME/CFS-specific fracture data, because reduced mobility is a well-documented cause of bone loss in other immobilizing conditions — a DXA-screening discussion is reasonable. (ch30 @spec:deconditioning-osteoporosis @subsec:bone-density-osteoporosis; cert 0.40; severity moderate/severe/very-severe; origin: literature integration.)],[Phase 3 / 0.40],

  [oq-vitamind-housebound], [Open question: whether housebound/low-sunlight ME/CFS patients are vitamin-D deficient is unresolved — the premise conflicts with the one direct cohort. A cohort (ME/CFS n=92 vs controls n=94, LC-MS/MS) found ME/CFS patients had *higher* 25(OH)D (60.2 vs 47.3 nmol/L, p=0.001, supplement-driven) and no vitamin D–fatigue association @Earl2017VitaminD, contradicting the assumption of deficiency; however that cohort was not severity-stratified, and housebound/very-severe patients may be underrepresented, so the question is not settled. The correct stance is to measure serum 25(OH)D when deficiency is suspected, not assume it. *Falsifiability:* a severity-stratified cohort of housebound/very-severe ME/CFS patients (vs mild) will show whether 25(OH)D tracks sunlight/mobility; falsified if housebound patients show no deficiency relative to ambulant patients. *Consequence:* clinicians should not assume vitamin D is deficient in a given ME/CFS patient; a serum 25(OH)D measurement resolves it, and supplementation for fatigue alone is not supported by direct evidence. (ch30 @oq-vitamind-housebound @subsec:bone-density-osteoporosis; cert 0.30; severity housebound/very-severe (unverified); origin: literature integration.)],[Phase 3 / 0.30],

  [spec-calcium-deficiency], [Speculation: restricted and avoidant diets in ME/CFS risk calcium deficiency. ME/CFS patients often restrict food intake (sensitivities, low-histamine/elimination diets, reduced appetite/preparation capacity in severe disease), which can lower calcium-rich-food intake (dairy, broccoli/cabbage, soya, tofu, nuts, fortified bread, fish with edible bones) below requirement; low calcium intake combined with the resorption state of disuse could worsen bone loss. No direct calcium-status study in ME/CFS exists (research gap). *Falsifiability:* a dietary-restriction/elimination history will associate with lower calcium intake and higher PTH (or lower adjusted calcium) after adjusting for vitamin D; falsified if restriction does not track calcium status. *Consequence:* patients on long-term elimination or restrictive diets should have calcium intake checked — bone can be lost silently for years, and restricted diets are a preventable contributor. (ch30 @spec-calcium-deficiency @subsec:bone-density-osteoporosis; cert 0.25; severity moderate/severe/very-severe; origin: literature integration.)],[Phase 3 / 0.25],

  [oq-weightbearing-infeasible], [Open question: weight-bearing exercise for bone health is not feasible in moderate–severe ME/CFS, and the trade-off is unresolved. Standard osteoporosis-prevention advice to do weight-bearing activity is unachievable for moderate–severe ME/CFS (it reliably triggers PEM), yet weight-bearing protects bone while the reduced-mobility state promotes bone loss (@spec:deconditioning-osteoporosis). Safe-movement approaches in ch30 (recumbent, seated, aquatic, isometric, bed-based) preserve some musculoskeletal loading without full weight-bearing stimulus, but whether they provide enough mechanical stimulus to protect BMD in ME/CFS is unknown. *Falsifiability:* non-weight-bearing recumbent/seated movement at sub-AT intensity will slow hip/lumbar BMD decline (DXA) vs no programmed movement without increasing PEM; falsified if non-weight-bearing loading fails to preserve BMD. *Consequence:* patients with moderate–severe ME/CFS should not be pressured into weight-bearing exercise for bone health — it is often impossible and can harm — but the resulting loss of bone-protective loading is a real, unmeasured risk clinicians should weigh against the cost of PEM. (ch30 @oq-weightbearing-infeasible @subsec:bone-density-osteoporosis; cert 0.40; severity moderate/severe (not feasible bedbound); origin: literature integration.)],[Phase 3 / 0.40],

  [lim osteoporosis-treatment-mecfs], [Limitation: osteoporosis treatment options exist but carry ME/CFS-specific caveats. Calcium and/or vitamin D supplementation is first-line only if serum levels are low; antiresorptives (alendronate, risedronate) reduce turnover but are associated with atypical femur fracture on long-term use (~100/100k person-yrs) @Shane2014AtypicalFemur and have strict administration requirements (upright posture, empty stomach) that are difficult or impossible for many bedbound patients @Arjunan2023Bisphosphonates; calcium-only supplements raise MI risk (HR 1.31) @Bolland2010CalciumCV; anabolic therapies (teriparatide) carry adverse effects (nausea, insomnia, flushing, myalgias, hypercalcemia) overlapping ME/CFS symptoms @TaylorSaag2019Anabolics. No ME/CFS or bedbound safety data exist; drug choice is likely to require trial and error under clinician supervision. *Consequence:* if a person with ME/CFS develops osteoporosis, treatment is available but not a simple off-the-shelf choice — side-effect overlap with ME/CFS symptoms and bedbound administration difficulty mean drug choice often requires trial and error under clinical supervision. (ch30 @subsec:bone-density-osteoporosis; cert n/a; severity all; origin: literature integration.)],[Phase 3 / n/a],

  [spec-severity-gradient-boneloss], [Speculation: bone loss in ME/CFS follows a severity gradient detectable by circulating turnover markers, refining the flat "all patients at risk" claim (origin: brainstorm idea 1.1). The disuse chain (@spec:deconditioning-osteoporosis) predicts a dose–response: mildly affected, still-ambulant patients show little/no bone loss, while severe/bedbound patients (sustained unloading) show measurable decline @Rolvien2022DisuseOsteoporosis; serum sclerostin/CTX/P1NP change on weeks–months before BMD falls on months–years. If correct, the moderate–severe/bedbound subset — not all ME/CFS — needs bone surveillance. *Falsifiability:* across a severity-stratified cohort, sclerostin and CTX rise and P1NP falls monotonically mild→severe and correlate with objective immobility and BMD decline, independent of age/sex/vitamin D. *Consequence:* if true, only severely affected, largely bedbound patients would need bone-density checks, sparing most patients unnecessary testing. (ch30 @spec-severity-gradient-boneloss @subsec:bone-density-osteoporosis; cert 0.30; severity moderate/severe/very-severe; origin: brainstorm idea 1.1.)],[Phase 5 / 0.30],

  [spec-inflammation-driven-boneloss], [Speculation: chronic inflammation — not just mechanical unloading — may drive bone loss in a subset of ambulatory ME/CFS patients (origin: brainstorm idea 1.2). Inflammatory cytokines (IL-6, TNF-α) promote RANKL and suppress osteoblast activity, causing bone loss independently of loading, so bone loss could occur even in ambulant patients with normal activity — the opposite prediction to @spec-severity-gradient-boneloss. Distinguishable by turnover profile (disuse: high sclerostin; inflammation: high RANKL/low P1NP with high IL-6/TNF-α). *Falsifiability:* a subgroup of ambulatory ME/CFS patients will show elevated CTX and suppressed P1NP with high IL-6/TNF-α but normal sclerostin and normal immobility, indicating an inflammatory rather than disuse driver. *Consequence:* if true, some patients with near-normal activity could still lose bone, so activity level alone would not indicate bone risk and a mobility-based screening rule would miss them. (ch30 @spec-inflammation-driven-boneloss @subsec:bone-density-osteoporosis; cert 0.20; severity all; origin: brainstorm idea 1.2.)],[Phase 5 / 0.20],

  [oq-boneloss-threshold], [Open question: whether ME/CFS mobility actually crosses the bone-loss threshold is unresolved (origin: brainstorm ideas 2.1/10.1). The bed-rest/SCI precedent behind @spec:deconditioning-osteoporosis involves continuous near-total unloading; moderate–severe ME/CFS retains some weight-bearing, and it is unresolved whether unloading is continuous enough to cross the bone-loss threshold. Decisive test: a severity-stratified cross-sectional DXA + sclerostin/CTX/P1NP + 25(OH)D + calcium + objective immobility study, filling the "no direct ME/CFS BMD study" gap. *Falsifiability:* if ME/CFS BMD is preserved across severity strata and sclerostin does not track immobility, H1's threshold is not crossed and the disuse mechanism is clinically irrelevant. *Consequence:* one non-invasive study would tell patients and doctors which — if any — patients actually lose bone, instead of assuming risk from bed-rest in other diseases. (ch30 @oq-boneloss-threshold @subsec:bone-density-osteoporosis; cert 0.45; severity moderate/severe/very-severe; origin: brainstorm ideas 2.1/10.1.)],[Phase 5 / 0.45],

  [lim osteoporosis-external-validity], [Limitation: every mechanistic anchor for the osteoporosis-risk claim is non-ME/CFS and mostly animal/review (Rolvien 2022 review, Hart 2021 review, Qin 2013 SCI rat model @Rolvien2022DisuseOsteoporosis @Hart2021Deconditioning @Qin2013MuscleBone), so external validity to ME/CFS is unestablished; the only direct ME/CFS study (Earl 2017) is not severity-stratified and supplement-exposed @Earl2017VitaminD. Even where disuse bone loss occurs, low fall risk may keep fracture risk low, and treatments carry their own harms — so the osteoporosis angle could be net-irrelevant to clinical care despite a correct mechanism. All bone-loss claims in ME/CFS are low-certainty speculation until severity-stratified data exist. *Consequence:* everything currently said about osteoporosis risk in ME/CFS is borrowed from bed-rest and animal studies, not measured in ME/CFS patients — read as hypothesis, not established risk; no supplementation or treatment should start without a demonstrated deficiency. (ch30 @subsec:bone-density-osteoporosis; cert n/a; severity all; origin: brainstorm categories 10/11/12.)],[Phase 5 / n/a],
)

= Entries added 2026-08-29: Prolactin Response to Buspirone Challenge in ME/CFS

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [cf prolactin-buspirone-exaggerated], [Clinical finding: ME/CFS patients mount an exaggerated prolactin response to an oral buspirone challenge despite normal baseline prolactin, replicated by an independent group (Bakheit 1992 @Bakheit1992Buspirone; Sharpe 1996 @Sharpe1996Buspirone from a separate team) plus a small case series (Sharma 2001 @Sharma2001Buspirone). The reported ME/CFS-vs-depression contrast (lowest in depression, highest in CFS) comes from a *d-fenfluramine* study, not buspirone @Cleare1995DepressionCFS — the buspirone-vs-depression comparison has never been performed. Null fenfluramine results @Yatham1995Fenfluramine @Bearn1995Fenfluramine argue against a purely global serotonergic mechanism without localizing the defect to D2; Sharpe's CFS group reported more nausea (a prolactin-raising confound not separable in that design). Small studies (n=11-20/arm), all pre-2010, line abandoned and never re-tested with modern criteria; replication needed. *Falsifiability:* a modern pre-registered buspirone challenge in IOM-criteria ME/CFS vs depression vs healthy shows no prolactin-AUC difference, the effect is an artifact of pre-Fukuda criteria/uncontrolled confounders, or it disappears after adjustment for nausea; falsified if ME/CFS no longer differs from controls. *Consequence:* if replicated with the nausea confound excluded, a controlled buspirone challenge could become a candidate test separating ME/CFS from healthy physiology — and, if the never-tested depression contrast holds, eventually from depression too. (ch10 @cf:prolactin-buspirone-exaggerated; cert 0.62 for the vs-control finding — the vs-depression discriminator is untested on buspirone; severity unknown — not stratified; origin: literature integration.)],[Phase 3 / 0.62],

  [oq prolactin-buspirone-mechanism], [Open question: what explains the exaggerated prolactin response is unresolved. Competing candidates: (a) reduced tuberoinfundibular dopaminergic tone (dopamine-D2 brake on lactotroph @BenJonathan2001ProlactinDopamine @Fitzgerald2008ProlactinDopamine @QiLytle2023TIDA) — constrained-in but not confirmed by the null fenfluramine results @Yatham1995Fenfluramine @Bearn1995Fenfluramine, and consistent with ME/CFS dopaminergic findings (basal-ganglia reward deficits; OSU6162 trial @Haghighi2021OSU6162) which concern other, anatomically distinct dopaminergic systems; (b) serotonergic 5-HT1A hypersensitivity — constrained by null growth-hormone response @Sharpe1996Buspirone; (c) estradiol modulation — links to ~80% female predominance (though the key replication studied men only) but no direct ME/CFS prolactin-by-sex study exists; (d) differential emetic (nausea) response — Sharpe's CFS group reported more nausea, and nausea itself raises prolactin; the hormonal signal could be a drug-tolerability epiphenomenon. Not mutually exclusive; decisive test is a modern study with both ME/CFS and depression arms, sex/menstrual-phase stratification, cortisol measurement (@Dinan2001Buspirone), and recorded nausea. *Falsifiability:* each mechanism makes a distinct, testable prediction about whether the exaggerated response is dopamine-, serotonin-, estradiol-, or nausea-dependent. *Consequence:* which mechanism is correct determines whether this peripheral test reflects a dopaminergic deficit, another endocrine effect, or a tolerability artifact — a prerequisite for using the challenge as a meaningful biomarker. (ch10 @oq:prolactin-buspirone-mechanism; cert n/a; severity unknown; origin: literature integration.)],[Phase 3 / n/a],

  [spec fra-estradiol-prolactin-link], [Speculation: estradiol modulation of the prolactin response may partly explain the ~80% female predominance of ME/CFS. Estradiol regulates prolactin by modulating the dopaminergic brake and lactotroph synthesis @BenJonathan2001ProlactinDopamine @QiLytle2023TIDA, and the exaggerated buspirone-prolactin response (@cf:prolactin-buspirone-exaggerated) could be sex-hormone-modulated and therefore female-skewed. No direct ME/CFS prolactin-by-sex or estradiol-stratified study exists (gap). *Falsifiability:* if estradiol-dependent modulation drives female predominance, the buspirone-stimulated prolactin response should be larger in premenopausal women and track estradiol status; falsified if the exaggerated response is sex-independent or does not vary with estradiol. *Consequence:* if confirmed, part of the female excess of ME/CFS could trace to a measurable endocrine mechanism, arguing for sex-stratifying the challenge test. (ch21 @spec:fra-estradiol-prolactin-link; cert 0.30; severity unknown; origin: literature integration.)],[Phase 3 / 0.30],

  [pred buspirone-challenge-replication], [Prediction/proposed study: a modern pre-registered buspirone-challenge replication will show a reproducible prolactin-AUC gradient (ME/CFS > healthy > depression) under standardized conditions (overnight fasting, same hour, medication washout, sex/menstrual-phase stratification), testing the historical finding with modern criteria. Falsified if a modern IOM-criteria ME/CFS cohort shows no difference from depression or healthy controls, or the effect disappears with confounder control. Feasible and cheap — one visit, standard endocrine assays, drug already in clinical use. *Consequence:* this one study would revive or retire a notable but abandoned biomarker line; either outcome is scientifically informative. (ch47 @sec:buspirone-challenge-replication @pred:buspirone-challenge-replication; cert n/a — proposed study; origin: literature integration.)],[Phase 3 / n/a],

  [spec prolactin-dopamine-window], [Speculation: the peripheral prolactin response to a D2-brake-lifting challenge acts as an indirect read-out of tuberoinfundibular (hypothalamic) dopaminergic tone, because prolactin is tonically inhibited by dopamine at the lactotroph D2 receptor @BenJonathan2001ProlactinDopamine @Fitzgerald2008ProlactinDopamine. If the exaggerated buspirone→prolactin response reflects reduced dopaminergic inhibitory tone, this blood test becomes a candidate non-invasive proxy — specific to the hypothalamic/pituitary system, not a measure of dopamine elsewhere in the brain — for a deep-brain dopamine signal that would otherwise need PET or CSF. *Falsifiability:* if the exaggerated response tracks a hypothalamic dopamine deficit, it should correlate with other dopamine-function markers (anhedonia/motivation, DAT/VMAT2) and be reproduced by a pure D2-antagonist challenge; falsified if abolished by 5-HT1A blockade or uncorrelated with dopamine-linked symptoms. *Consequence:* a simple blood test could give researchers a cheap, candidate proxy for one deep-brain dopamine signal, making a central hypothesis more testable without imaging — once validated. (ch10 @spec:prolactin-dopamine-window; cert 0.45; severity unknown; origin: brainstorm idea 1.2.)],[Phase 5 / 0.45],

  [spec prolactin-msn-link], [Speculation: the exaggerated prolactin response and dopamine-related motor/reward symptoms in ME/CFS could share a common dopaminergic deficit spanning both the tuberoinfundibular system (lactotroph) and the dopamine-regulated medium spiny neurons of the basal ganglia. A weak convergence hypothesis — it does not claim the pituitary finding causes striatal symptoms, nor even that the (anatomically distinct, independently regulated) systems co-vary; it proposes co-variation as plausible and testable, and explanatory if present. Connects to nigrostriatal dopaminergic findings in Long COVID (@spec:long-covid-dopamine-bridge). *Falsifiability:* the exaggerated prolactin response should correlate with striatal-dopamine or dopamine-linked measures (anhedonia, effort cost, motor fatigue); falsified if unrelated to all such measures. *Consequence:* if co-variation is confirmed, a peripheral test could serve as a candidate research proxy for one dopaminergic deficit otherwise requiring brain imaging — remaining hypothalamic-system-specific until then. (ch10 @spec:prolactin-msn-link; cert 0.30; severity unknown; origin: brainstorm idea 1.3.)],[Phase 5 / 0.30],

  [spec prolactin-subtype-marker], [Speculation: if the exaggerated prolactin response reflects a dopaminergic (D2-brake) abnormality present in only a subset of ME/CFS patients, the buspirone challenge could act as a biological subtype marker identifying a dopamine-dominant subgroup within the heterogeneous population (@cf:prolactin-buspirone-exaggerated). A dopaminergic subtype would differ on dopamine-linked symptoms (motivation, anhedonia, motor slowing) and possibly response to dopamine-modulating interventions. *Falsifiability:* within an ME/CFS cohort, exaggerated responders should cluster with higher dopamine-linked symptom burden and differ from non-responders on dopamine-sensitive measures; falsified if responders and non-responders are indistinguishable on all dopamine-linked measures. *Consequence:* if true, a single challenge test could separate a meaningful biological subgroup, pointing them toward dopamine-focused research and treatment. (ch10 @spec:prolactin-subtype-marker; cert 0.35; severity unknown; origin: brainstorm idea 1.4.)],[Phase 5 / 0.35],

  [spec long-covid-dopamine-bridge], [Speculation: the dopaminergic interpretation of the prolactin finding is mechanistically compatible with independent dopaminergic evidence from Long COVID — VMAT2-PET striatal dopamine-terminal loss (see ch09 neurological) and an open-label OSU6162 trial in ME/CFS @Haghighi2021OSU6162. If reduced dopaminergic activity underlies both the exaggerated prolactin response and Long COVID striatal dopamine loss, the two lines would support a shared dopamine-deficit account of post-infectious fatigue states — but they measure anatomically distinct nodes (tuberoinfundibular vs nigrostriatal) whose co-variation is an untested assumption of the bridge, and CSF dopamine indices are normal in PI-ME/CFS (ch09). *Falsifiability:* comorbid post-infectious ME/CFS/Long COVID patients with exaggerated prolactin responses should also show dopaminergic changes (DAT/VMAT2, dopamine-linked symptoms); falsified if prolactin response and striatal dopamine measures are independent. *Consequence:* if the lines converge, dopamine dysregulation would be a shared, targetable feature of post-infectious ME/CFS and Long COVID, and the low-cost prolactin challenge could screen for that subgroup. (ch10 @spec:long-covid-dopamine-bridge; cert 0.40; severity unknown; origin: brainstorm idea 8.1.)],[Phase 5 / 0.40],
)

= Entries added 2026-09-01: lifetime-energy-mild-cases

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [lim lifelong-onset-criterion], [Limitation (case-definition, ch05): the "new or definite onset (not lifelong)" criterion shared by Fukuda, Canadian Consensus, and IOM assumes a categorical boundary between a constitutional lifetime energy profile and acquired ME/CFS. That boundary is difficult to operationalize and risks excluding the mild, lifelong-energy-constrained patient. Sunnquist et al.\ (2015) found the lifelong-fatigue exclusion hard to operationalize, rarely met even by patients describing long-standing fatigue, and non-discriminating on symptoms/function, and recommended removing it @Sunnquist2015lifelongFatigue. Implication: a patient who has always run on low reserve can still acquire ME/CFS with a definite new PEM component; PEM — not premorbid energy baseline — is the discriminating feature. Severity applicability: mild / lifetime-energy presentations; moderate-to-severe transition not addressed. Falsifiable resolution: an IOM-criteria cohort stratified by self-reported lifelong fatigue showing no symptom/functional or biomarker differences between lifelong-fatigue and non-lifelong subgroups (supporting removal). Consequence: clinicians should not dismiss ME/CFS because the patient was always tired; the decisive feature is new-onset PEM. (ch05 @lim:lifelong-onset-criterion; origin: literature integration — Sunnquist 2015.)],[Phase 3 / n/a],

  [spec mild-constitutional-energy-spectrum], [Speculation (severity continuum, ch06 sec-02): a minority of ME/CFS patients report lifetime low/constrained energy — "always more tired than expected," ADHD/autism energetic profile, or constitutionally low reserve @Sunnquist2015lifelongFatigue @Jason2010FatigueTypes — raising whether mild/constitutional energy constraint is a distinct predisposing state on a continuous spectrum or the mild end of the same illness. Severity clustering identifies a low-severity subset functioning within a constrained daily energy envelope @Jason2010FatigueTypes, while in more-impaired patients the limiting factor is a low daily energy envelope rather than discrete crashes @Brown2013EnergyEnvelope; a childhood-onset chronic disabling fatigue trajectory (1.9% at 13), defined without PEM, is a measurable persistent low-functioning state @Collin2015childFatigue. Competing explanation: population data show the clearest premorbid predictor of later fatigue is excessive childhood energy, not low baseline @Harvey2009neurasthenia — reconcilable if the predisposing factor is a low reserve ceiling ($R_"headroom"$), an open question. Falsifiability: if children with objectively low baseline energy capacity develop ME/CFS at no higher rate than peers with normal capacity, the low-reserve-ceiling predisposing model is unsupported. Not yet replicated — no longitudinal cohort has tracked mild/constitutional low-reserve individuals into ME/CFS onset; transition to moderate/severe unmeasured. Severity applicability: mild / lifetime-energy; moderate-to-severe unknown. Consequence: mild constitutional patients warrant the same pacing education and PEM screening, but the label must not withhold diagnosis — PEM, not baseline energy, distinguishes disease. (ch06 @spec:mild-constitutional-energy-spectrum; origin: brainstorm.)],[Phase 3 / 0.45],

  [oq mild-lifetime-case-recognition], [Open question (case-finding, ch05 sec-08): whether to recognize mild/lifetime-energy ME/CFS by treating baseline energy level and PEM as two independent axes. The shared "not lifelong" onset criterion @Sunnquist2015lifelongFatigue excludes by assumption patients who have always been tired, yet lifelong fatigue is hard to operationalize and non-discriminating @Sunnquist2015lifelongFatigue. Proposed recognition pathway: (1) screen lifetime energy and PEM separately; (2) drop "lifelong fatigue" as exclusion; (3) use PEM presence as the gate to full assessment; (4) offer low-harm pacing to all low-energy patients (access). Research questions: would pre-registered removal of the exclusion change diagnosis without diluting the syndrome? Does a prospective cohort of lifetime-low-energy individuals tracking PEM onset show a mild→moderate/severe transition @Collin2015childFatigue? Critical caveat: broadening risks over-diagnosing tired-but-well people; PEM — not baseline energy — is the discriminator, and the mild end may lack a detectable PEM signature @Harvey2009neurasthenia. Severity applicability: mild / lifetime-energy; transition unmeasured. Consequence: separating baseline energy from PEM could stop clinicians dismissing the "always tired" patient and instead look specifically for a new, definite PEM component. (ch05 @oq:mild-lifetime-case-recognition; origin: brainstorm P1.1/C6.1/D9.1/R2.2.)],[Phase 5 / n/a],

  [lim mild-lifetime-critical-caveats], [Limitation (epistemic, ch05 sec-08): four concerns bound the mild/lifetime recognition proposal. (1) Removing the "not lifelong" exclusion could over-broaden ME/CFS to tired-but-well people — counter-guard is PEM as the gate, but PEM is self-report-bias-prone at the mild end. (2) PEM may not be detectable/reportable at the mild end, so a PEM-gated pathway could miss the target population. (3) The premorbid signal may be high energy, not low (Harvey OR 2.63 for excessive childhood energy) — if this null holds, lifelong low energy is a red herring and only a recognition/access gap survives @Harvey2009neurasthenia. (4) Evidence-quality limits: Sunnquist is single-cohort; 3 of 6 Phase-1 papers share the DePaul/Jason group; no longitudinal mild→moderate/severe data; severity self-reported @Sunnquist2015lifelongFatigue @Jason2010FatigueTypes @Brown2013EnergyEnvelope @Collin2015childFatigue. Severity applicability: mild / lifetime-energy. Consequence: treat the recognition proposal as a testable hypothesis and access pathway, not an established diagnostic expansion — over-application could do more harm than the under-recognition it tries to fix. (ch05 @lim:mild-lifetime-critical-caveats; origin: brainstorm C10.1/C10.2/C11.1/C12.1.)],[Phase 5 / n/a],

  [pred mild-lifetime-transition-cohort], [Prediction/proposed study (ch06 sec-03): a prospective cohort of individuals with documented lifelong low-energy constitution (low baseline, no PEM at baseline) will, after a triggering stressor, acquire a new definite PEM and functional decline (i.e., ME/CFS) at a higher rate than matched normal-baseline peers, with the transition marked by emergence of PEM rather than change in resting energy @Sunnquist2015lifelongFatigue. Falsified if lifetime-low-energy individuals develop ME/CFS at no higher rate than normal-baseline peers, or if later decline is explained entirely by cumulative overactivity (high-energy premorbid route @Harvey2009neurasthenia) rather than baseline reserve. Measurement: baseline energy + PEM screen, prospective 2-day CPET where feasible, functional capacity, and measured severity transitions @Brown2013EnergyEnvelope. Severity applicability: mild → moderate/severe transition. Consequence: resolves whether lifelong low-energy patients are a predisposed population needing early PEM screening/pacing or the visible tail of normal tiredness. (ch06 @pred:mild-lifetime-transition-cohort; origin: brainstorm R2.1.)],[Phase 5 / n/a],

  [syn mild-lifetime-recognition], [Synthesis (ch05 sec-08): converges the cycle's environments — lifelong energy constraint is continuous with ME/CFS at the mild end, the mild/lifetime patient is excluded by a non-discriminating "not lifelong" onset criterion @Sunnquist2015lifelongFatigue, and the low-reserve mild-end population is the causal-hierarchy model's near-separatrix subthreshold reservoir @Jason2010FatigueTypes @Brown2013EnergyEnvelope @Collin2015childFatigue. Claim is conditional: PEM, not baseline energy, is the discriminator; over-broadening risk and the high-energy premorbid alternative bound it @Harvey2009neurasthenia. Clinical path: do not exclude on lifelong fatigue; screen baseline-energy and PEM as two axes; reserve the diagnosis for those with new PEM; offer low-harm pacing to all. Open question: whether mild/lifetime patients transition to moderate/severe (@pred:mild-lifetime-transition-cohort). Overall certainty 0.45 for continuous-spectrum; recognition construct ~0.30. Severity applicability: mild / lifetime-energy. Consequence: clinicians should stop dismissing the "always tired" patient and look specifically for new-onset PEM. (ch05 @syn:mild-lifetime-recognition; origin: synthesis of this cycle.)],[Phase 10a / 0.45],
)

= Entries added 2026-09-02: Neurodivergent-Specific Psychological Consequences of ME/CFS

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [cf neurodivergent-diagnostic-overshadowing], [Clinical finding (ch09 subsec:social-emotional-dysfunction): in a Dutch register survey of autistic adults (n=1,211), 24.6% reported at least one prior psychiatric diagnosis perceived as a misdiagnosis; personality, anxiety, and mood disorders were most common, and chronic fatigue syndrome / burnout-related disorders were also explicitly listed, judged a misdiagnosis by 4% of the total sample @Kentrou2024autisticMisdiagnosis. The study captures diagnostic confusion / overshadowing around fatigue and energy symptoms in autistic adults, particularly women; it does not demonstrate that clinicians dismiss genuine ME/CFS as "just autism." *Falsifiability:* prospective cohort of autistic adults with new fatigue shows longer time-to-ME/CFS-diagnosis and lower PEM-assessment rates than non-autistic controls after adjusting for severity/access. (ch09 @cf:neurodivergent-diagnostic-overshadowing; cert 0.55; origin: literature integration.)],[Phase 3 / 0.55],

  [spec neurodivergent-masking-double-burden], [Speculation (ch09 subsec:social-emotional-dysfunction): autistic/ADHD camouflaging is a metabolically expensive self-regulation demand. Research with healthy participants shows sustained self-control depletes glucose and impairs subsequent self-regulation @Gailliot2007glucoseSelfControl; @Baumeister1998egoDepletion. In ME/CFS, where prefrontal metabolic reserves are already constrained, the same social encounter may require energy both for masking ME/CFS symptoms (hiding pain, flat affect, exhaustion) and for neurodivergent camouflaging (hiding autistic/ADHD traits). The two demands draw on the same prefrontal resource pool. Based on Grant 2026 (camouflaging predicts central-sensitivity symptoms) @Grant2026camouflagingCSS and Hodge 2026 (camouflaging--mental-health association) @Hodge2026camouflagingMH. *Falsifiability:* ND+ME/CFS patients report higher social-exertion cost and longer recovery than neurotypical ME/CFS patients matched for severity, correlating with masking burden; falsified if no dose–response between masking score and social-exertion cost across ND/NT × ME/CFS groups. (ch09 @spec:neurodivergent-masking-double-burden; cert 0.40; origin: literature integration.)],[Phase 3 / 0.40],

  [oq neurodivergent-identity-loss], [Open question (ch09 subsec:social-emotional-dysfunction): whether ME/CFS energy loss produces an ND-specific identity injury — loss of access to special interests and the focused activities that organize autistic/ADHD selfhood, regulation, and social connection — is unresolved. No study has compared autistic/ADHD people with and without ME/CFS on this dimension. *Falsifiability:* mixed-methods cohort of autistic/ADHD adults with ME/CFS shows greater special-interest disruption and identity-grief scores than neurotypical ME/CFS controls after adjusting for overall severity. (ch09 @oq:neurodivergent-identity-loss; cert n/a; origin: literature integration.)],[Phase 3 / n/a],

  [lim neurodivergent-evidence-directness], [Limitation (ch09 subsec:social-emotional-dysfunction): the ND-specific psychological-consequence claim rests on indirect evidence only — autistic-burnout phenomenology, camouflaging cost in central-sensitivity syndromes, diagnostic overshadowing in autism, and ADHD–CFS transdiagnostic comparisons. No published study prospectively assesses psychological outcomes in a cohort meeting both formal ME/CFS criteria and formal autism/ADHD criteria. Phenomenological overlap must not be presented as condition equivalence; masking-cost extrapolation is plausible but unmeasured in ME/CFS; identity-loss and diagnostic-overshadowing claims are hypothesis-generating. (ch09 @lim:neurodivergent-evidence-directness; cert n/a; origin: literature integration.)],[Phase 3 / n/a],

  [cf neurodivergent-differential-diagnosis], [Clinical finding (ch05 sec:differential): the presentations of autistic and ADHD patients overlap with ME/CFS across fatigue, sleep disturbance, social withdrawal, and cognitive slowing, creating diagnostic confusion. In a Dutch register survey of autistic adults (n=1,211), 24.6% reported at least one prior psychiatric diagnosis perceived as a misdiagnosis; chronic fatigue syndrome / burnout-related disorders were among the listed categories, judged a misdiagnosis by 4% of the total sample @Kentrou2024autisticMisdiagnosis. That pattern shows energy-related diagnoses figure in the diagnostic confusion autistic adults experience before autism recognition; it does not mean clinicians dismiss ME/CFS as "just autism." Adults with ADHD and chronic fatigue syndrome show overlapping psychological profiles (functional impairment, mood, self-efficacy) @Rogers2017ADHDFatigue. The differential discriminator is PEM regardless of comorbid ADHD/ASD. *Falsifiability:* prospective diagnostic study shows PEM distinguishes ME/CFS from ADHD/ASD presentations even when comorbid. (ch05 @cf:neurodivergent-differential-diagnosis; cert 0.55; origin: literature integration.)],[Phase 3 / 0.55],

  [compat note], [Compatibility (Phase 7): these claims reinforce the existing ADHD/ASD metabolic-reserve-predisposition hypotheses in ch07/ch36 by adding a *compounding* psychological/social layer and a *recognition barrier* (diagnostic overshadowing). No conflicts identified. They are independent of immune, viral, and pharmacological hypotheses but feed into the broader "energy cost" model. (origin: synthesis of this cycle.)],[Phase 7 / n/a],
)

= Entries added 2026-09-02: Post-Viral Post-Acute Syndromes (Combination Antiviral + Anti-Inflammatory)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec combination-antiviral-longcovid-pilot], [Speculation (ch37 @spec:combination-antiviral-longcovid-pilot): Pridgen & Putrino (2026) reported, in an open-label case series of 24 Long-COVID patients, that adding a 15-day Paxlovid course to a 120-day valacyclovir+celecoxib (IMC-2) backbone was associated with larger self-reported fatigue, brain-fog, and dysautonomia improvement than IMC-2 alone (PGIC fatigue +2, ($p < 0.0001$); VAS 55.3% greater reduction), reported durable to ~600 days @Pridgen2026HerpesAntiviralLongCOVID. This is the first data point — uncontrolled, in Long COVID not ME/CFS — on the combination antiviral + anti-inflammatory strategy identified as an untested gap in the antiviral-trial history; it does not contradict the negative results for brief Paxlovid courses (NIH STOP-PASC trial; observational data @Durstenfeld2024paxlovid). Critical caveats: no placebo/control, subjective endpoints only, small n (12/arm), single site, and a major inventor conflict of interest (author is patent-holder/company founder for IMC-2); for-profit IRB. No ME/CFS-specific data; severity applicability unknown (Long-COVID cohort, not stratified); no pregnancy/lactation data. Must not be read as efficacy or a clinical recommendation — hypothesis-generating pilot warranting a randomized, double-blind, placebo-controlled trial in a virus-selected ME/CFS subgroup. *Falsifiability:* a controlled trial in an ME/CFS cohort selected for elevated herpesvirus antibody titers and/or viral-persistence biomarkers shows no difference between the combination regimen and placebo at 6 months on fatigue/functioning → combination antiviral + anti-inflammatory is not an effective anti-reservoir strategy. (ch37 @spec:combination-antiviral-longcovid-pilot; cert 0.21 — discounted 0.85 for Long-COVID population; severity unknown; origin: literature integration.)],[Phase 3 / 0.21],
)

= Entries added 2026-09-04: EpiSwitch Cross-Condition Network Convergence (Hunter 2026)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec cross-condition-3d-convergence], [Speculation (ch36 @hyp:cross-condition-3d-convergence): when GWAS loci for ME/CFS (DecodeME), Long COVID, PTSD, RA, and MS are re-rendered as 3D genomic anchors (proprietary EpiSwitch Orion) and connected into protein-interaction networks, the gene sets share few individual genes yet interconnect into a dense landscape with candidate hubs (RUNX1, PPARGC1A/PGC-1alpha, STAT1, CDH2, NRP1, PLCG2) and enriched immune/cytokine, interferon, mitochondrial-biogenesis, metabolic, and neuroendocrine pathways @Hunter2026EpiSwitchCrossCondition. Offered as a unifying explanation for shared symptoms across fatigue-associated syndromes. Entirely in silico; no experimental validation; no permutation testing (self-admitted); vendor-funded (11/14 authors are Oxford BioDynamics employees); no independent replication. *Falsifiability:* an independent, non-proprietary re-analysis (open-source 3D-genome maps or Hi-C-derived anchors, permutation testing against a degree-matched null) failing to reproduce cross-condition convergence beyond chance would refute the shared-regulatory-architecture claim. (ch36 @hyp:cross-condition-3d-convergence; cert 0.20 — discounted 0.30 for computational-only population; severity unknown; origin: literature integration.)],[Phase 3 / 0.20],

  [lim cross-condition-convergence-evidence], [Limitation (ch36 @lim:cross-condition-convergence-evidence): the cross-disease network-convergence claim is not established biology — it rests on an in-silico, vendor-dependent analysis with no permutation test, no hub validation, and no independent replication @Hunter2026EpiSwitchCrossCondition. Independent evidence supports the *constituent* biology (CD8+ T-cell exhaustion @Iu2024CD8Exhaustion; T-cell-exhaustion markers in post-COVID/ME-CFS @Shahbaz2026single-cell-immune; energy-metabolism-immune-exhaustion interface @VanCampenhout2025EnergyImmune; elevated soluble LAG-3 in persistent post-COVID @Ueland2025sLAG3postCovid) but corroborates exhaustion mechanisms *within* single diseases, not cross-disease convergence. ME/CFS and Long COVID GWAS loci are essentially disjoint (DecodeME), cautioning against over-reading network "shared biology" as shared genetics. (ch36 @lim:cross-condition-convergence-evidence; cert n/a; origin: literature integration.)],[Phase 3 / n/a],

  [compat note], [Compatibility (Phase 7): cross-condition-3d-convergence weakly reinforces the CD8+ mitochondrial-exhaustion hypothesis (hyp:cd8-mito-fragmentation-exhaustion) via its PPARGC1A/mitochondrial + immune-exhaustion content, and feeds into the EpiSwitch diagnostic and frozen-chromatin nodes — but as in-silico cert 0.20 evidence it does NOT strengthen any single-disease mechanism (no bumps; existing evidence independent). The convergence caveat (lim:cross-condition-convergence-evidence) extends the vendor-COI limitation (lim:episwitch-caveats). No conflicts, no circular deps. Compat audit at tmp/compat-audit-episwitch-crosscondition-hunter2026-2026-09-04.md.],[Phase 7 / n/a],
)

= Entries added 2026-09-04: VZV Rash-Less Reactivation (vzv-reactivation)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec rashless-vzv-mecfs], [Speculation (ch08 @spec:rashless-vzv-mecfs): VZV---the third member of the documented poly-herpesvirus co-reactivation serologic pattern in ME/CFS @Palomo2026herpesvirus; VZV can cause systemic and neurovascular disease *without a rash* (zoster sine herpete / "internal shingles") @Bubak2026VZVInfection. Asymptomatic VZV reactivation drives arterial ischemic stroke in the general population (VIPS II: 9.8% vs 3.1% controls; up to one-third of childhood arterial ischemic strokes attributed to VZV) @Fullerton2025VIPSII @Bubak2026VZVInfection, and this rash-less mode mechanistically parallels the paper's abortive-lytic-replication (ALR) theme---immune activation and tissue consequences without detectable classical productive infection. However, no empirical cohort links rash-less VZV reactivation to ME/CFS symptom flares; static VZV serology does not discriminate ME/CFS (VZV IgG among six herpesviruses poorly distinguished ME/CFS subgroups in a UK Biobank re-analysis @Domingues2023HerpesIgG); HSV-family nulls @Koelle2002TwinsHSV @Buchwald1996ViralSerologies leave the temporal-reactivation question open; and the ME/CFS application rests on a conceptual hypothesis of peripheral-ganglion VZV involvement in chronic fatigue @Shapiro2009VZVgangliaCFS. The *mechanism* is well established; its *ME/CFS application* is hypothesis-level. *Falsifiability:* longitudinal VZV reactivation sampling (saliva/blood VZV PCR or paired anti-VZV dUTPase IgG) timed to PEM/symptom flares will detect transient VZV reactivation events correlating temporally with exacerbation beyond the poly-herpesvirus co-reactivation baseline; falsified if no temporal clustering around flares is found. (ch08 @spec:rashless-vzv-mecfs; cert 0.30 — ME/CFS application discounted for general-population mechanism evidence; severity unknown; origin: literature integration.)],[Phase 3 / 0.30],

  [compat note], [Compatibility (Phase 7): rashless-vzv-mecfs feeds into the ch08 poly-herpesvirus ALR model (@spec:poly-herpesvirus-alr) and the viral-reactivation-as-consequence/bidirectional framings — adding VZV as a virus whose rash-less mode parallels ALR. No certainty bumps (new spec cert 0.30 is below the feed-in ≥0.50 and independent-≥0.60 thresholds; mutual reinforcement of low-certainty speculation does not bump). Independent of viral-reactivation-as-cause and the LC combination-antiviral pilot. Compat audit at tmp/compat-audit-vzv-reactivation-2026-09-04.md.],[Phase 7 / n/a],
)

= Entries added 2026-09-04: Autism Social Perception & Stigma (autism-social-perception-stigma)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec thin-slice-mecfs-dismissal], [Speculation (ch40 @spec:thin-slice-mecfs-dismissal): cross-disease evidence (autism anchor Sasson2017, meta-analysis Wanigasekera2025, Parkinson Hemmesch2014, schizophrenia Parisi2026, facial-affect Foster2025) establishes that negative first impressions are driven by presentational *style* (reduced facial affect, expressivity, movement) independently of conversational *substance*, an effect robust within seconds and stable over exposure @Sasson2017ThinSlice @Wanigasekera2025FirstImpressionsMeta. ME/CFS patients frequently present with the implicated style (flat affect, reduced expressivity from neurometabolic dysfunction), so clinician dismissal of ME/CFS may be partly a thin-slice first-impression bias toward style before the reported medical substance (PEM, orthostatic intolerance) is weighed — a mechanism-level complement to the descriptive Bontempo invalidation model @ach:invalidation-model and diagnostic-delay hypothesis. *No direct ME/CFS-cohort study exists* — mechanism transfer by analogy (all source studies: general-population perceivers of another condition, population weight 0.75). *Falsifiability:* a thin-slice study in which clinicians rate ME/CFS patients vs controls, with and without audio-visual presentation, will show less favorable first impressions and reduced care-intent for the audio-visual condition that attenuates or disappears when only the consultation transcript is provided. (ch40 @spec:thin-slice-mecfs-dismissal; cert 0.45 — discounted, by analogy; severity unknown; origin: /integrate-topic autism-social-perception-stigma.)],[Phase 3 / 0.45],

  [oq disclosure-attenuation], [Open question (ch40 @oq:disclosure-attenuation): diagnostic disclosure reduces first-impression bias in some contexts but is condition-specific — autism disclosure improved employment-interview ratings @Norris2024DisclosureInterview; schizophrenia disclosure *worsened* first impressions while mislabeling as autistic *improved* them @Parisi2026SchizophreniaFirstImpressions; autistic raters did not gain from disclosure @DeBrabander2019FirstImpressionsAutisticObservers; diagnostic awareness moderated cross-neurotype rapport without behavioral mediation @Efthimiou2025DiagnosticStatusRapport. Whether disclosing an ME/CFS diagnosis to a clinician/adjudicator/employer attenuates thin-slice dismissal is untested; for a contested illness long associated with psychosomatic framing, the label could trigger a pre-formed negative stereotype rather than attenuate. (ch40 @oq:disclosure-attenuation; cert n/a — research question; origin: /integrate-topic autism-social-perception-stigma.)],[Phase 3 / n/a],

  [spec autism-firstimpression-mecfs-invisible], [Speculation (ch14d @spec:autism-firstimpression-mecfs-invisible): the autism double-empathy / relational model (Jones2024, Edey2016 double mind-blindness, Morrison2020 same-neurotype rapport, Morrison2019 rater-locus variability) frames cross-neurotype social difficulty as co-produced, not an intrinsic target deficit. Transferred by analogy to invisible illness: ME/CFS patients whose disease produces flat affect / reduced expressivity (ch09) may face a first-impression dismissal that is partly a *perceiver* phenomenon; the relational model implies the modifiable locus is the perceiver (shift weight from how the patient looks to what the patient reports), paralleling stigmatisation subtree node 8.7 "Autism Stigma → Neurodiversity Reversal". *Analogy/translation gap explicit* — no ME/CFS-cohort first-impression study exists. *Falsifiability:* a thin-slice study of ME/CFS patients vs controls will show less favorable impressions in the audio-visual vs transcript-only condition, with perceiver-level variables accounting for more variance than patient characteristics (mirroring the autism rater-locus finding). (ch14d @spec:autism-firstimpression-mecfs-invisible; cert 0.40 — discounted, by analogy; severity unknown; origin: /integrate-topic autism-social-perception-stigma.)],[Phase 3 / 0.40],

  [spec mecfs-motivation-misread], [Speculation (ch40 @spec:mecfs-motivation-misread): the thin-slice first-impression mechanism may operate for ME/CFS through a *specific* attribution error — low motor output / reduced affect / slowed speech read as low *motivation or malingering* (an effort/agency inference), not as the social-awkwardness inference dominant in autism @Sasson2017ThinSlice. Consistent with slowed-movement-read-negatively in Parkinson's @Hemmesch2014ParkinsonFirstImpressions and the causal-stigma finding that psychosomatic/volitional attribution is the strongest dismissal predictor @Froehlich2022CausalStigma. If so, ME/CFS dismissal is a misattributed-cause error feeding psychologization/invalidation; remedy requires countering the effort default, not only weighting reported substance. *Limitations:* no thin-slice study has tested motivation attribution for fatigue targets — extension by analogy. *Falsifiability:* in a thin-slice task, perceivers free-labeling why they respond less favorably to ME/CFS audio-visual clips will disproportionately use motivation/effort words (vs transcripts), and this motivation attribution — not global likeability — will mediate reduced care-intent. (ch40 @spec:mecfs-motivation-misread; cert 0.30 — by analogy; severity unknown; origin: brainstorm idea 1.2.)],[Phase 5 / 0.30],

  [compat note], [Compatibility (Phase 7): thin-slice-mecfs-dismissal and autism-firstimpression-mecfs-invisible reinforce the stigmatisation subtree node 8.7 ("Autism Stigma → Neurodiversity Reversal", speculation 0.30, not yet integrated) and the ch09 social-emotional-dysfunction framing (observer misattribution of flat affect), and extend the general ME/CFS stigma content (ch40 invalidation @ach:invalidation-model). spec:mecfs-motivation-misread specifically REINFORCES the pre-existing stigmatisation registry entries — "Illness Name Is an Independent Vector of Stigma" (Jason 2002: CFS label → lazy/malingering attributions) and "Perceived Stigma via Causal Attribution Pathway" (Froehlich 2022) — by supplying the thin-slice *mechanism* by which a low-motivation/malingering inference forms from presentational style (the visible analogue of the name-triggered stereotype). No certainty bumps applied (all new ME/CFS-transfer specs are by-analogy discounted ≤0.45, below the ≥0.60 reinforcement threshold, and Active Caps forbid bumping ME/CFS-transfer claims above 0.45 without a direct ME/CFS-cohort study). They are independent of (do not modify) the ASD-as-biological-predisposition hypotheses (ch07/ch14d neurodevelopmental-secondary) and the ND-psychological-consequences claims (ch09, ch05) — these operate on a different axis (biological/secondary vs social-perception). Compat audit at tmp/compat-audit-autism-social-perception-stigma-2026-09-04.md.],[Phase 7 / n/a],
)

= Entries added 2026-09-07: Autoimmune Small Fiber Neuropathy Serological Subtype (autoimmune-sfn-subtype)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq autoimmune-sfn-serological-subtype], [Open question (ch09 @oq:autoimmune-sfn-serological-subtype): is there a distinct autoimmune *serological* SFN subtype in ME/CFS defined by anti-TS-HDS (IgM) and anti-FGFR3 (IgG) antibodies? Supportive groups report these antibodies in cryptogenic/non-length-dependent SFN and sensory neuronopathy with DRG-predominance @Antoine2015FGFR3 @Levine2020TSHDSFGFR3 @Tholance2020FGFR3, and a mouse study reports FGFR3-Ab-induced DRG hypersensitivity @Salih2026FGFR3Pathogenic — but the claim is contested and NOT established. Independent real-world data show limited disease specificity and no immunotherapy-response prediction @Chompoopong2023TSHDS; antibodies occur irrespective of objective small-fiber damage @Trevino2021TSHDSFGFR3 @Murin2024SFNsero; the anti-FGFR3 assay is not standardised across labs @Appeltshauser2025FGFR3assay; fibromyalgia proxies (closest to ME/CFS) show no TS-HDS elevation or the reverse direction @Malik2019TSHDSfibromyalgia @Nissan2023TSHDSfibromyalgia; both controlled IVIG trials are negative @Gibbons2023IVIGpilot @Geerts2021IVIG @Ng2026IVIGsystrev; and an editorial calls the antibody-guided IVIG signal "fading" @Katzberg2023IVIGsignal. *No ME/CFS-cohort study exists.* *Falsifiability:* a prospectively phenotyped ME/CFS cohort with antibody testing, skin-biopsy IENFD, and sudomotor testing will fail to find a seropositive subgroup that (a) has reduced IENFD/sudomotor dysfunction relative to seronegative patients and (b) responds to IVIG in an antibody-stratified trial — falsifying the ME/CFS-relevant subtype claim if seropositivity tracks neither objective small-fiber damage nor immunotherapy response. (ch09 @oq:autoimmune-sfn-serological-subtype; cert n/a — research question; severity unknown; origin: /integrate-topic autoimmune-sfn-subtype.)],[Phase 3 / n/a],

  [lim autoimmune-sfn-serology-not-validated], [Limitation (ch09 @lim:autoimmune-sfn-serology-not-validated): anti-TS-HDS/anti-FGFR3 serology is commercially testable but NOT a validated diagnostic marker or IVIG-selection tool in ME/CFS. No ME/CFS-cohort study exists; fibromyalgia (closest overlapping population) shows no elevation or the reverse @Malik2019TSHDSfibromyalgia @Nissan2023TSHDSfibromyalgia; real-world data find limited specificity and no response prediction @Chompoopong2023TSHDS; the assay is not inter-lab standardised @Appeltshauser2025FGFR3assay; both controlled IVIG trials are negative @Gibbons2023IVIGpilot @Geerts2021IVIG while the positive open-label report is uncontrolled and responder-selective @Zeidman2022IVIG. Distinct from the IgG-DRG passive-transfer axis (@hyp:drg-sfn-igg-mecfs), which has direct experimental support in post-infectious cohorts. (ch09 @lim:autoimmune-sfn-serology-not-validated; cert n/a; severity unknown; origin: /integrate-topic autoimmune-sfn-subtype.)],[Phase 3 / n/a],

  [compat note], [Compatibility (Phase 7): oq:autoimmune-sfn-serological-subtype and lim:autoimmune-sfn-serology-not-validated are INDEPENDENT of the stronger IgG-DRG passive-transfer axis (@hyp:drg-sfn-igg-mecfs) and the ISR-DRG mechanism (@spec:isr-drg-sfn) — the serological TS-HDS/FGFR3 claim is a separate, contested biomarker hypothesis that the content explicitly does NOT conflate with the passive-transfer DRG evidence. They neither reinforce nor conflict with the Sjögren's autoimmune-SFN CCM open question (@oq:ccm-sjogren-overlap-pattern) or the fibromyalgia-ME/CFS-POTS triad hypothesis — those address structural/GPCR-autoantibody mechanisms, not the TS-HDS/FGFR3 serological markers. The limitation (lim:autoimmune-sfn-serology-not-validated) does not modify any existing claim's certainty (both new rows are cert n/a — research question + limitation; no certainty adjustment applicable under Phase-7 rules or Active Caps). No reinforcement, no conflict, no circular dependencies, no feed-in. Compat audit at tmp/compat-audit-autoimmune-sfn-subtype-2026-09-07.md.],[Phase 7 / n/a],
)
= Entries added 2026-09-09: LDN vs Metformin Phenotype Triage (ldn-metformin-bifurcation-triage)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [oq ldn-metformin-phenotype-triage], [Open question (ch47 @oq:ldn-metformin-phenotype-triage): could LDN vs metformin ever become a phenotype-guided first-line choice (LDN for neuroimmune/TRPM3-dominant, metformin for immunometabolic)? No validated biomarker selects either drug today, and the two arms are NOT equally evidenced — metformin has been tested in established disease and failed to show symptom benefit (one completed RCT negative @Lim2026MetforminPASC; a second adaptive trial stopped its metformin arm for futility @Reis2026fluvoxamine), whereas LDN has never been tested in a completed placebo-controlled RCT for this endpoint. The best case for metformin is that the failed trials were unselected and did not stratify by insulin resistance — the design that can mask a true subgroup effect; its one positive RCT-level signal (COVID-OUT acute-phase prevention, 41% RRR, 6.3% vs 10.4% by day 300 @Reis2023COVIDOUT) arose in a defined early/metabolically-loaded context, and post-infectious insulin resistance is documented in the same trigger population @Sanhueza2026NETosisIR. The mechanism-specific endpoints (REE, NETosis; the latter has no routine clinical marker) are unverified in ME/CFS — never measured — which is distinct from refuted, and no negative trial has been re-analysed by HOMA-IR subgroup. *Falsifiable prediction (joint, two-stage):* first an enrichment trial (HOMA-IR-high established ME/CFS, metformin vs placebo, REE + NET/insulin + symptom endpoints); if signal, the fuller TRPM3 x HOMA-IR stratified randomization vs LDN would show a significant phenotype x drug interaction (metformin better in HOMA-IR-high/TRPM3-normal; LDN better in TRPM3-abnormal/insulin-sensitive). Indeterminate if mechanism-endpoint (REE/NETosis) signal appears without symptom improvement — that establishes metabolic modulation without clinical benefit, requiring a separate clinical-endpoint trial rather than declaring falsification. *Consequence:* neither drug has demonstrated established-disease symptom benefit; for a post-viral-fatigue patient with insulin resistance now the choice is empirical, and metformin must NOT be imported into established ME/CFS on the strength of its acute-phase prevention signal. (ch47 @oq:ldn-metformin-phenotype-triage; cert n/a — research question; severity unknown; origin: /integrate-topic ldn-metformin-bifurcation-triage.)],[Phase 3 / n/a],

  [compat note], [Compatibility (Phase 7): oq:ldn-metformin-phenotype-triage is INDEPENDENT of (does not modify) the concurrent-adjunct framing @hyp:metabolic-immune-ldn (metformin added to preserve LDN benefit in prediabetics — an either/or triage question is a different axis, so no conflict). It is COMPLEMENTARY to the ch33 LDN pharmacodiagnostic differential (@sec:low-dose-naltrexone-ldn LDN TLR4/TRPM3 dose-window content) and consistent with the ch06 endotype/subgroup framework. No certainty bump applies (cert n/a — research question; Active Caps forbid bumping above 0.45). Phase 6 (re-run): the metformin efficacy-refuting evidence (Lim2026 negative; REVIVE metformin-arm futility) was surfaced as inline caveats at the two pre-existing metformin candidate-treatment claims — @spec:metformin-netosis (ch31) and @spec:metformin-metabolic-platform (ch30) — per the safety override for inefficacy evidence and visibility symmetry; no certainty reduction applied (the trials measured fatigue/PASC-recovery, a different endpoint from NETosis/REE, a conservative cross-outcome overlap). Compat audit at tmp/compat-audit-ldn-metformin-bifurcation-2026-09-09.md.],[Phase 7 / n/a],
)

= Entries added 2026-09-10: Population Pharmacodiagnostic Corpus (pharmacodiagnostic-corpus)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [hyp population-pharmacodiagnostic-corpus], [Hypothesis (ch33 @hyp:population-pharmacodiagnostic-corpus): a set of uncoordinated single-patient drug trials, pooled, can estimate population and subgroup treatment effects and thereby rank rate-limiting mechanisms in ME/CFS. Statistical feasibility is established in general populations — pooled n-of-1 trials yield group means @Punja2016Nof1Aggregation @Zucker2010, multi-level Bayesian models combine multiple single-patient trials handling trend/carryover/autocorrelation @Schmid2022BayesianNof1, and aggregated n-of-1 designs are formalized for predictive-biomarker/responder-subgroup validation @Hendrickson2020AggregatedNof1. Applied to ME/CFS it is untested; no such corpus exists. *Falsifiability:* a corpus constructed from pooled ME/CFS drug-response reports recovers at least one drug-response association independently confirmed by a blinded randomized trial at a rate above chance, and for the minority of drugs with independent trial estimates its population estimates agree with them (ρ > 0.5 across those drugs); falsified if no pooled association replicates in any blinded trial, or if the corpus ranking's correlation with the trial-based ranking is ρ ≤ 0.5 where both exist. (ch33 @hyp:population-pharmacodiagnostic-corpus; cert 0.45 — methodological, general population; severity unknown; origin: /integrate-topic pharmacodiagnostic-corpus.)],[Phase 3 / 0.45],

  [spec dose-band-duration-load-bearing], [Speculation (ch33 @spec:dose-band-duration-load-bearing): the corpus only carries mechanism information if each report captures the dose band and duration of the trial, because a null at the top of a dose range is uninformative about a window below it (@sec:dose-response-categories). "LDN did not help" pools to nothing; "LDN 0.5 mg, 8 weeks, fog improved, lost at 3.0 mg" constrains the TLR4/Nrf2 window. Current forum/clinic reports are mostly yes/no and cannot be pooled retrospectively without loss @Bourke2020PatientGeneratedData. *Falsifiability:* a corpus recording dose band + duration predicts an independent outcome better than a yes/no corpus for the same drugs (pre-specified margin), and band-specific response rates exceed off-band rates ≥2× for at least one drug; falsified if the binary corpus predicts equally well or if band-specific rates are flat across bands for all drugs examined. (ch33 @spec:dose-band-duration-load-bearing; cert 0.40 — design inference; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [spec convergent-aggregation-cancels-confounders], [Speculation (ch33 @spec:convergent-aggregation-cancels-confounders): per-patient confounders (placebo, fluctuation) are independent and cancel in aggregate, but shared bias (notoriety, reporting, self-selection) does not; consistency of a responder-subgroup pattern is not sufficient on its own (a socially amplified false signal is also consistent) and population-level consistency is not necessary (a subgroup signal need not move the population). But independence reduces noise, not systematic bias — notoriety, reporting bias, and self-selection are shared across a community and do not cancel @Cutroneo2023Disproportionality @Richiardi2007NINFEAInternet. Open-label placebo moves subjective outcomes @FlavioReis2025OpenLabelPlacebo @KleineBorgmann2025OpenLabelPlacebos and unblinded single-case aggregation inflates response (95% favourable under high bias) @Nikles2022Nof1Physiotherapy. *Falsifiability:* the per-drug response variance partitions into an estimable shared component and a mechanism-relevant between-patient component; the mechanism-relevant fraction exceeds zero for some drugs and apparent between-drug differences shrink after adjusting for shared channel and popularity. Falsified if the mechanism-relevant fraction is indistinguishable from zero for all drugs (signal fully explained by shared expectation and channel effects). The verbal claim carries a structural-unfalsifiability flag. (ch33 @spec:convergent-aggregation-cancels-confounders; cert 0.30 — statistical principle, untested in ME/CFS; severity unknown; origin: brainstorm.)],[Phase 5 / 0.30],

  [spec response-heterogeneity-subtypes], [Speculation (ch33 @spec:response-heterogeneity-subtypes): heterogeneous drug response discloses subtypes — the ARDS HARP-2 case shows two subphenotypes responding differentially to simvastatin, so an overall-null trial contained a real mechanism-revealing differential response @Calfee2018ARDSsubphenotypes, and ME/CFS has substantial partially reproducible within-diagnosis heterogeneity @Vaes2023SymptomClusters. A corpus should therefore seek responder subgroups, not a single average. *Falsifiability:* corpus-derived responder subgroups differ on at least one independently measured objective marker (between-subgroup effect size larger than within-subgroup variability); falsified if the subgroups show no objective separation. (ch33 @spec:response-heterogeneity-subtypes; cert 0.42 — cross-disease inference + measured heterogeneity; severity unknown; origin: brainstorm.)],[Phase 5 / 0.42],

  [oq corpus-minimum-data-schema], [Open question (ch33 @oq:corpus-minimum-data-schema): what minimum schema makes a drug-response report poolable? Seven candidate fields each have a basis — drug @Eckey2025PatientReported @Frost2009PatientsLikeMe, dose @Bourke2020PatientGeneratedData, dose band, duration @KleineBorgmann2025OpenLabelPlacebos @Schmid2022BayesianNof1, response domain @Calfee2018ARDSsubphenotypes @Vaes2023SymptomClusters, side-effect type @vanPuijenbroek2002Disproportionality @Cutroneo2023Disproportionality, stop reason @Micale2024SocialMediaMeds. One further variable is mandatory to test the null — a per-drug measure of community discussion volume or prescribing popularity; whether the set is sufficient, and what denominator or comparator is needed, is unresolved; disproportionality ranks associations without denominators @vanPuijenbroek2002Disproportionality but cannot establish causation @Cutroneo2023Disproportionality @Noguchi2021SignalDetection. (ch33 @oq:corpus-minimum-data-schema; cert n/a — research question; severity unknown; origin: brainstorm.)],[Phase 3 / n/a],

  [lim corpus-cannot-conclude], [Limitation (ch33 @lim:corpus-cannot-conclude): four structural limits not fixable by scale — (1) cannot confirm mechanism (disproportionality/observational inference generate hypotheses, not causal conclusions @Cutroneo2023Disproportionality @Zong2022EHRrepurposing); (2) cannot resolve spectrally identical hypotheses (two mechanisms predicting the same response to every accessible drug are indistinguishable — @sec:pharmacodiagnostic-matrix-clinical); (3) cannot overcome unblinded self-report @FlavioReis2025OpenLabelPlacebo @Nikles2022Nof1Physiotherapy; (4) cannot generalize from respondents to the population (web cohorts self-selected @Richiardi2007NINFEAInternet). A fifth ME/CFS-specific limit: severe patients are least able to contribute @Loth2026mecfs. (ch33 @lim:corpus-cannot-conclude; cert 0.60 — each limit established methodologically; severity unknown; origin: /integrate-topic pharmacodiagnostic-corpus.)],[Phase 3 / 0.60],

  [prop pharmacodiagnostic-corpus-specification], [Proposal (ch33 @prop:pharmacodiagnostic-corpus-specification): a minimum viable corpus specification — unit = one drug trial with the seven fields; response coded per domain (not global better/worse); aggregation = multi-level Bayesian pooling with responder-subgroup analysis @Schmid2022BayesianNof1 @Zucker2010 @Hendrickson2020AggregatedNof1 @Calfee2018ARDSsubphenotypes; output = ranked candidate pathways plus discriminating probes (@sec:pharmacodiagnostic-matrix-clinical); governance = published schema/aggregation/reading rules with the limits as standing caveats. Not a claim that a corpus exists. (ch33 @prop:pharmacodiagnostic-corpus-specification; cert 0.35 — design proposal from established methods; severity unknown; origin: brainstorm.) *Falsifiability:* an implementation following this specification yields a per-drug responder ranking with split-half agreement ρ > 0.5, and the top-ranked pathway survives adjustment for indication and treatment popularity (rank correlation > 0.7); falsified if split-half agreement is ≈ 0 or if adjustment materially reshuffles the ranking.],[Phase 5 / 0.35],

  [prop patient-drug-response-corpus], [Proposal (ch46 @prop:patient-drug-response-corpus): the chapter's N-of-1 and registry infrastructure already captures much of what a pharmacodiagnostic corpus needs but not in poolable form; minimum fields and multi-level Bayesian aggregation as in @prop:pharmacodiagnostic-corpus-specification; direct precedent is the Eckey 2025 ME/CFS + long-COVID treatment survey (n=3,925, >150 treatments) which ranks treatments by perceived benefit but not mechanisms @Eckey2025PatientReported. (ch46 @prop:patient-drug-response-corpus; cert 0.35 — design proposal; severity unknown; origin: brainstorm.) *Falsifiability:* a corpus built to the schema reproduces ≥1 known drug-response association and yields a per-drug ranking with split-half agreement ρ > 0.5 that tracks dose/target rather than community discussion volume; falsified if the ranking is unstable across splits, if no pooled association survives adjustment for indication/popularity, or if it tracks discussion volume rather than pharmacology (@lim:corpus-alternative-explanations).],[Phase 5 / 0.35],

  [lim corpus-inherits-pgkd-limits], [Limitation (ch46 @lim:corpus-inherits-pgkd-limits): a corpus built from patient/clinician reports inherits every limit of patient-generated knowledge — self-selection @lim:evidence-quality, community error amplification @lim:community-error-amplification, unblinding (open-label placebo @FlavioReis2025OpenLabelPlacebo @Nikles2022Nof1Physiotherapy), and severe-patient under-representation @oq:severity-epistemic-gradient. These define it as a hypothesis-generation instrument, not a conclusion. (ch46 @lim:corpus-inherits-pgkd-limits; cert n/a — synthesis of documented limits; severity unknown; origin: /integrate-topic pharmacodiagnostic-corpus.)],[Phase 3 / n/a],

  [spec pooled-nulls-more-informative], [Speculation (ch33 @spec:pooled-nulls-more-informative): positive reports are inflated by open-label placebo/enthusiasm/publication bias while null reports appear less inflated by expectation and are mostly absent from the published record — though fluctuation and regression to the mean offset this, so their net-bias advantage is estimated, not assumed — so the corpus's marginal value may concentrate in the null space. *Falsifiability:* in a corpus capturing both outcomes with equal recruitment effort, cross-cohort ICC is higher for null than positive reports, compared against the corpus's own inert-intervention floor (not a bare base rate, since agreement-on-noise can mimic the asymmetry); falsified if positives agree as well or better after that adjustment. (ch33 @spec:pooled-nulls-more-informative; cert 0.40; severity unknown; origin: brainstorm. The un-operationalized form — that nulls are 'more informative' — is unfalsifiable without the ICC or equivalent metric.)],[Phase 5 / 0.40],

  [spec variance-decomposition], [Speculation (ch33 @spec:variance-decomposition): partition each drug's response variance into a shared component (expectation/channel/era) and an idiosyncratic component (patient-specific); within the idiosyncratic component the mechanism-relevant part is the between-patient subgroup structure tracking dose/target/co-variable, separated from unstructured noise. The ratio of mechanism-relevant variance to shared variance is an estimable per-drug quantity governing how much each report counts. *Falsifiability:* per-drug mechanism-relevant variance fractions predict cross-cohort replication of that drug's responder pattern (higher fraction → higher replication, ρ > 0.4); falsified if the mechanism-relevant fraction is unrelated to replication, or near zero for all drugs (only shared bias and noise recoverable). (ch33 @spec:variance-decomposition; cert 0.40; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [spec inert-intervention-floor], [Speculation (ch33 @spec:inert-intervention-floor): mechanistically-inert interventions form an internal control arm estimating the community's expectation/recall/fluctuation floor under the corpus's own conditions; subtracting it converts a raw catalog into an expectation-adjusted one. Supplements are the high-volume stratum @Eckey2025PatientReported. *Falsifiability:* inert interventions pool to a stable non-zero floor of magnitude smaller than targeted drugs' response, whose subtraction changes the pathway ranking (at least one top-5 pathway changes rank); falsified if the inert floor is zero, equals the targeted-drug magnitude (corpus measures expectation, not mechanism), if subtraction leaves the ranking unchanged, or if the inert stratum's response is unstable under pre-registration (the floor is hypothesis-space-dependent, not a fixed baseline). (ch33 @spec:inert-intervention-floor; cert 0.40; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [prop hybrid-corpus-nested-nof1], [Proposal (ch33 @prop:hybrid-corpus-nested-nof1): observational corpus supplies wide hypothesis-generating signal; a nested randomized double-blind placebo-controlled n-of-1 sub-study on the corpus's top 3–5 drugs supplies causal confirmation. Components established @Punja2016Nof1Aggregation @Zucker2010 @Schmid2022BayesianNof1. *Falsifiability:* top-ranked corpus drug beats placebo in the nested blinded sub-study at a higher rate than a randomly chosen corpus drug; falsified if nomination does not enrich for blinded-confirmed response. (ch33 @prop:hybrid-corpus-nested-nof1; cert 0.40; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [prop shared-lc-corpus], [Proposal (ch33 @prop:shared-lc-corpus): a shared ME/CFS + long-COVID corpus tests mechanism overlap directly — drug-response fingerprints should correlate more within each condition than between them at equal severity. Joint survey exists @Eckey2025PatientReported. *Falsifiability:* ρ_within > ρ_between for severity-matched pairs; falsified if fingerprints indistinguishable across conditions. (ch33 @prop:shared-lc-corpus; cert 0.40; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [prop corpus-discovers-probes], [Proposal (ch33 @prop:corpus-discovers-probes): rank existing drugs by the empirical narrowness of their responder subgroup (response concentration/entropy) to find high-spectral-resolution probes — data-driven rather than heuristic, avoiding the labeling-bias concern in the expected-response matrix @Hendrickson2020AggregatedNof1 @Calfee2018ARDSsubphenotypes. *Falsifiability:* empirical response concentration predicts discriminating power in an independent validation cohort after confounder adjustment; falsified if unrelated or if the concentration disappears after adjustment. (ch33 @prop:corpus-discovers-probes; cert 0.35; severity unknown; origin: brainstorm. Clinician-matrix agreement cannot validate the method because the matrix is the labeling-biased object the proposal avoids.)],[Phase 5 / 0.35],

  [lim corpus-alternative-explanations], [Limitation (ch33 @lim:corpus-alternative-explanations): the corpus's testable null is that a model using only severity + drug-class popularity/availability + community discussion volume fits the response matrix as well as a model that additionally uses dose and molecular target (making the corpus a treatment-preference catalog like Eckey 2025 @Eckey2025PatientReported). Three specific alternatives — confounding by indication @Zong2022EHRrepurposing @Shahn2022AntihypertensiveRepurposing, community amplification (apparent efficacy tracking discussion volume), and spectral degeneracy of the drug set (many mechanism assignments fit equally) — can each produce the apparent signal without mechanism. Rejection requires recording indication + co-medication, subtracting an internal inert-intervention floor, showing response tracks dose/target rather than discussion volume (pre-registered model comparison), and demonstrating a small set of fitting mechanism assignments (from the volume-adjusted matrix). (ch33 @lim:corpus-alternative-explanations; cert 0.50; severity unknown; origin: brainstorm.)],[Phase 5 / 0.50],

  [lim corpus-measurement-limits], [Limitation (ch33 @lim:corpus-measurement-limits): four measurement problems bound precision — (1) unblinded non-standardized outcome (the class open-label placebo moves most @FlavioReis2025OpenLabelPlacebo @KleineBorgmann2025OpenLabelPlacebos) requires a validated instrument; (2) no denominator @vanPuijenbroek2002Disproportionality; (3) polypharmacy/co-prescription confound @Schmid2022BayesianNof1; (4) recall and survivor bias in retrospective reports @Bourke2020PatientGeneratedData @Richiardi2007NINFEAInternet. (ch33 @lim:corpus-measurement-limits; cert 0.55; severity unknown; origin: brainstorm.)],[Phase 5 / 0.55],

  [lim corpus-selection-bias], [Limitation (ch33 @lim:corpus-selection-bias): contributors are self-selected (online, English-speaking, mild-to-moderate, resourced), so the severe long-duration patients whose responses would be most informative are least likely to contribute — non-random missingness correlating with the biology being ranked. Fixable only by caregiver-mediated/low-tech reporting by design @Richiardi2007NINFEAInternet @oq:severity-epistemic-gradient. (ch33 @lim:corpus-selection-bias; cert 0.55; severity unknown; origin: brainstorm.)],[Phase 5 / 0.55],

  [syn pharmacodiagnostic-corpus-model], [Synthesis (ch33 @syn:pharmacodiagnostic-corpus-model): the corpus is structured as a constraint-satisfaction problem whose statistical feasibility is established in general populations; its data substrate already exists; its most informative signal may sit in null reports; and it cannot confirm mechanism, resolve spectral degeneracy, overcome unblinding, or generalize from self-selected respondents. Consistency is not sufficient (a socially amplified false signal is also consistent) nor necessary (a subgroup signal need not move the population). The test is not calibration alone — if the adjusted residual ranking tracks discussion volume rather than dose/target, the proposal is abandoned. (ch33 @syn:pharmacodiagnostic-corpus-model; cert n/a — synthesis; severity unknown; origin: /integrate-topic pharmacodiagnostic-corpus.)],[Phase 10a / n/a],

  [compat note], [Compatibility (Phase 7): @hyp:population-pharmacodiagnostic-corpus REINFORCES the ch33 single-patient pharmacodiagnostic framework (@sec:differential-diagnostic-algorithm, @sec:pharmacodiagnostic-matrix-clinical) and the ch34 constraint-satisfaction matrix (@sec:pharmacodiagnostic-matrix) — it is the population-scale extension of the same constraint-propagation logic, not a competing claim. It FEEDS INTO the ch46 patient-generated-knowledge chapter (@ach:nof1-paradigm, @lim:nof1-limitations, @lim:community-error-amplification, @oq:null-epistemic-value): the corpus is the concrete research use of patient N-of-1 data. It is INDEPENDENT of the pharmacodiagnostic-origin-inference axis (origin elimination) — one ranks mechanisms, the other eliminates origin categories. The limits (@lim:corpus-cannot-conclude, @lim:corpus-inherits-pgkd-limits) are consistent with @lim:nof1-limitations and @lim:knowledge-ceiling; no conflict. No certainty bumps applied — the corpus claim is a methodological proposal (cert 0.45) whose supporting papers are general-population (discounted below 0.60), below the reinforcement-bump threshold; Active Caps permit normal bump rules but no qualifying incoming evidence exists. Compat audit at tmp/compat-audit-pharmacodiagnostic-corpus-2026-09-10.md.],[Phase 7 / n/a],
)

= Entries added 2026-09-10: Eckey 2025 Mechanism Re-analysis (eckey2025-mechanism-reanalysis)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec eckey-mechanism-ranking-projection], [Speculation (ch33 @spec:eckey-mechanism-ranking-projection): the Eckey 2025 ME/CFS + long-COVID treatment survey (n=3,925; >150 interventions; public Datasets S1–S3) ranks treatments by perceived benefit (NAS) but not mechanisms @Eckey2025PatientReported; mapping each treatment to its known target and projecting the benefit ranking onto the hypothesis space yields a mechanism ranking testable by split-half replication, using drug-set enrichment @Napolitano2016DrugSetEnrichment @Napolitano2019gep2pep and subgroup-validation machinery @Lipkovich2017SubgroupIdentification. Cluster-specific responses already exist (IgG multisystemic; stimulants cognitive). *Falsifiability:* projected subgroup-specific mechanism ranking has split-half agreement ρ > 0.5 and top pathway survives popularity adjustment; falsified if ranking unstable (ρ ≈ 0), no subgroup ranking survives, or explained entirely by treatment popularity. (ch33 @spec:eckey-mechanism-ranking-projection; cert 0.45 — dataset + method exist, projection never performed; severity unknown; origin: /integrate-topic eckey2025-mechanism-reanalysis.)],[Phase 3 / 0.45],

  [oq eckey-ranking-reliability-threshold], [Open question (ch33 @oq:eckey-ranking-reliability-threshold): no published standard establishes what split-half rank correlation counts as replication for a patient-reported treatment-benefit ranking projected onto mechanisms; closest machinery is general subgroup validation, which warns unconstrained subgroup rankings overfit @Lipkovich2017SubgroupIdentification. Outcome is unblinded/non-standardized (self-reported benefit ≠ objective function @Rekeland2022PROMmecfs; instrument choice changes measured response @Haywood2014PROMsystematic) and expectation alone moves this outcome class @FlavioReis2025OpenLabelPlacebo @KleineBorgmann2025OpenLabelPlacebos. A second ME/CFS ranking dataset offers an external concordance check but is not a reliability standard @Dorczok2026InterventionHelpfulness. (ch33 @oq:eckey-ranking-reliability-threshold; cert n/a — research question; severity unknown; origin: /integrate-topic eckey2025-mechanism-reanalysis.)],[Phase 3 / n/a],

  [lim eckey-projection-manufactures-ranking], [Limitation (ch33 @lim:eckey-projection-manufactures-ranking): popularity and many-to-many target mapping can manufacture an apparent mechanism ranking without mechanism. Apparent efficacy may track community discussion volume/prescribing (@Simmering2014WebSearchUtilization @Stallion2026GLP1SocialMedia; though web data can also carry genuine signal @YomTov2013WebSearchSurveillance) or a *structured* placebo network @WangRS2017PlaceboNetwork; and one drug maps to several mechanisms (LDN → TRPM3 + TLR4/glia @Lohn2024TRPM3LDN; autonomic drugs act on distinct targets for one symptom @Mar2020POTSMechanisms @Hasan2020POTSMedication). Eckey authors name self-selection/recall/placebo/polypharmacy. *Falsifiability:* a severity+popularity+volume model fits the response matrix at least as well as a dose+target model (pre-registered out-of-sample); falsified (ranking supported) if the target-and-dose model wins by a pre-specified margin after floor subtraction. (ch33 @lim:eckey-projection-manufactures-ranking; cert 0.50 — established threats + documented ME/CFS mapping ambiguity; severity unknown; origin: /integrate-topic eckey2025-mechanism-reanalysis.)],[Phase 3 / 0.50],

  [spec eckey-vitamin-c-self-calibration], [Speculation (ch33 @spec:eckey-vitamin-c-self-calibration): Eckey contains an internal low-expectation comparator — oral non-liposomal vitamin C with FDR-adjusted p-values @Eckey2025PatientReported — so every NAS can be expressed as a margin over the survey's own expectation floor before target mapping, making the projection self-calibrating in a way the parent corpus is not. Double-edged: vitamin C is not obviously mechanistically inert (antioxidant/collagen/immune; cf. @CastroMarrero2021CoQ10), so it validates itself as a floor only if it behaves statistically like the inert-supplement class, and refutes that use if it tracks dose or a specific domain. *Falsifiability:* the vitamin-C NAS distribution is statistically indistinguishable from the pooled distribution of independently judged mechanistically-inert supplements (no significant NAS difference after FDR), and subtracting it changes at least one top-5 projected mechanism; falsified if vitamin C separates from the inert stratum or its margin is domain-specific. (ch33 @spec:eckey-vitamin-c-self-calibration; cert 0.42; severity unknown; origin: brainstorm.)],[Phase 5 / 0.42],

  [spec eckey-cluster-discordance], [Speculation (ch33 @spec:eckey-cluster-discordance): averaging each treatment's NAS across the cohort hides a mechanism rate-limiting in one cluster but irrelevant in another; the higher-information statistic is the between-cluster variance of a treatment's NAS conditional on its overall NAS. Eckey documents cluster-specific response (IgG 73.3% multisystemic; ADHD stimulants 62.1% cognitive but non-significant multisystemic) @Eckey2025PatientReported; ARDS HARP-2 shows a real differential response inside an overall-null trial @Calfee2018ARDSsubphenotypes; ME/CFS shows within-diagnosis heterogeneity @Vaes2023SymptomClusters. Because drug-set enrichment assumes drugs sharing a target cohere @Napolitano2016DrugSetEnrichment while ME/CFS drug→target assignment is many-to-many @Lohn2024TRPM3LDN, dose-response geometry (NAS-vs-dose-band shape) is an alternative identifier that does not trust target labels. *Falsifiability:* a discordance-weighted mechanism ranking replicates across random cohort halves (ρ > 0.5) while the mean-weighted ranking does not, or the two differ by ≥1 top-5 mechanism; falsified if identical or if discordance fails to replicate better than the mean. (ch33 @spec:eckey-cluster-discordance; cert 0.38; severity unknown; origin: brainstorm.)],[Phase 5 / 0.38],

  [spec eckey-null-projection], [Speculation (ch33 @spec:eckey-null-projection): the proposal projects only positive NAS values onto targets, but a null-projection yields negative constraints — treatments whose target is documented and engaged (by dose/pharmacodynamics) while NAS sits at/near the vitamin C floor identify mechanisms repeatedly *engaged without moving symptoms*, i.e. non-rate-limiting pathways @spec:pooled-nulls-more-informative. The design is circular unless "target engaged" is defined from dose/target, never from benefit: many-to-many assignment @Lohn2024TRPM3LDN and target-distinct autonomic drugs for one symptom @Mar2020POTSMechanisms @Hasan2020POTSMedication both smuggle benefit back in. *Falsifiability:* for ≥1 documented target, treatments mapping to it cluster at/near the vitamin-C floor across clusters while target-engagement markers (dose, side-effect signature) are present; falsified if target-engagement and NAS are confounded by construction (no drug has an established target and a null NAS), making the null-projection uncomputable. (ch33 @spec:eckey-null-projection; cert 0.33; severity unknown; origin: brainstorm.)],[Phase 5 / 0.33],

  [spec eckey-cross-condition-gap], [Speculation (ch33 @spec:eckey-cross-condition-gap): Eckey's two populations are not identically ranked (ME/CFS vs long-COVID NAS values share R²=0.68 of variance) @Eckey2025PatientReported; reading the projection per condition, concordant mechanisms are candidate shared mechanisms and divergent ones candidate condition-specific mechanisms @Vaes2023SymptomClusters @Calfee2018ARDSsubphenotypes. The R²=0.68 is a descriptive treatment-level quantity, not a null distribution: using it as a mechanism-level rank-gap baseline is an assumption, not a derived result (no sampling model bridges the two levels; unadjusted for severity distribution; high concordance is equally consistent with shared popularity). The proposal becomes a real test only with a severity-matched comparison and a permutation-derived rank-gap null. *Falsifiability:* after severity-matched per-condition projection, ≥1 mechanism's cross-condition rank gap exceeds a permutation-derived null (not the raw R²=0.68) and its discordance replicates across random halves; falsified if all projected rankings are no more divergent than the derived null predicts, or diverging mechanisms fail to replicate. (ch33 @spec:eckey-cross-condition-gap; cert 0.40; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [oq eckey-validation-design], [Open question (ch33 @oq:eckey-validation-design): the projection has never been applied to patient-reported benefit, so its null — that the ranking carries no mechanism beyond popularity and severity — can be rejected only by a pre-specified design: (a) validate the pipeline on synthetic ground truth (simulate a known mechanism ranking and recover it), (b) use the structured placebo network as a negative-control arm @WangRS2017PlaceboNetwork, (c) derive the replication threshold by permutation rather than the ρ>0.5 convention, (d) build the popularity covariate from the survey instrument itself, (e) run an instrument-invariance pre-check against an independent ME/CFS survey @Dorczok2026InterventionHelpfulness before any concordance claim. Subgroup-validation machinery @Lipkovich2017SubgroupIdentification supplies the multiplicity control. (ch33 @oq:eckey-validation-design; cert n/a — research question; severity unknown; origin: brainstorm.)],[Phase 5 / n/a],

  [compat note eckey], [Compatibility (Phase 7): the Eckey re-analysis cluster REINFORCES @hyp:population-pharmacodiagnostic-corpus (a single-dataset execution of the ranking thesis), @spec:inert-intervention-floor (@spec:eckey-vitamin-c-self-calibration is its within-dataset instance), @spec:response-heterogeneity-subtypes and @prop:corpus-discovers-probes (@spec:eckey-cluster-discordance), @spec:pooled-nulls-more-informative (@spec:eckey-null-projection), @prop:shared-lc-corpus (@spec:eckey-cross-condition-gap; shares the R²=0.68 baseline), and @lim:corpus-alternative-explanations / @lim:corpus-measurement-limits (@lim:eckey-projection-manufactures-ranking). It FEEDS INTO @prop:pharmacodiagnostic-corpus-specification, @prop:patient-drug-response-corpus, @oq:corpus-minimum-data-schema, and @prop:hybrid-corpus-nested-nof1 via @oq:eckey-validation-design. No conflicts; the only internal tension (@spec:eckey-null-projection vs. @lim:eckey-projection-manufactures-ranking) is resolved by requiring engagement to be defined from dose/target, not benefit. No certainty adjustments — incoming evidence is methodological (discounted below 0.60), below the bump threshold; Active Caps cap 0.45 not crossed. Compat audit at tmp/compat-audit-eckey2025-mechanism-reanalysis-2026-09-10.md.],[Phase 7 / n/a],

  [syn eckey-mechanism-reanalysis-model], [Synthesis (ch33 @syn:eckey-mechanism-reanalysis-model): the Eckey 2025 survey is the corpus thesis's first executable test on existing data — it carries an internal expectation floor (vitamin C reference), supplies two internal tests (cluster discordance; ME/CFS-vs-LC localization), and has both positive and null reports for negative constraints. What it lacks is a basis for belief before validation: no split-half reliability standard for this ranking class, and popularity / many-to-many mapping / target-ontology dependence can each manufacture a ranking. The unanswered question is not whether the projection can run but whether a pre-registered design makes its output rejectable. Cross-refs @spec:eckey-mechanism-ranking-projection @spec:eckey-vitamin-c-self-calibration @spec:eckey-cluster-discordance @spec:eckey-null-projection @spec:eckey-cross-condition-gap @oq:eckey-ranking-reliability-threshold @oq:eckey-validation-design @lim:eckey-projection-manufactures-ranking. (ch33 @syn:eckey-mechanism-reanalysis-model; cert n/a — synthesis; severity unknown; origin: /integrate-topic eckey2025-mechanism-reanalysis.)],[Phase 10a / n/a],
)

= Entries added 2026-09-13: Common Biology of Fatigue Across Immune-Inflammatory Diseases (common-fatigue-biology)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [hyp shared-neuroimmune-fatigue-programme], [Hypothesis (ch16 @hyp:shared-neuroimmune-fatigue-programme): pathological fatigue across immune-inflammatory diseases may reflect, in part, a shared neuroimmune programme (sickness-behaviour cytokine-to-brain signalling) rather than many unrelated disease-specific fatigues. Prevalence estimates are broadly similar but span a wide range ($~42$–90%), a range also compatible with generic chronic-illness/questionnaire effects; the estimates are questionnaire-based and not immune-specific: MS $~80$% @Khan2014MSfatigue, SLE 67–90% @Kawka2021SLEfatigue, axSpA $~56$% @Tang2023AxialSpAFatigue, PsA $~51$% @Tang2025PsoriaticArthritisFatigue, IBD 47% (72% active) @DSilva2022IBDfatigue, MG 42–82% @Ruiter2020MyastheniaFatigue, PBC $>$50% @Lynch2022PBCfatigue, cancer 49% (62% on treatment) @AlMaqbali2021CancerFatigue. Human mechanistic support: ICI therapy — 58.5% of 53 patients developed worsening fatigue, distinguished by cytotoxic effector CD8+ expansion and stronger Th1 @Li2025ICIfatigue (confounded by ICI endocrinopathies/anaemia, not excluded); Dubbo cohort — EBV/Coxiella/Ross River each → $~11$% post-infectious chronic fatigue at 6 months @Hickie2006DubboCohort. Unifying reviews @Morris2016NeuroImmuneFatigue @Arnett2012InflammatoryFatigueSickness. *Falsifiability:* a pre-registered harmonized cross-disease cohort measuring the same cytokine-to-brain markers (IL-6/IL-1β/TNF-α, kynurenine:tryptophan, central-motivational proxy) shows fatigue severity tracking the neuroimmune panel better than disease-activity markers across diseases; falsified if disease-activity markers predict fatigue equally well or better across all conditions. (ch16 @hyp:shared-neuroimmune-fatigue-programme; cert 0.55 — cross-disease prevalence well-replicated, shared-programme interpretation untested as one hypothesis; severity unknown; origin: /integrate-topic common-fatigue-biology.)],[Phase 3 / 0.55],

  [spec immune-metabolic-energy-redistribution], [Speculation (ch16 @spec:immune-metabolic-energy-redistribution): persistent immune activation imposes a metabolic demand (activated T cells increase glucose uptake, glycolysis, protein synthesis, proliferation @Fenckova2024SelfishBrainImmune) that may compete with brain and muscle for substrate — a "selfish brain" vs "selfish immune system" allocation conflict. Direct support is acute-model: LPS lowered blood and CSF glucose and suppressed spontaneous activity in mice, partially rescued by glucose @Kealy2020InflammationBrainEnergy; human evidence is impaired brain glucose utilization in an inflammation-associated delirium cohort (n=406) @Titlestad2024BrainGlucoseDelirium. *Translation gap:* the causal glucose-substrate experiment is in mice; the human data are delirium, not ME/CFS; no study has measured an immune-metabolic allocation conflict in ME/CFS or Long COVID. *Competing explanation:* the human ICI correlate is immune-activation level (Th1/effector CD8), not measured substrate @Li2025ICIfatigue — cytokines may act directly on motivational circuits without any glucose shortfall; the two accounts are indistinguishable with current data. *Falsifiability:* in a prospective ME/CFS/post-infectious cohort, immune-metabolic demand markers (activated-T-cell glycolytic flux, glucose turnover) inversely track brain/muscle substrate availability (brain glucose or high-energy phosphate imaging, muscle PCr recovery) and correlate with fatigue severity; falsified if demand markers are unrelated to substrate availability, or fatigue tracks only direct cytokine signalling with no substrate change. (ch16 @spec:immune-metabolic-energy-redistribution; cert 0.33 — mouse + human-CSF, translation gap, single-programme dependency; severity unknown; origin: source thread / brainstorm.)],[Phase 3 / 0.33],

  [oq fatigue-heterogeneity-or-single-entity], [Open question (ch16 @oq:fatigue-heterogeneity-or-single-entity): should pathological fatigue be treated as one entity on a 0–10 severity scale, or as several mechanistically distinct subtypes? Heterogeneity evidence: MG distinguishes objective fatigability from subjective fatigue @Ruiter2020MyastheniaFatigue; PBC adds an autonomic axis (40% vs 6% orthostatic; independently associated with fatigue+cognition) @Newton2007PBCautonomic; fatigue is dissociated from disease activity in SLE @Kawka2021SLEfatigue, sarcoidosis @deKleijn2009SarcoidosisFatigue, SSc @Basta2018SScFatigue; it persists in AAV remission @Harper2021VasculitisFatigue. Suggests multiple maintenance mechanisms (cytokine-driven, autonomic, central-motivational, bioenergetic). *Alternative:* apparent heterogeneity could be measurement heterogeneity (different instruments/thresholds). *Testable now* with existing assays (cytokine panels, CD8 immunophenotyping, tilt/QSART, metabolomics). *Falsifiability:* biologically defined subtypes (≥ immune-inflammatory, autonomic, central-motivational) separate in an unsupervised multi-modal cross-disease analysis and each predict a distinct treatment response; falsified if fatigue maps onto a single dominant dimension with no separable mechanistic clusters. (ch16 @oq:fatigue-heterogeneity-or-single-entity; cert n/a — research question; severity unknown; origin: /integrate-topic common-fatigue-biology.)],[Phase 3 / n/a],

  [lim inflammation-necessary-not-sufficient], [Limitation (ch16 @lim:inflammation-necessary-not-sufficient): the shared-neuroimmune-programme account does not explain why fatigue severity is often dissociated from disease activity — fatigue persists in AAV remission @Harper2021VasculitisFatigue, correlates poorly with activity in SLE @Kawka2021SLEfatigue, and can remain when sarcoidosis organ inflammation is controlled @deKleijn2009SarcoidosisFatigue; conversely glucocorticoid treatment in sarcoidosis was associated with *more* fatigue (observational; indication-confounded) @deKleijn2009SarcoidosisFatigue. Implication: the dissociation evidence establishes that immune activation is *not sufficient* for persistent fatigue; necessity is unproven, since an inflammation-independent mechanism could sustain fatigue without any active inflammatory contribution. A second maintenance mechanism (autonomic, central-motivational, or bioenergetic) must sustain persistent fatigue — exactly the situation in ME/CFS, where fatigue persists long after the trigger resolves. One cross-disease candidate is the autonomic/orthostatic axis (PBC 40% vs 6%, independently associated with fatigue+cognition @Newton2007PBCautonomic), consistent with shared autonomic dysregulation @syn:comparative-nosology-framework. (ch16 @lim:inflammation-necessary-not-sufficient; cert n/a — limitation; severity unknown; origin: /integrate-topic common-fatigue-biology.)],[Phase 3 / n/a],

  [spec fatigue-tracks-immune-kinetics], [Speculation (ch16 @spec:fatigue-tracks-immune-kinetics): a different resolution of the dissociation problem is temporal — fatigue may track the *rate of change* of immune activation rather than its steady-state level, because sustained cytokines induce tolerance (receptor desensitisation/negative feedback) while a rising state does not @Fenckova2024SelfishBrainImmune. This would explain why fatigue is prominent during acute activation (ICI cohort 58.5% worsening with effector-CD8/Th1 expansion @Li2025ICIfatigue) yet dissociates from stable disease-activity measures in chronic disease (SLE @Kawka2021SLEfatigue, sarcoidosis @deKleijn2009SarcoidosisFatigue, SSc @Basta2018SScFatigue, AAV remission @Harper2021VasculitisFatigue). *Competing explanation:* subtype-mixing (@oq:fatigue-heterogeneity-or-single-entity) or a second inflammation-independent mechanism (@lim:inflammation-necessary-not-sufficient). *Translation gap:* kinetic inference from cross-sectional/acute-phase data; no rate-of-change-vs-fatigue-trajectory study exists. *Falsifiability:* in a longitudinal cohort, within-individual fatigue severity correlates more strongly with the first difference of the immune-activation panel than with its absolute level; falsified if fatigue tracks the tonic level as well or better. (ch16 @spec:fatigue-tracks-immune-kinetics; cert 0.33 — single cross-sectional ICI source, no kinetic measurement in ME/CFS; severity unknown; origin: brainstorm.)],[Phase 5 / 0.33],

  [compat note common-fatigue-biology], [Compatibility (Phase 7): @hyp:shared-neuroimmune-fatigue-programme REINFORCES @spec:lc-adhd-neuroimmune-shared-substrate (kynurenine-to-dopamine axis is a specific instance of the cytokine-to-brain programme) and the ch08 neuroinflammation subsection (@sec:neuroinflammation). @oq:fatigue-heterogeneity-or-single-entity REINFORCES the ch16 three-axis framework (@syn:comparative-nosology-framework) — mechanism-defined subtypes are the same argument applied to fatigue specifically — and the ch03 fatigue cluster entries (@hyp:fatigue-embedded-clusters, @clf:fatigue-vs-fatigability, @oq:fatigue-subjective-objective). @spec:immune-metabolic-energy-redistribution FEEDS INTO the ch07 energy-metabolism chapter and the ch33/34 pharmacodiagnostic corpus's mechanism-ranking space (@spec:eckey-mechanism-ranking-projection). @lim:inflammation-necessary-not-sufficient is consistent with the ch06/ch15 fatigue-vs-CNS-inflammation plan and @lim:neuroinflammation-measurement-challenges. No conflicts; no certainty bumps (incoming cross-disease evidence is other-population, discounted below the 0.60 bump threshold; no ME/CFS-cohort paper was added). Compat audit at tmp/compat-audit-common-fatigue-biology-2026-09-13.md.],[Phase 7 / n/a],

  [syn common-fatigue-biology-model], [Synthesis (ch16 @syn:common-fatigue-biology-model): fatigue prevalence is convergent across 15 immune-inflammatory diseases ($~50$–90%) and defined-immune-stimulus human models (ICI 58.5%; Dubbo $~11$% at 6 months) show immune activation can produce fatigue @hyp:shared-neuroimmune-fatigue-programme; but the relationship to disease activity is not convergent — dissociation in SLE/sarcoidosis/SSc and persistence in AAV remission mean inflammation is not sufficient for persistent fatigue (and necessity is unproven) @lim:inflammation-necessary-not-sufficient. Two non-exclusive resolutions remain open: fatigue tracks immune *kinetics* @spec:fatigue-tracks-immune-kinetics, or pooled signal averages distinct subtypes @oq:fatigue-heterogeneity-or-single-entity. The immunometabolic allocation-conflict account has mouse/delirium proof-of-principle only and competes with a direct cytokine-to-motivation account @spec:immune-metabolic-energy-redistribution. The synthesis rests on cross-disease/model evidence; no ME/CFS cohort has tested the shared programme, so its application to ME/CFS remains an analogy. (ch16 @syn:common-fatigue-biology-model; cert n/a — synthesis; severity unknown; origin: /integrate-topic common-fatigue-biology.)],[Phase 10a / n/a],
)

= Entries added 2026-09-13: Stimulant Arousal/Reward vs Attention Networks (kay2025-stimulant-arousal-reward)

#table(
  columns: (1fr, 2.4fr, 1fr),
  [*ID / Label*], [*Details*], [*Phase / Cert*],

  [spec stimulant-arousal-reward-not-attention], [Speculation (ch33 @spec:stimulant-arousal-reward-not-attention): large-sample human evidence (ABCD n=11,875 + controlled methylphenidate challenge) localizes therapeutic stimulant action to arousal (somato-cognitive action/motor) and reward-salience (salience/parietal-memory) networks, with no effect in dorsal/ventral attention or frontoparietal control networks @Kay2025stimulantarousalreward; concordant meta-analyses show no reliable objective cognitive enhancement in rested healthy adults @Ilieva2015StimulantMetaAnalysis @Roberts2020CognitiveEnhancementMeta @Marraccini2016StimulantMetaAnalysis @Repantis2010ModafinilMPHenhancement, and amphetamines raise willingness to invest effort without improving ability @Chong2023AmphetamineMotivation. Read through this, a positive stimulant response in ME/CFS is consistent with low arousal/reward-effort salience rather than a restored attention capacity (the site of drug action constrains what changes, not what was broken); the underlying energy deficit that drives objective impairment is untouched, mechanistically explaining the masking/overexertion hazard (stimulants raise effort level, lower effort quality @Bowman2023NotSoSmart; survey +77.1% brain fog but −1.5% PEM @Eckey2025PatientReported). *Competing mechanism:* task-fMRI meta-analysis reports right inferior frontal/insular (cognitive-control) activation increases @Rubia2014StimulantBrainMeta — a design/sample difference rather than a proven contradiction. *Moderator caveat:* Kay's objective-cognition benefit appeared in depleted (ADHD/sleep-deprived) participants, a state ME/CFS may resemble, so the attention-capacity null may not transfer to an energy-depleted brain. *Translation gap:* no ME/CFS-cohort test; cross-disease (general population + ADHD). *Falsifiability:* an ME/CFS stimulant challenge should show subjective arousal/effort-reward benefit without a specific cognitive-control improvement (the Rubia prediction is the reverse: a specific cognitive-control improvement with an appropriate baseline deficit); disconfirmed by the Rubia pattern, by benefit scaling with objective attention improvement rather than subjective arousal, or by benefit being non-selective across all patients. Note the attention-capacity claim is bounded to rested brains — it may not hold in ME/CFS if ME/CFS resembles Kay's depleted subgroup. Consequence: a clinician should read a good stimulant response as a probe of arousal/reward, not as proof of an attention defect, because the drug can raise effort without restoring capacity — mechanistically explaining why it can mask fatigue and enable overexertion. (ch33 @spec:stimulant-arousal-reward-not-attention; cert 0.60 — raw 0.80 general-population/ADHD discounted; severity unknown; origin: /integrate-topic kay2025-stimulant-arousal-reward.)],[Phase 3 / 0.60],

  [oq stimulant-arousal-vs-cognitive-control], [Open question (ch33 @oq:stimulant-arousal-vs-cognitive-control): for ME/CFS, does a positive stimulant response index low arousal/reward salience (Kay 2025 @Kay2025stimulantarousalreward) or a cognitive-control circuit idling below capacity (Rubia 2014 @Rubia2014StimulantBrainMeta)? The discounted certainties differ by ~0.10 (0.60 vs 0.49), within measurement uncertainty, and Kay attributes the discrepancy to design (large brain-wide association vs small task-fMRI ROI studies), but the two designs measure different things (resting-state connectivity vs task-evoked control), so it is not fully adjudicated. The two accounts predict different differential inferences from a positive response. *Falsifiability:* an ME/CFS stimulant challenge with simultaneous subjective arousal/reward scales and an objective cognitive-control task distinguishes them — arousal/reward benefit without cognitive-control improvement supports Kay; a specific cognitive-control improvement with an appropriate baseline deficit supports Rubia. Consequence: resolving this decides whether a positive stimulant response is a reward/arousal probe or evidence of an under-driven cognitive-control circuit — changing which upstream mechanism is targeted next. (ch33 @oq:stimulant-arousal-vs-cognitive-control; cert n/a — research question; severity unknown; origin: /integrate-topic kay2025-stimulant-arousal-reward.)],[Phase 3 / n/a],

  [spec stimulant-endophenotypes-arousal-reward], [Speculation (ch33 @spec:stimulant-endophenotypes-arousal-reward): the two stimulant systems (noradrenergic arousal; dopaminergic reward-effort salience @Kay2025stimulantarousalreward) suggest a positive response in ME/CFS may have two compositions (though Kay found two correlated networks, not demonstrated separable systems): an arousal-dominant phenotype (wakefulness/alertness gain) predicted to prefer arousal-selective agents (modafinil/armodafinil/pitolisant @Repantis2010ModafinilMPHenhancement) versus a reward-effort-dominant phenotype (drive/initiation gain) predicted to prefer methylphenidate @Chong2023AmphetamineMotivation @Bowman2023NotSoSmart. Adrenergic dysfunction in ME/CFS/FM @Hendrix2025AdrenergicDysfunction supplies a plausible arousal substrate; direct ME/CFS reward-motivation data are absent. *Competing explanation:* a single non-specific "feeling better" factor, with differences dose/side-effect driven. *Translation gap:* no ME/CFS cross-over study. *Falsifiability:* requires a baseline classifier independent of drug response; given one, arousal-classified patients respond to arousal-selective agents and reward-classified patients to methylphenidate on a pre-specified within-patient outcome; non-selective benefit, or no baseline classifier predicting the matched drug, falsifies separability. Consequence: if real, drug choice could follow the dominant symptom (wakefulness vs drive) rather than treating all responders identically. (ch33 @spec:stimulant-endophenotypes-arousal-reward; cert 0.40 — raw 0.53 general-population/ADHD discounted; severity unknown; origin: brainstorm.)],[Phase 5 / 0.40],

  [syn kay-stimulant-arousal-reward-probe], [Synthesis (ch33 @syn:kay-stimulant-arousal-reward-probe): convergent human evidence places stimulant action on arousal and reward-salience networks, not attention-control networks @Kay2025stimulantarousalreward, with no objective cognitive enhancement in rested adults @Ilieva2015StimulantMetaAnalysis @Roberts2020CognitiveEnhancementMeta and effort-invigoration without ability gains @Chong2023AmphetamineMotivation @Bowman2023NotSoSmart. Read through ME/CFS, a positive response is better read as an arousal/reward-effort signal (@spec:stimulant-arousal-reward-not-attention) than as proof of a broken attention system, and a response may fractionate into arousal-deficient vs reward-effort-deficient subtypes (@spec:stimulant-endophenotypes-arousal-reward) — hypothesis-generating only, lacking an independent classifier, against an unresolved cognitive-control competitor @oq:stimulant-arousal-vs-cognitive-control. Cross-refs @spec:stimulant-arousal-reward-not-attention @oq:stimulant-arousal-vs-cognitive-control @spec:stimulant-endophenotypes-arousal-reward. Consequence: stimulants may serve as probes of whether a patient's problem is feeling awake or feeling motivated, but they are not evidence of an attention defect. (ch33 @syn:kay-stimulant-arousal-reward-probe; cert n/a — synthesis; severity unknown; origin: /integrate-topic kay2025-stimulant-arousal-reward.)],[Phase 10a / n/a],

  [compat note kay2025-stimulant-arousal-reward], [Compatibility (Phase 7): @spec:stimulant-arousal-reward-not-attention REINFORCES the ch07 PFC energy-failure framework (@syn:prefrontal-energy-adhd-unification; @sec:prefrontal-executive-adhd) by refining what the stimulant signal means, and REINFORCES @spec:adhd-mecfs-same-root — the same low-arousal/reward-effort mechanism applies in both conditions. It is CONSISTENT WITH the existing ch33 stimulant differential content (@sec:cns-stimulants) and the masking/overexertion warning. It FEEDS INTO @oq:stimulant-arousal-vs-cognitive-control as a possible ME/CFS probe of reward-effort motivation. The endophenotype speculation @spec:stimulant-endophenotypes-arousal-reward FEEDS INTO @oq:stimulant-arousal-vs-cognitive-control and the ch33 stimulant drug-selection content. No conflict: the Rubia cognitive-control account is retained as @oq:stimulant-arousal-vs-cognitive-control. No certainty bumps — incoming evidence is general-population/ADHD (discounted 0.60), and the new claim is itself the adjusted value; the ch07 synthesis is not bumped because the incoming evidence is cross-disease, not ME/CFS-specific. Compat audit at tmp/compat-audit-kay2025-stimulant-arousal-reward-2026-09-13.md.],[Phase 7 / n/a],
)
