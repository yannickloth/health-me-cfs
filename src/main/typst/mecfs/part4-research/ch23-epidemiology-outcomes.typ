...
Evidence supports a genetic contribution to ME/CFS susceptibility, with the genetic architecture increasingly well-characterised by large-scale studies:
    ...
    - *Genome-wide studies*: DecodeME (n>15,000) and the Maccallini 2026 meta-GWAS (19,470 cases, 699,111 controls) have identified replicated brain-enriched genetic architecture with glutamatergic synapse genes as the most specific signal @DecodeME2025 @Maccallini2026metaGWAS. SNP heritability is 9.5%. No significant genetic correlation with autoimmune diseases. See Section @sec:omics-studies and Chapter @ch:genetics-epigenetics.
