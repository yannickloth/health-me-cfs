...
#include "../../protocols/proto-clinical-decision-algorithm-sleep-medication-selection.typ"
...
#include "../../warnings/warn-gabapentin-sleep-breathing-warning.typ"

#include "../../limitations/lim-gabapentin-sleep-architecture-uncertainties.typ"
    ...
    - *Suvorexant/lemborexant*: Orexin receptor antagonists that may be particularly relevant given documented orexin pathway dysfunction in post-viral fatigue states @Ruhrländer2025orexinPASC @Heinicke2025orexinCOVID and hypothesized functional orexin suppression in ME/CFS (Section @spec:mecfs-functional-narcolepsy). Clinical experience in ME/CFS is limited. *Caveat:* if ME/CFS involves orexin deficiency, DORAs could theoretically worsen it by antagonizing already-scarce ligand — though daridorexant's short half-life and sleep-consolidation benefits may outweigh this concern
