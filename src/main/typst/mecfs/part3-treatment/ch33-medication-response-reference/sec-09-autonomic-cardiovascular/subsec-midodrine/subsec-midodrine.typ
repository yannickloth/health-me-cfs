...
==== If midodrine does NOT work

- Venous pooling may not be dominant; the mechanism may be hypovolemia (fludrocortisone-responsive).
- In hyperadrenergic POTS, excessive sympathetic tone is already present — adding an α1 agonist raises blood pressure without improving orthostatic tolerance.
...
==== How midodrine combines with other medications
...
The full pharmacodiagnostic entry — including mechanism-exclusion logic, dose-specific side-effect diagnostic patterns, combination diagnostics, and worsening risk profiles — is at @ch:mechanistic-cascade-tracing (Chapter 34, sec-12, Midodrine entry).
