...
This is investigational — measure NET biomarkers before and after to assess biological response, not just symptoms. Inhaled dornase alfa targets pulmonary NETs; systemic delivery for vascular NETs may require a different approach.

==== How dornase alfa combines with other medications
...
The full pharmacodiagnostic entry — including mechanism-exclusion logic, dose-specific side-effect diagnostic patterns, combination diagnostics, and worsening risk profiles — is at @ch:mechanistic-cascade-tracing (Chapter 34, sec-12, Dornase alfa entry).
