...
The gut--vagal pathway is particularly vulnerable: butyrate deficiency (documented in ME/CFS microbiome studies) reduces enterochromaffin cell signalling to vagal afferents. Kaelberer et al.\ (2018) demonstrated that enteroendocrine cells form glutamatergic synapses with vagal neurons @Kaelberer2018; these mucosal vagal afferent terminals are predominantly unmyelinated C-fibres. Reduced butyrate thus compounds the structural C-fibre deficit with a functional chemosensory deficit.
