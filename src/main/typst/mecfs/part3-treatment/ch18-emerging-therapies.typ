...
- CoQ10 200~mg + NADH 20~mg daily: Highest-quality current evidence (RCT n=207); appropriate for discussion with all patients
- Pyridostigmine 30--60~mg: Two positive controlled hemodynamic studies; appropriate for patients with documented orthostatic intolerance or preload failure
- Low-dose naltrexone 1.5--4.5~mg: Convergent evidence across fibromyalgia and ME/CFS case series; reasonable to offer patients unresponsive to first-line symptomatic management (see Section:sigma1-fluvoxamine)
- Fluvoxamine 25~mg: Sigma-1 receptor agonism with small ME/CFS trial support (see Section:sigma1-fluvoxamine)
...
TMS used as a _diagnostic_ probe---not a therapy---has revealed objectively abnormal motor cortex function in CFS patients. Samii et al. found that after exercise, healthy controls showed motor evoked potential (MEP) amplitudes at 218% of baseline, while CFS patients reached only 126%---a near-absence of the normal post-exercise facilitation response Starr et al. confirmed significantly higher resting motor thresholds (reduced cortical excitability) and absent post-exercise MEP facilitation in CFS Davey et al. demonstrated that motor performance deficits correlated with changes in corticospinal excitability, supporting a neurophysiological rather than psychological basis for motor dysfunction
...
- *Kakuda et al. (2016)*: Case series, n=7 (5 completed). High-frequency rTMS to left dorsolateral prefrontal cortex (DLPFC) over 3 days. Most patients showed improvement on Visual Analogue Scale fatigue and Brief Fatigue Inventory. Two required intensity reduction for mild adverse reactions

- *Yang et al. (2020)*: Open-label, n=22 (9 severe, 13 mild). 10~Hz high-frequency rTMS to prefrontal cortex. Fatigue improved regardless of baseline severity, with significant VAS reductions at discharge and 2-week follow-up

- *Miwa & Inoue (2023)*: Open-label, n=30. Dual-target intermittent theta burst stimulation (iTBS) to left DLPFC and left primary motor cortex (M1), 600 pulses per site, 10 sessions over 2-week hospitalization. Results: 67% achieved ≥2-point improvement on performance status; orthostatic intolerance resolved in 83% (10/12); disequilibrium resolved in 88% (15/17); pain improved in 70% (7/10). Median performance status decreased from 7 to 5 (p#sym.lt 0.01)

- *Miwa (2025)*: Extension study, n=13 treated of 160 assessed. Same dual-target iTBS protocol. 85% (11/13) recovered balance function. Static disequilibrium prevalence 25%, kinetic 44% in the assessed cohort
...
- *Toh et al. (2022) meta-analysis*: 11 sham-controlled RCTs, 303 patients. rTMS was superior to sham for pain (SMD = −0.35, p=0.01) and quality of life (SMD = −0.51, p=0.0003). No significant effect on depression or anxiety

- *Su et al. (2021) meta-analysis*: 18 RCTs, 643 patients. Significant reduction in disease impact (SMD = −0.700), pain, depression, and anxiety. Effects persisted at 1.5--3 months follow-up

- *Lefaucheur et al. (2020) guidelines*: Assigned *Level B evidence (probable efficacy)* for high-frequency rTMS of left M1 or DLPFC in fibromyalgia ME/CFS was not separately graded due to insufficient evidence.
...
- *ATP substrate provision*:
  - *D-ribose* 10--15~g: Ribose is the sugar backbone of ATP; provides direct substrate for ATP resynthesis. An open-label, uncontrolled survey (n=257) reported 61% improvement in energy; the absence of a control group prevents distinguishing specific from placebo effects, and the lead author has commercial interests in supplement products. *CONTRAINDICATION*: Diabetes, hypoglycemia (paradoxically lowers blood glucose)---see warning in Chapter:action-mild-moderate
  - *Citrulline-malate* 3--6~g: Dual mechanism---malate replenishes depleted TCA cycle intermediates (documented deficiency in ME/CFS); citrulline supports urea cycle/ammonia detoxification. 31P-MRS evidence in healthy subjects shows 34% increased oxidative ATP production; extrapolation to ME/CFS is inferential
...
- *High-dose antioxidant buffer*:
  - *N-acetylcysteine (NAC)* 1200--1800~mg: Glutathione precursor; scavenges ROS. Targets documented 36% brain glutathione deficiency in ME/CFS, replicated with 7T MRS First oral NAC crosses BBB and elevates brain GSH. Pilot data suggest symptom improvement at 1800~mg/day; NIH RCT ongoing (NCT04542161)
  ...
  - #warning-env(title: [Antioxidant-Mitophagy Trade-off])[High-dose antioxidants (NAC, ALA, Vitamin C) may blunt PINK1/Parkin-mediated mitophagy, because ROS and mild mitochondrial membrane depolarisation are required signals for mitophagy initiation Scavenging these signals in Phase 1 (0--2h) could interfere with Phase 2 damaged-mitochondria removal, potentially prolonging the functional deficit. The protocol simultaneously prescribes Urolithin A (mitophagy activator) in Phase 2 to compensate, but the net interaction is untested. Conservative option: reduce antioxidant dose and duration, limiting high-dose antioxidants to the first 2--4 hours only.]
...
*Mechanistic support*:
- ATP depletion as PEM driver: Documented in Heng 2025
- Mitochondrial damage-regeneration gap: Matches 13-day CPET recovery timeline
- NAD+ depletion via PARP: Established pathway with ME/CFS abnormalities
...
If the HSAT2 exosomal loop is operative in ME/CFS:hsat2-exosome-mdsc, NRTI use could theoretically reduce the loop amplitude. This is a *research-stage question*, not a treatment recommendation. Several obstacles make direct translation premature:
...
The three core targets of the HSAT2 inflammaging model — HERV-K/LINE-1 retrotransposon activation, NAD+/SIRT1-axis failure, and cumulative PEM-driven HSAT2 amplification — map onto three available interventions: lamivudine (NRTI, suppresses HERV-K RT activity and LINE-1/cGAS-STING:nrti-hsat2); NR (NAD+ precursor, restores SIRT1/SUV39H1-mediated H3K9me3 maintenance:nr-nmn-hsat2); and strict pacing (prevents HSF1-mediated HSAT2 amplification per exertional event:pacing-hsat2-prophylaxis). Each addresses a different failure mode; the combination is mechanistically non-redundant and collectively covers the three principal entry points for HSAT2 derepression.
...
*Mechanistic non-redundancy check:* Lamivudine acts on RT-dependent amplification (HERV-K, LINE-1 cDNA); NR acts on the SIRT1 deacetylase that maintains H3K9me3; pacing reduces the frequency of HSF1-triggering events. If any single mechanism dominates, single-agent intervention should be equally effective; if the gain product $alpha gamma$ in the MDSC×EV model requires all three failure modes simultaneously, the combination is superior:hsat2-mdsc-ode-model.
...
Phosphodiesterase-5 (PDE5) inhibitors (sildenafil, tadalafil) are established MDSC-depleting agents in oncology: they reduce MDSC arginase-1 and iNOS expression, promoting MDSC differentiation into mature myeloid cells, and have been shown to restore T-cell and NK function in tumor-bearing mice and cancer patients. The arginase-1/L-arginine mechanism is the same pathway proposed to suppress NK cytotoxicity in ME/CFS via MDSC expansion:mdsc-nk-bridge.
...
PD-1/PD-L1 checkpoint inhibitors (atezolizumab, durvalumab, pembrolizumab) cause severe or life-threatening immune-related adverse events (irAEs) in 20–60% of cancer patients (grade 3–4 in 20–35%). Documented irAEs include autoimmune pneumonitis, colitis, hepatitis, myocarditis, and severe endocrinopathies. In ME/CFS, where immune checkpoint signaling is already dysregulated and where MCAS, mast cell activation, and autoimmune comorbidities are common, the irAE risk profile is unpredictable and potentially worse than in cancer. No ME/CFS clinical trial of any checkpoint inhibitor is ongoing or planned as of 2026. These agents must not be used outside a prospective clinical trial with a full institutional review process and safety monitoring board. Certainty that benefit would outweigh harm: 0.10 — listed for mechanistic completeness only.
]

#open-question(title: [Could Checkpoint Blockade (Anti-PD-L1) Reverse ME/CFS T-Cell and NK Exhaustion?])[


Iu et al.\ identified PD-L1/2 upregulation on ME/CFS monocytes as a proximate suppressor of CD8+ T-cell function; Eaton-Fitch et al.\ confirmed shared PD-1/CTLA-4 dysregulation in ME/CFS and Long COVID. In oncology, anti-PD-L1 checkpoint blockade (atezolizumab, durvalumab) reverses T-cell exhaustion and restores anti-tumor immunity.

The question of whether checkpoint blockade could be repurposed in ME/CFS is a legitimate mechanistic question, but with profound safety constraints: (1) checkpoint blockade carries 15–25% risk of serious immune-related adverse events (irAEs) including pneumonitis, colitis, hepatitis, and severe endocrinopathies; (2) ME/CFS patients may have exaggerated irAE susceptibility if underlying mast cell or autoimmune predisposition is present; (3) if T-cell exhaustion in ME/CFS is driven by EV-cargo programming rather than antigen-driven exhaustion:tcell-exhaust-ev-downstream, checkpoint reversal would be temporarily effective but would not address the upstream cause. This is a research question only, not a clinical direction.
...
The cycle dynamics framework (Chapter:core-symptoms,:pem, "Ratchet Effect") identifies seven irreversibility mechanisms. Not all are equally entrenched, and treatment windows exist where aggressive intervention may reverse seemingly permanent dysfunction. This section provides a mechanism-by-mechanism analysis of reversibility potential.
...
#figure(
  table(
    ...
    [Muscle deconditioning], [Muscle rebuilds with careful progressive loading below PEM threshold], [Isometric exercises, very gradual reconditioning (see Chapter:action-mild-moderate)], [Return to 50--70% of pre-illness strength (if PEM avoided)],
  ),
...
where $g_i$ is the gain of each component process (ROS generation, mitochondrial damage, biogenesis impairment, etc.). This multiplicative relationship is standard in feedback systems analysis
...
*Proposed clinical proxy*: We hypothesize that recovery time after standardized exertion _correlates with_ (but does not define) cycle gain. This correlation requires empirical validation. The mapping between recovery time and $G$ proposed in:cycle-gain-prognosis is a testable hypothesis, not an established relationship.
...
#figure(
  ...
  caption: [Proposed Cycle Gain Classification and Prognosis (Hypothetical---Requires Validation). #super[\*]Specific prognosis percentages removed as they were not empirically derived. The qualitative relationship (longer recovery → poorer prognosis) is hypothesized based on disease chronicity patterns but the quantitative mapping to $G$ values requires prospective validation. *Evidence Grade: D* (entire classification scheme is theoretical).]
)
...
The AIMM cascade (Section:sodium-calcium-cascade) proceeds as: ischaemia → proton accumulation → NHE1 activation → Na#super[+] overload → NCX1 reversal → mitochondrial Ca#super[2+] overload → OXPHOS failure. Bridging candidates act at different nodes:
...
*Pyridostigmine* (acetylcholinesterase inhibitor) enhances cholinergic tone, which stimulates Na#super[+]/K#super[+]-ATPase via muscarinic signaling. Its primary indication in ME/CFS is hemodynamic orthostatic intolerance, where two controlled studies have produced positive results. Joseph et al.\ (2022) demonstrated improved preload failure on invasive cardiopulmonary exercise testing, and Squires et al.\ (2023) documented improved long-term exercise capacity (oxygen uptake efficiency slope, pulmonary vascular capacitance) These results suggest pyridostigmine acts on vascular physiology relevant to the ischaemic component of the AIMM model, though the mechanism has not been characterized at the ionic level. Its inclusion in the autonomic arm of the LIFT trial (low-dose naltrexone + pyridostigmine) tests an additional immunomodulatory hypothesis via the cholinergic anti-inflammatory pathway.

*CoQ10 + NADH* acts downstream of the ionic cascade, supporting mitochondrial electron transport capacity in the context of energy deficit rather than blocking the ionic trigger. Castro-Marrero et al.\ (2021) conducted a prospective RCT (n=207) of 200 mg CoQ10 + 20 mg NADH daily for 12 weeks and reported significant reductions in cognitive fatigue (p#sym.lt 0.001), improvements in overall fatigue impact (FIS-40, p=0.022), and quality of life (SF-36, p#sym.lt 0.05), with benefits persisting four weeks post-treatment This represents the highest-quality current evidence for a mitochondrial-support intervention in ME/CFS. CoQ10 bioavailability is formulation-dependent; crystal-modified ubiquinone achieves approximately 75% better absorption than standard crystalline formulations.

==== Active Clinical Trials

*Vericiguat* is a soluble guanylate cyclase (sGC) stimulator approved for heart failure with reduced ejection fraction. By elevating cGMP independently of nitric oxide availability, it produces vasodilation, reduces cardiac preload, and has demonstrated mitochondrial protective effects in preclinical cardiac ischaemia models. Its relevance to ME/CFS derives from the vascular insufficiency component of the AIMM model: if endothelial NO bioavailability is impaired (the mechanism proposed in Section:endothelial), sGC stimulation could partially compensate. The Scheibenbogen group (Charité Berlin) holds a patent application on sGC stimulators for ME/CFS treatment and has registered a clinical trial (NCT05697640) testing vericiguat in ME/CFS patients. No efficacy results are published as of early 2026.
...
The DecodeME identification of autophagy genes (_FBXL4_ for mitophagy, _CCPG1_ for ER-phagy) at or near genome-wide significance suggests that impaired organelle quality control may contribute to ME/CFS in a genetically defined subset (Hypothesis:mitophagy-vulnerability, Chapter:genetics-epigenetics)
...
*Evidence:* Williams 2025 case series ($n = 5$) documented ADHD symptom improvement with low-dose BH4 (0.088–0.292 mg/kg/day) ColpaniFilho 2025 systematic review consistently found low BH4 in ASD No ME/CFS trials exist.
...
_Rationale:_ The Vernon 2025 survey data (77% brain fog improvement, $-1.5%$ PEM effect;) and the Architecture C stimulant analysis (@pred:stimulant-pacing-interaction) suggest that the net PEM-neutral effect masks two opposing subgroups. Reframing methylphenidate not as a fatigue treatment but as a cognitive efficiency intervention — paired with enforced pacing to prevent activity escalation — may capture the $R_"headroom"$ benefit while avoiding the PEM risk.
...
_Target population:_ ME/CFS patients with ADHD comorbidity or documented catecholamine deficiency (Walitt 2024 CSF metabolites;).
...
*Certainty: 0.40.* The "wrong fibers" hypothesis (Speculation:vns-wrong-fibres) addresses the _device_ side of VNS non-response. This speculation addresses the _patient_ side: vagal C-fiber afferents may be structurally damaged in ME/CFS, creating a vicious cycle independent of stimulation parameters.
...
The gut--vagal pathway is particularly vulnerable: butyrate deficiency (documented in ME/CFS microbiome studies) reduces enterochromaffin cell signaling to vagal afferents. Kaelberer et al.\ (2018) demonstrated that enteroendocrine cells form glutamatergic synapses with vagal neurons; these mucosal vagal afferent terminals are predominantly unmyelinated C-fibers. Reduced butyrate thus compounds the structural C-fiber deficit with a functional chemosensory deficit.
...
Three publications report outcomes after SGB in Long COVID patients. Liu & Duricka 2022 (J Neuroimmunol; _n_ = 2) is a two-patient case report in which both patients improved across fatigue, PEM, cognitive dysfunction, and sleep Pearson et al.\ 2023 (Cureus; _n_ = 41) is a retrospective cohort from a chronic pain practice in which 86% reported symptom reduction; there is no control group Duricka & Liu 2024 (Autonomic Neuroscience) is a retrospective chart review from the same group as the 2022 paper, confirming improvements in fatigue, PEM, cognition, and mood Two of the three publications originate from the same authors, so this represents two independent data sources, not three.
...
Endothelial glycocalyx damage in Long COVID has been documented directly by intravital microscopy and indirectly via plasma syndecan-1 shedding Whether the same mechanism operates in ME/CFS outside Long COVID has not been directly measured; the overlap in microclot and endothelial findings makes it a plausible inference but not an established fact.
...
Charfeddine et al.\ (2022) conducted the TUN-EndCOV study, a multi-centre controlled trial in Long COVID patients with persistent cardiac symptoms:
...
Patterson et al.\ (2023) — the same group that proposed the hypothesis — reported outcomes in 18 participants (case series) receiving maraviroc 300 mg twice daily plus pravastatin 10 mg daily:
...
T-cell exhaustion---characterized by upregulated PD-1 and reduced cytotoxic capacity---has been documented in ME/CFS and Long COVID (Chapter:immune-dysfunction). Pembrolizumab is an anti-PD-1 monoclonal antibody approved for multiple cancers; it releases the brakes on exhausted T cells by blocking the PD-1 inhibitory checkpoint. Use in ME/CFS or Long COVID is off-label and investigational only.
...
Psilocybin is a 5-HT2A serotonin receptor agonist that produces acute psychedelic effects and --- more durably --- appears to reduce default-mode-network activity and promote dendritic spine growth in preclinical models. Whether "default-mode-network hyperactivity" is a consistent ME/CFS finding is contested: some neuroimaging studies show hypoactivation rather than hyperactivation, and the relationship to brain fog symptoms has not been established causally. Putative mechanistic relevance to ME/CFS includes serotonergic modulation of the tryptophan/kynurenine pathway (Chapter:neurological) and preclinical anti-inflammatory effects via 5-HT2A signaling. However, 5-HT2A agonism does not directly modulate kynurenine pathway enzymes (IDO, TDO, KMO); any interaction between serotonergic and kynurenine dysregulation would be indirect and speculative.

There are no controlled trial data in ME/CFS. Available evidence consists of a single case report by Chopra et al.\ (2024) of a patient who self-administered psilocybin combined with MDMA and reported significant symptom improvement --- the combination makes it impossible to attribute the effect to psilocybin alone --- and an observational Reddit-based investigation by Bobak et al.\ (2025) suggesting potential benefit for Long COVID neuropsychiatric symptoms (78% of 110 self-reporting users described improvement).
...
*Outcome:* The Phase 2 RCT (NCT05633407) failed to meet its primary endpoint. An open-label extension was subsequently terminated. Peer-reviewed publication of full results is pending as of early 2026. *Contextual note:* The efgartigimod failure is one of several data points complicating the autoantibody hypothesis: the Anft 2025 independent-centre immunoadsorption study also showed successful autoantibody elimination without significant symptom improvement. However, efgartigimod's mechanism (accelerated IgG catabolism) differs from immunoadsorption (physical removal), and the trial was unstratified—see:immune-reset for discussion of how IgG depletion route may matter.
...
*Biological foundation:* Charvet et al. (iScience, 2023) demonstrated HERV-W ENV expression in peripheral blood cells of 221 COVID-19 patients across multiple variants, with expression levels correlating with disease severity Giménez-Orenga et al. (Front Immunol, 2022) showed persistent HERV-W ENV antigenemia in post-COVID patients, with anti-SARS-CoV-2 IgE strongly correlated with physical dysfunction ($r = -0.81$, $p < 0.01$) The HERV-W hypothesis is also relevant to ME/CFS outside Long COVID: endogenous retroviral activation has been proposed as a contributor to neuroinflammation in ME/CFS following other viral triggers.
...
Therapeutic plasma exchange (TPE, also called plasmapheresis) removes a patient's plasma and replaces it with donor albumin or fresh frozen plasma, thereby eliminating circulating proteins including autoantibodies, inflammatory mediators, fibrinogen, and microclots. The rationale for ME/CFS and Long COVID rests on the autoantibody hypothesis: if pathogenic GPCR-fAbs or other IgG autoantibodies drive symptoms (Section:immunoadsorption), removing plasma should provide at least transient relief.

*Pre-2025 evidence:* Kiprov et al. (F1000Research, 2021) published a single case report (_n_ = 1) of a 68-year-old male with long-haul COVID who received multiple TPE sessions and returned to normal activities Inflammatory macrophage markers diminished, NK cell and cytotoxic CD8 T-cell markers increased, and the patient reported functional recovery. This proof-of-concept case stimulated wider interest in apheresis approaches.

*The sham-controlled trial (2025):* España-Cueto et al. (Nature Communications, 2025) conducted the first sham-controlled randomized trial of TPE in post-COVID condition (_n_ = 50; 25 TPE, 25 sham) Participants received six sessions over seventeen days. Both arms had comparable safety profiles. The TPE arm showed no improvement over sham on the primary composite outcome (functional status, symptomatology, quality of life, neurocognitive symptoms) or the prespecified secondary endpoints. The trial population was clinically heterogeneous; participants were not pre-stratified by autoantibody positivity.
...
*Note:* For immunoadsorption (a related but distinct apheresis approach targeting IgG specifically), see Section:immunoadsorption.
...
*Components:* Aspirin 75~mg once daily + clopidogrel 75~mg once daily + apixaban 5~mg twice daily + pantoprazole 40~mg once daily (gastric protection). Duration: 2--6 months
...
The Bergen data establish that a substantial fraction of Giardia-infected patients do not develop ME/CFS — approximately 74% of laboratory-confirmed cases did not develop the condition at 3 years The question of whether treatment timing within the acute phase predicts ME/CFS conversion has not been studied directly (see Open Question:parasite-prevention), but standard clinical practice recommends prompt eradication therapy regardless of ME/CFS risk, making this a zero-cost opportunity.
...
- *Early post-infection monitoring.* Patients who develop persistent fatigue, post-exertional malaise, or orthostatic symptoms in the 3–12 months following a documented intestinal parasitic infection should be evaluated for ME/CFS using standard diagnostic criteria (Chapter:diagnostic-criteria). Early recognition avoids the compounding harm of misdiagnosis and inappropriate activity recommendations.

- *No evidence supports prophylactic antiparasitic therapy in established ME/CFS.* The inciting trigger vs.\ sustaining mechanism distinction (Section:parasites-post-infectious) means that antiparasitic treatment in a patient who cleared their infection years ago carries negligible theoretical benefit for ME/CFS itself. Prescribing empirical antiparasitic therapy to ME/CFS patients without documented active infection is not supported by any evidence and exposes patients to unnecessary drug side effects.
...
*(Certainty: 0.45 -- supported by POTS/MCAS triad therapy response data including retrospective analyses; no ME/CFS-specific RCT for this combination. Note: uncontrolled retrospective response rates (77--95% PEM reduction in Weinstock 2024) are subject to substantial selection bias and typically attenuate by 50% or more in controlled trials; certainty is calibrated to evidence grade D, not to the effect-size magnitude.)*

For ME/CFS patients with confirmed Domain 6 positivity (mast cell / histaminergic dysregulation, Section:domain6-mast-cell), a low-cost oral combination of ketotifen and famotidine addresses complementary receptor targets with distinct pharmacological profiles and low interaction risk.

*Mechanistic rationale:*

    - *Ketotifen (1--2 mg at bedtime)*: First-generation H1 antihistamine with additional mast cell stabilizing activity (inhibits degranulation independently of H1 blockade). Unlike cetirizine or loratadine, ketotifen crosses the blood-brain barrier and may address hypothalamic mast cell activation Its mast cell-stabilizing effect reduces mediator release before it occurs (prophylactic), whereas H1 blockade acts on already-released histamine (reactive). Known to reduce PEM frequency in retrospective MCAS analysis
    - *Famotidine (20--40 mg twice daily)*: H2 antihistamine that targets cardiac H2 receptors (reducing histamine-driven palpitations and tachycardia), gastric H2 receptors (reducing histamine-driven GI symptoms), and has documented anti-inflammatory effects independent of H2 blockade that were observed in Long COVID RCT signals. Famotidine + H1 combination in Long COVID patients with ME/CFS features produced "improvement in energy and cognitive function" with worsening on discontinuation

*Distinction from cromolyn+LDN combination (Section:cromolyn-ldn-mcas):* Cromolyn+LDN targets the mast cell--TRPM3/NK axis; ketotifen+famotidine targets the H1/H2 receptor axis plus mast cell stabilization. The two approaches are mechanistically complementary and can be combined in refractory cases. Ketotifen+famotidine is the simpler, lower-cost first-line option; cromolyn+LDN is appropriate when NK cell dysfunction is documented (Domain 1 overlap).
...
*Interactions:* Ketotifen may enhance sedation from CNS depressants, antiemetics (particularly metoclopramide), and other antihistamines. *QTc risk:* Ketotifen and ondansetron (commonly used for ME/CFS nausea/gastroparesis) both prolong the QTc interval; the combination should be avoided or used only with baseline and follow-up ECG. If the patient is already on ondansetron, metoclopramide, or another QTc-prolonging agent, a baseline ECG is mandatory before initiating ketotifen; do not initiate if baseline QTc exceeds 450 ms in women or 440 ms in men (relative contraindication); discontinue immediately if QTc exceeds 500 ms or increases >60 ms from baseline. Famotidine has minimal drug interactions at standard doses but may affect atazanavir absorption if relevant. Both are generally well-tolerated in ME/CFS populations.

#warning-env(title: [No ME/CFS RCT for this Combination Exists])[
No randomized controlled trial has evaluated ketotifen + famotidine in ME/CFS. The 77--95% PEM reduction rates reported by come from an uncontrolled retrospective analysis; placebo response, natural fluctuation, and selection bias cannot be excluded. The Steinberg 1996 terfenadine (H1 monotherapy) RCT was negative -- H1 alone is insufficient. H1+H2 combination is the minimum effective approach based on mechanistic reasoning and available case evidence. Physician supervision is required.
]
...
A subset of MCAS patients have somatic or germline KIT pathway alterations -- including the D816V KIT mutation or gene expression-level KIT upregulation -- that drive mast cell hyperplasia and hyperreactivity without meeting full systemic mastocytosis criteria. Imatinib (a tyrosine kinase inhibitor targeting BCR-ABL, KIT, and PDGFR) has shown benefit in small case series of non-clonal MCAS with KIT pathway involvement At low doses (100 mg daily rather than oncology doses of 400--800 mg), imatinib is generally well-tolerated.

In ME/CFS-MCAS patients with persistently elevated baseline tryptase (>11 ng/mL, the threshold above which clonal mast cell disease should be excluded per) or positive KIT D816V testing in peripheral blood or skin biopsy, low-dose imatinib represents a precision subset approach: narrowly targeted to patients with biochemical evidence of KIT pathway involvement, avoiding non-specific immunosuppression.

*Who might benefit:* ME/CFS-MCAS patients who (a) meet MCAS diagnostic criteria, (b) have persistent tryptase >11 ng/mL on at least two separate measurements, (c) have failed H1+H2 antihistamine + mast cell stabilizer combination (Sections:ketotifen-famotidine-domain6 and:cromolyn-ldn-mcas), and (d) have had systemic mastocytosis excluded by bone marrow biopsy or tryptase trend.

*Referral required before any further evaluation:* Any patient potentially meeting criteria (a)–(d) above must be referred to haematology or allergy/immunology with mastocytosis experience. Bone marrow biopsy and KIT mutation testing require specialist coordination. A GP should not initiate this evaluation or the drug without an active specialist relationship.
...
*Drug interactions:* Imatinib is metabolized by CYP3A4 and inhibits CYP2D6 and CYP3A4. Check interactions with all current medications. Notable interactions in ME/CFS polypharmacy: midodrine (CYP3A4 substrate), fludrocortisone (CYP3A4 substrate — imatinib's CYP3A4 inhibition can raise fludrocortisone exposure, risking fluid retention, hypertension, and hypokalemia; monitor closely in POTS patients), some antihistamines, warfarin (CYP2C9 probe).
...
*Practical protocol for MCAS-positive ME/CFS patients:* Start with 5--10 minutes daily tVNS (auricular branch targeting cymba concha), building slowly to 30 minutes over 4--6 weeks per the standard ME/CFS tVNS titration protocol (Section:tvns-pots, Chapter:action-mild-moderate). Monitor for PEM aggravation; reduce session duration immediately if symptoms worsen.
...
The post-parasitic mast cell priming speculation (Speculation:parasite-mcas-priming, Chapter:immune-dysfunction) proposes that acute Giardia infection may permanently sensitize intestinal mast cells, producing a post-parasitic MCAS phenotype characterized by food intolerances, chemical sensitivities, flushing, autonomic instability, and fatigue that began after the acute parasitic infection.

Clinically, this phenotype is indistinguishable from MCAS from any other cause — the same diagnostic criteria apply and the same treatments are used. The treatment protocols for MCAS in ME/CFS are covered in full in Section:allergies-mast-cells. The contribution of this section is to heighten index of suspicion: patients with parasitic-onset ME/CFS who have not yet been evaluated for MCAS should be screened, particularly if their symptom profile includes the following features that commenced or worsened after the acute infection:
...
*If MCAS criteria are met,* the full mast cell treatment protocol applies (Section:allergies-mast-cells). A therapeutic trial of H1 + H2 antihistamine combination prior to formal diagnosis is reasonable given the safety profile of these agents, though this should be done under clinical supervision — H2 blockers can affect heart rate and interact with other medications. This recommendation is based on mechanistic inference from Speculation:parasite-mcas-priming and lacks direct evidence in post-parasitic ME/CFS specifically (Evidence Grade E).

== Duodenal Mucosal Repair
<sec:duodenal-mucosal-repair>

Wensaas et al.\ (2018) documented persistent duodenal histological changes — villous atrophy and intraepithelial lymphocytosis — in a subset of Bergen cohort patients at 10 years post-infection In patients with these changes, ongoing mucosal barrier dysfunction could maintain chronic LPS translocation and systemic immune activation as a sustaining ME/CFS mechanism (Open Question:duodenal-microbiome).
...
The IDO1 kynurenine shunt speculation (Speculation:parasite-ido1-kynurenine, Chapter:immune-dysfunction) proposes that intestinal parasitic infection may epigenetically prime IDO1 overexpression, creating a persistent kynurenine shunt that drives neuroinflammation and cognitive dysfunction in post-parasitic ME/CFS. This is a speculative mechanistic model with no direct human evidence, but it maps onto a therapeutic target — IDO1 inhibition — that has existing pharmacological tools developed for oncology.
...
The molecular mimicry speculation (Speculation:giardia-molecular-mimicry, Chapter:immune-dysfunction) proposes that Giardia VSP epitopes may prime GPCR autoantibody production via molecular mimicry. If correct, a subset of post-parasitic ME/CFS patients would have elevated anti-muscarinic and/or anti-β₂-adrenergic receptor autoantibodies — the same targets studied in the broader ME/CFS autoimmunity literature

This has an immediately actionable implication: post-parasitic ME/CFS patients being evaluated for immunoadsorption (Section:immunoadsorption) or rituximab should have GPCR autoantibody profiling as part of their pre-treatment workup, using the same autoantibody panel applied in the broader ME/CFS autoimmune subtype literature. If autoantibodies are present, post-parasitic patients are eligible for the same immunoadsorption protocols as post-viral autoimmune-phenotype patients; the trigger (parasitic vs.\ viral) does not change the treatment target if the endpoint is the same (GPCR autoantibody reduction).
...
*Proposed mechanisms:* PEMF stimulates the nitric oxide/eNOS pathway in vascular endothelium — calcium/calmodulin binding activates endothelial NO synthase, increasing NO release and arteriolar relaxation. Additional mechanisms include adenosine A2A receptor upregulation (cAMP elevation, anti-inflammatory) and voltage-gated calcium channel activation. These are biologically coherent mechanisms with basic science support, but their operation in ME/CFS microvascular pathophysiology is untested.

*Clinical evidence — direct ME/CFS data:* None. No published RCT has enrolled ME/CFS patients.

*Closest analogues:*

- *Fibromyalgia (BEMER-specific RCT, negative — the largest controlled study):* Multanen et al.\ (2018) conducted the largest BEMER-specific controlled trial — a crossover RCT in 108 fibromyalgia patients Pain scores decreased equally in both active and sham arms. The conclusion was unambiguous: BEMER was not effective for pain or functioning in fibromyalgia. This is the most directly relevant controlled study and it is negative.

- *Multiple sclerosis fatigue (BEMER-specific RCT, positive short-term but not sustained):* Piatkowski et al.\ (2009) randomized 37 MS patients to BEMER vs sham, 8 minutes twice daily for 12 weeks The Modified Fatigue Impact Scale (MFIS) and Fatigue Severity Scale (FSS) improved significantly at 12 weeks. However, at 6-week follow-up after stopping therapy, no significant between-group difference remained — effects did not persist after discontinuation.

- *Post-COVID fatigue (case reports only):* Two case reports describe PEMF use in post-COVID fatigue patients, but single-patient observations cannot distinguish device effect from natural recovery or concurrent interventions.

*Independent systematic review:* Hug & Röösli (2012) conducted a systematic review of whole-body PEMF devices without industry funding and concluded that "scientific evidence for therapeutic effects of whole-body PEMF devices is insufficient"

*ME/CFS-specific concerns:* No published study has assessed whether PEMF sessions trigger post-exertional malaise. One post-COVID case reported transient post-session fatigue after the first treatment Given ME/CFS patients' vulnerability to PEM from physical stimulation, any trial of PEMF should begin with the shortest available session duration, with a carer or support person present for the first session, and with PEM symptoms monitored for 48 hours afterwards.

#limitation(title: [PEMF/BEMER: Insufficient Evidence in ME/CFS; Negative Fibromyalgia RCT])[
The BEMER device's largest controlled trial (fibromyalgia, n=108) was negative No ME/CFS trial exists. The MS fatigue trial showed effects that did not persist after stopping therapy The proposed microcirculation mechanism has biological plausibility but has not been tested in the ME/CFS context. PEM risk is uncharacterized. Marketing claims ("scientifically proven," "up to 30% microcirculation improvement") substantially exceed what peer-reviewed evidence supports.
]
...
However, the entire published evidence base on earthing originates from a single network of financially conflicted authors — James Oschman, Gaétan Chevalier, and Stephen Sinatra — who are contractors, shareholders, or founders of EarthFx Inc. (the commercial entity that produces and sells earthing products) This constitutes a closed citation loop with no independent replication. The best-designed study is a stepped-wedge cluster trial (n=16), which is substantially underpowered and unreplicated. The foundational mechanism — free electron antioxidant transfer via direct contact with the Earth's surface — lacks independent biophysical validation.
...
- McCully & Natelson (1999) found significantly slower post-exercise O₂ resaturation time constants in CFS patients (46.5 vs 29.4 seconds) — suggesting impaired oxidative metabolism or autonomic dysregulation of muscle blood flow
- Vermeulen & Vermeulen van Eck (2014) documented decreased O₂ extraction at peak exercise via cardiopulmonary exercise testing (peak extraction 10.8 vs 13.5 ml/100ml in women; 13.7 vs 19.5 ml/100ml in men) — peripheral extraction failure independent of delivery
- Miller et al.\ (2015) applied NIRS during a submaximal handgrip test in 16 ME/CFS vs 16 controls and found reduced hemoglobin changes at comparable perceived exertion, proposing NIRS as a PEM risk stratification tool
- In Long COVID — which substantially overlaps with ME/CFS — Colosio et al.\ (2023) and Jamieson et al.\ (2024) independently confirmed reduced NIRS-measured oxidative capacity (time constants 38.7 vs 24.6 seconds; p=0.001), with the Colosio study confirming reduced mitochondrial complex activity on biopsy

*The Moxy Monitor specifically:* The Moxy Monitor (Fortiori Design LLC) is a consumer-grade wrist-worn NIRS device validated for exercise physiology applications in healthy subjects It outputs continuous SmO₂ (%) during activity. It has not been tested in ME/CFS research or clinical settings; its validity is established only in healthy subjects with adipose tissue thickness ≤15~mm.
...
Reis et al.\ (2026) conducted a Bayesian adaptive platform RCT in 399 adults in Brazil with fatigue persisting $≥$90 days after confirmed SARS-CoV-2 infection Three arms: fluvoxamine 100 mg twice daily, metformin 750 mg twice daily, and matching placebo, over 60 days of treatment with 90-day follow-up.
...
*SARS-CoV-2 and S1R:* Gordon et al.\ (2020) mapped the entire SARS-CoV-2 protein interactome and found that viral non-structural proteins Nsp6 and Nsp8 directly bind the sigma-1 receptor This is not incidental: Nsp6 and Nsp8 are both ER-localized replication proteins. By binding S1R, SARS-CoV-2 may co-opt ER proteostasis machinery for replication while simultaneously disrupting host stress responses.

*S1R agonism as therapeutic mechanism:*

Fluvoxamine is the most potent S1R agonist among commercially available SSRIs, with Ki approximately 36 nM at S1R vs.\ Ki 4,000--10,000 nM for other SSRIs At therapeutic doses (100 mg twice daily), plasma concentrations are sufficient to occupy S1R meaningfully. The proposed mechanism chain:
...
The rationale for IMT in ME/CFS is distinct from general exercise rehabilitation. Rather than increasing total cardiovascular load (which risks PEM), IMT targets a specific muscle group with direct physiological relevance:
    ...
    - *Venous return*: Diaphragmatic contraction generates the thoracic pressure gradient that drives venous return to the right heart; stronger diaphragmatic function may partially compensate for the preload failure documented in ME/CFS
    - *Dysfunctional breathing correction*: 42.1% of ME/CFS patients show dysfunctional breathing patterns and 32% exhibit hyperventilation; IMT may reduce reliance on accessory muscles (which consume 3× more energy than the diaphragm) and stabilize breathing mechanics

=== Clinical Evidence

Edgell et al.\ (2025) conducted a pilot RCT (NCT05196529) of 8 weeks of IMT in ME/CFS and PASC patients. Key design decision: training increased breathing frequency (shortened intervals between breaths) rather than increasing inspiratory pressure — specifically to avoid the high-effort muscle loading that could trigger PEM in ME/CFS.
...
El-Medany et al.\ (2024) measured hypoxic ventilatory response (HVR) — a direct index of carotid body chemoreflex sensitivity — in 14 non-hospitalised Long COVID patients vs.\ 14 matched controls:
...
The proposed mechanism: SARS-CoV-2 enters carotid body glomus cells via their ACE2 receptor abundance, directly sensitising the chemoreflex. Sensitised carotid bodies generate exaggerated respiratory responses to mild hypoxia and hypercapnia, contributing to dysfunctional breathing, breathlessness, and the ventilatory inefficiency documented on CPET. Orthostatic CO#sub[2] falls documented in ME/CFS — PETCO#sub[2] dropping to 26–30 mmHg during tilt testing vs.\ 36 mmHg in controls — may partly reflect carotid body-driven respiratory overcompensation rather than primary hyperventilation.

=== Therapeutic Target: P2X3 Antagonism

P2X3 receptors are expressed in carotid body afferent fibers and modulate chemoreflex sensitivity. *Gefapixant*, a P2X3/P2X2/3 antagonist already approved in some markets for refractory chronic cough, has been proposed as a pharmacological target to reduce carotid body sensitization No trial has tested gefapixant in ME/CFS or Long COVID at the time of writing.

#speculation(title: [Carotid Body Sensitisation as a Reversible Amplifier of Orthostatic Intolerance in ME/CFS])[
If carotid body sensitization occurs in ME/CFS (by analogy with Long COVID), it would function as a reversible physiological amplifier: normal mild orthostatic hypoxia and CO#sub[2] changes trigger exaggerated hyperventilation, orthostatic hypocapnia falls further, cerebral vasoconstriction worsens, and cognitive symptoms and OI are amplified beyond what the underlying cardiac preload failure alone would produce.
...
Urolithin A is a gut microbiome metabolite derived from ellagitannins (found in pomegranates, walnuts, red wine). It is the first natural compound shown in a randomized controlled trial to induce mitophagy in humans via a PHB2-dependent mechanism: Ryu et al.\ (2016) demonstrated in _C. elegans_ and mammalian cells that urolithin A induces mitophagy specifically through a PHB2-mediated pathway; Andreux et al.\ (2019) demonstrated in a Phase 1 human RCT (n=60, elderly) that urolithin A 500 mg/day for 4 weeks improved mitochondrial gene expression in skeletal muscle and was well-tolerated.
...
#warning-env(title: [ME/CFS Gut Microbiome Caveat: Urolithin A Conversion])[
  Urolithin A is produced from dietary ellagitannins by specific gut bacteria, primarily _Gordonibacter urolithinfaciens_ and _Ellagibacter isourolithinifaciens_. A substantial fraction of the general population — estimated at 30-40% — lack these bacteria and produce negligible urolithin A from dietary ellagitannins. In ME/CFS, where gut dysbiosis is common (Chapter:gut-microbiome), the proportion of "non-converters" may be even higher. Supplement-form urolithin A (Mitopure®) bypasses this bottleneck by providing the active compound directly; dietary ellagitannin approaches (pomegranate juice) are unreliable without knowing conversion status.
]
...
The pregnancy-improvement signal in ME/CFS (@Schacterle2004pregnancy; approximately 30% of patients improve during gestation) motivates a series of related pharmacological hypotheses centered on the progesterone–allopregnanolone–GABA-A axis. These are distinct from the primary bridge-therapy hypothesis introduced in:micronized-progesterone-bridge (Chapter:epidemiology-outcomes); this section covers dosing schedule optimization, oral neurosteroid analogs, upstream precursors, and combination approaches that extend that hypothesis.
...
*Certainty: 0.30.* Continuous oral progesterone downregulates progesterone receptors, abolishing neurosteroid and neuroprotective gene expression profiles in animal models Arbitrary cyclic schedules (e.g., days 15–28 of a calendar month) may misalign with the patient's actual ovulatory cycle. A more pharmacologically rational approach would synchronize administration with the patient's documented luteal phase: begin oral micronized progesterone at confirmed ovulation (LH surge) and continue for 10–14 days, followed by complete cessation.

Rationale: allopregnanolone produced from oral micronized progesterone exhibits a biphasic GABA-A dose-response — low concentrations paradoxically worsen anxiety, whereas concentrations above a threshold produce tonic inhibition analogous to the pregnancy milieu Synchronized luteal-phase dosing aims to reach and maintain suprathreshold concentrations during the phase when the patient's existing hormonal environment is most permissive.
...
If the allopregnanolone route accounts for the HPA-calming, sleep-improving, and anti-inflammatory effects proposed in:micronized-progesterone-bridge, ganaxolone would deliver those effects without progesterone receptor activation — removing the hormonal risks (thromboembolic, endometrial, breast) and the requirement for intact 5α-reductase conversion. Access is the primary barrier: ganaxolone is not approved for ME/CFS, carries significant off-label prescribing barriers, and is expensive.
...
- *Timing and dose may define success.* TBI progesterone failure may reflect wrong timing relative to injury cascade. ME/CFS trials must carefully specify timing (postpartum-onset window, cycle phase) and dose (avoid biphasic zone per).
...
Low-dose naltrexone (LDN, 1.5–4.5 mg/day) reduces TLR4 signaling on microglia and macrophages, attenuates IL-6 and TNF-α production, and may stabilize Treg function — the same dysregulated axis in both lichen sclerosus and ME/CFS ME/CFS LDN trials have produced mixed results in heterogeneous cohorts; the poor effect sizes may reflect dilution by non-TLR4-driven ME/CFS subtypes. If the autoimmune-terrain subgroup (identifiable by LS comorbidity, anti-muscarinic autoantibodies, or elevated Th1 cytokines) is specifically enriched for TLR4-axis overactivation, then LDN response rate in this subgroup may substantially exceed the population average.

Anecdotal case series suggest LS improvement with LDN, providing indirect evidence for TLR4 involvement in LS pathogenesis A shared trial population (ME/CFS+LS patients) would simultaneously test LDN in two conditions with proposed shared mechanism, potentially accelerating evidence generation in both fields.
...
The concepts in this section derive from the mitochondrial reserve threshold model (Section:mtdna-reserve-threshold in Chapter:integrative-models). None of the interventions below has been tested in a controlled ME/CFS trial targeting reserve enhancement. This is a research-stage synthesis of mechanistic rationale and small-scale or off-condition evidence. Do not interpret as clinical guidance. All interventions require physician discussion before implementation.
]

The mitochondrial reserve threshold hypothesis (Section:mtdna-reserve-threshold) predicts that pre-existing low reserve capacity facilitates ME/CFS onset after a viral trigger, and that reserve expansion could constitute both a preventive and therapeutic strategy. The following speculative treatment concepts share the goal of expanding spare respiratory capacity (SRC).
...
If mtDNA haplogroup modulates symptom cluster expression, haplogroup-tailored supplementation targeting the bioenergetic vulnerabilities associated with each haplogroup represents a personalizable research approach. Consumer genetic tests provide haplogroup classification at minimal cost.

Proposed mechanistic matching: *Haplogroup H* (tight coupling, exercise-crash phenotype per) → MitoQ 10 mg/day (mitochondrially-targeted antioxidant to address ROS from tight coupling under demand) + conservative pacing thresholds. *Haplogroup U* (anti-inflammatory coupling, milder PEM per) → focus on other deficit domains rather than antioxidant-loading. *Haplogroup J* (joint pain protection per) → investigate whether joint-targeted physiotherapy has differential benefit in this subgroup.
...
*Certainty: 0.20.*
Salubrinal and Sephin1 inhibit GADD34/PP1 dephosphorylation of eIF2α, prolonging the ISR. If the post-SARS-CoV-2 subgroup has chronically suppressed ISR via N2b-mediated PKR inhibition, GADD34 inhibitors could restore ISR tone. Guanabenz (FDA-approved antihypertensive with GADD34-inhibitory activity, 8--32 mg/day) is the most accessible repurposing candidate given its existing human safety profile.
...
*Certainty: 0.35.*
Mdivi-1 blocks DRP1-mediated mitochondrial fission. If the HHV-6 miR-aU14--miR-30--p53--DRP1 axis is active in ME/CFS tissue, DRP1 inhibition would address the downstream fragmentation directly. Newer selective DRP1 inhibitors (Drpitor1a) with reduced complex I off-target effects are in preclinical development.
...
GCN2 inhibitors (GCN2iB) block the amino acid deprivation arm of ISR. Götz et al.\ showed GCN2 suppression extends Drosophila lifespan, establishing biological plausibility. PERK inhibitors (GSK2606414) block the ER stress arm most directly implicated in ME/CFS by Wang et al.\ Pancreatic beta-cell toxicity limits systemic PERK inhibition (PERK is required for insulin secretion); selective tissue-targeted delivery remains an unresolved challenge.
...
- *GlyNAC (glycine + N-acetylcysteine):* Restores glutathione and reduces oxidative ER stress, a primary PERK activator Glycine also feeds the one-carbon pathway downstream of ATF4's serine biosynthesis program. RCT evidence exists in aging contexts; ME/CFS data absent. Certainty: 0.35.

- *Urolithin A (Mitopure):* Induces mitophagy via PHB2, clearing DRP1-fragmented dysfunctional mitochondria — the end-product of HHV-6 miR-aU14-driven fragmentation Mechanistically complementary to ISR normalisation. Already discussed in Section:mitophagy-targeting-mecfs. Certainty: 0.30.
...
- *Methylene blue:* Alternative electron carrier bypassing Complex I/III defects from respiratory supercomplex disruption Addresses the downstream energy deficit. ⚠️ SSRI interaction (serotonin syndrome risk) — contraindicated with fluvoxamine and other serotonergic agents. Certainty: 0.25.
...
- *Lithium (microdose, 1–5 mg lithium orotate):* GSK3 inhibition and autophagy induction modulate ISR via ATF4. Already discussed for IP3R/MAM axis in Section:fluvoxamine-lithium-ip3r. ⚠️ Renal and thyroid monitoring required even at low doses. Certainty: 0.15.
