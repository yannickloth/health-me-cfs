...
Memantine is an uncompetitive NMDA receptor antagonist approved for moderate-to-severe Alzheimer's disease. Its mechanism---blocking excessive glutamatergic excitation while preserving physiological signaling---is potentially relevant to the excitatory/inhibitory imbalance hypothesised in ME/CFS autonomic circuits (Hypothesis @hyp:glutamatergic-autonomic-bridge, Chapter @ch:integrative-models).
...
*Limitations:* Alternative explanations for VNS response variability — ME/CFS heterogeneity in etiology, disease stage, and comorbidity profile — are at least as parsimonious as the fibre-selectivity hypothesis and require no novel assumptions. Pure autonomic-vs-inflammatory subtype separation does not exist in clinical reality: most ME/CFS patients have mixed features, which limits the predictive value of this framework. The CNAP monitoring required for direct fibre-class confirmation is not available in clinical settings. The validated subtyping tool ("autonomic-dominant vs. immune-dominant") this hypothesis requires does not exist.
...
"Earthing" or "grounding" refers to direct physical contact with the Earth's surface electrical potential, typically via conductive mattress overlays, grounding sheets, or barefoot contact with soil. The proposed mechanism is transfer of the Earth's surface electrons to the body, hypothesised to act as antioxidants neutralising reactive oxygen species, normalize cortisol circadian rhythms, and shift autonomic tone toward parasympathetic dominance.
