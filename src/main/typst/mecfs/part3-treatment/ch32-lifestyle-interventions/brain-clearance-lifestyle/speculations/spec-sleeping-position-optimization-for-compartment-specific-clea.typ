...
#speculation(title: [Sleeping Position Optimization for Compartment-Specific Clearance Exit Route Alignment])[
*Certainty: 0.40.* Chayama et al.\ demonstrate that different brain regions drain to distinct compartments following a nearest-exit principle — dorsal cortex to dorsal dura/skull, striatum to basal skull/nasal @Chayama2026BrainClearance. Gravity and body position may differentially affect clearance through these compartments. Lateral decubitus position enhances glymphatic transport versus supine (Lee 2015). This refinement adds route-specific optimization: patients with executive dysfunction (dorsal-prefrontal) may benefit from lateral position to align dorsal drainage routes with gravity; patients with sensorimotor or basal symptoms may benefit from head-elevated position.
