...
*For patients*: start with comorbidity management (Section @sec:comorbidity-management), where the largest symptom gains often lie, then post-exertional malaise and pacing (Section @sec:managing-pem). Then read only the single domain section that most impairs you (see the section list in the opening).
