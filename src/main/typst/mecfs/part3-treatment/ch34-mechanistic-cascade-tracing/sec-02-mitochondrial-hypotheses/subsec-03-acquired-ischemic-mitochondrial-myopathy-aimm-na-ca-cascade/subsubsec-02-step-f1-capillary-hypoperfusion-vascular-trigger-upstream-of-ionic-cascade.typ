...
#finding(claim: [No delivery intervention improves VO₂peak], explanation: [Bottleneck is NOT oxygen delivery — it is mitochondrial oxygen utilization; oxygen is reaching mitochondria but they cannot use it; proceed to mitochondrial-level probes], certainty: [Low to Medium], level: [Partial root cause])
