...
*Escalation Protocol:*
    ...
    - *If progression despite metformin*: Consider GLP-1 agonist (semaglutide or liraglutide; liraglutide preferred for CNS endpoints given positive neurodegeneration trial data vs semaglutide negative in AD mouse model @FornyGermano2024GLP1negative)
    - *Rationale*: Additional weight regulation, greater glycemic control, cardiovascular benefit; emerging genetic evidence for ME/CFS target pathways @Gardner2026BRMEC15 (see @ch:genetics-epigenetics, Section @sec:glp1-genetics)
