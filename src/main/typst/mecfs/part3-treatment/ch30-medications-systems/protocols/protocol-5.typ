...
#protocol(title: [Drug Holiday Restore-Test — Distinguishing Adaptive Desensitisation from True Tolerance])[
...
*Rationale:* GPCR resensitization and Nrf2 adaptive hormesis both require drug-free intervals to maintain therapeutic sensitivity @CostaNeto2025GPCRTachyphylaxis @Gupta2018GPCRResensitization @Mushak2016TemporalHormesis. Continuous daily dosing fills this interval, causing the receptor population to shift toward a desensitized, internalized pool. If the loss of benefit is driven by this mechanism, a brief drug holiday allows resensitization — and benefit returns upon resumption at the same dose. This is a zero-cost, self-administered diagnostic procedure.

*Candidates:* Any drug whose therapeutic mechanism is GPCR-mediated (modafinil/DAT, duloxetine/NET, beta-blockers/β1, guanfacine/α2A, LDA/D2) or Nrf2-mediated (sulforaphane, NAC, melatonin, LDN low-dose). Does NOT apply to drugs with significant withdrawal risk (corticosteroids, high-dose beta-blockers, gabapentinoids) — for these, gradual tapering is required; a sudden drug holiday may trigger withdrawal @Hodding1980DrugWithdrawal. Does NOT apply to LDN at doses above 3.0 mg where benefit may be TRPM3-mediated — the mechanism is not receptor-desensitization-dependent and a drug holiday could extinguish the TRPM3 restoration signal that requires sustained receptor modulation.
