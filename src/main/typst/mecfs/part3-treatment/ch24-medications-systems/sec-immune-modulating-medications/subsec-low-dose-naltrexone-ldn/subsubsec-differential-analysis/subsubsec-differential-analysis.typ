...
==== What the Response Tells Us About LDN
...
===== If LDN works: improved fatigue, brain fog, PEM tolerance, or pain

====== Finding 1 — Neuroinflammation was present
...
*Certainty of this inference:* Low to Medium. LDN's TLR4 antagonism is established in vitro @Younger2013, and neuroinflammation is documented in ME/CFS (@sec:neuroinflammation). But we lack direct evidence that LDN's clinical effect in ME/CFS is TLR4-mediated, and whether LDN reaches brain microglia at clinical doses (1–4.5 mg) is unknown.

*What this finding does NOT tell us:* What is *causing* the neuroinflammation. The microglia could be responding to autoantibodies entering the brain (@sec:root-gpcr), viral components, mitochondrial debris, or vagal stress signals from the body. LDN calms microglia without removing the trigger.
...
*Certainty of this inference:* Low. Each link is individually plausible (TLR4→microglia established, inflammation→orexin suppression established in animal models @Grossberg2011orexinLethargy, orexin reduced in ME/CFS CSF). But no study has measured orexin before/after LDN treatment in ME/CFS patients.
...
*Why LDN response implicates it:* The endorphin rebound effect is well-documented in pain conditions @Younger2013. Pain relief and mood improvement on LDN likely involve this mechanism — but endorphin elevation alone is unlikely to explain PEM reduction, cognitive improvement, or immune modulation.
...
===== If LDN does NOT work (adequate dose ≥ 3–4.5 mg, ≥ 8–12 weeks)

====== Interpretation 1 — Neuroinflammation may not be the dominant mechanism
...
====== Interpretation 2 — TRPM3 dysfunction may be absent or not LDN-responsive
...
====== Interpretation 5 — Paradoxical reactor

A subset of ME/CFS patients worsen on LDN (@sec:paradoxical-reactor). Their adverse response is itself diagnostic — their ME/CFS involves mechanisms aggravated by opioid modulation or TLR4 blockade.

====== Interpretation 6 — LDN may not work better than placebo in ME/CFS
...
*LDN works + pyridostigmine works:*
Step 1: LDN → neuroinflammation/TRPM3 present. Step 2: Pyridostigmine increases acetylcholine, improving cerebral blood flow and parasympathetic function. Step 3: Both working = neuroinflammation → autonomic dysfunction compensated. Inflammatory-to-autonomic pathway, consistent with brainstem neuroinflammation disrupting autonomic centers (@sec:root-cns-energy).
→ *Prioritize anti-inflammatory treatment (upstream); add autonomic support for downstream symptoms.*

*LDN works + valacyclovir does NOT work:*
Step 1: LDN → neuroinflammation present. Step 2: Valacyclovir non-response → active herpesvirus replication unlikely as main driver. Step 3: Neuroinflammation without active viral replication → post-infectious mechanism: infection triggered persistent immune changes after viral clearance.
→ *Stop antiviral pursuit. Focus on immunomodulation and trigger identification.*

*LDN works + antihistamines do NOT work:*
Step 1: LDN → neuroinflammation present. Step 2: Antihistamine non-response → mast cell activation unlikely as primary neuroinflammation driver. Step 3: Neuroinflammation from non-mast-cell sources — autoantibodies, microglial priming, metabolic stress.
→ *Distinguishes MCAS-driven from autoantibody/post-infectious subtypes — treatment differs fundamentally.*

*LDN does NOT work + cimetidine works:*
Step 1: LDN non-response → TLR4/TRPM3 pathway less likely. Step 2: Cimetidine uniquely enhances T-cell function and inhibits CYP450. Step 3: Cimetidine-positive, LDN-negative → T-cell component, possibly viral reactivation. Matches VIM phenotype (@sec:vim-phenotype).
→ *VIM phenotype identified: cimetidine + amino acids + metabolic support + antivirals if indicated.*

*LDN does NOT work + pyridostigmine does NOT work + LDA works:*
Step 1: LDN non-response → neuroinflammation less likely. Step 2: Pyridostigmine non-response → cholinergic autonomic dysfunction less likely. Step 3: LDA response → dopamine signaling impairment. Step 4: Dopamine-responsive, neuroinflammation-non-responsive, autonomic-non-responsive → primary dopaminergic deficit.
→ *Prioritize cognitive/dopaminergic support with caution: dopamine compensates downstream while upstream driver continues.*
