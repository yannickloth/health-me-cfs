...
*LDA works + LDN works:*
Step 1: LDA → dopamine insufficient. Step 2: LDN → neuroinflammation present. Step 3: Neuroinflammation → IDO/BH4 depletion → dopamine synthesis failure (compensated by LDA). The "inflammatory dopamine depletion" pattern — mechanistically coherent, prevalence in ME/CFS unknown.
