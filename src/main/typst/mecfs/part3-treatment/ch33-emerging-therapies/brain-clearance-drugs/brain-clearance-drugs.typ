...
#include "speculations/spec-tgn-020-aqp4-inhibitor-for-slow-diffusive-component-restorat.typ"

=== Inflammation-Induced Routing Protection

#include "speculations/spec-tlr4-antagonist-tak-242-as-pem-prophylaxis-via-routing-disru.typ"

=== Perivascular Structure Restoration

#include "speculations/spec-losartan-for-perivascular-fibrosis-reversal.typ"

#include "speculations/spec-minocycline-for-reactive-astrocyte-reduction-and-endfoot-re.typ"

#include "speculations/spec-glycine-for-perivascular-anti-fibrotic-effect.typ"

=== AQP4 and Oxidative Protection

#include "speculations/spec-alpha-lipoic-acid-for-aqp4-oxidation-protection.typ"

#include "speculations/spec-taurine-for-osmotic-gradient-support-and-aqp4-enhancement.typ"

#include "speculations/spec-omega-3-fatty-acids-for-membrane-fluidity-and-perivascular-c.typ"

#include "speculations/spec-n-acetylcysteine-for-aqp4-preservation-via-oxidative-stress.typ"
