...
#proposal(title: [Magnesium L-Threonate for Vasomotion and NMDA Modulation])[
*Certainty: 0.32.* NE oscillations drive vasomotion via calcium signaling in vascular smooth muscle (Hauglund 2025, Section @sec:ch15-ne-vasomotion). Magnesium modulates calcium channels and NMDA receptor function. Magnesium L-threonate crosses the blood-brain barrier, unlike other magnesium salts. By supporting calcium homeostasis in vascular smooth muscle and reducing NMDA-mediated excitotoxicity, magnesium L-threonate could enhance vasomotion amplitude — the primary pump driving glymphatic clearance through the fast advective pathway identified by Toscano 2026.

*Rationale.* Chayama et al.\ show that the skull and dural compartments are the primary clearance routes for brain-derived proteins @Chayama2026BrainClearance. Vasomotion (LC-NE oscillation-driven) is the pump that moves proteins through these compartments. Magnesium's calcium-modulating properties may support this pump.
