...
#finding(claim: [Neither pyridostigmine nor pentoxifylline improve VO₂peak / O₂ extraction], explanation: [Primary lesion is the BM itself — structural barrier that no currently available drug directly targets; interventions would need BM thinning, collagen degradation reversal, or downstream mitochondrial protection], certainty: [Low to Medium], level: [Partial root cause])
