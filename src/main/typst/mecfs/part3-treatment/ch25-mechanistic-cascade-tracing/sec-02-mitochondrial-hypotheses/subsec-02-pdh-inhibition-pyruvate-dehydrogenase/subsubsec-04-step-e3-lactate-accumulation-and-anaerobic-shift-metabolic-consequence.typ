...
#finding(claim: [Pyridostigmine reduces lactate by 30% and thiamine reduces it by another 40%], explanation: [Both delivery (perfusion) and enzyme (PDH) bottlenecks coexist — combined 70% reduction indicates both are rate-limiting; residual 30% suggests additional bottlenecks: ETC complex deficiency, NAD⁺ deficit, or genetic metabolic limitations], certainty: [Low to Medium], level: [Partial root cause])
