...
Architecture C (@sec:architecture-c-metabolic-reserve) generates a severity-stratified intervention approach combining pharmacological, supplement, and non-pharmacological components. The protocol is ordered by accessibility and risk, with the most conservative interventions applied first. All components are individually referenced in their respective chapters; this section provides the integrated protocol.
