...
*Certainty*   Medium — double-blind RCT with invasive hemodynamic measurements.

*Does NOT tell us*   whether preload failure is from autoantibody-mediated vascular dysfunction, hypovolemia, or connective tissue laxity.

*Action*   volume expansion (fludrocortisone, sodium) and compression become particularly relevant.

*Level of action*   Partial root cause — pyridostigmine compensates for impaired ganglionic transmission without addressing what caused it.

Finding 2 — Cholinergic anti-inflammatory pathway was engaged. Pyridostigmine increases acetylcholine, activating α7 nicotinic receptors on macrophages and T cells — vagally-mediated immune modulation. PISCO COVID-19 RCT (n=188): pyridostigmine halved 28-day mortality (HR 0.47) with no change in systemic cytokines @FragosoSaavedra2022pisco — suggesting tissue-level immune modulation.

*Certainty*   Low — evidence from COVID-19, not ME/CFS.

*Level of action*   Partial root cause.

Finding 3 — Autonomic nerve function was partially preserved. Pyridostigmine potentiates existing acetylcholine — it cannot create a signal where nerves have degenerated. Okamoto et al. (2025) showed preserved baroreflex function predicts response @Okamoto2025pyridostigmine.

*Certainty*   Medium.

*Action*   if pyridostigmine works, autonomic nerves are functional — treating the upstream cause could restore normal autonomic tone, potentially eliminating the need for ongoing pyridostigmine.
