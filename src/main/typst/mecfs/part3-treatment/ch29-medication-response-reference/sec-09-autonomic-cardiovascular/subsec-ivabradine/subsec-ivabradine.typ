...
Finding 1 — Tachycardia was primary
...
*Certainty*   Medium — mechanism is well characterized; no ME/CFS-specific RCT.

*Does NOT tell us*   why sympathetic drive or sinoatrial automaticity is elevated (autoantibody, central noradrenergic dysregulation, deconditioning).

*Action*   Confirms tachycardia as a treatment target; supports continued rate control.

*Level of action*   Symptom management.

Finding 2 — Tachycardia was compensatory (if ivabradine WORSENS symptoms)

If symptoms worsen, the elevated heart rate was compensating for low stroke volume — reducing heart rate lowers cardiac output further. This is itself a diagnostic result: it distinguishes low-SV POTS from hyperadrenergic POTS.

*Certainty*   Medium — the worsening response is a direct physiological signal.

*Does NOT tell us*   the source of the low stroke volume (hypovolemia, venous pooling, reduced venous return).

*Action*   Redirect toward volume expansion and venoconstriction strategies rather than rate control.

*Level of action*   Symptom management (diagnostic redirection).
...
==== ✗ If ivabradine does NOT work

- Tachycardia may not be the dominant mechanism — venous pooling or hypovolemia may predominate.
