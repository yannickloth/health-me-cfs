...
*Certainty*   Medium — CSF catecholamine reduction documented @Walitt2024NIH; stimulant surveys 77.1% brain fog improvement @Vernon2025PNAS; methylphenidate RCT 17% response @Blockmans2006methylphenidate; solriamfetol RCT significant fatigue improvement (p=0.039) @Young2025solriamfetol. But effect sizes modest and survey data uncontrolled.

*Does NOT tell us*   why catecholamines are deficient; whether benefit is sustainable (masking fatigue enables overexertion — PNAS: +77.1% brain fog but −1.5% PEM).

*Action*   catecholamine involvement confirmed; combine with LDN (neuroinflammation) or mitochondrial supplements (metabolic constraint) to identify upstream cause.

*Level of action*   Symptom management — stimulants compensate for deficient signaling without restoring production or removing inflammatory precursor depletion.

Finding 2 — Dopamine deficit type (methylphenidate/solriamfetol vs. amphetamines). Reuptake blocker works but amphetamines cause severe crashes → low-production deficiency (stores depleted, production insufficient to replenish).

*Certainty*   Low to Medium.

*Level of action*   Symptom management.

Finding 3 — Brain energy metabolism integrity (modafinil vs. methylphenidate). Modafinil has brain ATP enhancement and M1→M2 microglial shift @Minzenberg2008modafinil. Methylphenidate increases REE +7% and chronically decreases hippocampal ATP @Graveling2023stimulantmitochondria. Modafinil tolerated + methylphenidate worsens energy → brain can benefit from ATP enhancement but cannot tolerate +7% metabolic cost.

*Certainty*   Low (modafinil's only ME/CFS RCT was negative, n=14 @Randall2005modafinil).

*Level of action*   Symptom management — modafinil blurs toward partial root cause (brain-level, speculative).

Finding 4 — Histaminergic arousal system intact (pitolisant). Pitolisant blocks H3 autoreceptors, increasing endogenous histamine. Works without sympathetic activation → histaminergic pathway functional.

*Certainty*   Low — no ME/CFS data.

*Level of action*   Partial root cause (speculative) — anti-neuroinflammatory M1→M2 microglial shift.
