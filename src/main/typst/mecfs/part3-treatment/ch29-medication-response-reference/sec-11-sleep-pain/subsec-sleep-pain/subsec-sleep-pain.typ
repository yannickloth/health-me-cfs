...
Sleep medications are almost universally symptomatic — they improve sleep quality without identifying why sleep was poor. Melatonin carries possible circadian anti-inflammatory synergy with LDN + NAD+. Gabapentin increases N3 duration but may produce physiologically abnormal deep sleep and worsens OSA (AHI increase). Z-drugs may impair glymphatic clearance (NE oscillation suppression ~50% in animal models). DORAs (suvorexant, lemborexant, daridorexant) are theoretically informative: if a DORA improves sleep without worsening daytime fatigue, orexin is dysregulated (circadian misalignment); if it worsens fatigue, orexin is globally deficient — DORAs contraindicated, orexin agonists relevant.
