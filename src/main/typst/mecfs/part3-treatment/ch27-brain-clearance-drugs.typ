...
#speculation(title: [Low-Dose Clonidine for LC-NE Oscillation Stabilization and Fast Advective Flow Enhancement])[
*Certainty: 0.35. (0.40→0.35: Sulheim 2014 clonidine RCT null in adolescent CFS @Sulheim2014clonidine provides negative evidence for the broader mechanism — if clonidine improved glymphatic clearance via NE oscillation stabilisation, some clinical benefit should have been detectable. The central NE deficiency documented in ME/CFS @Aregawi2026Noradrenergic means clonidine would further suppress already-low LC output, potentially worsening glymphatic clearance rather than improving it. The distinction between suppressing "excessive tonic NE" (the prior rationale) and "already-low tonic NE" is critical and was not accounted for.)* NE oscillations at approximately 0.05 Hz drive vasomotion and the fast advective component of glymphatic clearance (Hauglund 2025). Chayama et al.\ show that NE-driven vasomotion powers clearance through dura and skull compartments @Chayama2026BrainClearance. Low-dose clonidine (0.025--0.05 mg at bedtime) was proposed to reduce excessive tonic NE drive while preserving LC oscillatory competence, but the Aregawi et al. (2026) demonstration of *low* central NE in ME/CFS undermines this rationale: there is no excessive tonic drive to reduce. The Sulheim et al. (2014) RCT of clonidine in adolescent CFS (n=120) found no symptom improvement, consistent with the mismatch model in which central NE is pathologically low @Sulheim2014clonidine. Nevertheless, the concept (restoring infraslow vasomotion rhythm) remains mechanistically sound; the question is whether other interventions (DORAs, atomoxetine timed to circadian phase) could achieve this without suppressing LC output.
...
#speculation(title: [TGN-020 (AQP4 Inhibitor) for Slow Diffusive Component Restoration])[
*Certainty: 0.30.* AQP4 provides the osmotic gradient driving the slow diffusive component of glymphatic transport (Toscano 2026, approximately 0.1 micron/s). In ME/CFS, AQP4 is depolarized at astrocytic endfeet. TGN-020 is an investigational AQP4 modulator that could restore polarized AQP4 localization to the perivascular endfoot membrane, enhancing slow diffusion. Chayama et al.\ @Chayama2026BrainClearance confirm that AQP4-rich perivascular spaces are the physiological clearance conduits.
...
=== Perivascular Structure Restoration

#speculation(title: [Losartan for Perivascular Fibrosis Reversal])[
*Certainty: 0.40.* Chayama et al.\ @Chayama2026BrainClearance document perivascular spaces as the primary clearance conduits. Chronic glymphatic impairment in ME/CFS involves perivascular fibrosis and basement membrane thickening (Section @sec:ch15-glymphatic, approximately 70x recovery timescale). Losartan, an angiotensin II receptor blocker, has anti-fibrotic properties independent of its antihypertensive effects — documented in kidney, liver, and cardiac fibrosis models.
...
#speculation(title: [Glycine for Perivascular Anti-Fibrotic Effect])[
*Certainty: 0.32.* Glycine is a simple amino acid with documented anti-fibrotic properties in liver and kidney via inhibition of TGF-beta signaling and collagen synthesis. Chayama et al.\ @Chayama2026BrainClearance demonstrate that perivascular spaces are the structural conduits requiring patency. Glycine could reduce perivascular collagen deposition and support clearance route integrity.
...
=== AQP4 and Oxidative Protection

#speculation(title: [Alpha-Lipoic Acid for AQP4 Oxidation Protection])[
*Certainty: 0.35.* AQP4 is susceptible to oxidative damage, which contributes to depolarization at astrocytic endfeet. Systemic oxidative stress is documented in ME/CFS (reduced cortical glutathione, Section @sec:ch15-oxidative-stress). Alpha-lipoic acid is a potent antioxidant that crosses the BBB. By reducing AQP4 oxidation, ALA may preserve AQP4 polarization and slow diffusive glymphatic transport. Chayama et al.\ @Chayama2026BrainClearance confirm AQP4-rich perivascular spaces are the clearance conduits.
...
#speculation(title: [Taurine for Osmotic Gradient Support and AQP4 Enhancement])[
*Certainty: 0.30.* Taurine is an organic osmolyte concentrated in astrocytes that maintains cell volume and osmotic gradients. By supporting the osmotic driving force for AQP4-mediated water transport, taurine could enhance the slow diffusive component of glymphatic flow. Chayama et al.\ @Chayama2026BrainClearance show that perivascular AQP4-rich interfaces are the clearance conduits.
...
#speculation(title: [N-Acetylcysteine for AQP4 Preservation via Oxidative Stress Reduction])[
*Certainty: 0.38.* NAC is a glutathione precursor that crosses the BBB. One pilot trial in ME/CFS normalized cortical glutathione, ventricular lactate, and symptom scores (Shungu 2016). By reducing perivascular oxidative stress, NAC may preserve AQP4 polarization at astrocytic endfeet. Chayama et al.\ @Chayama2026BrainClearance confirm AQP4-rich perivascular spaces are the clearance conduits.
