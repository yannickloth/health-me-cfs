...
Zinc is essential for thymic hormone production---thymulin is zinc-dependent---and zinc deficiency impairs thymic output and naive T cell survival (for review of zinc-thymulin axis, see Dardenne 2002). Many adolescents have suboptimal zinc status during puberty when zinc requirements increase, coinciding with the early ME/CFS onset peak at age ~16 @McGrath2026bimodalOnset. Zinc supplementation (30 mg/day elemental zinc with 2 mg copper to prevent copper depletion) could theoretically support residual thymic function in early-onset patients via the zinc-thymulin axis. *Falsifiable prediction:* 30 mg/day zinc × 12 weeks will increase recent thymic emigrants (CD31+ naive CD4 T cells) by ≥20% in early-onset (onset ≤20y) ME/CFS but not in late-onset (onset ≥30y, less than 10% increase). Zinc supplementation would be expected to be more effective in early-onset than late-onset patients because residual thymic tissue in younger patients is more responsive to thymic hormone support.
*Certainty: 0.30* (zinc-thymulin axis well-established in immunology; reinforced by thymic-EBV synchrony hypothesis cert 0.45, melatonin-thymic spec, and T1D pubertal bridge — three independent lines converge on pubertal thymic window as early-onset mechanism; no ME/CFS-specific zinc-thymic outcome studies). *Not yet tested in ME/CFS.*
...
Melatonin is produced by the pineal gland and by thymic epithelial cells, where it regulates thymic hormone production, T cell maturation, and protects thymocytes from apoptosis (Carrillo-Vico et al. 2005). Melatonin levels decline during puberty, coinciding with thymic involution and the early ME/CFS onset peak. Physiological-dose melatonin (0.3--0.5 mg, matching endogenous production levels) could theoretically provide direct intrathymic support in early-onset patients, in contrast to the supraphysiological doses (3--10 mg) commonly used for sleep induction. *Falsifiable prediction:* Physiological-dose melatonin (0.3 mg nightly × 16 weeks) will increase recent thymic emigrants (CD31+ naive CD4 T cells) by ≥15% in early-onset (onset ≤18y) ME/CFS but not in late-onset (onset ≥35y, less than 5% increase). Supraphysiological dose (5 mg) will produce less than 5% increase or ≥5% decrease in RTEs in both groups. If 0.3 mg shows no RTE increase or 5 mg significantly increases RTEs, the thymic-protectant hypothesis is not supported. Melatonin also has direct antiviral activity against EBV in vitro, providing a secondary mechanistic rationale for early-onset patients where EBV/IM is disproportionately involved.
*Certainty: 0.30* (intrathymic melatonin biology well-established in animal models; reinforced by thymic-EBV synchrony hypothesis cert 0.45 and zinc-thymulin spec — three independent lines converge on pubertal thymic window; no ME/CFS melatonin-thymic outcome studies). *Not yet tested in ME/CFS.*
