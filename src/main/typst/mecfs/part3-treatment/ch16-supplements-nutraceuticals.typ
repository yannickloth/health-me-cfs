...
Melatonin is produced by the pineal gland and by thymic epithelial cells, where it regulates thymic hormone production, T cell maturation, and protects thymocytes from apoptosis (Carrillo-Vico et al. 2005). Melatonin levels decline during puberty, coinciding with thymic involution and the early ME/CFS onset peak. Physiological-dose melatonin (0.3--0.5 mg, matching endogenous production levels) could theoretically provide direct intrathymic support in early-onset patients, in contrast to the supraphysiological doses (3--10 mg) commonly used for sleep induction. *Falsifiable prediction:* Physiological-dose melatonin (0.3 mg nightly × 16 weeks) will increase recent thymic emigrants (CD31+ naive CD4 T cells) by ≥15% in early-onset (onset ≤18y) ME/CFS but not in late-onset (onset ≥35y, less than 5% increase). Supraphysiological dose (5 mg) will produce less than 5% increase or ≥5% decrease in RTEs in both groups. If 0.3 mg produces less than 15% RTE increase (the threshold for support) or 5 mg increases RTEs, the thymic-protectant hypothesis is not supported. Melatonin also has direct antiviral activity against EBV in vitro, providing a secondary mechanistic rationale for early-onset patients where EBV/IM is disproportionately involved.
*Certainty: 0.30* (intrathymic melatonin biology well-established in animal models; reinforced by thymic-EBV synchrony hypothesis cert 0.45 and zinc-thymulin spec — three mutually reinforcing lines (same core premise: pubertal thymic window is a critical vulnerability period); no ME/CFS melatonin-thymic outcome studies). *Not yet tested in ME/CFS.*
