...
#include "../../key-points/key-very-severe-mecfs-025-functional-capacity.typ"
...
*Intervention priorities for very severe ME/CFS:*
    ...
    - *Disability and housing security*: Patients at very severe levels have almost universally lost employment. Social Security Disability Insurance (SSDI) and Supplemental Security Income (SSI) applications should be top priority, supported by comprehensive medical documentation of inability to work. Housing security and food security often become fragile; medical providers should connect patients with social work services, disability advocates, and community resources. Formal food insecurity screening using the validated Hunger Vital Sign (Section @ach:food-insecurity-disease-burden) is increasingly warranted given evidence that food access difficulties compound disease severity in ME/CFS and Long COVID.
