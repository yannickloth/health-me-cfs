...
#practical-warning(title: [Physician Collaboration Required])[
Pediatric medication dosing, particularly for off-label uses, requires close collaboration with physicians experienced in pediatric medicine. The dosing recommendations in this chapter reflect published literature and clinical practice guidelines but must be individualized based on the child's weight, age, comorbidities, and response. The Centers for Disease Control and Prevention explicitly recommends “extra caution when prescribing medicines for children with ME/CFS” and “starting medications at the smallest possible doses” @CDC2024pediatric. All pharmacological interventions should be initiated and monitored by qualified healthcare providers.
]

#limitation(title: [Pediatric Severe Protocols: Adult Extrapolation with Limited Paediatric Data])[
Treatment protocols in this chapter are largely adapted from adult ME/CFS management (Chapter @ch:urgent-action-severe) with paediatric dosing adjustments. Key epistemic boundaries:
...
Approximately 5–10% of pediatric ME/CFS cases fall into the severe category, though this may be underestimated because severely affected children are often unable to participate in medical visits or research studies @Rowe2020severeME.

=== Mast Cell Activation Syndrome (MCAS) Management in Severe Pediatric Cases
...
==== Pediatric MCAS Treatment

#protocol(title: [Pediatric Mast Cell Management])[
...
#proposal(title: [C5: Pediatric-Adapted Butyrate Protocol (0.45)])[
  ...
  *Testable Predictions.*
  ...
  1. Pediatric ME/CFS patients using pediatric-adapted butyrate dosing will show improved gut barrier function markers (zonulin, LPS, I-FABP) compared to untreated controls.
  2. Butyrate supplementation will reduce post-exertional GI symptom severity in pediatric patients (bloating, cramping, diarrhea).
  3. Pediatric patients on butyrate will maintain or improve growth parameters (weight, height, BMI percentile) compared to pre-treatment baseline or untreated controls.
...
=== Equipment Needs for Bedbound Children
...
*Evidence level*: Plausible (subtype framework from Chapter @sec:selective-dysfunction, adapted for pediatrics)
...
Medical management of severe pediatric ME/CFS follows similar principles to adult management (Chapter @ch:urgent-action-severe) but requires pediatric-specific dosing and heightened attention to developmental effects. The CDC recommends extra caution with pediatric ME/CFS medications, starting at lowest possible doses @CDC2024pediatric.

=== Orthostatic Intolerance (Priority)
<subsec:ped-severe-oi>

Orthostatic intolerance (OI) affects 70–90% of pediatric ME/CFS patients, compared to approximately 40–70% of adults @Rowe2017pediatric. This higher prevalence makes OI management the single most important intervention in pediatric ME/CFS. Treatment of orthostatic intolerance improves not only cardiovascular symptoms but also fatigue, cognitive function, and overall wellbeing @Ojha2024pediatricPOTS.

==== Non-Pharmacological Interventions

Non-pharmacological measures should be implemented first and continued even if medications are added:

#protocol(title: [Pediatric OI Non-Pharmacological Protocol])[
...
#protocol(title: [Pediatric OI Pharmacological Protocol])[
...
Alpha-1 agonist that causes vasoconstriction, increasing blood pressure and reducing venous pooling. Pediatric POTS studies report 78% response rate @Ojha2024pediatricPOTS.
...
#protocol(title: [Pediatric Sensitization-Prevention Protocol])[

*Anti-Neuroinflammatory Foundation*

A multi-component approach targets neuroinflammatory activation, which underlies both PEM and progressive sensitization. The goal is to interrupt the cycle where each crash and each infection creates lasting sensitization (see Chapter @ch:neurological for discussion of \hyperref[hyp:pem-kindling-sensitization]{PEM kindling hypothesis} and Chapter @ch:immune-dysfunction for discussion of \hyperref[spec:infection-damage-ratchet]{infection damage ratchet mechanisms}).
...
Sleep deprivation perpetuates neuroinflammation. Severe cases warrant sleep medicine evaluation:
    ...
    - *Optimization*: Melatonin, trazodone, or low-dose amitriptyline (see Protocol @protocol:ped-sleep) as needed to ensure adequate sleep quality
...
Preventing overexertion is critical to preventing sensitization cascade:
    ...
    - *Threshold definition*: Establish safe heart rate ceiling based on aerobic threshold calculation: $(220 - "age") times 0.55$ to $0.60$
...
#protocol(title: [Pediatric Pain Management Protocol])[
...
#practical-warning(title: [Black Box Warning: Pediatric Antidepressants])[
...
==== Sleep Hygiene for Bedbound Children
...
Standard sleep hygiene recommendations require modification for bedbound patients who cannot leave their beds:
    ...
    - *Temperature*: Cooler room temperatures (65–68{\textdegree}F) facilitate sleep

==== Sleep Medications

#protocol(title: [Pediatric Sleep Protocol])[

*First-Line: Melatonin*

Melatonin is the preferred first-line sleep aid for pediatric ME/CFS due to safety profile and documented efficacy @castromarrero2021melatonin.
...
#practical-warning(title: [Avoid in Pediatrics])[
...
==== Circadian Light Therapy for Energy and Sleep Alignment

#hypothesis(title: [Circadian Energy Misallocation in Pediatric ME/CFS])[
The selective energy dysfunction hypothesis (Chapter @sec:selective-dysfunction, lines 628–645) proposes that circadian dysregulation impairs energy budget allocation, explaining why pediatric patients often have evening energy spikes despite daytime exhaustion.
]
...
==== When Cognitive Symptoms May Improve

Cognitive function often improves with OI treatment. If orthostatic intolerance is inadequately treated, cerebral hypoperfusion (reduced blood flow to brain) contributes significantly to brain fog (see Chapter @ch:cardiovascular, Section @sec:orthostatic-hypotension). Many children experience noticeable cognitive improvement within 1–2 weeks of effective OI management. Always optimize OI treatment before assuming cognitive dysfunction is irreversible.

==== Intranasal Delivery for CNS-Targeted Cognitive Support

#key-point(title: [BBB Vulnerability in Pediatric ME/CFS])[
The selective energy dysfunction hypothesis (Chapter @sec:selective-dysfunction, lines 238–257) proposes that the blood-brain barrier may be compromised in ME/CFS, limiting delivery of cognitive support compounds. Intranasal delivery bypasses the BBB via olfactory nerve pathways.
]
...
#practical-warning(title: [This Is NOT Graded Exercise Therapy])[
...
In the United States, severely ill children retain legal rights to education:
    ...
    - *Individuals with Disabilities Education Act (IDEA)*: Entitles children with disabilities to Free Appropriate Public Education (FAPE) through Individualized Education Program (IEP)
    - *Section 504 of Rehabilitation Act*: Prohibits discrimination against students with disabilities; provides for 504 Plans with accommodations
    - *Homebound instruction*: Most states require school districts to provide instruction at home for students unable to attend school due to illness

=== Homebound Instruction Protocols
...
=== Maintaining Academic Trajectory
...
Severe pediatric ME/CFS creates financial strain:
    ...
    - *Lost parental work*: One or both parents may need to reduce work or stop working to provide care
    - *Medical expenses*: Specialty care, medications, supplements, equipment often poorly covered by insurance
    - *Home modifications*: May require investment in equipment or home changes
    - *Lost child income*: Adolescents lose ability to work part-time jobs

Resources:

    - *Family Medical Leave Act (FMLA)*: Provides job-protected leave for care of ill child (unpaid, but protects employment)
    - *State disability programs*: Some states have family caregiver support programs
    - *SSI for child*: Supplemental Security Income may be available for severely disabled children in low-income families
    - *Charitable assistance*: ME/CFS organizations and general chronic illness charities may provide grants
    - *Medical bill negotiation*: Many hospitals offer charity care or payment plans
...
=== Malnutrition and Feeding Concerns
...
Interventions:
    ...
    - *Tube feeding consideration*: If unable to maintain adequate nutrition orally and weight loss continues, nasogastric or PEG tube feeding may be necessary—this is a serious decision requiring specialist involvement
...
#practical-warning(title: [Suicide Risk Assessment])[
...
=== Distinguishing Severity from Concurrent Illness
...
Long-term follow-up studies demonstrate substantially better outcomes in pediatric ME/CFS than adult disease @Rowe2019pediatric:
...
Adult ME/CFS has dramatically worse outcomes (see Chapter @ch:disease-course and Section @sec:adult-recovery-evidence for comprehensive analysis):

    - Recovery: Only 5% (median across studies)
    - Improvement: $lt.eq$22%
...
=== Hope Maintenance with Realistic Expectations
...
#key-point(title: [The Pediatric Advantage])[
...
For ambulatory pediatric patients who are still attending school, see Chapter @ch:pediatric-ambulatory for school accommodation frameworks, IEP/504 planning, and pacing strategies for school-attending children. For adult severe ME/CFS management, see Chapter @ch:urgent-action-severe. For detailed discussion of pathophysiology underlying these interventions, see Chapter @ch:cardiovascular (orthostatic mechanisms), Chapter @ch:energy-metabolism (metabolic dysfunction), and Chapter @ch:immune-dysfunction (immune abnormalities).
]
