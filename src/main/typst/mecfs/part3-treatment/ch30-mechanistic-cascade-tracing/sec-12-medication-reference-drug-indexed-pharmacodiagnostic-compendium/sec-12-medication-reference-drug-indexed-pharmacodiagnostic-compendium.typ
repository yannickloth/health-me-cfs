...
*Appears in:* @sec:wasf3-cascade Step D2, @sec:pdh-cascade, @sec:aimm-cascade, cross-reference matrix Phase 4 Group C.
...
*Appears in:* Cross-reference matrix Phase 4 Group C, @sec:trpv1-cascade Step B1.
...
*Appears in:* @sec:gerlier-dopamine-node, @sec:microglial-cascade Step K2d, @sec:dopamine-convergence, @sec:trpm3-cascade (M4 CNS), cross-reference matrix.
...
*Appears in:* @sec:trpv1-cascade Step B2, cross-reference matrix.
...
*Appears in:* @sec:trpm3-cascade Step A4, @sec:microglial-cascade Step K2b (LC-NE dysfunction), @sec:noradrenergic-node, cross-reference matrix.
...
*Appears in:* Cross-reference matrix Group B, @sec:gpcr-cascade I1.
...
*Appears in:* Cross-reference matrix Group B, @sec:dopamine-convergence.
...
*Appears in:* Cross-reference matrix Group C, @sec:aimm-cascade.
...
*Appears in:* Cross-reference matrix Group A, @sec:gpcr-cascade I1.
...
*Appears in:* Cross-reference matrix, @sec:aimm-cascade F1.
...
*Appears in:* @sec:noradrenergic-node, cross-reference matrix.
...
*Appears in:* @sec:trpm3-cascade Step A4, cross-reference matrix.
...
*Appears in:* @sec:vagal-cascade R1, cross-reference matrix.
...
#strong[+] Iron deficiency rate-limiting for oxygen transport, ETC function, and neurotransmitter synthesis. Iron repletion restores hemoglobin, mitochondrial complexes, and catecholamine synthesis — confirms iron deficiency was the dominant correctable lesion.

#strong[−] Iron not rate-limiting. Ferritin normal + no improvement → fatigue is not iron-mediated — one of the most common ME/CFS mimics excluded. If iron supplementation causes worsening → iron overload or hepcidin dysregulation.

#strong[SE] GI intolerance → standard iron GI side effects — switch to iron bisglycinate or heme iron polypeptide. No ferritin rise at 4 weeks → hepcidin blockade — confirms inflammatory hepcidin elevation preventing iron absorption (Pattern 4). The non-response IS diagnostic: the patient has anemia of chronic inflammation (hepcidin-mediated iron sequestration), not iron deficiency — IV iron may bypass the hepcidin block.

#strong[W] *Mechanism:* A (iron overload if supplemented in the absence of deficiency — hemochromatosis gene carriers). G (GI mucosal irritation with prolonged oral iron). *Protracted risk:* Very Low. *Permanent risk:* Very Low (unless undiagnosed hemochromatosis). *Rechallenge:* Yes, with ferritin and TSAT monitoring. Iron deficiency must be excluded before diagnosing ME/CFS — the fatigue, cognitive dysfunction, and exercise intolerance are indistinguishable. If no ferritin rise at 4 weeks: check hepcidin — IV iron may be needed to bypass the hepcidin block in inflammatory ME/CFS.
...
*Appears in:* Cross-reference matrix Group B, @sec:pots-cascade.
...
#strong[−] AMPK not rate-limiting; or GI side effects prevent titration to therapeutic dose.
...
*Appears in:* @sec:wasf3-cascade D2--D3, @sec:pdh-cascade E2, @sec:nad-cascade G2, cross-reference matrix.
...
*Appears in:* @sec:gerlier-dopamine-node, cross-reference matrix.
...
*Appears in:* @sec:piezo2-cascade C1, cross-reference matrix.
...
*Appears in:* Cross-reference matrix Group B, @sec:piezo2-cascade C2.
...
*Appears in:* @sec:trpm3-cascade Step A4, cross-reference matrix entries for individual drugs (duloxetine, fluvoxamine, amitriptyline).
