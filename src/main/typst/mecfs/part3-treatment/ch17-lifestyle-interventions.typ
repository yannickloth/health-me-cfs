...
*Certainty: 0.55.* (0.60→0.55: Mancini/Natelson 2026 null replication of Day 2 CPET decline reduces certainty of CPET-specific support; framework remains grounded in energy envelope theory and patient-reported harms. Incoming evidence certainty 0.60). Grounded in energy envelope theory, patient-reported harms from GET, and CPET evidence (contested — see limitation note above). The framework is conceptual, not a testable mechanism.
