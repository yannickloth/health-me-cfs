...
These findings demonstrate that exertion *impairs rather than improves physiological function* in ME/CFS. GET protocols that require repeated exertion before recovery is complete would predictably produce cumulative deterioration—precisely what patients report.
