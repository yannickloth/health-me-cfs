...
- *If dose escalation from 1.5 to 4.5 mg extinguishes benefit:* The hormetic window has been crossed -> Nrf2 reserve is depleted by TLR4 over-blockade. This is NOT a failed titration --- it identifies that the therapeutic mechanism is TLR4 hormetic priming, not TRPM3 restoration. Maintain at the effective low dose.
