...
*Consequence:* If you take a drug that shouldn't work — because your mechanism hypothesis says the thing it needs is broken — and it works anyway, you've learned something important: your hypothesis has a structural flaw. TRPM3 said mast cell Ca²⁺ entry should be impossible; ketotifen (which depends on Ca²⁺ blocking) made you feel better. One of those two things is wrong — and the drug response tells you which one.
(Origin: brainstorm.)
