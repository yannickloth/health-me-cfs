...
*Population limitation:* The OSA risk was demonstrated in older men (mean age 68) without baseline OSA @Piovezan2017gabapentinOSA. ME/CFS patients are predominantly female (70-80%) with mean age 45-50, and many have comorbidities not studied. Whether the risk generalizes to the ME/CFS population is uncertain; conservative screening using STOP-Bang is advisable pending ME/CFS-specific data.
    ...
    - *Suvorexant/lemborexant*: Orexin receptor antagonists that may be particularly relevant given hypothesized orexin pathway dysfunction in ME/CFS. Clinical experience in ME/CFS is limited
     - *Z-drugs* (zolpidem, eszopiclone): Effective for sleep initiation but do not improve the unrefreshing quality of ME/CFS sleep. Risk of dependence with long-term use; best reserved for intermittent use. Note: Z-drugs suppress NE oscillation amplitude by approximately 50% in animal models, potentially impairing glymphatic clearance @Hauglund2025neVasomotion; SleepFM's large-scale validation that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions @Thapa2026sleepfm supports the clinical importance of preserving coupling integrity
