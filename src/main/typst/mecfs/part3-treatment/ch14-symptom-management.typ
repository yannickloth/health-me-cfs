...
#warning-env(title: [This Cannot Be Overstated])[
...
*Population limitation:* The OSA risk was demonstrated in older men (mean age 68) without baseline OSA @Piovezan2017gabapentinOSA. ME/CFS patients are predominantly female (70-80%) with mean age 45-50, and many have comorbidities not studied. Whether the risk generalizes to the ME/CFS population is uncertain; conservative screening using STOP-Bang is advisable pending ME/CFS-specific data.
    ...
    - *Suvorexant/lemborexant*: Orexin receptor antagonists that may be particularly relevant given hypothesized orexin pathway dysfunction in ME/CFS. Clinical experience in ME/CFS is limited
     - *Z-drugs* (zolpidem, eszopiclone): Effective for sleep initiation but do not improve the unrefreshing quality of ME/CFS sleep. Risk of dependence with long-term use; best reserved for intermittent use. Note: Z-drugs suppress NE oscillation amplitude by approximately 50% in animal models, potentially impairing glymphatic clearance @Hauglund2025neVasomotion; SleepFM's observation that cross-modal physiological decoupling during sleep predicts disease onset across 130+ conditions @Thapa2026sleepfm provides a mechanistic rationale for concern, though no clinical data link Z-drug use to worsened outcomes in any condition and the predictive finding is observational, not interventional
...
#warning-env(title: [Opioid Prescribing in ME/CFS])[
...
Non-pharmacological management is the foundation of orthostatic intolerance treatment and should be implemented before or alongside medications. A qualitative study by Uppal et al. (2026, Raj lab) found that POTS patients in their sample consistently reported modest medication effectiveness and valued non-pharmacological strategies (salt loading, compression garments, exercise within tolerance) as core components of their management @Uppal2026qualitative. Most patients had tried multiple medications with limited benefit — underscoring the importance of realistic expectations and that non-pharmacological strategies are essential complements, not alternatives, to pharmacotherapy. Qualitative studies capture patient experience, which may reflect suboptimal dosing, poor specialist access, or early discontinuation from side effects in addition to genuine pharmacodynamic limitation; these findings are formative rather than confirmatory regarding medication effectiveness.
    ...
    - *Graded reconditioning*: If tolerated within the energy envelope, recumbent exercise (recumbent cycling, swimming, rowing) can maintain cardiovascular function and prevent orthostatic deconditioning without the orthostatic stress of upright exercise. The Dallas/Leeds POTS protocol provides a clinical precedent from an adjacent condition: seated rowing, recumbent cycling, and swimming as starting modalities, with documented cardiovascular benefits in POTS patients @Fu2010DallasProtocol @Fu2018ExercisePOTS — however, the protocol has not been tested in ME/CFS, and community completion drops to 41 percent from 76 percent in research settings. The goal is maintenance, not fitness improvement — progression must be extremely gradual and must not trigger PEM (see Section @subsec:fitness-maintenance for the fitness-maintenance framework and Section @subsec:land-rowing for land-based rowing)
...
#speculation(title: [Passive Heat Therapy: Unvalidated Clinical Observation])[
*(Certainty: 0.35.)* Two small uncontrolled pilot studies reported that passive heat therapy may be tolerated in ME/CFS: Soejima et al. (n=10, 5×/week × 4 weeks, Waon far-infrared sauna 60°C, 15 min) reported reduced fatigue (p < 0.05) and improved mood in an uncontrolled, unblinded design — results that cannot distinguish treatment effect from placebo, regression to the mean, or Hawthorne effect @Soejima2015WaonTherapyCFS. Separately, Hochecker et al. (2025, n=9, within-subject pre-post, single center, unreplicated) reported cellular-level effects: whole-body hyperthermia (WBH, core temperature 39°C) reduced autophagy marker LC3-II by 17.84% (p=0.0065) and increased mitochondrial respiration (basal +66.60%, ATP +61.41%, maximal +97.88%, spare capacity +112.35%) in PBMCs @Hochecker2025HyperthermiaMECFS — a study with no clinical outcome measures. Whether these two observations are causally connected (cellular improvement → clinical benefit) is unknown; they may represent independent phenomena. Both studies are small, uncontrolled, from single centers, and unreplicated.
