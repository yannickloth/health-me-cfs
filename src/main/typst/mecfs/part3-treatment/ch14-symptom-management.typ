...
*(Certainty: 0.45.)* A clinically relevant but unvalidated observation: despite near-universal heat intolerance, controlled passive heat therapy (far-infrared sauna / Waon therapy, 60°C for 15 min, followed by 30 min rest) produced significant reductions in fatigue (p < 0.05), improvement in negative mood (anxiety, depression), and improved performance status in CFS patients (n=10, 5×/week × 4 weeks) with zero adverse events @Soejima2015WaonTherapyCFS — though this was an uncontrolled, unblinded pilot. Hochecker et al. (2025) provided a possible cellular mechanism: whole-body hyperthermia (WBH, core temperature 39°C) in ME/CFS patients (n=9) reduced autophagy marker LC3-II by 17.84% (p=0.0065) and increased mitochondrial respiration across all parameters — basal (+66.60%, p=0.0040), ATP production (+61.41%, p=0.0023), maximal (+97.88%, p=0.0071), and spare capacity (+112.35%, p=0.0086) — consistent with improved tissue perfusion and oxygen availability @Hochecker2025HyperthermiaMECFS.
