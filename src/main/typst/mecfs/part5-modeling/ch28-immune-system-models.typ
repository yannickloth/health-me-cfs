...
$
frac(d ["MC_act"], d t) &= k_"MC,0" + k_"MC,ECM" dot.op (["ECMfrag"]^2) / (K_"ECMfrag"^2 + ["ECMfrag"]^2) - k_"MC,stab" dot.op ["MC_act"] \
frac(d ["ECM_q"], d t) &= k_"ECM,synth" - k_"ECM,deg" dot.op ["MMP"] dot.op ["ECM_q"] \
frac(d ["MMP"], d t) &= k_"MMP,MC" dot.op ["MC_act"] + k_"MMP,inf" dot.op ["IL-6"] - k_"MMP,clear" dot.op ["MMP"] \
frac(d ["ECMfrag"], d t) &= k_"ECM,frag" dot.op ["MMP"] dot.op ["ECM_q"] - k_"ECM,frag,clear" dot.op ["ECMfrag"]
$
