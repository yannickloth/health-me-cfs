...
#include "sec-02-personalized-pacing-optimization/sec-02-personalized-pacing-optimization.typ"
#include "sec-03-treatment-selection-and-optimization/sec-03-treatment-selection-and-optimization.typ"
#include "sec-04-prognosis-prediction/sec-04-prognosis-prediction.typ"
#include "sec-05-clinical-decision-support/sec-05-clinical-decision-support.typ"
#include "sec-06-drug-development-applications/sec-06-drug-development-applications.typ"
#include "sec-07-optimal-control-theory-for-pacing/sec-07-optimal-control-theory-for-pacing.typ"
#include "sec-08-global-sensitivity-analysis-and-drug-target-ranking/sec-08-global-sensitivity-analysis-and-drug-target-ranking.typ"
#include "sec-09-network-controllability-and-minimum-intervention-sets/sec-09-network-controllability-and-minimum-intervention-sets.typ"
#include "sec-10-model-predicted-treatment-candidates/sec-10-model-predicted-treatment-candidates.typ"
#include "sec-11-virtual-population-simulation/sec-11-virtual-population-simulation.typ"
#include "sec-12-novel-predictions-results-that-emerge-only-from-the-formal-m/sec-12-novel-predictions-results-that-emerge-only-from-the-formal-m.typ"
#include "sec-13-implementation-roadmap/sec-13-implementation-roadmap.typ"
