...
A recent prospective cohort study of 168 ME/CFS patients followed for 20–51 months found @Lacourt2022prognosis:
...
*Pediatric Recovery.*
Children and adolescents with ME/CFS have substantially better outcomes than adults @Rowe2019pediatric:
...
The dramatic difference between pediatric (54–94% improve or fully recover) and adult ($lt.eq$22% improve) outcomes suggests that biological factors related to developmental plasticity may facilitate recovery in young patients, or that adults face barriers to recovery not present in children. For pediatric-specific treatment protocols that leverage this critical intervention window, see Chapters @ch:pediatric-severe and @ch:pediatric-ambulatory.

#limitation(title: [Adult Recovery Rate Data: Severe Methodological Constraints])[
Published adult ME/CFS recovery rates (commonly cited as $tilde$5%) are derived from a small evidence base with severe methodological limitations that cut in both directions—potentially under- _or_ overestimating true rates:
    ...
    - The hypotheses that true recovery potential “may be substantially higher” (Hypothesis @hyp:selection-bias-recovery) and that adult outcomes “might approach paediatric levels” (Hypothesis @hyp:true-adult-recovery) are unfalsified but also untested; they should not be read as evidence that recovery is likely.
...
#hypothesis(title: [Developmental Plasticity Window])[
...
#key-point(title: [Reframing Adult Recovery])[
The commonly cited $tilde$5% adult recovery rate may substantially underestimate true recovery potential due to measurement artifacts, selection bias, inadequate treatment, and environmental factors that differ systematically from pediatric populations. While full recovery remains uncommon, the evidence limitations are severe enough that the true rate is genuinely uncertain.
]

==== The Observed Evidence

Systematic reviews consistently report low recovery rates in adults. The most recent prospective cohort study found complete recovery in 8.3% and significant improvement in 4.8% of 168 patients followed for a median of 5 years @Lacourt2022prognosis. Earlier systematic reviews report median full recovery of 5% (range 0–31%) and median improvement of 39.5% (range 8–63%) @Cairns2005prognosis.
...
The improvement rate of $tilde$40% is substantially more common than full recovery. Many patients achieve meaningful functional gains—transitioning from severe to moderate, or moderate to mild—without meeting strict recovery criteria. This distinction between “improvement” and “recovery” is clinically important: improvement is achievable for many, even when cure is not.
...
*Selection Bias.*
Most prognosis studies recruit from tertiary specialty clinics, introducing several biases:
    ...
    - *Treatment-seeking bias*: Studies recruit patients “still actively seeking health care” @Lacourt2022prognosis, excluding those who have given up or recovered
...
Emerging treatment data suggests that subsets of patients respond to targeted interventions:

    - Immunoadsorption: 70% clinical response in patients with elevated autoantibodies @Stein2024immunoadsorption (suggesting an autoimmune subtype)
    - Low-dose naltrexone: 73.9% report positive response in retrospective studies @Polo2019
...
#hypothesis(title: [Selection Bias in Published Recovery Rates])[
...
Limited evidence suggests the following factors are associated with better outcomes in adults:
    ...
    - *Shorter diagnostic delay*: Each year of delay reduces recovery odds by $tilde$2%
    - *Older age at onset*: Counterintuitively, older age at onset predicts better outcomes (OR 1.06 per year, $p = 0.028$) @Lacourt2022prognosis—mechanism unknown
...
Recovery, when it occurs, typically follows a slow trajectory:
    ...
    - Transition through severity levels (severe $arrow.r$ moderate $arrow.r$ mild) rather than sudden resolution
...
==== Comparison with Pediatric Recovery

The 68% vs.\ 5% recovery gap between pediatric and adult ME/CFS represents a natural experiment with profound implications (see also Section @sec:ped-severe-prognosis and Hypothesis @hyp:developmental-window).

The 13-fold difference in recovery rates between children (68% at 10 years) and adults ($tilde$5%) cannot be fully explained by biological factors alone. Contributing factors likely include:
...
If these environmental factors substantially explain the gap, adult outcomes might improve with earlier diagnosis, better accommodations, and adequate rest opportunity. This remains to be tested.
The hypothesis of developmental plasticity (Hypothesis @hyp:developmental-window) may also contribute: the developing nervous and immune systems may have recovery capacity that diminishes with age. However, even if biological plasticity explains part of the gap, the environmental differences are so substantial that they likely contribute meaningfully.
...
#key-point(title: [Counseling Adult Patients on Prognosis])[
When counseling adult patients:

    - Full recovery is uncommon ($tilde$5–10%) but does occur
    - Meaningful improvement is more common ($tilde$40%)
...
#open-question(title: [Critical Gaps in Adult ME/CFS Prognosis Research])[
...
#hypothesis(title: [True Adult Recovery Potential])[
...
Analysis of recovery and improvement in ME/CFS has identified several positive prognostic factors @Lacourt2022prognosis:
...
*Factors That Do Not Predict Outcomes.*
...
*Functional Impairment Statistics.*
Population-based studies consistently document severe functional impairment @Pendergrast2020housebound:
...
*Quality of Life.*
ME/CFS consistently ranks among the lowest quality of life scores of any chronic condition @hvidberg2015quality @kingdon2018functional:
...
*All-Cause Mortality.*
Large registry studies have not found significantly elevated all-cause mortality in ME/CFS compared to the general population @Roberts2016 @GenRe2023. However, these studies have important limitations:
...
*Suicide.*
In contrast to all-cause mortality, suicide risk is consistently and substantially elevated in ME/CFS @Roberts2016 @McManimen2016 @Chu2021suicide:
...
The elevated suicide risk in the absence of depression underscores that ME/CFS-specific suffering—not psychiatric comorbidity—drives suicide risk. This suffering includes:
    ...
    - Social isolation
    - The specific circumstance of very severe ME/CFS (see Section @sec:severe-reality)

Suicide prevention in ME/CFS must address these ME/CFS-specific factors, not merely screen for depression.

*Cardiovascular Mortality.*
Memorial record studies suggest possible elevation of cardiovascular mortality @McManimen2016 @Sirotiak2025:
...
*Mean Age at Death.*
Memorial record studies report substantially reduced life expectancy @McManimen2016 @Sirotiak2025:
