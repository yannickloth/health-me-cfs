...
#speculation(title: [Is Post-Exertional Malaise Possible Without Fatigue?])[
Post-exertional malaise is defined here as a multi-system symptom cascade, not as "exertional fatigue" (see @ach:pem-distinct-from-fatigue). This raises a question the literature has not directly tested: can PEM occur *without* fatigue---either as the dominant feature of a crash, or in a patient whose baseline fatigue is minimal?

*Temporal case 1 (within the crash window):* Crashes may be dominated by cognitive, autonomic, pain, or flu-like symptoms with fatigue present but subdominant, or even below the patient's symptom-reporting threshold. Davenport et al. found that a four-symptom set---fatigue, cognitive dysfunction, absence of positive affect, and functional decline---was needed to discriminate ME/CFS from controls; three of the four are not fatigue @Davenport2023twoSymptoms. (Certainty: 0.35. Indirect.)

*Temporal case 2 (at PEM onset):* The immediate post-exertion response may be cognitive or autonomic before any tiredness registers. In principle, a crash could lack fatigue entirely if the dominant expressive channels (neuroinflammatory, autonomic, pain) outrun the metabolic-fatigue readout. No study has dissected the first hours of a PEM episode hour-by-hour. (Certainty: 0.30. Indirect.)

*Temporal case 3 (between crashes / at baseline):* PEM is an effort-triggered response, not a resting-fatigue state. A patient with near-normal baseline fatigue can nevertheless be PEM-positive---the "crash-predominant" phenotype described in Chapter @ch:symptom-mechanisms. This is the strongest "PEM without (baseline) fatigue" case. It is supported by the finding that PEM severity stratifies patients independently of baseline fatigue severity @May2020PEMburden. (Certainty: 0.45.)

*Consequence:* If fatigue is treated as a necessary feature of PEM---or of ME/CFS more broadly---then PEM-predominant, low-fatigue patients can be misclassified or under-served. Recognizing that PEM is identified by any multi-system post-exertional worsening, not by tiredness alone, widens accurate case capture. These scenarios are candidate mechanisms; none is directly documented, and all require within-subject time-series confirmation before being asserted.

*Falsifiable prediction (two independent criteria):* (a) *True biological fatigue-absence* is falsified if, using free-text symptom elicitation with no fatigue prompt, no objectively confirmed crash episode is ever described in purely non-fatigue terms (i.e., fatigue, however labeled, is always spontaneously reported). (b) The *artifact reading* is falsified if a measurable fraction (e.g. $>$10%) of patients describe crashes in purely non-fatigue terms under free-text elicitation AND, when directly probed with a multi-synonym fatigue instrument across several domains, still report zero fatigue. If patients who describe non-fatigue crashes endorse some fatigue when directly probed, the artifact reading is supported rather than falsified.

(Severity coverage: not stratified by severity --- this speculative development applies most directly to crash-predominant patients across mild-to-moderate levels who can report symptoms; the relevance to severe/very-severe patients, whose symptom reporting is constrained, is unstudied. The crash-predominant phenotype itself is a recognised presentation in Chapter @ch:symptom-mechanisms.)
] <spec:pem-without-fatigue-temporal>

#speculation(title: [Mechanisms by Which a Crash Could Express Without Prominent Fatigue])[
If PEM-without-fatigue occurs, several mechanisms---each consistent with the multi-system cascade but none directly tested as an isolated pathway---could explain it. All are presented as candidate explanations with indirect support.

*M1. Non-fatigue dominant expressive channels.* PEM is a multi-effector cascade (metabolic → neuroinflammatory → autonomic → pain → cognitive). Fatigue is one readout. A patient whose dominant expression is autonomic (palpitations, orthostatic collapse), cognitive (brain fog), or pain-led may crash without prominent fatigue. Supported by the finding that PEM's most discriminating symptoms include multiple non-fatigue domains @Davenport2023twoSymptoms and that PEM is a primary factor independent of cognitive and sleep domains @Conroy2023empirical. (Certainty: 0.40. Indirect.)

*M2. Two-factor PEM substructure.* Exploratory factor analysis decomposes PEM into generalized fatigue and muscle-specific fatigue @McManimen2019deconstruct. A patient with a weak somatic-fatigue arm but strong other-domain expression would present a non-fatigue-dominant crash. (Certainty: 0.40. Indirect.)

*M3. Trigger-type dependence.* Cognitive, emotional, or orthostatic exertion may elicit cognitive- or autonomic-dominant crashes with less somatic fatigue than physically-triggered crashes. The paper's trigger taxonomy in the Definition and Characteristics subsection already distinguishes these exertion types (physical, cognitive, emotional, orthostatic). (Certainty: 0.35. Analogical.)

*M4. Labeling / measurement frame.* Fatigue is a culturally loaded subjective label. Patients often report "heaviness," "unwellness," "brain fog," or a "toxic feeling" rather than "fatigue." Apparent fatigue-absence may be a reporting artifact, consistent with evidence that PEM-item wording materially changes classification @Jason2015definingPEM. (Certainty: 0.45. Indirect.) Of the five mechanisms, M4 (or its combined form with M5) is the most parsimonious account of apparent fatigue-absence: it requires no novel biological pathway, is directly consistent with the wording-sensitivity finding, and can explain all observed cases without positing a truly fatigue-free state. M1--M3 remain plausible but are less parsimonious pending direct testing.

*M5. Self-report vs objective dissociation.* Objectively provoked PEM (2-day CPET) can be non-fatigue-dominant even where questionnaire fatigue is prominent, and the reverse holds in some post-COVID patients @Stussman2025selfReport. The measurement gap means "no reported fatigue" and "no fatigue" are not equivalent. (Certainty: 0.40. Indirect.)

*Falsifiable predictions (two independent criteria):* (a) True biological fatigue-absence is falsified if, using free-text elicitation with no fatigue prompt, no objectively confirmed crash is ever described in purely non-fatigue terms. (b) The artifact reading is falsified if a measurable fraction of crashes are described in purely non-fatigue terms AND report zero fatigue even when directly probed with a multi-synonym fatigue instrument. Additional tests: (c) cognitive/orthostatic-triggered crashes show systematically lower fatigue intensity than physically-triggered crashes; (d) if M2 holds, patients with a low muscle-fatigue arm spare myalgic symptoms during crashes while retaining cognitive/autonomic symptoms.

*Consequence:* These mechanisms, if confirmed, would change how clinicians elicit PEM (multi-system probe, trigger-type consideration, symptom-lexicon awareness) and how diagnostic instruments are scored (post-exertional worsening in any system, not fatigue only). Until direct evidence exists, they remain speculative: coding any of M1--M5 as established fact is not justified.

(Severity coverage: not stratified by severity --- the mechanisms are inferred from ambulatory cohorts and the ch18 crash-predominant phenotype; applicability to severe/very-severe patients, whose symptom expression may be monosymptomatic or dominated by a single channel, is unstudied and represents a direction for the proposed within-subject research.)
] <spec:pem-without-fatigue-mechanisms>

#open-question(title: [Is "PEM Without Fatigue" Ever a Real Phenomenon, or Always a Measurement Artifact?])[
The strongest competing interpretation is that reported "PEM without fatigue" is never a true absence of fatigue, but always a measurement, labeling, or reporting artifact. Fatigue is a culturally loaded and imprecise subjective label: patients often report "heaviness," "unwellness," "brain fog," or a "toxic feeling" instead of the word "fatigue" @Jason2015definingPEM. The IOM (2015) case definition treats fatigue as a required diagnostic component alongside PEM @IOM2015redefining, and no validated PEM instrument scores a crash as PEM-positive while explicitly recording zero fatigue.

If this null interpretation holds, then the temporal cases and mechanisms proposed here (@spec:pem-without-fatigue-temporal, @spec:pem-without-fatigue-mechanisms) describe different *ways of experiencing or reporting* a low-fatigue-looking crash, not crashes in which fatigue is biologically absent. Under this view, "fatigue-absence" reflects channel dominance, symptom vocabulary, or trigger type---not a distinct biological state.

*Falsifiable discriminator:* A within-subject study pairing free-text symptom elicitation (no fatigue prompt, no fatigue rating scale shown) with a structured multi-system PEM instrument would separate the two readings. If patients who describe crashes in purely non-fatigue terms still rate some form of fatigue when directly probed, the artifact reading dominates. If a measurable fraction report no fatigue even when directly and repeatedly probed with fatigue synonyms across multiple domains, the artifact reading is incomplete.

*Consequence:* The honest default until such evidence exists is that "PEM without fatigue" is a candidate, not an established phenomenon. Both readings---true fatigue-absence (biology) and reported fatigue-absence (measurement/labeling)---must be held in view, because deciding between them changes whether clinicians should treat low-fatigue crashes as real PEM or as a symptom-elicitation gap.
] <oq:pem-without-fatigue-null>

#open-question(title: [Do Some PEM Crashes Carry a Near-Syncopal "Shutdown" Quality Distinct From Upright Orthostatic Intolerance?])[
Patients sometimes describe severe crashes in near-syncopal terms---a sense of "sinking," of approaching loss of consciousness without actually losing consciousness, of the system being "powered down." The question is whether this reflects a *distinct, crash-phase* orthostatic-cerebral event or whether such descriptions simply use pre-syncopal language to convey the profound energy failure already discussed above (@oq:pem-selfreport-vs-objective). It is closely related to---but sharper than---the autonomic "expressive channel" through which a crash can be experienced without prominent fatigue (@spec:pem-without-fatigue-mechanisms): the question here is whether that autonomic channel ever takes on an objective near-syncopal, blood-pressure or cerebral-perfusion signature in the post-exertional window itself, rather than only on upright tilt.

Orthostatic syncope and pre-syncope are common and well documented in ME/CFS when provoked by *upright posture* on tilt testing or standing: neurally mediated hypotension is detected in the large majority of affected patients @BouHolaigah1995NMH, and pediatric cohorts faint on tilt @Stewart1998NMHchildren. Orthostatic intolerance (POTS/orthostatic hypotension on tilt) also correlates with worse post-exertional malaise @Jason2024TiltTable. But these findings document syncope on *standing*, not a near-syncopal quality intrinsic to the *post-exertional* crash.

A physiological substrate for a crash-phase pre-syncopal sensation is plausible but contested. Orthostatic and exertional stress reduce cerebral blood flow in a large fraction of ME/CFS patients @Novak2026AutonomicPhenotype, and a submaximal-exercise provocation study reports reduced global cerebral blood flow accompanying post-exertional symptom exacerbation---the closest published analogue to a crash-associated perfusion change @Rayhan2021SubmaximalPEM. However, this cerebral-hypoperfusion mechanism is directly challenged by a tilt study finding no difference in cerebral blood-flow velocity between ME/CFS and controls @Razumovsky2003CerebralHemodynamics. The mechanism is therefore not established.

*Falsifiable prediction:* If crash-phase near-syncope is a real, distinct phenomenon with an orthostatic-cerebral basis, then (a) a standardized PEM provocation (for example a two-day cardiopulmonary exercise test) in patients who report near-syncopal crashes should produce measurable orthostatic-blood-pressure or cerebral-perfusion changes *during or shortly after exertion*---not only on upright tilt---and (b) the near-syncopal crash description should co-occur with objective orthostatic findings in the same patients. If patients who describe near-syncopal crashes show no orthostatic or cerebral-perfusion change in either the post-exertional or the upright setting, the description is better read as metaphor for energy collapse rather than a distinct event.

*Consequence:* Until this evidence exists, clinicians should not interpret a near-syncopal crash description as proof of a separate disorder (for example, primary dysautonomia) nor dismiss it as exaggeration---but they should also not assert a distinct crash-phase mechanism. Orthostatic testing of the patient who describes such crashes, and avoidance of assuming a purely upright-posture cause, is the honest interim response.

(Severity applicability: unknown---the underlying studies draw on ambulatory cohorts; a near-syncopal crash quality, if real, would most plausibly affect severe/very-severe patients, but this is inferred rather than measured.)
...
#synthesis(title: [Post-Exertional Malaise Is a Multi-System Cascade That Extends Beyond Fatigue Alone])[
The convergent evidence establishes that post-exertional malaise is a multi-system symptom cascade rather than a synonym for simple (normative) exercise fatigue: it is unusually highly discriminating of ME/CFS, loads as an independent factor separable from cognitive and sleep domains, and is measured by instruments that retain discriminant validity against general-fatigue scales (@ach:pem-distinct-from-fatigue). Because fatigue is only one component readout of this cascade -- not the whole of it -- the crisis question of whether PEM can occur without fatigue has a coherent structural framing: a crash dominated by cognitive, autonomic, pain, or flu-like symptoms can in principle qualify as PEM even when fatigue is subdominant, and a patient with near-normal baseline fatigue can still be PEM-positive (@spec:pem-without-fatigue-temporal, @spec:pem-without-fatigue-mechanisms). (Overall certainty: 0.45 --- the construct-distinction line is moderately strong at 0.60, but the core claims here are the candidate temporal cases and mechanisms, which are entirely indirect at 0.30--0.45.)

This answer is conditional, not established. No study has directly tested fatigue-absence within a crash. The strongest null reading is that reported "fatigue-absence" is always a measurement or labeling artifact rather than a biological state, and until within-subject data exist this null remains the epistemic default for both clinical and research purposes (@oq:pem-without-fatigue-null). The case-definition hierarchy (Fukuda fatigue-centric and PEM-optional, vs CCC/ICC/IOM PEM-required) determines whether such patients are captured at all (@spec:case-definition-pem-hierarchy), and the wide gap between self-reported and objectively provoked PEM warns that measurement method, not just biology, drives these classifications (@oq:pem-selfreport-vs-objective).

*Implication:* For diagnosis and clinical practice, post-exertional worsening across any body system -- cognitive, autonomic, pain, flu-like, not fatigue alone -- should be elicited when screening for PEM, without asserting that fatigue is absent in the patients who present this way. For research, separating whether "PEM without fatigue" is biology or artifact requires within-subject, hour-by-hour crash logging paired with multi-synonym symptom elicitation; until such data exist the question remains open.

*Consequence:* Multiple independent lines converge on the same clinical correction -- PEM is identified by multi-system post-exertional worsening, not by tiredness alone -- so clinicians and case definitions should not treat fatigue as the only required marker of PEM. At the same time, the scientific community should not yet assert that true fatigue-absence is real; the default is that apparent fatigue-absence reflects measurement, labeling, or reporting until within-subject data show otherwise.
