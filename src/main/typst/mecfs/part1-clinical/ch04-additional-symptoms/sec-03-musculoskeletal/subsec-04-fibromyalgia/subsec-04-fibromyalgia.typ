...
Significant symptom overlap exists between ME/CFS and fibromyalgia, with 20-70% of fibromyalgia patients presenting an ME/CFS-compatible clinical picture. This overlap reflects symptom-based convergence rather than proven uniform pathophysiological mechanisms @Honore2026sharedMechanisms:

#include "limitations/lim-overlap-statistic-interpretation.typ"
...
#include "hypotheses/hyp-neuroinflammation-common-mechanism.typ"

#include "limitations/lim-tspo-pet-study-limitation.typ"
