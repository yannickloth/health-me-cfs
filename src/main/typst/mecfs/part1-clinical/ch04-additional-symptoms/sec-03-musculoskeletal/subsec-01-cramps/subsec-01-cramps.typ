...
*Mechanism.*
Muscle relaxation requires ATP to pump calcium ions back into storage. When ATP is in\-sufficient, muscles cannot fully relax, leading to spontaneous cramping. This reflects the same energy deficit causing fatigue, but mani\-fested as impaired muscle relaxation. This is the muscular/metabolic candidate; a competing neurogenic (nerve-excitability) explanation is considered in @oq:neurogenic-vs-muscular-cramp.

#open-question(title: [Neurogenic vs Muscular Origin of Spontaneous Cramps])[
...
*Muscular (sarcolemmal depolarization) — the modestly favored account.* The only published ME/CFS-specific account of cramps and fasciculations proposes a muscular mechanism: Na⁺/K⁺-ATPase dysfunction → sarcolemmal depolarization → hyperexcitability, and explicitly excludes a neuronal cause @WirthSteinacker2025fasciculations. It is consistent with documented ME/CFS muscle findings — sodium overload @Petter2022sodium and subsarcolemmal mitochondrial pathology @Bizjak2024muscleMito — and with the energy-deficit mechanism above. However, this account is itself only a hypothesis (certainty ~0.35), so its advantage is a matter of ME/CFS-specific relevance rather than robust empirical strength.

*Neurogenic (motor-nerve-terminal hyperexcitability) — the less-supported import.* In the general population, spontaneous cramps are often traced to motor-nerve-terminal hyperexcitability — increased HCN-channel inward rectification in cramp-fasciculation syndrome @Czesnik2015HCN and sustained abnormal spinal reflex activity @Maughan2019MuscleCramping — with sensory-nerve TRP channels able to gate this threshold @Craighead2017TRPcramp. However, this mechanism has no direct ME/CFS-specific empirical support; it is imported from a different clinical context (a benign syndrome and exercise physiology), and its transferability discount leaves it only marginally below the muscular account. The open question is whether this less-supported neurogenic route contributes in ME/CFS *in addition to* the muscular mechanism, or whether the muscular mechanism is complete.

*Discriminating evidence.* Magnesium does not prevent cramps in a Cochrane meta-analysis @Garrison2020MagnesiumCramps — this cuts against a simple ion-deficit explanation regardless of which mechanism dominates. Small-fiber neuropathy, present in ME/CFS, is associated with cramps in the general population via intramuscular-nerve excitation @Lopate2013CrampsSFN, and could in principle bridge either model.
...
#speculation(title: [Motor-Nerve Hyperexcitability as a Contributor to ME/CFS Spontaneous Cramps])[
*(Origin: brainstorm.)* *(Certainty: 0.30 — general-population mechanism, untested in ME/CFS.)* Spontaneous, exertion-independent cramps in ME/CFS might partly reflect motor-nerve-terminal hyperexcitability rather than (or in addition to) the energy-deficit model above. In the general population this is the default mechanism — ion-channel (HCN) driven @Czesnik2015HCN, sometimes associated with small-fiber neuropathy exciting intramuscular nerves @Lopate2013CrampsSFN. ME/CFS patients show small-fiber neuropathy, so a neurogenic contribution to their cramps is plausible but unproven.
...
#speculation(title: [Single Pump Failure as a Unifying Explanation for Both Cramp Mechanisms])[
*(Origin: brainstorm.)* *(Certainty: 0.15 — mechanistically coherent but entirely unmeasured in ME/CFS, and the least-parsimonious of the options.)* The Na⁺/K⁺-ATPase maintains the resting membrane potential in *all* excitable cells — muscle fibres and motor-nerve terminals alike. The muscular model posits pump dysfunction → sarcolemmal depolarization → muscle hyperexcitability @WirthSteinacker2025fasciculations, while the neurogenic model posits nerve-terminal depolarization → ectopic discharge @Czesnik2015HCN. The two "competing" origins could in principle share a single upstream ion-homeostasis defect that depolarizes both cell types. However, this unification is the least-parsimonious hypothesis: it posits an *additional*, unmeasured two-tissue correlated defect, beyond either single-tissue account, and it is offered only as a possibility, not as a preferred explanation.
...
#limitation(title: [The Discriminating Measurement for Cramp Origin Has Not Been Performed])[
*(Origin: brainstorm.)* While the muscular mechanism is the better-supported account (it is ME/CFS-specific and consistent with documented muscle findings), the *discriminating* measurement — whether a neurogenic contribution exists in addition — has not been performed. The muscular model's "excludes a neuronal cause" is a hypothesis-paper assertion (certainty 0.35), not an electrophysiological measurement @WirthSteinacker2025fasciculations. The neurogenic side rests on extrapolation from benign cramp-fasciculation syndrome and exercise-induced cramp physiology — a different disease context that does not clearly transfer to spontaneous cramps in a chronic multi-system disease @Czesnik2015HCN, @Maughan2019MuscleCramping. No ME/CFS study has measured axonal excitability, muscle resting membrane potential, or the discriminating readouts. The muscular account should therefore be treated as the working default, not as a fully settled measurement; the possible neurogenic addition remains unverified.
