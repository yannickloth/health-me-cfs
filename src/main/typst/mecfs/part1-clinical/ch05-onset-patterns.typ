...
Additional signs that individually appear benign but collectively suggest subclinical energy insufficiency include:
    ...
    - *Excessive thirst and salt craving*: Early autonomic compensation for subclinical hypovolemia and RAAS dysfunction (see @sec:raas)
