...
*Clinical Presentation.*
    ...
    - Convergence insufficiency and difficulty sustaining reading @johansson2022visual
    - New-onset misalignment of the eyes (adult-onset strabismus) — rare and, when present, points to involvement of the nerves controlling the eye muscles @moustardas2026ocular

*Mechanism.*
Vision problems reflect ciliary muscle fatigue (accommodation requires sustained ATP for muscle contraction), autonomic dysfunction affecting pupil control, and energy-dependent visual processing in the brain. Post-infectious cohorts make these mechanisms concrete: in patients with persistent ocular symptoms after mild COVID-19, standard eye exams are normal, yet specialised testing reveals weakened autonomic pupillary reflexes (pupils admitting excess light, explaining light sensitivity), corneal small-nerve degeneration, and — in a minority — adult-onset strabismus from oculomotor nerve involvement @moustardas2026ocular. Task-evoked pupillary dynamics are measurably blunted in post-COVID syndrome @smit2026pupillary, and dry-eye prevalence is elevated after COVID-19 @naseri2025dryeye. The dry-eye (sicca) symptom itself has several candidate mechanisms in ME/CFS — autonomic (parasympathetic) withdrawal from the tear glands, anticholinergic medication effects, and possible subclinical autoimmune overlap with Sjögren's syndrome — discussed and contrasted in @spec:mecfs-lacrimal-denervation and @spec:me-cfs-sicca-m3-antibodies, with the medication and dry-eye confounds weighed in @lim:ocular-surface-mecfs-confounds. Whether the same profile characterises ME/CFS specifically remains untested (see @cf:postcovid-ocular-syndrome).

#speculation(title: [FL-41 Precision-Tinted Lenses as a Low-Risk Photophobia Measure])[
*(Origin: brainstorm.)* *(Certainty: 0.25.)* If ME/CFS photophobia arises partly from impaired autonomic pupil control admitting excess light @moustardas2026ocular, reducing the incident light load may ease symptoms independent of the underlying nerve pathology. FL-41 tint (a rose-coloured filter attenuating ~480 nm blue-green light) has controlled-trial support for photophobia in migraine and blepharospasm and is inexpensive, non-pharmacological, and free of systemic side effects — a rare combination for severe and bedbound patients who tolerate few interventions.
