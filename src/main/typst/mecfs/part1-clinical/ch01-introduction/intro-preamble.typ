...
*For researchers*: read the terminology and disease-classification sections (@sec:terminology, @sec:disease-classification) to fix definitions, then the prognosis-course section (@sec:prognosis-course) for natural-history framing relevant to study design.
]
