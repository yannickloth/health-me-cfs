...
*Clinical note*: These complications are reported anecdotally and have not been formally characterized in ME/CFS populations. The population attributable risk remains extremely small: a nationwide registry found an adjuvanted influenza vaccine raised no CFS/ME risk (HR 0.97), while influenza infection did (HR 2.04) @Magnus2015influenza. This section is included to alert clinicians to the possibility that vaccine-temporal associations may represent a specific immunological subtype rather than universal vaccine danger; it is not a basis for avoiding vaccination. Routine vaccination remains recommended for ME/CFS patients and the wider population, as the benefit of infection prevention far outweighs any theoretical vaccine-related risk. Patients with this history warrant the same investigation of autoimmune markers and underlying immune dysregulation as any new ME/CFS presentation (see Section @sec:exhausted-surveillance).
...
#include "warnings/warn-association-vs-causation-in-viral-triggers.typ"
...
The insidious nature of gradual onset often delays diagnosis, as patients and clinicians attribute symptoms to other causes. Mean diagnostic delay is longer in gradual-onset cases, which has prognostic significance (see Section on Prognosis).
...
#include "clinical-findings/cf-documented-pre-diagnostic-medical-utilization-window.typ"

#include "speculations/spec-retrospective-prodromal-syndrome-as-subclinical-metabolic-reserve-depletion.typ"

#include "limitations/lim-limitations-of-retrospective-prodromal-pattern-recognition.typ"

#include "open-questions/oq-prospective-validation-of-me-cfs-prodromal-signs.typ"
...
#include "speculations/spec-adaptation-debt-training-without-supercompensation-as-mitochondrial-biogenesis-failure.typ"

#include "speculations/spec-the-cognitive-energy-cliff-discrete-phase-transition-in-brain-atp-allocation.typ"

#include "hypotheses/hyp-the-holiday-paradox-delayed-crash-as-sympathetic-withdrawal-syndrome.typ"

#include "hypotheses/hyp-puberty-as-a-reserve-depleting-event-explaining-the-age-16-onset-peak.typ"
...
#include "speculations/spec-overtraining-syndrome-as-recoverable-me-cfs-same-mechanism-pre-hysteresis.typ"

#include "speculations/spec-relative-energy-deficiency-in-sport-red-s-as-gender-specific-prodrome.typ"

#include "speculations/spec-burnout-to-me-cfs-pipeline-allostatic-overload-as-adult-prodrome.typ"
...
#include "speculations/spec-training-ratio-protocol-periodization-for-energy-limited-athletes.typ"
...
#include "limitations/lim-multi-hit-cascade-retrospective-pattern-recognition-not-prospective-validation.typ"

#include "warnings/warn-distinguishing-true-remission-from-marginal-functionality.typ"
...
#include "achievements/ach-bimodal-onset-age-peaks-confirmed-across-multiple-datasets.typ"
...
#include "clinical-findings/cf-early-onset-me-cfs-carries-higher-severity-and-greater-familial-clustering.typ"

#include "limitations/lim-bimodal-onset-self-report-and-cross-sectional-data.typ"
