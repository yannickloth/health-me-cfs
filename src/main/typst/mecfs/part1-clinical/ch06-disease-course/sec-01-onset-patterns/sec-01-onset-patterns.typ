...
*Clinical note*: These complications are reported anecdotally and have not been formally characterized in ME/CFS populations. The population attributable risk remains extremely small: a nationwide registry found an adjuvanted influenza vaccine raised no CFS/ME risk (HR 0.97), while influenza infection did (HR 2.04) @Magnus2015influenza. This section is included to alert clinicians to the possibility that vaccine-temporal associations may represent a specific immunological subtype rather than universal vaccine danger. Patients with this history warrant investigation of autoimmune markers and underlying immune dysregulation (see Section @sec:exhausted-surveillance).
