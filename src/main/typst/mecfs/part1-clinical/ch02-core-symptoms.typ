...
Post-exertional malaise represents an abnormal response to physical, cognitive, or emotional exertion in which even minor activity triggers a cascade of worsening symptoms. Unlike normal fatigue, PEM is characterized by:
    ...
    - *Disproportionate severity*: Minimal exertion produces profound symptom exacerbation
    - *Prolonged recovery*: Symptom worsening persists for days to weeks or longer
...
*Physical Exertion*
    ...
    - Walking, standing, or basic activities of daily living
...
*Cognitive Exertion*
    ...
    - Reading, writing, or computer work
    - Conversation or social interaction
    - Decision-making or problem-solving
    - Sensory stimulation (light, sound, crowds)
...
*Emotional Exertion*
    ...
    - Social demands
    - Medical appointments or advocacy

*Dietary and Environmental Factors*

    - Certain foods, including wheat in patients with non-celiac wheat sensitivity (approximately 15% of ME/CFS patients)
    - Food sensitivities may interact synergistically with physical exertion, amplifying PEM severity
    - Environmental exposures (chemical sensitivities, infections)
    - Sleep disruption

See @sec:food-sensitivities-wheat for detailed discussion of wheat sensitivity mechanisms and clinical assessment approaches.

==== Subjective Phenomenology: The Effort-Performance Disconnect

One of the most psychologically devastating aspects of PEM is the profound disconnect between subjective effort and objective performance. Patients consistently describe an internal experience of maximal exertion that produces minimal external results—a phenomenon that fundamentally challenges their sense of agency and capability @strassheim2021experiences @fennell2021elements.

*The Experience of Maximal Effort Producing Minimal Output*
...
This disconnect extends beyond physical tasks:
    ...
    - *Physical tasks*: Simple actions feel extraordinarily difficult; patients describe “giving everything” yet achieving almost nothing
    - *Cognitive tasks*: Intense concentration yields minimal comprehension or output
    - *Emotional regulation*: Enormous internal effort required to maintain composure or engage socially

*Psychological Sequelae: Helplessness and Loss of Agency*
...
The persistent effort-performance disconnect produces profound psychological consequences distinct from primary depression:
    ...
    / *Learned helplessness*: Repeated experiences of maximal effort failing to produce normal results can induce a state resembling learned helplessness—the recognition that one's actions do not reliably produce expected outcomes. This is not a cognitive distortion but an accurate perception of physiological reality.

    / *Loss of self-efficacy*: The inability to generate normal performance despite perceived maximum effort erodes confidence in one's capability. Patients often describe feeling “weak” or “useless,” not as depression-related negative cognition but as direct experiential feedback.

    / *Betrayal by one's body*: Many patients describe their body as having “betrayed” them or become “enemy territory”—the normal unity between intention and execution has fractured. Motor commands and cognitive efforts no longer reliably produce proportional results.

    / *Social invalidation*: Because the internal experience of extreme exertion is invisible to observers, patients face disbelief from family, friends, employers, and medical professionals. The statement “you don't look sick” becomes particularly traumatic when one is experiencing maximum physiological stress.

    / *Anticipatory anxiety*: Knowledge that even minor exertion may trigger severe crashes creates pervasive anxiety around all activities. Patients must constantly calculate risk, leading to hypervigilance and decision paralysis.

*Distinction from Primary Depression*

While the phenomenology of PEM may superficially resemble depression, key distinctions exist:

    - *Effort expenditure*: Depressed individuals typically experience reduced motivation to initiate effort; ME/CFS patients expend maximum subjective effort but achieve minimal results
    - *Activity relationship*: Depression may improve somewhat with activity; ME/CFS worsens predictably with exertion
    - *Physiological markers*: PEM produces objective physiological changes (documented via two-day CPET) absent in primary depression
    - *Cognitive content*: The helplessness in ME/CFS arises from accurate perception of physiological limitation, not cognitive distortion @geraghty2019cognitive

Many ME/CFS patients develop secondary depression as a consequence of chronic illness and loss of function, but the core effort-performance disconnect represents a direct physiological phenomenon, not a psychological disorder. The majority (78.1%) of ME/CFS patients who experience depression develop it _after_ disease onset, and 96% attribute their depression to disease severity and external factors rather than pre-existing psychiatric conditions @konig2024mental.
...
For patients previously defined by physical capability, intellectual performance, or caregiving roles, the loss of reliable energy production represents a fundamental identity disruption. The inability to protect oneself, care for dependents, or meet basic social obligations creates legitimate existential distress @fennell2021elements. Quality of life in ME/CFS is profoundly diminished, with patients scoring lower than those with multiple sclerosis, stroke, cancer, and other serious chronic conditions across nearly all functional domains @hvidberg2015quality @kingdon2018functional.

==== Severity Spectrum

PEM severity varies considerably:

    / *Mild*: Increased symptoms for 1–3 days following moderate exertion; can usually continue limited activities with careful pacing
    / *Moderate*: Severe symptom exacerbation lasting days to weeks following minimal exertion; requires extended rest periods
    / *Severe*: Profound crashes triggered by activities of daily living; largely bedbound; recovery may take weeks to months
    / *Very severe*: Any stimulation (light, sound, conversation) triggers immediate worsening; may be unable to tolerate even basic self-care

==== Baseline Energy Insufficiency: Living Below the Survival Threshold

While PEM represents the acute exacerbation following exertion, many ME/CFS patients describe a more insidious and pervasive problem: chronic baseline energy levels insufficient for basic existence. This creates a fundamentally different experience from episodic illness—it is a continuous state of inadequacy @strassheim2021experiences.

*The Experience of Perpetual Insufficiency*
...
Patients describe waking already depleted, as if they have already run a marathon before the day begins. Unlike healthy individuals who start each day with a replenished energy reserve, ME/CFS patients begin from deficit:
    ...
    - *Morning depletion*: Waking feeling as exhausted as when going to sleep, or worse
    - *Minimum activity burden*: Even basic hygiene, eating, or sitting upright feels overwhelming
    - *Continuous depletion*: Energy steadily drains throughout the day regardless of activity level
    - *No reserve*: Zero capacity to handle unexpected demands
    - *Micro-activities as exertion*: Actions that should be automatic (maintaining posture, processing sensory input) require conscious effort and consume limited energy
...
*Forced Overexertion: When Life Does Not Accommodate Limits*
...
Unlike research protocols where patients can carefully pace within their limits, real life imposes non-negotiable demands. This creates a situation of continuous forced overexertion:
    ...
    / *Basic survival needs*: Eating, toileting, hygiene cannot be deferred indefinitely. Even these minimal activities may exceed available energy.

    / *Medical appointments*: Navigating healthcare—attending appointments, waiting in waiting rooms, explaining symptoms, completing forms—requires energy patients do not have, creating the paradox of becoming sicker from seeking medical care.

    / *Caregiving responsibilities*: Parents must feed children, pet owners must care for animals, adult children must respond to aging parents' needs. These responsibilities do not pause for energy availability.

    / *Work and financial survival*: Many patients cannot afford to stop working despite severe energy limitations. The choice becomes: exceed limits and worsen disease, or face homelessness and starvation.

    / *Emergencies*: House fires, medical emergencies, natural disasters, family crises demand immediate responses that may require weeks or months of energy expenditure in moments.

    / *Social obligations*: Complete withdrawal results in loss of relationships, but social interaction is energetically costly. Patients must choose between isolation and overexertion.

    / *Bureaucratic demands*: Disability applications, insurance appeals, medical documentation require sustained cognitive effort precisely when cognition is most impaired.

*The Impossibility of Perfect Pacing*

While pacing (staying within energy limits to avoid PEM) represents the primary management strategy @jason2012energy, perfect pacing is functionally impossible for most patients:

    - *Unknown threshold*: The exertion level that will trigger PEM is variable and often unknowable in advance
    - *Declining reserves*: The safe activity level may decrease over time, making previously manageable activities dangerous
    - *Life is not optional*: Survival needs create forced exertion regardless of consequences
    - *Delayed feedback*: PEM onset occurs 12–48 hours after trigger, preventing real-time adjustment
    - *Compounding factors*: Stress, infection, hormonal cycles, weather, and other factors unpredictably lower the threshold
    - *Cumulative depletion*: Multiple small activities compound, each individually acceptable but collectively triggering crashes

This creates a chronic state of being forced to operate beyond one's physiological capacity. Patients are not failing to pace properly—they are trapped in circumstances that structurally require overexertion for survival. Research demonstrates that exceeding energy limits worsens functional outcomes, yet life circumstances often make such overexertion unavoidable @jason2009energy @brown2011activity.

*The Grinding Exhaustion of Baseline Inadequacy*

The continuous nature of baseline energy insufficiency distinguishes it from acute exhaustion:

    - *No recovery window*: There is no point at which energy feels restored; at best, crashes are avoided
    - *Perpetual calculation*: Every action requires assessment of energy cost versus necessity
    - *Invisible to others*: The constant internal struggle to perform basic tasks is entirely invisible; patients appear to be “doing nothing” while experiencing maximum effort to remain upright and conscious
    - *Accumulating deficits*: Years of operating below subsistence level compound, potentially worsening disease trajectory
    - *Eroded quality of life*: Even when avoiding severe crashes, life becomes reduced to the bare minimum, with no energy for joy, connection, or meaning

*Psychological Impact of Chronic Insufficiency*

The experience of perpetual energy deficit below survival requirements produces distinct psychological consequences:

    - *Perpetual crisis state*: Living constantly at the edge of capacity creates unrelenting stress
    - *Inability to plan*: When basic function is uncertain day-to-day, future planning becomes impossible
    - *Loss of identity*: Activities that defined one's self become permanently inaccessible
    - *Anticipatory dread*: Every upcoming obligation triggers fear about whether one will have sufficient energy
    - *Grief without resolution*: Unlike grief over a discrete loss, the loss of capability is ongoing and total
    - *Existential exhaustion*: Beyond physical fatigue, the sheer effort of continuing to exist in this state becomes overwhelming
...
#hypothesis(title: [WASF3 as Subset-Specific Mechanism])[
...
#limitation(title: [PEM Vicious Cycle Model: Illustrative Framework, Not Quantified Biology])[
The vicious cycle dynamics model below (cycle gain, sequential entry, ratchet effect) provides a conceptually useful framework for understanding disease progression, but its quantitative parameters are illustrative, not empirically derived:

    - Numerical values for “cycle gain” (5–10% vs.\ 30–50% ATP reduction per iteration), “repair capacity” (15–20% biogenesis rate), and “critical thresholds” are hypothetical estimates chosen to illustrate the model's logic, not measurements from ME/CFS patients.
    - The distinction between “escapable” and “inescapable” cycles has not been validated by longitudinal studies tracking cycle parameters over time in individual patients.
    - Whether ME/CFS progression truly follows a sequential cycle-recruitment pattern or reflects a single initial insult with variable downstream consequences is undetermined.
    - The model's predictions (earlier intervention = better outcomes, cycle number predicts severity) are consistent with clinical observation but have not been prospectively tested.
...
#hypothesis(title: [2-Day CPET as Diagnostic Tool])[
...
The core feature is lack of restoration from sleep:
    ...
    - Paradox: Some patients feel better with _less_ sleep (4–6 hours) than with full nights
...
In healthy fatigue, a 20-minute nap clears accumulated adenosine (the brain's primary sleep-pressure signal) and restores alertness. In ME/CFS, naps fail at multiple levels simultaneously:
    ...
    - *Adenosine clearance is futile*: The metabolic deficit (impaired mitochondrial ATP production) regenerates adenosine immediately after any transient clearance. The underlying fuel deficit persists regardless of rest duration (Section @sec:ch15-adenosine).
    - *Alpha-delta intrusion operates during naps*: The thalamic oscillation dysfunction that prevents restorative overnight sleep (Section @sec:thalamic-calcium-sleep) is not limited to nocturnal sleep. Short naps may produce 20 minutes of alpha-contaminated quasi-sleep rather than restorative Stage 2 with sleep spindles. The brain enters a hybrid state: neither fully awake nor properly asleep.
    - *Sleep inertia is amplified*: In healthy populations, nap-induced sleep inertia clears in 15--30 minutes; it is most severe after awakening from slow-wave sleep @Tassi2000sleepInertia. In ME/CFS, sleep inertia can persist 2--4 hours. Naps longer than 60 minutes that enter deep sleep risk prolonged inertia in a brain that struggles with state transitions due to energy-limited thalamic coordination (Section @sec:thalamic-calcium-sleep).
    - *Late naps disrupt fragile circadian timing*: ME/CFS patients already have fragile circadian rhythms --- flattened cortisol curves, delayed dim-light melatonin onset, desynchronised temperature cycles (Section @sec:circadian-desync). Late-afternoon naps shift the circadian clock further, delay nighttime sleep onset, and reduce overnight slow-wave sleep.
...
An observational study of 118 CFS patients found that afternoon napping predicted _worse_ objective cognitive dysfunction (25.6% variance explained, p<.001) and morning napping predicted worse subjective cognitive dysfunction @Gotts2015napCFS. The causal direction is unclear --- napping may reflect greater disease severity rather than causing cognitive decline --- but the association is consistent with the mechanistic framework: naps in ME/CFS fail to provide restoration and may displace activity that would better serve pacing goals.

Horizontal rest without sleep retains value: reducing cardiac preload (critical for patients with orthostatic intolerance), decreasing skeletal muscle energy expenditure, and potentially improving cerebral perfusion. Patients who "nap without sleeping" should not consider the rest wasted (Section @sec:sleep-optimization for practical nap guidance).

==== Morning Headache Characterisation
<sec:morning-headache-quality>

Many ME/CFS patients wake with a morning headache that defies standard classification. It is not the pulsing laterality of migraine, nor the band-like pressure of tension headache. Patients characteristically describe it as a deep, diffuse heaviness --- "toxic," "poisoned," "like waking up hungover without having drunk anything." This qualitative description is mechanistically informative: it is consistent with impaired overnight glymphatic clearance leaving metabolic waste (glutamate, lactate, inflammatory cytokines, mitochondrial debris) in the brain parenchyma (Section @sec:ch15-glymphatic). The patient is, in a precise sense, intoxicated --- not by an exogenous substance but by the brain's own uncleaned metabolic waste.

In patients with concurrent nocturnal hypoventilation --- common in severe ME/CFS due to respiratory muscle weakness --- retained CO#sub[2] adds a distinct vascular throbbing component via cerebral vasodilation. Some patients experience both: the diffuse toxic heaviness of glymphatic failure layered with the pulsing component of hypercapnia. Standard analgesics treat neither mechanism; improving slow-wave sleep quality (the glymphatic driver) and screening for nocturnal hypoventilation (the CO#sub[2] driver) address the actual causes.
...
The alpha-delta pattern is particularly notable @Moldofsky1975alphaDeltaSleep—the brain shows mixed activity suggesting it never fully enters restorative deep sleep, explaining the subjective experience of “sleeping but not resting.”

==== Autonomic Dysfunction During Sleep
...
==== Limitations of Standard Polysomnography
...
Sleep apnea can mimic ME/CFS symptoms:
    ...
    - *Overlap*: Fatigue, unrefreshing sleep, cognitive dysfunction, morning headaches
    - *Prevalence*: Affects 10–30% of general population @Peppard2013OSAprevalence @Senaratna2017OSAmeta @Young2002OSAepidemiology; higher in ME/CFS due to weight gain from inactivity
    - *Diagnostic clue*: Witnessed apneas, loud snoring, gasping during sleep
    - *Resolution*: CPAP treatment resolves symptoms in true OSA; improves but doesn't cure comorbid OSA in ME/CFS

*Clinical importance*: Some patients misdiagnosed with ME/CFS for years experience dramatic improvement with CPAP, indicating primary OSA was the cause. Polysomnography should be standard workup before diagnosing ME/CFS.

==== Upper Airway Resistance Syndrome (UARS)

A subtler form of sleep-disordered breathing:

    - Increased upper airway resistance without frank apneas
    - Causes repeated arousals (respiratory effort-related arousals, RERAs)
    - May be missed on standard apnea-hypopnea index (AHI)
    - Requires esophageal pressure monitoring for diagnosis
    - Responds to CPAP or oral appliances

==== Restless Legs Syndrome (RLS) and Periodic Limb Movement Disorder (PLMD)

Common in ME/CFS:

    - *RLS*: Uncomfortable sensations in legs requiring movement to relieve, worse at night
    - *PLMD*: Involuntary leg jerks during sleep causing microarousals
    - *Prevalence*: Higher in ME/CFS than general population
    - *Treatment*: Iron supple\-mentation (if ferritin \<75 ng/mL @Allen2018RLSironThreshold), dopamine agonists, gabapentin
...
Overlapping features:
    ...
    - Sleep inertia lasting hours
    - Non-restorative sleep
    - Requires Multiple Sleep Latency Test (MSLT) to differentiate from ME/CFS

==== Circadian Rhythm Disorders

ME/CFS frequently involves circadian disruption:

    - *Delayed Sleep-Wake Phase Disorder*: Cannot fall asleep until 2–6 AM
    - *Non-24-Hour Sleep-Wake Disorder*: Sleep time progressively delays each day
    - *Irregular Sleep-Wake Rhythm*: Fragmented sleep-wake patterns across 24 hours
    - May respond to light therapy, melatonin timing, or chronotherapy
...
*Executive Function.*
Executive functions appear relatively preserved compared to processing speed and memory. Meta-analysis found that “executive functions seemed little or not affected and instrumental functions appeared constantly preserved” @Cvejic2022cognitive. However, some patients demonstrate difficulties with mental flexibility, cognitive inhibition, and information generation, particularly under demanding conditions.

*Language and Word-Finding.*
Verbal fluency deficits manifest as word retrieval problems, slowed speech, and linguistic reversals (mixing up word order) @MCAM2024cognitive. Patients often describe “tip of the tongue” experiences and difficulty with verbal tests of unrelated word association learning and letter fluency. Communication difficulties extend to auditory sequencing problems that impair comprehension of spoken language.

=== Neuropsychological Testing
<subsec:neuropsych-testing>

*Objective Test Results.*
The Multi-Site Clinical Assessment of ME/CFS (MCAM) study (n=261 ME/CFS patients vs.\ 165 healthy controls) confirmed deficits in processing speed, attention, working memory, and learning efficiency using standardized neuropsychological batteries @MCAM2024cognitive. Between 21–38% of patients perform below the 1.5 standard deviation cutoff for clinically significant impairment on Stroop tests.
...
This pattern differs from depression (which shows more diffuse cognitive effects) and multiple sclerosis (which shows more widespread deficits including greater executive impairment) @DeLuca2004comparison @Teodoro2025MECFSvsMS.

*Distinction from Depression.*
Comparative studies demonstrate that ME/CFS cognitive deficits are not attributable to depression. In three-way comparisons of ME/CFS, major depression, and healthy controls, cognitive patterns differ significantly: ME/CFS patients show primary deficits in processing speed and logical memory that persist after controlling for depressive symptoms @DeLuca2004comparison. Additionally, cognitive performance in ME/CFS does not correlate with fatigue, pain, or depression levels, indicating independent pathophysiology @Teodoro2025MECFSvsMS.

*Subjective-Objective Dissociation.*
A notable finding is poor correlation between subjective cognitive complaints and objective test performance. Self-reported cognitive dysfunction correlates more strongly with fatigue (p \< 0.001), pain (p \< 0.001), and depression (p \< 0.001) than with actual measured deficits @MCAM2024cognitive. This suggests subjective complaints reflect overall symptom burden rather than specific cognitive impairments. However, strong concordance exists between subjective mental fatigue complaints and objective cognitive decline following exertion, highlighting the importance of assessing cognition in relation to activity.

=== Neuroimaging Findings
<subsec:neuroimaging>

*Functional MRI: Increased Activation.*
The most consistent fMRI finding is that ME/CFS patients exhibit “increased activations and recruited additional brain regions during cognitive tasks” @Shan2020neuroimaging. This compensatory activation suggests the brain works harder to achieve equivalent performance. Tasks with increasing complexity produce decreased activation in task-specific regions, indicating failure of normal efficiency mechanisms under cognitive load.

*Functional Connectivity Abnormalities.*
High-field (7T) fMRI studies reveal altered connectivity patterns. Abnormal salience network connectivity, particularly involving the right insula, appears across multiple studies—8 of 10 different ME/CFS-specific connections involve a salience network hub @Shan2020neuroimaging. Specific findings include:
...
Structural MRI studies have identified:
    ...
    - Frontal lobe volume reductions correlating with fatigue scores @Shan2020neuroimaging
...
Multiple neuroimaging modalities (fMRI, PET, MRS) converge on brainstem abnormalities as a consistent finding in ME/CFS @Shan2020neuroimaging. FDG-PET demonstrates glucose hypometabolism in the brainstem, supporting a physiological basis for fatigue, unrefreshing sleep, and cognitive symptoms. Impaired connectivity involving the brainstem has been identified in multiple studies and may reflect dysautonomia contributing to cognitive dysfunction through cerebral hypoperfusion.

== Autonomic Dysfunction
<sec:autonomic>

Autonomic dysfunction is present in 70–90% of ME/CFS patients @Newton2007autonomicDysfunction, manifesting as ortho\-static in\-tolerance, temperature dys\-regulation, and cardio\-vascular symptoms. The autonomic nervous system controls in\-voluntary functions including heart rate, blood pressure, digestion, temperature regulation, and bladder control. Dys\-autono\-mia in ME/CFS creates a cascade of disabling symptoms often mis\-attributed to anxiety or de\-conditioning.
...
POTS is the most common form of orthostatic intolerance in ME/CFS, affecting 25–50% of patients @Newton2008POTSprevalence.

*Diagnostic Criteria.*

    - *Heart rate increase*: $gt.eq$30 bpm within 10 minutes of standing (or $gt.eq$40 bpm in adolescents) @Sheldon2015POTScriteria
    ...
    - *Duration*: Symptoms present for $gt.eq$3 months
...
Less common than POTS but present in some ME/CFS patients:
    ...
    - *Definition*: Sustained drop in systolic BP $gt.eq$20 mmHg or diastolic BP $gt.eq$10 mmHg within 3 minutes of standing
...
*Interpretation.*
    ...
    - *POTS pattern*: Sustained HR increase $gt.eq$30 bpm without BP drop
...
Pain is a prominent symptom in ME/CFS, with approximately 80% of patients reporting significant pain in the past week @Unger2017pain. Pain is included as a diagnostic criterion in multiple case definitions and contributes substantially to disability and reduced quality of life.

=== Types of Pain in ME/CFS
<subsec:pain-types>

*Myalgia (Muscle Pain).*
Muscle pain is the most common pain complaint, affecting 72–94% of ME/CFS patients @Nijs2012muscle. The pain is typically widespread rather than localized and characteristically worsens 8–72 hours following physical exertion as part of post-exertional malaise. Patients describe deep, aching pain that differs from delayed-onset muscle soreness in healthy individuals—it occurs following minimal exertion, lasts substantially longer, and is accompanied by other PEM symptoms. The pain reflects underlying skeletal muscle dysfunction including mitochondrial impairment, oxidative stress, reduced heat shock proteins, and impaired muscle contractility @Jammes2021muscle.

*Arthralgia (Joint Pain).*
Joint pain affects 58–84% of patients and is included as a criterion in both Fukuda and Canadian Consensus definitions @Fukuda1994 @Carruthers2003. The pattern is characteristically migratory (moving between joints) and occurs without the swelling, redness, warmth, or deformity seen in inflammatory arthritis. This distinction is clinically important: presence of joint inflammation suggests an alternative diagnosis or comorbid condition requiring separate evaluation.

*Headaches.*
Headaches are significantly more common in ME/CFS than the general population: 84% experience migraine headaches (versus 5% in healthy controls) and 81% have tension-type headaches (versus 45% in controls) @Ravindran2011headache. The breakdown includes migraine without aura (60%), migraine with aura (24%), tension headaches only (12%), and no headaches (4%). ME/CFS patients with migraine demonstrate lower pressure pain thresholds (2.36 kg versus 5.23 kg in controls, p\<0.001) and higher fibromyalgia comorbidity (47% versus 0%) @Ravindran2011headache. Headaches are listed in Fukuda criteria as one of eight minor symptoms.

*Neuropathic Pain.*
A subset of ME/CFS patients experience neuropathic pain characterized by burning, tingling, or electric shock sensations. This correlates with the finding that 30–38% of ME/CFS patients have small fiber neuropathy (SFN) confirmed by skin biopsy demonstrating reduced intraepidermal nerve fiber density @Oaklander2022SFN. Of those with confirmed SFN, 93% have comorbid postural orthostatic tachycardia syndrome (POTS) or other orthostatic intolerance, suggesting shared pathophysiology involving autonomic small fibers @Devigili2023SFN.

=== Pain Mechanisms
<subsec:pain-mechanisms>

*Central Sensitization.*
Central sensitization—increased excitability of central nervous system pain pathways—is present in 84% of ME/CFS patients, compared to 95% of fibromyalgia patients and 0% of healthy controls @Nijs2021sensitization. This is defined by enhanced temporal summation (wind-up) combined with inefficient conditioned pain modulation. Clinical manifestations include:
    ...
    - Lower pressure pain thresholds: ME/CFS median 222 kPa versus healthy controls 311 kPa (p\<0.05) @Nijs2021sensitization

Central sensitization is driven by neuroinflammation—glial cell activation (microglia and astrocytes) in the spinal cord and brain releasing pro-inflammatory cytokines and chemokines that sustain neural hypersensitivity @Nijs2017neuroinflammation.

*Small Fiber Neuropathy.*
Small fiber neuropathy provides an objective, biopsy-confirmed mechanism for pain in a substantial subset of patients. Studies find 30–38% of ME/CFS patients meet diagnostic criteria for SFN @Oaklander2022SFN. Small fibers (A-delta and C fibers) mediate pain, temperature sensation, and autonomic function, explaining the overlap between pain and dysautonomia. The etiology of SFN in ME/CFS is not fully established but may involve autoimmune mechanisms, as autoantibodies against small fiber antigens have been identified in some patients.
...
The dominant mechanism underlying most ME/CFS pain phenotypes is increasingly characterized as *nociplastic*---arising from altered nociception in the central nervous system despite no clear evidence of peripheral tissue damage @Kosek2024Nociplastic @Baraniuk2025NociplasticMECFS. However, 30--38% of patients have biopsy-confirmed small fiber neuropathy by standardised criteria @Oaklander2022SFN (with higher estimates up to 80% when fibromyalgia-overlapping cohorts and less standardised methods are included @Grayston2019sfn), contributing a neuropathic component. The interaction between nociplastic and neuropathic mechanisms likely produces a hybrid pain phenotype (see @hyp:ch15-nociplastic-neuropathic-hybrid). Central sensitisation involves dysfunction of midbrain and brainstem descending anti-nociceptive pathways, where the periaqueductal grey and medulla fail to send adequate inhibitory signals. See @sec:ch15-central-sensitization for detailed mechanistic discussion.
...
Heightened sensitivity to sensory stimuli is a common but often underrecognized feature of ME/CFS, present in 70–90% of patients @Jason2013sensory. These sensitivities can be profoundly disabling and contribute significantly to activity limitation and social isolation.

=== Types of Sensory Sensitivity
<subsec:sensory-types>

*Photophobia (Light Sensitivity).*
Light sensitivity affects approximately 70% of ME/CFS patients @Jason2013sensory. Manifestations include:
...
Sound sensitivity affects 60–80% of patients and can be severely disabling @Jason2013sensory:
...
Sensitivity to chemicals and odors affects 40–60% of ME/CFS patients @Jason2013sensory:
...
This reflects autonomic dysfunction affecting thermoregulation (see Section @sec:autonomic).

=== Mechanisms of Sensory Sensitivity
<subsec:sensory-mechanisms>

*Central Sensitization.*
The same central sensitization mechanisms that produce pain hypersensitivity likely underlie broader sensory sensitivities. Reduced inhibitory control in the central nervous system leads to amplification of all sensory inputs, not just nociceptive signals @Nijs2017neuroinflammation.
