...
#requirement(title: [Post-Exertional Malaise (Mandatory Hallmark)])[
Post-exertional malaise must be present with ALL of the following characteristics:
    ...
    - *Multi-domain triggers*: Symptoms triggered by physical exertion _AND_ cognitive exertion _AND_ emotional exertion
...
#requirement(title: [Baseline Energy Insufficiency])[
...
#requirement(title: [Duration and Exclusion Criteria])[
...
These domains are interdependent:
    ...
    - Autoimmunity (GPCR autoantibodies) $arrow.r$ Mitochondrial dysfunction ($beta_2$-adrenergic signaling regulates mitochondrial biogenesis)
...
#warning-env(title: [Speculative Phenotype Cluster])[
...
#warning-env(title: [HIGH RISK for Progression to Severe Disease])[
...
*RED FLAGS (Immediate Danger):*
    ...
    - *Cognitive decline*: Word-finding difficulties, memory impairment, or inability to read/process information worsening (cognitive symptoms are most resistant to recovery) @Chu2019
