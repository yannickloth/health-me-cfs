...
#requirement(title: [Fukuda Diagnostic Criteria])[
Diagnosis requires:
...
#requirement(title: [Oxford Diagnostic Criteria])[
Diagnosis requires:
...
#warning-env(title: [Fundamental Problems with Oxford Criteria])[
...
#requirement(title: [Pediatric Adaptations])[
...
#warning-env(title: [Pediatric Differential Diagnosis])[
