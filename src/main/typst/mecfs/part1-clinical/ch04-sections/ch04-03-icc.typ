...
#warning-env(title: [ICC Limitations])[
The restrictiveness of ICC creates challenges:
    ...
    - *Reduced sensitivity*: Systematic review found ICC identifies only 60% of patients meeting Canadian Consensus Criteria @Brurberg2014
