...
*Data sources.*  Entries were compiled from ClinicalTrials.gov, the
...
*Currency.*  This registry was last updated on 2026-03-07.
Study status information may have changed since that date; readers should
verify current status via the URLs provided.

*Scope.*  The registry includes studies that are actively recruiting,
...
in the main text and Appendix @app:annotated-bibliography.

#limitation(title: [Registry Completeness])[
...
<sec:registry-rosetta-stone>
    ...
    / *Contact/URL:*: #link("https://meassociation.org.uk/2025/12/driving-discovery-the-me-association-invests-1-1m-into-pioneering-research-programme/")
    ...
    / *Mechanism/Focus:*: Side-by-side cellular and molecular analyses of
    ...
    / *Primary Outcomes:*: Shared and distinguishing molecular signatures
        between ME/CFS and Long Covid; candidate biomarkers
    / *Estimated Completion:*: 2028 (3-year study)
    / *Timeline:*: Recruitment started Q4 2025; 3-month progress update
        published March 2026; interim analysis expected mid-study
    / *Publication Medium:*: Not yet announced; likely high-impact
        immunology or multidisciplinary journal; open access expected given
        charity funding
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 11 (gut
        microbiome), Ch. 13 (integrative models), Ch. 14 @sec:cross-disease
...
<sec:registry-bioquest>
    ...
    / *Principal Investigator:*: Jonas Bergquist (proteomics lead);
        coordinated by Open Medicine Foundation (OMF) research team
    / *Institution:*: Uppsala University (Sweden) and Open Medicine
        Foundation collaborative centres
    / *Contact/URL:*: #link("https://ns1.omf.ngo/bioquest-update/")
    ...
    / *Cohort:*: 400 ME/CFS + 400 healthy controls + 200 disease controls
    ...
    / *Mechanism/Focus:*: Large-scale metabolomics, lipidomics, proteomics,
    ...
    / *Primary Outcomes:*: Validated ME/CFS biomarker panel; biologically
        defined patient subgroups
    / *Estimated Completion:*: Results expected 2026–2027
    / *Timeline:*: Sample integration approved 2025; testing began late 2025;
        bioinformatic analysis ongoing
    / *Publication Medium:*: Expected in high-impact journal; OMF typically
        publishes open access
    / *Document Relevance:*: Ch. 6 (energy metabolism), Ch. 7 (immune
...
<sec:registry-decodeme>
    ...
    / *Principal Investigator:*: Chris Ponting, Professor of Medical
        Bioinformatics
    / *Institution:*: University of Edinburgh, United Kingdom
    / *Contact/URL:*: #link("https://www.decodeme.org.uk/")
    ...
    / *Cohort:*: \textgreater20,000 ME/CFS patients (DNA samples);
        UK-based, self-reported diagnosis with GP confirmation
    / *Mechanism/Focus:*: First large-scale GWAS for ME/CFS.  Aims to
        ...
        participants.
    / *Primary Outcomes:*: Genome-wide significant loci for ME/CFS;
        genetic correlation with related conditions; polygenic risk scores
    / *Estimated Completion:*: First results expected 2026
    / *Timeline:*: Recruitment launched 2022; sample collection completed
        2024; genotyping in progress; first GWAS results anticipated 2026
    / *Publication Medium:*: Expected in genetics/genomics journal
        (e.g., _Nature Genetics_); open access
...
=== EpiSwitch CFS Epigenetic Diagnostic
<sec:registry-episwitch>
    ...
    / *Contact/URL:*: #link("https://doi.org/10.1186/s12967-025-07203-w")
    / *Registry ID:*: N/A (proof-of-concept; clinical validation pending)
    / *Funder:*: Oxford BioDynamics (industry)
    / *Status:*: Proof-of-concept published October 2025; clinical
        validation studies planned
    / *Phase:*: Diagnostic development (pre-clinical validation)
    / *Cohort:*: Initial study: 47 severe ME/CFS patients + 61 healthy
        controls.  Larger validation cohorts needed.
    / *Mechanism/Focus:*: EpiSwitch 3D genomic profiling of chromosome
    ...
    / *Primary Outcomes:*: Sensitivity 92%, specificity 98%, overall
        accuracy 96% in proof-of-concept validation cohort
    / *Estimated Completion:*: Clinical validation timeline not yet
        announced
...
=== PrecisionLife Combinatorial Genomics
<sec:registry-precisionlife>
    ...
    / *Contact/URL:*: #link("https://precisionlife.com/news-and-events/me-genetics-study")
    / *Registry ID:*: N/A (secondary analysis of DecodeME and UK Biobank data)
    / *Funder:*: PrecisionLife (industry) with access to DecodeME consortium
        data
    / *Status:*: Published December 2025
    / *Phase:*: Computational genomics (AI-led combinatorial analytics)
    / *Cohort:*: Two DecodeME cohorts + UK Biobank; results confirmed across
        three independent datasets
    / *Mechanism/Focus:*: Applied combinatorial analytics platform to
    ...
    / *Primary Outcomes:*: Identified 250+ core genes associated with
    ...
    / *Publication Medium:*: PrecisionLife press release and preprint;
        peer-reviewed publication expected
    / *Document Relevance:*: Ch. 12 (genetic factors), Ch. 13 (integrative
        models), Ch. 14 @sec:cross-disease (long COVID overlap)

The PrecisionLife analysis complements the DecodeME GWAS
(Section @sec:registry-decodeme) by detecting higher-order gene–gene
...
explored in Ch. 14 @sec:cross-disease.  However, combinatorial
...
=== BioMapAI (Gut Microbiome and Metabolomics)
<sec:registry-biomapai>

    / *Principal Investigator:*: Derya Unutmaz (Jackson Laboratory);
        AI platform developed with Duke University
    / *Institution:*: Jackson Laboratory (JAX) and Duke University
        School of Medicine, United States
    / *Contact/URL:*: #link("https://medschool.duke.edu/news/ai-thats-finally-making-sense-chronic-fatigue-syndrome")
    ...
    / *Cohort:*: 153 ME/CFS patients + 96 healthy controls, followed
        longitudinally over 4 years
    / *Mechanism/Focus:*: AI platform integrating gut metagenomics, plasma
    ...
    / *Primary Outcomes:*: Multi-modal diagnostic classifier; longitudinal
        trajectory modelling; microbiome-metabolome interaction networks
    / *Estimated Completion:*: Ongoing longitudinal follow-up; initial
        results published 2025
    / *Timeline:*: Recruitment 2020–2023; initial AI classifier published
        July 2025; longitudinal analysis ongoing
    / *Publication Medium:*: Initial results in high-impact journal (2025);
        longitudinal follow-up expected 2026–2027
    / *Document Relevance:*: Ch. 11 (gut microbiome), Ch. 6 (energy
...
=== ME Association PhD Project (Metabolite and Infection Markers)
<sec:registry-mea-phd>

    / *Principal Investigator:*: Aleyna Lumsden (PhD candidate); supervised
        across multiple institutions
    / *Institution:*: Rosalind Franklin Institute, Imperial College London,
        and National Phenome Centre, United Kingdom
    / *Contact/URL:*: #link("https://meassociation.org.uk/2025/11/research-new-funding-awarded-to-phd-project-that-will-identify-key-metabolites-and-infection-markers-in-me-cfs/")
    ...
    / *Mechanism/Focus:*: Advanced mass spectrometry and informatics to
    ...
    / *Primary Outcomes:*: Novel metabolite identification; infection
...
=== MEA–UCL Blood Biomarker Pilot
<sec:registry-mea-ucl>

    / *Principal Investigator:*: Sophie Hicks (PhD student); supervisors
        Dr.\ Amanda Heslegrave, Dr.\ Michael Zandi, Prof.\ Henrik Zetterberg
    / *Institution:*: UK DRI Fluid Biomarker Laboratory, UCL Institute of
        Neurology, London
    ...
    / *Cohort:*: Blood samples from ME/CFS patients (UK ME/CFS Biobank),
        Long Covid patients (UCLH STIMULATE-ICP study), and healthy volunteers
    / *Mechanism/Focus:*: Searches for blood-based biomarkers linking
    ...
    / *Primary Outcomes:*: Candidate blood biomarkers correlated with
        symptom clusters
    / *Estimated Completion:*: $tilde$February 2027
    / *Timeline:*: 12-month pilot; may lead to larger validation study
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction),
...
Chapter @sec:cross-disease.

=== Cornell Cell-Free RNA Liquid Biopsy
<sec:registry-cfrna>

    / *Principal Investigator:*: Iwijn De Vlaminck (Biomedical Engineering)
        and Maureen Hanson (Molecular Biology and Genetics)
    / *Institution:*: Cornell University, Ithaca, NY
    / *Contact/URL:*: #link("https://doi.org/10.1073/pnas.2507345122")
    ...
    / *Mechanism/Focus:*: Profiled circulating cell-free RNA (cfRNA) in
    ...
    / *Primary Outcomes:*: GLM-LASSO classifier AUC 0.81, accuracy 77%.
        Not yet diagnostic-grade but substantial advance over prior attempts
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Proceedings of the National Academy of
        Sciences_
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 20 (biomarker
...
cfRNA carries ME/CFS-relevant biological signal @Gardella2025cfRNA.
The T cell exhaustion and platelet activation signatures align with
independent findings from single-cell transcriptomics
(Section @sec:registry-tcell-exhaustion) and proteomics
(Section @sec:registry-cell-reports-medicine).  Prospective validation
...
<sec:registry-cell-reports-medicine>
    ...
    / *Primary Outcomes:*: Converging evidence across energy, immune, and
        vascular axes; reduced CD56#super[low]CD16#super[+]
        NK cells (antiviral), increased plasmacytoid DCs
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Cell Reports Medicine_
    / *Document Relevance:*: Ch. 6 (energy metabolism), Ch. 7 (immune
...
perform @CellReportsMedicine2025MECFS.  The reduced ATP/ADP ratio in
...
microclot literature @Nunes2022microclots.
...
=== Charit\'{e Immunoadsorption Trial (IA-PACS-CFS)}
...
<sec:registry-bc007>
    ...
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT05911009")
    / *Registry ID:*: NCT05911009 (Phase II, $n=114$); earlier Phase IIa
        ($n=29$)
    / *Funder:*: Berlin Cures GmbH (industry)
    / *Status:*: Phase II completed/in analysis
    / *Phase:*: Phase IIa (crossover, $n=29$) and Phase II ($n=114$)
    / *Cohort:*: Post-COVID syndrome patients with functional GPCR
        autoantibodies and predominant fatigue
    / *Mechanism/Focus:*: Rovunaptabin (BC007) is an aptamer that
    ...
    / *Primary Outcomes:*: Fatigue severity; autoantibody neutralisation;
        safety
    / *Estimated Completion:*: Results expected 2026
    / *Timeline:*: Phase IIa enrolled 29 patients; Phase II enrolled 114
        patients; analysis ongoing
    / *Publication Medium:*: Not yet announced; industry-sponsored trials
...
<sec:registry-resetme>
    ...
    / *Phase:*: Phase II, randomised, double-blind, placebo-controlled
        (2:1 ratio)
    / *Cohort:*: 66 participants; moderate-to-severe ME/CFS (CCC criteria),
        minimum 2-year disease duration
    / *Mechanism/Focus:*: Daratumumab is an anti-CD38 monoclonal antibody
    ...
    / *Primary Outcomes:*: Symptom reduction (SF-36 Physical Function);
        safety
    / *Estimated Completion:*: $tilde$2027 (72-week total participation)
    / *Timeline:*: 26-week treatment period, 72-week follow-up from June
        2025 start
    / *Publication Medium:*: Not yet announced; pilot published in
        _Frontiers in Medicine_, June 2025
    / *Document Relevance:*: Ch. 7 (immune dysfunction—autoantibodies),
...
(Section @sec:registry-bc007) and immunoadsorption
(Section @sec:registry-charite-ia), this trial represents the third
...
=== NCNED TRPM3 Ion Channel Programme
<sec:registry-ncned-trpm3>

    / *Principal Investigator:*: Sonya Marshall-Gradisnik, Professor of
        Immunology
    / *Institution:*: National Centre for Neuroimmunology and Emerging
        Diseases (NCNED), Griffith University, Australia
    / *Contact/URL:*: #link("https://www.griffith.edu.au/research/health/national-centre-neuroimmunology-emerging-diseases")
    ...
    / *Mechanism/Focus:*: Systematic investigation of TRPM3 ion channel
    ...
    / *Publication Medium:*: Published in _PLOS ONE_ and
        specialty journals; future publications expected similarly
    / *Document Relevance:*: Ch. 8 (neurological dysfunction), Ch. 7
...
=== Charit\'{e Neuroimaging Biomarker Study}
<sec:registry-charite-neuroimaging>
    ...
    / *Mechanism/Focus:*: Investigates whether functional brain changes—
...
to a treatable target in ME/CFS @HBOT2025mecfs.  However, the
...
== Large-Scale Federally Funded Programmes
<sec:registry-federal>
// =============================================================================

=== RECOVER-TLC Clinical Trials Programme
<sec:registry-recover>

    / *Principal Investigator:*: Multiple PIs across sites
    / *Institution:*: NIH-funded, multi-site across the United States
    / *Contact/URL:*: #link("https://recovercovid.org/")
    / *Registry ID:*: Multiple NCT numbers (programme-level)
    / *Funder:*: NIH (National Institutes of Health)
    / *Status:*: Active; multiple trials at different stages
    / *Phase:*: Multiple interventional trials (Phase II–III)
    / *Cohort:*: Long Covid patients (with substantial ME/CFS overlap)
    / *Mechanism/Focus:*: The RECOVER-Treating Long COVID (TLC) programme
        includes multiple treatment trials:
        
            - *REVERSE-LC*: Baricitinib (JAK inhibitor) for
                neurocognitive and cardiopulmonary symptoms; recruiting
            - *RECOVER Energize*: Structured pacing for PEM
                ($n=600$); completing December 2025
            - *LDN trial*: Low-dose naltrexone for fatigue in
                ages 6–25; enrolment estimated summer 2026
            - *GLP-1 agonist trial*: Targeting immune
                dysregulation; enrolment estimated late summer 2026
        
    / *Primary Outcomes:*: Vary by trial; include symptom severity,
        exercise tolerance, immune markers, quality of life
    / *Estimated Completion:*: Results from first-round trials expected
        by end of 2026
    / *Timeline:*: RECOVER programme initiated 2021; TLC trials began
        2024–2025; second-round trials planning 2026
    / *Publication Medium:*: High-impact journals; all results expected
        to be open access (NIH-funded)
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 10
        (cardiovascular), Ch. 17 (pacing), Ch. 14
        @sec:cross-disease (cross-disease)
...
=== LIFT Trial (Low-Dose Naltrexone and Pyridostigmine)
<sec:registry-lift>

    / *Principal Investigator:*: David Systrom, MD
    / *Institution:*: Brigham and Women's Hospital, Harvard Medical School,
        United States
    / *Contact/URL:*: #link("https://solvecfs.org/exploring-current-me-cfs-and-long-covid-clinical-trials-on-national-clinical-trials-day/")
    ...
    / *Mechanism/Focus:*: Tests whether low-dose naltrexone (LDN) and
    ...
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 16 (supplements and nutraceuticals),
...
<sec:registry-uab-ldn>
    ...
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT07285473")
    ...
    / *Mechanism/Focus:*: Dose-finding study for low-dose naltrexone in
        ...
        paediatric LDN trial (Section @sec:registry-recover): this
        study focuses on determining optimal adult LDN dosing specifically
        for ME/CFS.  Remote design enables broad US enrolment.
    / *Primary Outcomes:*: Dose-response for symptom reduction;
        safety and tolerability
    / *Estimated Completion:*: Not yet announced
    / *Timeline:*: Recruitment ongoing as of 2026
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 16 (supplements—LDN),
...
=== Low-Dose Rapamycin in ME/CFS and Long Covid
<sec:registry-rapamycin>

    / *Principal Investigator:*: Multi-site collaboration
    / *Institution:*: Simmaron Research Institute, Bateman Horne Center,
        CDC, and Mayo Clinic, United States
    / *Contact/URL:*: #link("https://batemanhornecenter.org/promising-clinical-trials/")
    ...
    / *Mechanism/Focus:*: Rapamycin (sirolimus) is an mTOR inhibitor with
        ...
        abnormalities.
    / *Primary Outcomes:*: Symptom improvement; immune marker changes;
        safety and tolerability
    / *Estimated Completion:*: Not yet announced
    / *Timeline:*: Study active as of 2025–2026
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 6 (energy
...
=== Lumbrokinase for ME/CFS and Long Covid
<sec:registry-lumbrokinase>

    / *Principal Investigator:*: David Putrino, PhD
    / *Institution:*: Abilities Research Center, Mount Sinai Icahn School
        of Medicine, United States
    / *Contact/URL:*: #link("https://solvecfs.org/exploring-current-me-cfs-and-long-covid-clinical-trials-on-national-clinical-trials-day/")
    / *Funder:*: Institutional
    / *Status:*: Recruiting
    / *Phase:*: Clinical trial (interventional)
    / *Cohort:*: Adults with Long Covid, post-treatment Lyme disease
        syndrome, and ME/CFS
    / *Mechanism/Focus:*: Lumbrokinase is a fibrinolytic enzyme targeting
    ...
    / *Primary Outcomes:*: Fibrinolytic markers; symptom scores; exercise
        tolerance
    / *Estimated Completion:*: Not yet announced
    / *Timeline:*: Recruitment ongoing as of 2026
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 10 (cardiovascular dysfunction),
        Ch. 19 (integrative approaches)
...
<sec:registry-hydrogen-water>
    ...
    / *Mechanism/Focus:*: Hydrogen-rich water as an antioxidant
        ...
        neuroinflammation.
    / *Primary Outcomes:*: Fatigue severity; stress markers; physical
        function
    / *Estimated Completion:*: Not yet announced
    / *Timeline:*: Recruitment ongoing as of 2026
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 6 (energy metabolism—oxidative stress),
...
=== RESTORE-ME: Oxaloacetate for ME/CFS Fatigue
<sec:registry-restore-me>

    / *Principal Investigator:*: Alan Cash, PhD
    / *Institution:*: Terra Biological LLC, United States (multi-site RCT)
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT05273372")
    / *Registry ID:*: NCT05273372
    / *Funder:*: Terra Biological LLC (industry)
    / *Status:*: Results published (November 2024)
    / *Phase:*: Phase II, randomised, double-blind, placebo-controlled
    / *Cohort:*: 82 ME/CFS patients (2,000mg oxaloacetate vs control
        daily for 3 months)
    / *Mechanism/Focus:*: Oxaloacetate (OAA) is a mitochondrial metabolite
        that supports the citric acid cycle and NAD#super[+]/NADH ratio.
        Targets metabolic dysfunction by supplementing a key TCA cycle
        intermediate.
    / *Primary Outcomes:*: Fatigue reduced $>$25% from baseline in
        OAA group ($p=0.0039$ vs control); cognitive improvement at
        day 60 ($p=0.034$); modest increase in uptime at day 30
    / *Estimated Completion:*: Completed
    / *Timeline:*: RCT completed 2024; results published November 2024
        in _Frontiers in Neurology_; cognitive follow-up published
        2025
    / *Publication Medium:*: _Frontiers in Neurology_ (open access)
    / *Document Relevance:*: Ch. 6 (energy metabolism—TCA cycle),
        Ch. 16 (supplements and nutraceuticals)
...
<sec:registry-sgb>
    ...
    / *Contact/URL:*: #link("https://doi.org/10.1080/21641846.2025.2455876")
    / *Funder:*: Solve ME/CFS Initiative (Ramsay Research Grant)
    / *Status:*: Pilot study published (February 2025); larger trials needed
    / *Phase:*: Prospective cohort pilot ($n=10$)
    / *Cohort:*: 10 patients meeting both WHO Long Covid and IOM ME/CFS
        criteria
    / *Mechanism/Focus:*: Sequential bilateral stellate ganglion blocks
    ...
    / *Primary Outcomes:*: Significant improvements in cognition, physical
    ...
    / *Timeline:*: Pilot published February 2025; larger trial planning
        stage
    / *Publication Medium:*: _Fatigue: Biomedicine, Health &
        Behavior_ (2025)
    / *Document Relevance:*: Ch. 10 (cardiovascular/autonomic dysfunction),
...
=== Transcutaneous Vagus Nerve Stimulation (tVNS) for Long Covid/ME/CFS
<sec:registry-tvns>

    / *Principal Investigator:*: Multiple investigators (several parallel
        studies)
    / *Institution:*: Multi-site (US and European studies)
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT06585254")
    / *Registry ID:*: NCT06585254 (US dosing study); additional European
        trials ongoing
    ...
    / *Cohort:*: Long Covid and ME/CFS patients fulfilling CFS criteria;
        prior studies $n=10$–25 per trial
    / *Mechanism/Focus:*: Non-invasive auricular stimulation of the vagus
    ...
    / *Primary Outcomes:*: Optimal stimulation parameters; health-related
        quality of life; fatigue severity; autonomic function
    / *Estimated Completion:*: Varies by trial; results expected 2026–2027
    / *Timeline:*: Multiple pilot studies published 2024–2025; current
        trials optimising parameters and assessing efficacy in larger cohorts
    / *Publication Medium:*: _Frontiers in Neurology_, _PLOS
        ONE_, and others (prior studies published open access)
    / *Document Relevance:*: Ch. 8 (neurological dysfunction), Ch. 10
...
<sec:registry-masitinib>
    ...
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT05449444")
    ...
    / *Mechanism/Focus:*: Masitinib is a tyrosine kinase inhibitor that
    ...
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction—mast cells),
        Ch. 19 (integrative approaches)
...
<sec:registry-cornell-nac>
    ...
    / *Primary Outcomes:*: Brain GSH levels (MRS); plasma oxidative stress
        markers
    / *Estimated Completion:*: $tilde$2026
...
=== NSU Directed Probiotics for ME/CFS
<sec:registry-nsu-probiotics>

    / *Principal Investigator:*: Nancy Klimas, MD
    / *Institution:*: Nova Southeastern University, Institute for
        Neuro-Immune Medicine, United States
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT06211062")
    / *Registry ID:*: NCT06211062
    / *Funder:*: Institutional
    / *Status:*: Recruiting (Phase 2)
    / *Phase:*: Phase 2, randomised, placebo-controlled
    / *Cohort:*: 100 participants (25 per arm $times$4 arms: ME/CFS
        with/without IBS $times$ active/placebo), ages 45–70, Canadian
        Consensus Criteria
    / *Mechanism/Focus:*: Tests i3.1 probiotic (Floradapt Intensive GI) to
    ...
    / *Primary Outcomes:*: GI inflammation markers; IBS severity score;
        ME/CFS global function; assessed at 8 and 12 weeks
    / *Estimated Completion:*: $tilde$2026
    / *Timeline:*: Recruitment ongoing
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 11 (gut microbiome—primary),
...
<sec:registry-address-lc>
    ...
    / *Cohort:*: 200 adults with Long Covid, enriched for cognitive
        impairment and fatigue, symptoms $gt.eq$3 months
    / *Mechanism/Focus:*: Bezisterim (NE3107) is an orally bioavailable,
    ...
    / *Primary Outcomes:*: Cogstate Cognition battery (cognitive
        performance); secondary: fatigue
    / *Estimated Completion:*: Data expected H1 2026
    / *Timeline:*: 84-day treatment period
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction—neuroinflammation),
...
=== LC-REVITALIZE (Upadacitinib + Pirfenidone)
<sec:registry-lc-revitalize>
    ...
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT06928272")
    / *Registry ID:*: NCT06928272
    / *Funder:*: Schmidt Initiative for Long COVID (SILC)
    / *Status:*: Recruiting (Phase 3)
    / *Phase:*: Phase 3, double-blind, placebo-controlled, multi-arm
        platform
    / *Cohort:*: $tilde$348 adults with Long Covid (prior confirmed
        SARS-CoV-2, symptoms $gt.eq$3 months); sites in Brazil, Canada,
        Italy, Uganda, USA, Zambia
    / *Mechanism/Focus:*: Repurposed drug platform trial.  Upadacitinib
    ...
    / *Primary Outcomes:*: Five symptom domains: fatigue, breathlessness,
        cognition, musculoskeletal pain, circulation
    / *Estimated Completion:*: $tilde$2027
    / *Timeline:*: Recruitment ongoing across 6 countries
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction—JAK pathway),
...
baricitinib trial (Section @sec:registry-recover), testing a more
...
<sec:registry-viral-persistence>
    ...
    / *Cohort:*: Adults with established Long Covid (STOP-PASC and PAX LC
        trials)
    / *Mechanism/Focus:*: Nirmatrelvir/ritonavir (Paxlovid) for 15 days
        ...
        PAX LC trials showed *no therapeutic benefit*, despite
        the viral persistence hypothesis.
    / *Primary Outcomes:*: No significant improvement in Long Covid
        symptoms vs placebo in either trial
    / *Estimated Completion:*: Completed
    / *Timeline:*: Results from STOP-PASC (systems immunology analysis)
        published December 2025; PAX LC results published in
        _The Lancet Infectious Diseases_ (2025)
    / *Publication Medium:*: _The Lancet Infectious Diseases_;
        _medRxiv_ (systems immunology analysis)
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 14
        @sec:cross-disease (cross-disease), Ch. 24 (controversies)
...
<sec:registry-chiime>
    ...
    / *Principal Investigator:*: UCSF / PolyBio Research Foundation network
    ...
    / *Contact/URL:*: #link("https://clinicaltrials.gov/study/NCT07227441")
    ...
    / *Cohort:*: ME/CFS patients with pre-2019 onset only (excludes Long
        Covid onset to avoid confounding)
    / *Mechanism/Focus:*: Investigates viral persistence (particularly
    ...
    / *Primary Outcomes:*: Longitudinal biomarker trajectories; enterovirus
    ...
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 7 (immune dysfunction—viral persistence),
...
=== Herpesvirus Reactivation and Anti-dUTPase Antibodies
<sec:registry-herpesvirus-reactivation>

    / *Principal Investigator:*: Mar{\'\i}a Palomo and collaborators
    / *Institution:*: Multi-centre (Spain / USA)
    / *Contact/URL:*: #link("https://doi.org/10.1002/jmv.70769")
    / *Funder:*: Institutional
    / *Status:*: Published 2026
    / *Phase:*: Observational (case-control)
    / *Cohort:*: ME/CFS patients + healthy controls
    / *Mechanism/Focus:*: Measured antibodies to EBV, HHV-6, and VZV, plus
    ...
    / *Primary Outcomes:*: Multi-herpesvirus co-reactivation as hallmark of
        post-infectious ME/CFS; anti-dUTPase IgG as fatigue-associated marker
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Journal of Medical Virology_
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 9
...
reactivation of a single pathogen @Palomo2026herpesvirus.  The
...
=== Post-IM Longitudinal Cohort: Seven-Year Follow-Up
<sec:registry-post-im-cohort>

    / *Principal Investigator:*: Ben Z.\ Katz, MD
    / *Institution:*: Northwestern University / multi-site (USA)
    / *Contact/URL:*: #link("https://doi.org/10.3389/fmed.2026.1676628")
    / *Funder:*: NIH
    / *Status:*: Published 2026
    / *Phase:*: Observational, prospective longitudinal cohort
    / *Cohort:*: 4,501 college students enrolled before developing
        infectious mononucleosis (IM); followed for 7 years
    / *Mechanism/Focus:*: Uniquely prospective design: baseline data
    ...
    / *Primary Outcomes:*: ME/CFS incidence: 13% at 6 months, declining to
        $tilde$4% at 24 months post-IM.  Risk factor identification at 7-year
        endpoint
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Frontiers in Medicine_
    / *Document Relevance:*: Ch. 9 (infection and triggers), Ch. 23
        (epidemiology), Ch. 14 @sec:cross-disease (post-viral overlap)
...
(Section @sec:registry-decodeme).  The declining incidence from 13% to
...
previously observed with EBV, Ross River virus, and _Coxiella
burnetii_ @RECOVER2025.  The RECOVER infrastructure's
...
=== CD8+ T Cell Exhaustion Atlas
<sec:registry-tcell-exhaustion>

    / *Principal Investigator:*: Multiple groups (NIH intramural)
    / *Institution:*: NIH / multi-centre
    / *Contact/URL:*: #link("https://doi.org/10.1073/pnas.2415119121")
    / *Funder:*: NIH intramural
    / *Status:*: Published 2025
    / *Phase:*: Observational (scRNA-seq atlas)
    / *Cohort:*: 28 ME/CFS patients + 30 sedentary controls; 336,269
        T lymphoid cells analysed
    / *Mechanism/Focus:*: Single-cell transcriptomics of CD8+ T cells at
    ...
    / *Primary Outcomes:*: CD8+ T cells in ME/CFS show exhaustion-associated
        gene expression; exercise provocation amplifies the dysregulation
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Proceedings of the National Academy
        of Sciences_
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 6 (energy
...
burden @Mayer2025Tcellexhaustion.  The exercise provocation design is
...
=== Single-Cell Immune Remodelling in Long COVID–ME/CFS
<sec:registry-elahi-singlecell>
    ...
    / *Cohort:*: Female long COVID–ME/CFS patients (12 months post-acute
        infection) versus recovered individuals
    / *Mechanism/Focus:*: scRNA-seq of PBMCs examining monocyte, NK cell,
        ...
        those who recovered.
    / *Primary Outcomes:*: Distinct monocyte polarisation, NK cell
        dysfunction, and T cell exhaustion patterns specific to ME/CFS
        development after COVID-19
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Nature Communications_
    / *Document Relevance:*: Ch. 7 (immune dysfunction), Ch. 14
        @sec:cross-disease (long COVID comparison)

This study complements the NIH T cell atlas
(Section @sec:registry-tcell-exhaustion) by examining the transition
...
pathological from physiological post-infection states @Elahi2026singlecell.

=== IgG Immune Complexes Disrupting Cellular Energetics
<sec:registry-igg-complexes>
    ...
    / *Mechanism/Focus:*: Isolated IgG complexes from ME/CFS patient
        sera and applied them to human umbilical vein endothelial cells (HUVECs).  Demonstrated that
        ME/CFS-derived IgG induces mitochondrial fragmentation while maintaining ATP production (stress adaptation rather than energy collapse), triggers IL-1β secretion, and produces disease-specific proteomic signatures: post-COVID IgG enriched in hemostasis/clotting pathways, classic ME/CFS in extracellular matrix remodelling pathways.
    ...
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Brain, Behavior, and Immunity -- Health_
    / *Document Relevance:*: Ch. 6 (energy metabolism), Ch. 7 (immune
        dysfunction—autoantibodies), Ch. 10 (endothelial dysfunction), Ch. 13 (integrative models)

This is among the strongest “transfer experiment” results in ME/CFS:
applying patient-derived IgG to healthy endothelial cells recapitulates mitochondrial disruption and inflammatory activation,
implicating humoral immune factors as causal rather than
epiphenomenal @Liu2026IgGcomplexes.  If replicated with purified IgG
subfractions, it could identify specific autoantibody targets and converge
with the daratumumab (Section @sec:registry-resetme) and
immunoadsorption (Section @sec:registry-charite-ia) therapeutic
approaches.
...
=== MCAM Multi-Site Autonomic Dysfunction Study
<sec:registry-mcam>

    / *Principal Investigator:*: Elizabeth Unger and collaborators
    / *Institution:*: CDC / multi-site (USA)
    / *Contact/URL:*: #link("https://doi.org/10.3390/jcm14176269")
    / *Funder:*: CDC
    / *Status:*: Published 2025
    / *Phase:*: Observational (multi-site clinical assessment)
    / *Cohort:*: ME/CFS patients from the MCAM (Multi-Site Clinical
        Assessment of ME/CFS) programme
    / *Mechanism/Focus:*: Characterised autonomic dysfunction using
        ...
        of recruitment site.
    / *Primary Outcomes:*: Autonomic dysfunction symptoms are pervasive
        in ME/CFS; COMPASS-31 scores significantly elevated versus controls
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Journal of Clinical Medicine_
    / *Document Relevance:*: Ch. 10 (cardiovascular), Ch. 8 (neurological
...
<sec:registry-sfn>
    ...
    / *Primary Outcomes:*: SFN features present in both ME/CFS and
        post-COVID; corneal nerve fibre density reduced
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _European Journal of Neurology_
    / *Document Relevance:*: Ch. 8 (neurological dysfunction), Ch. 10
        (cardiovascular—perfusion), Ch. 14 @sec:cross-disease
...
self-reported @Azcue2025sfn.  The corneal confocal microscopy approach
...
<sec:registry-microvascular>
    ...
    / *Primary Outcomes:*: Endothelial dysfunction detectable via retinal
    ...
    / *Document Relevance:*: Ch. 10 (cardiovascular), Ch. 13 (integrative
        models)

Retinal vessel analysis offers a window into systemic microvascular health
without invasive procedures @MicrovascularRemodeling2026.  The
...
findings @Nunes2022microclots and the coagulation proteomics
data @CoagulationProteomics2024.

=== POTS Autonomic Profiling Across Aetiologies
<sec:registry-pots-profiling>
    ...
    / *Cohort:*: POTS patients from syncope, CFS, and post-COVID-19
        populations
    / *Mechanism/Focus:*: Identified distinct autonomic profiles:
        ...
        regulation.
    / *Primary Outcomes:*: CFS-related POTS has a distinct autonomic
...
Section @sec:registry-tvns) may be more appropriate than the
beta-blockade used for hyperadrenergic
POTS @POTSautonomicProfiles2025.
...
=== Largest Two-Day CPET Study
<sec:registry-2day-cpet>

    / *Principal Investigator:*: Multiple groups
    / *Institution:*: Multi-centre (USA)
    / *Contact/URL:*: #link("https://doi.org/10.1186/s12967-024-05410-5")
    / *Funder:*: Institutional
    / *Status:*: Published 2024
    / *Phase:*: Observational (physiological testing)
    / *Cohort:*: Largest 2-day CPET cohort in ME/CFS to date
    / *Mechanism/Focus:*: Two-day cardiopulmonary exercise testing to
        objectively measure post-exertional malaise.  Significant reductions
        in VO#sub[2] and workload at the ventilatory anaerobic threshold (VAT)
    ...
    / *Primary Outcomes:*: Impaired recovery after exertional stressor;
        cardiac, pulmonary, and metabolic contributions to exertion
        intolerance; larger effect sizes at VAT than peak
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Journal of Translational Medicine_
    / *Document Relevance:*: Ch. 6 (energy metabolism), Ch. 10
...
cohorts @keller2024cpet.  The finding that cardiac, pulmonary, and
...
<sec:registry-skeletal-muscle>
    ...
    / *Mechanism/Focus:*: Muscle biopsies analysed for mitochondrial
        ...
        deconditioning.
    / *Primary Outcomes:*: ME/CFS muscle pathology is distinct from
        deconditioning; WASF3 elevation confirmed in skeletal muscle tissue
    / *Estimated Completion:*: Preprint published; peer review pending
    / *Publication Medium:*: medRxiv
    / *Document Relevance:*: Ch. 6 (energy metabolism—WASF3), Ch. 17
...
bed rest patterns @SkeletalMuscle2025longCOVID.  The distinct
pathology (WASF3 elevation, mitochondrial complex loss) aligns with the NIH
WASF3 findings @wang2023wasf3 and supports a disease-specific
...
=== JAX AI-Integrated Gut Microbiome Diagnostic
<sec:registry-jax-microbiome>

    / *Principal Investigator:*: Jackson Laboratory and Duke University
        collaborators
    / *Institution:*: JAX / Duke University (USA)
    / *Contact/URL:*: #link("https://www.jax.org/news-and-insights/2025/july/gut-microbiome-may-predict-invisible-chronic-fatigue-syndrome-and-long-covid")
    / *Funder:*: Institutional / NIH
    / *Status:*: Published July 2025
    / *Phase:*: Diagnostic development (AI-driven)
    / *Cohort:*: 249 individuals
    / *Mechanism/Focus:*: Applied an AI platform to stool, blood, and
    ...
    / *Primary Outcomes:*: 90% diagnostic accuracy; multimodal data
        (stool + blood + labs) outperforms any single data type
    / *Estimated Completion:*: Published
    / *Document Relevance:*: Ch. 11 (gut microbiome), Ch. 20 (biomarker
        research), Ch. 25 (translational findings)
...
cohort @JAXmicrobiome2025.  The multimodal approach (combining stool
...
=== Gut Microbial Composition Differences in CFS
<sec:registry-gut-composition>

    / *Principal Investigator:*: Multiple groups
    / *Institution:*: Multi-centre
    / *Contact/URL:*: #link("https://doi.org/10.1038/s41598-025-16438-y")
    / *Status:*: Published 2025
    / *Phase:*: Observational (case-control)
    / *Cohort:*: CFS patients versus healthy controls
    / *Mechanism/Focus:*: 16S rRNA sequencing of gut microbiota.  Found
        reduced microbial diversity, depletion of anti-inflammatory taxa
        (_Faecalibacterium prausnitzii_, _Bifidobacterium_),
        and enrichment of pro-inflammatory _Clostridium_ species in
        ME/CFS.
    / *Primary Outcomes:*: Significant between-group differences in gut
        microbial composition
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Scientific Reports_
    / *Document Relevance:*: Ch. 11 (gut microbiome), Ch. 7 (immune
        dysfunction—gut-mediated inflammation)

The depletion of _F.\ prausnitzii_ (a major butyrate producer) is
...
immune activation @GutMicrobialComposition2025.
...
=== Sex-Specific Steroid Hormone Profiling
<sec:registry-steroid-hormones>

    / *Principal Investigator:*: Multiple groups
    / *Institution:*: Multi-centre
    / *Contact/URL:*: #link("https://doi.org/10.1007/s40618-024-02334-1")
    / *Funder:*: Institutional
    / *Status:*: Published 2024
    / *Phase:*: Observational (cross-sectional)
    / *Cohort:*: ME/CFS patients + healthy controls
    / *Mechanism/Focus:*: UHPLC-MS/MS analysis of circulating steroid
        ...
        hormone profiles.
    / *Primary Outcomes:*: Sex-specific steroid hormone dysregulation in
        ME/CFS; reinforces need for sex-stratified analyses
    / *Estimated Completion:*: Published
    / *Publication Medium:*: _Journal of Endocrinological
        Investigation_
    / *Document Relevance:*: Ch. 8 (neuroendocrine dysfunction), Ch. 23
        (epidemiology—sex differences)

The sex-based differences in steroid profiles may partly explain the
female predominance in ME/CFS ($tilde$3:1 female-to-male
ratio) @pipper2024steroid.  The use of mass spectrometry
...
=== OMF Kynurenine Supplementation Trial
<sec:registry-kynurenine-trial>

    / *Principal Investigator:*: Open Medicine Foundation researchers
    / *Institution:*: OMF-funded site
    / *Contact/URL:*: #link("https://www.omf.ngo/kynurenine-trial-in-me-cfs/")
    / *Funder:*: Open Medicine Foundation
    / *Status:*: Recruiting / active
    / *Phase:*: Interventional (RCT, crossover)
    / *Cohort:*: ME/CFS patients
    / *Mechanism/Focus:*: Randomised to kynurenine or placebo for 3 months
...
neurotoxic (quinolinic acid) metabolites @OMFkynureninetrial.
...
understood @EDSMCAS2026review @hEDSgenetics2024MCAS.  The
...
Sections @sec:registry-charite-ia–@sec:registry-resetme.

// =============================================================================

== Conferences and Funding Initiatives
<sec:registry-conferences>
// =============================================================================

=== International ME/CFS Conference 2026 (Berlin)
<sec:registry-berlin-2026>

    / *Organiser:*: ME/CFS Research Foundation
    / *Location:*: Berlin, Germany
    / *Dates:*: 7–8 May 2026
    / *Contact/URL:*: #link("https://mecfs-research.org/en/news-conference2026/")
    / *Focus:*: Day 1: disease mechanisms (PEM, pain, cognitive dysfunction,
    ...
    / *Document Relevance:*: Multiple chapters; unpublished data presented
        here may update several registry entries

This conference is the primary venue for new ME/CFS data presentation in
2026 @BerlinConference2026.  Several registry entries (BC007, HBOT,
LDN trials) may present interim or final results.  The registry should be
updated after the conference.

=== ME/CFS Research Foundation 2026 Funding Strategy
<sec:registry-mecfs-foundation-2026>

    / *Organiser:*: ME/CFS Research Foundation (Germany)
    / *Contact/URL:*: #link("https://mecfs-research.org/en/fundingstrategy2026/")
    / *Focus:*: 2026 funding priorities: autoimmunity, immune
    ...
    / *Document Relevance:*: Signals research direction for the field;
...
=== Long Covid Wearable Device Study
<sec:registry-wearable>

    / *Principal Investigator:*: Julia Moore Vogel, PhD
    / *Institution:*: Scripps Research Institute, United States
    / *Contact/URL:*: #link("https://solvecfs.org/exploring-current-me-cfs-and-long-covid-clinical-trials-on-national-clinical-trials-day/")
    / *Funder:*: Institutional
    / *Status:*: Recruiting
    / *Phase:*: Observational, digital health
    / *Cohort:*: Adults with Long Covid, ME/CFS, or POTS
    / *Mechanism/Focus:*: Evaluates whether consumer wearable devices
        ...
        PEM triggers.
    / *Primary Outcomes:*: Pacing adherence; symptom management
        effectiveness; quality of life; PEM episode frequency
    / *Estimated Completion:*: Not yet announced
    / *Timeline:*: Recruitment ongoing as of 2026
    / *Publication Medium:*: Not yet announced
    / *Document Relevance:*: Ch. 17 (lifestyle interventions—pacing),
