...
The author (Yannick Loth) contributed:
    ...
    - *Lived experience*: Direct, first-person experience of severe illness with symptoms consistent with ME/CFS (formal diagnostic documentation pending) providing the phenomenological foundation and motivation for this work
    - *Research direction*: Identifying research gaps, selecting topics for investigation, and determining which mechanisms and treatments warranted detailed exploration
    - *Literature selection*: Choosing which papers to prioritize, which findings were most significant, and how to organize the overwhelming volume of ME/CFS research into a coherent framework
    - *Critical evaluation*: Assessing study quality, identifying methodological limitations, distinguishing high-certainty findings from speculative claims, and evaluating evidence strength
    - *Clinical data*: All personal case data in Appendix I, including symptom tracking, medication trials, and functional capacity measurements collected through lived experience with the disease
    - *Structural decisions*: Choosing theorem-like environments (hypothesis, achievement, warning, etc.) to make epistemic status of claims immediately clear—a structural choice designed to facilitate critical review
    - *Systems analysis*: Applying software architecture thinking to understand ME/CFS as a complex multisystem disease, identifying potential mechanistic relationships and integration points across physiological systems
    - *Quality control*: Conducting extensive review cycles to verify medical accuracy, logical consistency, and appropriate citation of sources
    - *Organizational framework*: Deciding document structure, what content to include, how to balance comprehensiveness with accessibility, and how to serve multiple audiences (patients, clinicians, researchers)
...
Despite the substantial AI contribution, the author takes full responsibility for:
    ...
    - The decision to publish and disseminate this work
    - All medical claims, treatment discussions, and mechanistic explanations
    - Any errors, misconceptions, or unjustified conclusions
    - The interpretation and implications of research findings
    - Personal case data and clinical observations

*Critical disclaimer*: The author is *not a medical doctor* and has no formal medical training. While he holds engineering degrees and received formal training in mathematics and analytical methods, he is not qualified to provide medical advice. This work represents independent patient research and systematic literature review, not clinical guidance.
...
== Transparency and Reproducibility
    ...
    - This disclosure is made voluntarily and in good faith.
    - The manuscript was developed using Claude Sonnet 4.5 and Claude Opus 4.5 (Anthropic).
    - The manuscript source is available at: #link("https://github.com/yannickloth/health-me-cfs")[github.com/yannickloth/health-me-cfs]
    - Correspondence regarding the content should be directed to the author.
