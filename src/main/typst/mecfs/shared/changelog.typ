...
=== New Content
  ...
  - *Lichen sclerosus as a shared immune terrain marker and ME/CFS comorbidity signal* (Chapter 7, new Section @sec:lichen-sclerosus-immune-terrain with @spec:lichen-sclerosus-immune-terrain (certainty 0.25), @oq:lichen-sclerosus-temporal, @hyp:il15-trans-presentation (certainty 0.45), @hyp:mir155-foxp3-mecfs (certainty 0.30), @hyp:trm-mecfs (certainty 0.30), @hyp:ecm1-axis-mecfs (certainty 0.40); Chapter 5, new Section @sec:lichen-sclerosus-subgroup with @hyp:lichen-trip-switch (certainty 0.35), @spec:lichen-sclerosus-subgroup (certainty 0.20), Section @sec:estrogen-th1-subgroup with @hyp:estrogen-th1-subgroup (certainty 0.35); Chapter 13, new @hyp:subclinical-fibrosis-mecfs (certainty 0.40); Chapter 14d, new Section @sec:th1-fibrotic-comparators with @hyp:ssc-ifn-fatigue-model (certainty 0.30) and @hyp:vitiligo-trm-control (certainty 0.25); Chapter 16, new Section @subsec:quercetin-nac-th1-stack with @spec:quercetin-nac-th1 (certainty 0.20); Chapter 18, new Sections @subsec:ldn-autoimmune-terrain with @spec:ldn-autoimmune-terrain (certainty 0.25) and @subsec:steroid-pulse-pem with @spec:steroid-pulse-pem (certainty 0.15); Chapter 20, new @oq:ecm1-autoantibody-mecfs; hypothesis-registry.typ, 16 new entries in @tab:hypothesis-registry-2026-05-01-lichen-sclerosus; references.bib, 11 new entries; Appendix H, 11 annotated entries in lichen-sclerosus-mecfs research stream; 2026-05-01): Integration of lichen sclerosus (LS) — a chronic Th1-dominant auto-immune dermatosis — as a window into ME/CFS immune predisposition terrain. The core finding from 11 papers: LS and ME/CFS share the same cytokine signature (IL-7, IL-15, IFN-γ, TNF-α elevated; IL-10 reduced), the same Treg dysfunction mechanism (miR-155/Foxp3 axis), overlapping genetic risk loci (PTPN22, CTLA4, HLA-DQ7), and a parallel autoimmune comorbidity cluster (Hashimoto's, Sjögren's, SLE, vitiligo). No published study has directly measured LS prevalence in ME/CFS populations — this is identified as a primary research gap. The fibromyalgia null result (Halonen 2024; n=10,692; OR 0.85) is prominently included as a constraining data point. Four mechanistic hypotheses are integrated: (1) IL-15 trans-presentation as a tissue-localized amplification loop explaining the "inflamed but not inflammatory" paradox; (2) miR-155/Foxp3 as a shared epigenetic switch amenable to Treg restoration strategies; (3) ME/CFS as a multi-organ tissue-resident memory T-cell persistence syndrome (PEM kinetics matching TRM reactivation); (4) ECM1 autoantibodies as a unifying connective-tissue-immune bridge spanning gut, BBB, and vascular barriers. The trip-switch prodrome hypothesis (PTPN22 R620W convergence) proposes LS as a pre-ME/CFS risk marker in registry-linkage studies. Estrogen withdrawal is integrated as a shared Th1-derepression mechanism linking post-menopausal LS onset to perimenopausal ME/CFS worsening. Fibrosis biology from LS provides a structural irreversibility model for long-duration ME/CFS (shear-wave elastography as a testable prediction). Cross-disease comparators (SSc IFN-signature, vitiligo as non-fibrotic TRM control) are added in Chapter 14d. Treatment implications are strictly research-stage (quercetin+NAC for oxidative stress, LDN subgroup enrichment, steroid pulse at PEM onset) with explicit warning environments and non-recommendation framing throughout. _Motivated by:_ @DeLuca2023LS2023Update --- definitive LS 2023 update establishing Th1 cytokine signature and miR-155/Foxp3 mechanism; @Paganelli2025LSCytokines --- current cytokine landscape and ECM1 autoantibody prevalence; @Kassels2024LSAutoimmune --- population-level autoimmune comorbidity cohort (n=83,103) providing the comorbidity landscape shared with ME/CFS; @Halonen2024LSRiskFactorsFinland --- largest case-control (n=10,692) including the fibromyalgia null result constraining the hypothesis; @Batham2024MECFSAutoimmunity --- ME/CFS autoimmunity systematic review establishing shared terrain without confirmed causal autoimmune mechanism.
  ...
  - *Functional deficiency below diagnostic thresholds* (Chapter 4 Section `ch04-08-differential-diagnosis`, new Section `sec:functional-deficiency` with 9 environments covering iron, magnesium, B12, vitamin D, thyroid; references.bib, 12 new entries; 2026-04-21): New differential diagnosis subsection on conditions invisible to standard laboratory reference ranges. Iron: RCT evidence for fatigue benefit at ferritin #sym.lt 50~µg/L (WHO threshold #sym.lt 15) @Vaucher2012 @Krayenbuehl2011; meta-analysis confirms effect size 0.33 @Yokoi2017. Magnesium: serum measures #sym.lt 1% of body stores @Workinger2018. B12: functional deficiency via methylmalonic acid despite normal serum (Low certainty 0.35) @RussellJones2022. Vitamin D: bone threshold 20 ng/mL vs immune threshold 40--60 ng/mL @Holick2011 @Charoenngam2020. Thyroid: DIO2 Thr92Ala polymorphism causing tissue T3 deficit with normal TSH @Panicker2009; low T3 in ME/CFS with OR 2.56 @RuizNunez2018; Hashimoto fatigue with normal TSH @Ott2011. Critical counterweight: Joustra 2017 @Joustra2017 shows no serum differences in CFS --- compatible with (not contradicting) the functional deficiency hypothesis since serum testing is the wrong measurement. _Motivated by:_ @Vaucher2012 --- RCT demonstrating fatigue improvement in IDWA at ferritin levels reported "normal" by standard labs; @Panicker2009 --- DIO2 polymorphism producing tissue-level hypothyroidism invisible to TSH screening.

  - *Strengthened Septad diagnostic map: prevalence priors, sequencing rationale, confirmation criterion, MCAS-triggered pathway, and genetic predisposition layer* (Chapter 5, new Sections @sec:septad-strengthened-map covering 5 gaps, @sec:septad-mechanistic-hypotheses covering 3 hypotheses + 4 speculations + 2 open questions; hypothesis-registry.typ, 2 new registry tables @tab:hypothesis-registry-2026-05-01-septad-map and @tab:hypothesis-registry-2026-05-01-septad-mechanistic; Appendix H, 6 new annotated entries (Eccles 2021, Steinsvik 2023, Vazquez 2022, Weinstock 2021, Afrin/Molderings 2020, Wirth/Löhn 2023); references.bib, 6 new entries; 2026-05-01): Structural extension of the Kaufman/Maxwell Septad co-occurring conditions framework into a 5-gap diagnostic map. *Gap 1 (prevalence priors):* A new prevalence table (@tab:septad-prevalence) establishes that hypermobility spectrum (81% by Brighton criteria, ascertainment-biased; 15--18% by strict hEDS criteria), POTS/OI (27%), and clinical MCAS (25.3%) are all more prevalent than formal MCAS diagnosis (16.7%) in ME/CFS cohorts. *Gap 2 (MCAS-first rationale):* MCAS-first treatment sequencing is explicitly justified by treatability and upstream amplification — not prevalence (where hypermobility dominates). *Gap 3 (confirmation criterion):* "Disproportionate upstream improvement" operationalized as ≥2-of-4 downstream domain improvement within 4--8 weeks of MCAS-targeted therapy (@obs:cascade-confirmation), adapted from ECNM-AIM criteria; limitations (placebo/regression-to-mean) stated explicitly. *Gap 4 (MCAS-triggered ME/CFS pathway):* New hypothesis branch (@hyp:mcas-mecfs-phenotype, certainty 0.35) for the rare subset where MCAS onset preceded ME/CFS onset; accompanied by a warning environment presenting the contradicting Rohrhofer 2025 temporal evidence (97.2% of ME/CFS patients developed MCAS after ME/CFS onset). *Gap 5 (genetic predisposition):* Conditional genetic testing layer (@spec:septad-genetics) for TPSAB1 copy number (HaT), KIT D816V, and HNMT Thr105Ile — each indicated conditionally on phenotype, not universally; Vazquez 2022 null result (HaT in hEDS = general population rate) cited as critical corrective. New mechanistic hypotheses from the Septad map: hypermobility as permissive substrate (0.55), mast cell as cascade ignition node (0.45), Septad as single neuroimmune connective syndrome NICS (0.40, embryological error corrected from prior draft: mast cells are hematopoietic not neural-crest derived); speculations on amplification ratchet, third-trigger model, MCAS mediator subtype, and HNMT clearance failure; open questions on latent class structure and treatment-duration interaction. _Motivated by:_ @Rohrhofer2025mecfsmast --- Austrian ME/CFS cohort (n=687) providing MCAS prevalence and temporal sequence data contradicting MCAS-as-primary-driver; @Eccles2021hypermobility --- 81% Brighton positivity in FM/ME/CFS specialist clinic establishing hypermobility as the most prevalent Septad component; @Vazquez2022TPSAB1 --- null result: HaT prevalence in hEDS (4.9%) equals general population, justifying conditional-not-universal testing; @Yao2025MCASPOTStriad --- 75--91% MCAS therapy response rates with and without biochemical confirmation.
  ...
  - *HSAT2 hypothesis expansion: upstream regulators, cross-pathway bridges, therapeutic angles, and biomarker candidates* (Chapter 7, expanded @spec:hsat2-pem-amplification with SIRT1→SUV39H1/SETDB1 cascade detail; Chapter 13, expanded @spec:hsat2-centromere-stress with CTCF topological domain loss pathway; Chapter 14a, new @spec:sirt1-hsat2-upstream (certainty 0.25) on SIRT1 depletion as upstream epigenetic gate, new @spec:ctcf-hsat2-route (certainty 0.20) on CTCF occupancy loss as alternative derepression route, new @spec:hsat2-tlr3-rig-i (certainty 0.20) on HSAT2 RNA as endogenous TLR3/RIG-I agonist; Chapter 14d, expanded @spec:hsat2-long-covid-bridge with viral-SIRT1 depletion sub-mechanism; Chapter 16, expanded @spec:nac-hsat2 with GSH-SIRT1 mechanistic rationale, expanded @spec:methyl-donor-hsat2 with SAM-dependent H3K9me3 pathway, new @spec:nr-nmn-hsat2 (certainty 0.20) on NAD#super[+] precursors restoring SIRT1 activity; Chapter 17, new @spec:sleep-sirt1-hsat2 (certainty 0.25) on sleep as SIRT1 activity window and HSAT2 suppression interval, new @oq:cold-exposure-hsat2, expanded @spec:heat-hsat2-caution with SIRT1 heat-degradation mechanism; Chapter 18, expanded @spec:hsat2-pem-amplification with SIRT1→H3K9me3 downstream loop, new @spec:mdsc-nk-bridge (certainty 0.20) on EV-mediated MDSC-NK suppression loop; Chapter 20, new @spec:hsat2-biomarker-panel expansion with SIRT1 activity assay inclusion, new @oq:skin-senescence-biopsy, expanded @oq:hsat2-longitudinal; Chapter 6, new @spec:cenpa-senescence-stromal (certainty 0.25) on CENP-A mislocalization as senescence amplifier, new @hyp:arginine-mdsc-nk (certainty 0.35) on arginine depletion as primary NK suppression mechanism; hypothesis-registry.typ, 17 new entries added to @tab:hypothesis-registry-2026-05-01-hsat2 in the second integration pass; 2026-05-01): Phase 4 brainstorm expansion of the HSAT2 hypothesis cluster, adding upstream regulatory nodes and cross-pathway connections identified through systematic brainstorming. *Upstream regulators:* SIRT1 depletion (via energy stress, oxidative burden, or viral SIRT1 cleavage) as the primary epigenetic gate controlling SUV39H1/SETDB1 activity and hence H3K9me3 maintenance at pericentromeric loci (@spec:sirt1-hsat2-upstream); CTCF topological domain loss as an alternative derepression route when chromatin loop anchors are disrupted (@spec:ctcf-hsat2-route). *Innate immune bridge:* HSAT2 RNA as an endogenous TLR3/RIG-I agonist potentially driving type-I interferon induction and feed-forward loop through type-I IFN further depleting SIRT1 (@spec:hsat2-tlr3-rig-i). *Therapeutic convergence:* NAD#super[+] precursors (NR, NMN) reclassified from generic mitochondrial supplements to targeted SIRT1-activity restorers in the HSAT2 pathway context (@spec:nr-nmn-hsat2); methyl donors (SAM, folate, B12) connected explicitly to the H3K9me3 re-silencing requirement for re-establishing pericentromeric heterochromatin; sleep architecture connected to SIRT1 rhythmic activity and the hypothesis that restorative sleep is mechanistically required for HSAT2 re-suppression (@spec:sleep-sirt1-hsat2). *Biomarker additions:* skin senescence biopsy as an accessible tissue window for HSAT2 expression and CENP-A mislocalization (@oq:skin-senescence-biopsy); CENP-A mislocalization in fibroblasts as a potential non-invasive proxy (@spec:cenpa-senescence-stromal); arginine/citrulline ratio as a plasma surrogate for MDSC arginase-1 activity (@hyp:arginine-mdsc-nk). All new environments explicitly inherit the core evidence-base limitation: no ME/CFS-specific HSAT2 experimental data exist; all mechanistic pathways are extrapolated from cancer biology (Evdokimova 2019 bioRxiv, Ewing sarcoma), senescence biology, and general chromatin regulation. _Motivated by:_ @BoschPresegue2011SIRT1SUV39H1 --- direct biochemical evidence that SIRT1 controls SUV39H1 activity and H3K9me3 at pericentromeric repeats; @Miyata2021HSAT2senescence --- HSAT2 expression in cellular senescence contexts establishing the CENP-A mislocalization connection; @Evdokimova2019HSAT2exosome --- primary mechanistic anchor (exosomal HSAT2, Ewing sarcoma); @Kishikawa2016HSATIIserum --- TLR3 activation by repeat RNA as the basis for the innate immune bridge speculation; @Ninomiya2023HSATII --- HSAT2 in immune suppression; @Jeffery2021CENPAp53 --- CENP-A mislocalization as a p53-activating senescence signal; @Wang2019SLEMDSC --- MDSC flow cytometry reference for the arginine-depletion biomarker protocol.

=== Quality

  - *Comprehensive UK→US English normalization across 10 scope files* (Chapters 7, 13, 14a, 14d, 16, 17, 18, 20, hypothesis-registry.typ, appendix-h; 2026-05-01): Full adversarial review pass normalized ~200+ pre-existing UK spelling variants to US English across all chapters modified during the HSAT2 integration sessions. Patterns corrected include: -ise/-isation/-ised/-ising → -ize/-ization/-ized/-izing (characterised, standardised, sensitisation, internalisation, organising, randomised, etc.); programme → program; behaviour/behavioural → behavior/behavioral; aetiology → etiology; haemoglobin/haematology/haemodynamic → hemoglobin/hematology/hemodynamic; tumour → tumor; oedema → edema; rigour → rigor; modelling/signalling/analysing → modeling/signaling/analyzing; anaemia → anemia; paraesthesias → paresthesias; defence → defense; favour → favor; practised → practiced. One AI-marker phrase removed from ch20 ("It should be noted that" → direct assertion). One critical Typst build error fixed in appendix-h: bare `*` in `Haplogroup HHV*:` was parsed as an unclosed emphasis delimiter; corrected to `HHV**:` (empty bold span). Build verified clean after all corrections: zero errors, 3 pre-existing "no text within stars" warnings only.
