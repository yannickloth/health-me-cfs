...
== Version 6 (2026-03-08 – 2026-04-10)
...
=== Literature Integration
  ...
  - *Adversarial review quality improvements: Ch18 therapeutic frameworks* (Chapter 18, Sections `sec:novel-frameworks`, `subsubsec:emergency-pem-protocol`, `sec:aimm-bridging`, `subsec:cycle-gain-measurement`; Appendix H, 2 new entries; references.bib, 2 new entries): Six targeted fixes applied following six-persona adversarial review. *(1) Antioxidant-mitophagy trade-off warning* added to Emergency PEM Protocol Phase 1: high-dose NAC/ALA/Vitamin C may blunt PINK1/Parkin mitophagy by scavenging required ROS signals — cited to mitohormesis literature @Ristow2009oxidativehormesis; conservative dose-limiting option provided. *(2) Drug interaction expansion* for Emergency PEM Protocol: fludrocortisone (NSAIDs reduce natriuretic efficacy), midodrine (haemodynamic monitoring), LDN (no interaction), beta-blockers (cold-face immersion caution), antihistamines, and pyridostigmine all checked against protocol components. *(3) Competing mechanistic frameworks disclaimer* added to AIMM bridging section: CDR/purinergic model (Naviaux @Naviaux2014cdr), itaconate shunt (Phair), and Systrom preload failure are presented as alternative frameworks with equal explanatory power for bridging agent benefits. *(4) G_proxy warning box* added to cycle gain measurement: the formula is explicitly labelled an ad hoc heuristic not derived from the control-theoretic loop gain definition; alternative operationalisations (recovery time alone, AUC, two-day CPET ratio) proposed. *(5) Glymphatic hypothesis critique* added to `#hypothesis(Glymphatic Dysfunction)`: Smith and Verkman 2018 methodological critique @SmithVerkman2018glymphatic acknowledged; prediction reformulated to be mechanism-agnostic. *(6) Clinician quick reference observation box* added at chapter opening, listing actionability by category: available now (CoQ10+NADH, pyridostigmine, LDN, fluvoxamine), active trials (vericiguat, trimetazidine), specialist referral (rTMS), and research-only (MDC002, G_proxy, Emergency PEM Protocol). _Motivated by:_ adversarial review personas cynic, sophist, strawman, reductionist, clinician, and devil's advocate (2026-04-11) — each identified separate convergent vulnerabilities; Emergency PEM Protocol polypharmacy risk was flagged by four of six personas.

  - *Probiotic and FMT evidence update* (Chapter 11, probiotic and FMT subsections; references.bib, 4 new entries): Updated with 2024--2025 trial data. B.\ infantis 35624 corrected to $n = 48$ female patients with citation @Groeger2013Bifido. STOP-FATIGUE synbiotic RCT integrated @Ranisavljev2025synbiotic ($n = 26$ post-COVID ME/CFS; multi-strain formulation (_L. rhamnosus_ DSM 32550 + _L. plantarum_ DSM 34532 + _B. lactis_ DSM 32269 + _B. longum_ DSM 32946 + FOS + zinc) × 3 months; PEM reduction $p = 0.02$; fatigue not significantly reduced). Salonen et al.\ 2023 FMT pilot added @Salonen2023FMT ($n = 11$, negative; engraftment not assessed). Skjevling et al.\ 2024 Comeback Study protocol added @Skjevling2024FMTprotocol ($n = 80$; FSS $>$ 1.2 improvement at 3 months as primary endpoint; results pending). _Motivated by:_ Ranisavljev et al.\ 2025 @Ranisavljev2025synbiotic — first synbiotic trial showing a PEM-specific statistically significant outcome, albeit in a small sample; Salonen et al.\ 2023 @Salonen2023FMT — the only completed FMT RCT in ME/CFS; Groeger et al.\ 2013 @Groeger2013Bifido — correcting a prior citation gap.
