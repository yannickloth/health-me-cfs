...
=== New Content
  ...
  - *Blood and immune system convergence: immune remodeling, white matter neuroinflammation, complement genetics, and emerging biomarkers* (Chapter 7, new Section @sec:immune-remodeling with 4 environments; Chapter 8, new Sections @sec:nii-neuroinflammation, @sec:csf-proteome-mecfs, @sec:brainstem-autonomic-loop with 3 environments; Chapter 20, new Section @sec:emerging-biomarkers-convergence with 1 limitation; hypothesis-registry.typ, 8 new entries in table @tab:registry-blood-immune-convergence; Appendix H, new Section @sec:bib-blood-immune-convergence with 6 annotated entries; references.bib, 6 new entries; 2026-04-16): Integration of 12 studies synthesised by Cort Johnson (Health Rising, 2026-04-14) from which two major convergent themes emerged: (1) immune _remodeling_ (altered networking, not just activation) and (2) blood/blood vessel dysfunction across brain, blood, and CSF compartments. Six new papers added to bib (Seifert 2026 EV signatures, Bragee 2026 CSF proteomics, Yu 2026 NII neuroinflammation, Shahbaz 2026 scRNA-seq immune remodeling, Maya 2026 complement genetics, Germain 2025 longitudinal exercise proteomics); six already-cited papers cross-referenced. Key novel content: first in vivo white matter neuroinflammation evidence via NII diffusion MRI (n=67/group; conventional DTI missed all abnormalities); Galectin-9--TIM-3 axis identified as driver of gamma-delta and MAIT cell depletion; complement pQTL-defined inflammatory subgroup (high C3/low Bb); largest longitudinal exercise proteomics study (n=132) capturing PEM molecular dynamics; CSF complement/coagulation enrichment in POTS+ and severe patients. New hypotheses: complement-driven perivascular mast cell amplification loop (certainty 0.45), brainstem autonomic three-node bistable system (certainty 0.40), complement inflammatory subgroup (certainty 0.50). New speculations: Galectin-9--TIM-3 axis mechanism (certainty 0.35), EV-mediated inter-compartment signaling (certainty 0.25). _Motivated by:_ @Seifert2026extracellular-vesicles — EV cargo as inter-compartment signaling vector; @Yu2026diffusion-neuroinflammation — first NII evidence of white matter neuroinflammation in ME/CFS; @Shahbaz2026single-cell-immune — scRNA-seq revealing Galectin-9--TIM-3 as driver of tissue-resident cell depletion; @Maya2026complement-genetics — complement pQTL subgroup with UK Biobank validation; @Germain2025plasma-proteome-exertion — longitudinal PEM proteomics distinguishing disease from deconditioning; @Bragée2026csf-proteome — CSF complement/coagulation enrichment linking peripheral and central compartments; @Hoel2026proteome — serum proteome immune reprogramming evidence.
...
- *CSF drainage synergy*: (Chapter 14a, new Section `sec:csf-drainage-synergy` and 3 new sub-sections `sec:sequential-therapy-perrin-ca`, `sec:onsd-overnight`, `sec:micro-nph-bridge`; Chapter 19, acetazolamide entry expanded with CSF-production-reduction mechanism and ICP-lowering rationale, cognitive/POTS cautions, cross-reference to hypothesis; Chapter 17, Perrin technique cross-reference added; Chapter 14 mechanism-treatment map, CA inhibitors row added; Chapter 14a, sequential therapy, ONSD monitoring, and micro-NPH bridge speculations; Appendix H, 7 new annotated entries; Appendix H, 3 new annotated subsections; references.bib, 11 new entries from Phase 1 plus 4 supporting entries; hypothesis registry, 4 new entries. Proposed synergistic combination of carbonic anhydrase inhibitors (acetazolamide/topiramate) with Perrin Technique to address glymphatic clearance failure from both sides—reducing CSF input while improving mechanical lymphatic drainage. Targets conserved CTD+IIH+CCI+POTS+MCAS phenotype (Midtlien 2024). Critical safety concerns documented: Mitchell 2025 cognitive worsening at ICP-reducing doses; Medow 2024 no acute cognitive benefit for ME/CFS+POTS; POTS volume depletion risk. _Motivated by:_ Wall et al. 2014 @Wall2014IIHTT — Class I evidence for acetazolamide as first-line IIH therapy; Riste et al. 2025 @Riste2025perrinLongCOVID — first Perrin skill-based Technique RCT showing fatigue improvement; Midtlien et al. 2024 @Midtlien2024CVDphenotype — CTD+IIH+CCI+POTS+MCAS phenotype with pressure hypersensitivity. 
    ...
    echo ""
    echo "145:     hypothesis registry updated with 5 new entries: (Chapter 14a, new Section `sec:csf-drainage-synergy` and 3 new sub-sections `sec:sequential-therapy-perrin-ca`, `sec:onsd-overnight`, `sec:micro-nph-bridge`; Chapter 19, acetazolamide entry expanded with CSF-production-reduction mechanism and ICP-lowering rationale, cognitive/POTS cautions, cross-reference to hypothesis; Chapter 17, Perrin technique cross-reference added; Chapter 14 mechanism-treatment map, CA inhibitors row added; Chapter 14a, sequential therapy, ONSD monitoring, and micro-NPH bridge speculations; Appendix H, 7 new annotated entries; Appendix H, 3 new annotated subsections; references.bib, 11 new entries from Phase 1 plus 4 supporting entries; hypothesis registry, 4 new entries. Proposed synergistic combination of carbonic anhydrase inhibitors (acetazolamide/topiramate) with Perrin Technique to address glymphatic clearance failure from both sides — reducing CSF input while improving mechanical lymphatic drainage. Targets conserved CTD+IIH+CCI+POTS+MCAS phenotype (Midtlien 2024). Critical safety concerns documented: Mitchell 2025 cognitive worsening at ICP-reducing doses; Medow 2024 no acute cognitive benefit for ME/CFS+POTS; POTS volume depletion risk. _Motivated by:_ Wall et al. 2014 @Wall2014IIHTT — Class I evidence for acetazolamide as first-line IIH therapy; Riste et al. 2025 @Riste2025perrinLongCOVID — first Perrin Technique RCT showing fatigue improvement; Midtlien et al. 2024 @Midtlien2024CVDphenotype — CTD+IIH+CCI+POTS+MCAS phenotype with pressure hypersensitivity. _Motivated by:_ @Souza2024 — topiramate inhibits mast cell degranulation; @Bragee2020 — 80% craniocervical obstructions; @Henderson2017EDS — EDS-IIH comorbidity cluster."
    echo ""
