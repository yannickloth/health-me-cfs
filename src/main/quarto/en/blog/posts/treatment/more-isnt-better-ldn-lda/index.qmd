...
*This post draws on the hormesis framework developed in [Loth 2026](https://yannickloth.github.io/health-me-cfs/). The LDN dose-response analysis was triggered by a clinical observation from Kevin Lee (personal communication, July 2026); the expansion to 17 medications was triggered by Yannick L.'s observation that the same logic applies to LDA and other low-dose drugs. For the full mechanistic cascade analysis — including the LDN multi-target dose-response cascade, the inverted-U diagnostic pattern across 17 medications, and the HIP-B trial specification — see the primary paper.*

*Start of the dose-response series (this post) · [Part 2: The Inverted-U Is Not One Thing](../inverted-u-not-one-thing/) · [Part 3: Your LDN Dose Is a Diagnostic](../dose-is-diagnostic-ldn/) · [Part 4: The Pharmacopoeia](../pharmacopoeia-dose-meaning/) · [Part 5: How to Run a Dose-Finding Trial](../dose-finding-protocols/) · Related: [Dismiss the Dose, Not the Drug](../dose-first-search-strategy/)*
