---
title: "Part 2: The Inverted-U Is Not One Unique Thing — Four Ways a Drug Can Stop Working When You Raise the Dose"
...
**The surprise in this category — melatonin.** Melatonin is the drug where the "more is better" assumption fails in the least obvious way, because the drug has two effects that respond completely differently to dose. The first is the chronobiotic signal — the message to the brain's clock that day is ending and sleep should begin. This signal does not get stronger with a higher dose. It is a phase cue, not a sedative: once it has told the clock the time, more of the molecule adds nothing to that message. The second effect — anti-inflammatory and antioxidant action through MT1/MT2 receptors that feed into the Nrf2 system — is hormetic. It works at physiological doses (roughly 0.3–1 mg) and *inverts* as the dose rises into the supraphysiological range, because sustained high occupancy desensitises the receptors that carried the protective signal.

The trap is that the two effects are invisible to the person taking the pill. Someone who sleeps a little on 0.3 mg reasonably assumes 3 mg will make them sleep more — but the sleep-onset benefit they already have was the chronobiotic phase cue, which does not scale, and the anti-inflammatory benefit they did not notice is quietly being extinguished by receptor desensitisation. What looks like "taking more of the same helpful drug" is actually two changes at once: the scaling effect that was never there to begin with, plus the loss of a hormetic benefit that was real. This is why a patient can report that melatonin "stopped working" or started causing a daytime grogginess "hangover" and depression-like mood at 3–5 mg. Those are signatures of sustained supraphysiological exposure — the hangover from a prolonged high plasma level, and the depression-like flattening that comes from a high dose suppressing daytime dopaminergic tone. The drug has not "worn off." The dose was not protecting a benefit; it was erasing it.
...
**The surprise in this category — duloxetine.** Duloxetine quietly contains two different drugs, and the dose separates them. It blocks the serotonin transporter (SERT) at low occupancy and the norepinephrine transporter (NET) only once occupancy rises. These two actions have opposite dose-response shapes. The serotonergic action — the pain, sleep, and anxiety relief — is monotonic: it saturates and stays, with no inverted-U. The noradrenergic action — the energy, motivation, and drive — is a true catecholamine inverted-U: it climbs into benefit as NET engages and then collapses as norepinephrine overshoots the prefrontal optimum.

The consequence is the most disorienting drug behaviour in the group: a patient can raise the dose and *lose the energy benefit while keeping the pain relief*, and interpret that as the drug "stopping working" — when in fact half of it is working exactly as well as before. The pain signal is serotonergic and never inverted; the energy signal crossed its own peak. Disentangling the two is itself diagnostic. If raising the dose removes the energy lift but spares pain relief, the norepinephrine system is sitting on the right arm of its curve — the correct move is to drop back to the dose that held energy benefit, not to conclude the drug has failed, and not to abandon it, because the pain relief was never the part that turned. The two mechanisms can be separated by dose because they occupy different transporters at different concentrations — a built-in within-patient experiment no single drug class usually offers.

**The surprise in this category — beta-blockers.** Every drug so far raises catecholamine tone and pushes the system toward its peak from the left. Beta-blockers are the exception that completes the picture: they *lower* catecholamine action, pushing from the right arm toward the peak. Guanfacine does this too, by quieting the locus coeruleus. So the category contains drugs that move tone up and drugs that move it down, and both directions can be therapeutic.

The surprise is what a patient who benefits from *both* directions reveals. If a low-dose elevator (modafinil) helps you *and* a low-dose reducer (a beta-blocker, or guanfacine) helps you, you have not contradicted yourself — you have exposed that your baseline catecholamine tone is usable across a wide band, because both a small addition and a small subtraction land inside the tolerable range. That wide peak is itself information: it means your catecholamine system is not the brittle bottleneck. The converse is the diagnostic edge case. A patient who is helped by modafinil but cognitively dulled by even a low-dose beta-blocker is sitting on the left arm with genuinely low baseline tone — for them, the reducer is not a neutral experiment, it is pushing an already-low system below the floor, and combining beta-blockers with guanfacine would be actively counterproductive. The direction of the drug you respond to is a probe of where you sit on the curve, and the category's real power is that it tests both directions at once.
...
**The surprise in this category — corticosteroids.** This is the most dangerous surprise in the entire catalogue, and the one where the dose curve is most easily misread. Corticosteroids are not a single drug with a dose-response curve. They are two drugs separated by a threshold, and crossing that threshold inverts not just the benefit but the physiology you were trying to help.

At a physiological dose, a corticosteroid is not really a treatment — it is a *replacement*. In a patient whose own HPA axis produces too little cortisol (a state worth suspecting in ME/CFS, though not assumed), low-dose hydrocortisone or prednisone simply supplies the anti-inflammatory glucocorticoid signal the body should have been making. The benefit comes from restoring a deficit. This is why a dramatic response at replacement dose is itself a diagnostic prompt to run an ACTH/cortisol workup — the drug only produces a striking effect if something endogenous was genuinely missing.

Above that physiological window, the drug stops being a replacement and becomes a *suppressor* of the very axis that makes the hormone. Supraphysiological dosing tells the pituitary and adrenal glands to stand down — the body reduces its own cortisol production to match what it now receives from outside. The problem is what happens on the way down. Because the axis has been silenced, stopping or tapering the drug removes the outside cortisol *before* the body has resumed making its own — leaving a window with no cortisol at all. The rebound inflammation that follows is frequently worse than the original illness, and it is not a sign the drug stopped working; it is the withdrawal of a hormone the body had been told not to make. This is why corticosteroids must be tapered, never stopped abruptly, and why the taper can be difficult even at modest doses if the axis has been suppressed.

The clinical rule this yields is counterintuitive and worth stating plainly: with corticosteroids, the dose that helps is the smallest one that restores a deficit, and raising it past the replacement window does not add benefit — it converts the drug into something that endangers the system it was supporting. The "more is better" assumption is not merely ineffective here; it is the specific mechanism by which a helpful replacement becomes a harmful suppressor with a rebound trap on the way out. Because of the real harm potential, any corticosteroid use in ME/CFS — at any dose, replacement or higher — belongs under a clinician's guidance, and the surprise being described is a caution about mechanism, not a recommendation to try it.
...
**The surprise in this category — NAC.** NAC is the one drug in the whole catalogue where the curve runs *backwards* from intuition, and it is the drug patients are most likely to abandon on the strength of a misleading single trial. NAC is an antioxidant *precursor*: the body uses it to make glutathione, the cell's main redox buffer. The mistake is to think of NAC itself as the antioxidant. It is not. It is raw material, and the first thing the body does with a load of it is process it — and that processing step itself produces a burst of reactive oxidant intermediates before the glutathione is built.

At 600 mg, that processing burst can exhaust existing glutathione faster than new glutathione is made — the cell is briefly *more* oxidatively stressed, not less. In roughly a fifth to a third of patients this shows up as a paradoxical worsening: flu-like symptoms, oxidative malaise, feeling worse within hours of the pill. The natural conclusion — "NAC makes me worse, it is not for me" — is wrong in a specific way. The worsening is not the drug's steady-state effect; it is a transient overshoot during the synthesis ramp. At 1,200 mg, the synthetic pathway has saturated and net glutathione is rising, and many of the same patients who felt worse on 600 mg feel better on 1,200. The dose that hurts is *lower* than the dose that helps.

This is why a single failed NAC trial at 600 mg is not a verdict. The clinical moves that respect the curve are to start low enough to avoid the burst and build past it (splitting the dose, for example, so the body is never asked to process a large single bolus), or to recognise that a patient who worsens on 600 mg but improves on 1,200 mg has a glutathione pathway that is intact but capacity-limited — a finding that carries its own meaning, since it predicts that other Nrf2-cluster drugs working through Keap1 (sulforaphane) or GSK-3β (lithium) may succeed where a single low NAC dose seemed to fail.
...
### Category 1 — Nrf2 hormesis drugs
...
### Category 4 — Target selection and biphasic biochemistry
