...
- Mitochondrial: 2-day CPET, organic acids, acylcarnitine profile [@Naviaux2016metabolomics]
...
- Autoantibodies → immunoadsorption [@Scheibenbogen2018immunoadsorption] (where available)
...
This predicts that ME/CFS clinical trials will continue to fail until they stratify by mechanism. A rituximab [@Fluge2011rituximab] trial that enrols all ME/CFS patients will fail on average, even if it cures every patient with a specific autoantibody profile. The signal is real. The trial design buries it.
...
**First:** your disease is real, biological, measurable, and mechanistically explicable [@IOM2015]. It is not one thing — it is a convergence of mechanisms — but that does not make it less real. It makes it more complex and harder to treat, which is a property of the disease, not of your psychology.
...
This series [@Loth2026website] began with a question: why are you so tired? The answer turned out to be: for fourteen possible reasons, in varying combinations, maintained by feedback loops that resist individual intervention.
