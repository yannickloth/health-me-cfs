...
The mechanism is thought to be autonomic. The vagus nerve controls the motility of the stomach — the waves of contraction that grind food and push it onward. In ME/CFS, autonomic dysfunction affects that vagal drive, and the stomach empties slowly. The impaired emptying then produces the digestive symptoms and the nutritional challenges above.
...
- **Domperidone** can prolong the cardiac QT interval — a baseline ECG/QT assessment and QTc monitoring are prudent before and during use [@Ingrosso2023GastroparesisDrugsNMA].
