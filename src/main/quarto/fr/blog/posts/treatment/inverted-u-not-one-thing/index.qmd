...
**La surprise de cette catégorie — la mélatonine.** La mélatonine est le médicament où l'hypothèse « plus, c'est mieux » échoue de la manière la moins évidente, parce que le médicament a deux effets qui répondent au dosage de façon complètement différente. Le premier est le signal chronobiotique — le message à l'horloge du cerveau que le jour se termine et que le sommeil doit commencer. Ce signal ne devient pas plus fort avec une dose plus élevée. C'est un signal de phase, pas un sédatif : une fois qu'il a dit à l'horloge l'heure qu'il est, ajouter plus de molécule n'ajoute rien à ce message. Le second effet — une action anti-inflammatoire et antioxydante via les récepteurs MT1/MT2 qui alimentent le système Nrf2 — est hormétique. Il fonctionne à des doses physiologiques (environ 0,3–1 mg) et *s'inverse* quand la dose monte dans la gamme supraphysiologique, parce qu'une occupation élevée soutenue désensibilise les récepteurs qui portaient le signal protecteur.

Le piège est que les deux effets sont invisibles pour la personne qui prend la pilule. Quelqu'un qui dort un peu à 0,3 mg suppose raisonnablement que 3 mg le fera dormir davantage — mais le bénéfice d'endormissement qu'il a déjà était le signal de phase chronobiotique, qui ne monte pas en échelle, et le bénéfice anti-inflammatoire qu'il n'a pas remarqué est discrètement éteint par la désensibilisation des récepteurs. Ce qui ressemble à « prendre plus du même médicament utile » est en réalité deux changements à la fois : l'effet d'échelle qui n'était jamais là, plus la perte d'un bénéfice hormétique qui était réel. C'est pourquoi un patient peut rapporter que la mélatonine « a cessé de fonctionner » ou a commencé à provoquer une somnolence diurne « gueule de bois » et une humeur de type dépressive à 3–5 mg. Ce sont des signatures d'une exposition supraphysiologique soutenue — la gueule de bois d'un taux plasmatique élevé prolongé, et l'aplatissement de type dépressif qui vient d'une dose élevée supprimant le tonus dopaminergique diurne. Le médicament ne s'est pas « épuisé ». La dose ne protégeait pas un bénéfice ; elle l'effaçait.
...
**La surprise de cette catégorie — la duloxétine.** La duloxétine contient discrètement deux médicaments différents, et la dose les sépare. Elle bloque le transporteur de la sérotonine (SERT) à faible occupation et le transporteur de la noradrénaline (NET) seulement quand l'occupation monte. Ces deux actions ont des formes de dose-réponse opposées. L'action sérotoninergique — le soulagement de la douleur, du sommeil et de l'anxiété — est monotone : elle se sature et demeure, sans U inversé. L'action noradrénergique — l'énergie, la motivation, l'entrain — est un véritable U inversé des catécholamines : elle grimpe vers le bénéfice quand le NET s'engage puis s'effondre quand la noradrénaline dépasse l'optimum préfrontal.

La conséquence est le comportement médicamenteux le plus déroutant du groupe : un patient peut augmenter la dose et *perdre le bénéfice d'énergie tout en gardant le soulagement de la douleur*, et interpréter cela comme le médicament qui « cesse de fonctionner » — alors qu'en réalité la moitié de celui-ci fonctionne exactement aussi bien qu'avant. Le signal de douleur est sérotoninergique et ne s'est jamais inversé ; le signal d'énergie a franchi son propre pic. Démêler les deux est en soi diagnostique. Si augmenter la dose retire le coup d'énergie mais épargne le soulagement de la douleur, le système noradrénergique se trouve sur le bras droit de sa courbe — le bon geste est de revenir à la dose qui maintenait le bénéfice d'énergie, pas de conclure que le médicament a échoué, et pas de l'abandonner, parce que le soulagement de la douleur n'a jamais été la partie qui s'est inversée. Les deux mécanismes peuvent être séparés par la dose parce qu'ils occupent des transporteurs différents à des concentrations différentes — une expérience intra-patient intégrée qu'aucune autre classe de médicaments n'offre d'ordinaire.

**La surprise de cette catégorie — les bêta-bloquants.** Tous les médicaments jusqu'ici élèvent le tonus catécholaminergique et poussent le système vers son pic depuis la gauche. Les bêta-bloquants sont l'exception qui complète le tableau : ils *abaissent* l'action des catécholamines, poussant depuis le bras droit vers le pic. La guanfacine fait de même, en apaisant le locus cœruleus. La catégorie contient donc des médicaments qui montent le tonus et d'autres qui le descendent, et les deux directions peuvent être thérapeutiques.

La surprise est ce que révèle un patient qui bénéficie des *deux* directions. Si un élévateur à faible dose (modafinil) vous aide *et* qu'un réducteur à faible dose (un bêta-bloquant, ou la guanfacine) vous aide, vous ne vous êtes pas contredit — vous avez révélé que votre tonus catécholaminergique de base est utilisable sur une large bande, parce qu'une petite addition et une petite soustraction tombent toutes deux dans la plage tolérable. Ce pic large est en lui-même une information : cela signifie que votre système catécholaminergique n'est pas le goulot d'étranglement fragile. L'inverse est le cas limite diagnostique. Un patient aidé par le modafinil mais émoussé cognitivement même par un bêta-bloquant à faible dose se trouve sur le bras gauche avec un tonus basal réellement faible — pour lui, le réducteur n'est pas une expérience neutre, il pousse un système déjà bas sous le plancher, et combiner bêta-bloquants et guanfacine serait activement contre-productif. La direction du médicament auquel vous répondez est une sonde de votre position sur la courbe, et la vraie force de la catégorie est qu'elle teste les deux directions à la fois.
...
**La surprise de cette catégorie — les corticostéroïdes.** C'est la surprise la plus dangereuse de tout le catalogue, et celle où la courbe de dose est le plus facilement mal lue. Les corticostéroïdes ne sont pas un seul médicament avec une courbe dose-réponse. Ce sont deux médicaments séparés par un seuil, et franchir ce seuil inverse non seulement le bénéfice mais la physiologie que vous essayiez d'aider.

À une dose physiologique, un corticostéroïde n'est pas vraiment un traitement — c'est un *remplacement*. Chez un patient dont l'axe HPA produit trop peu de cortisol (un état qu'il vaut la peine de suspecter dans l'EM/SFC, sans pour autant le présumer), l'hydrocortisone ou la prednisone à faible dose fournit simplement le signal glucocorticoïde anti-inflammatoire que le corps aurait dû produire. Le bénéfice vient de la restauration d'un déficit. C'est pourquoi une réponse spectaculaire à la dose de remplacement est en elle-même une invite diagnostique à pratiquer un bilan ACTH/cortisol — le médicament ne produit un effet frappant que si quelque chose d'endogène manquait réellement.

Au-dessus de cette fenêtre physiologique, le médicament cesse d'être un remplacement et devient un *suppresseur* de l'axe même qui fabrique l'hormone. Un dosage supraphysiologique dit à l'hypophyse et aux glandes surrénales de se mettre en retrait — le corps réduit sa propre production de cortisol pour correspondre à ce qu'il reçoit maintenant de l'extérieur. Le problème est ce qui se passe en descendant. Parce que l'axe a été réduit au silence, arrêter ou réduire le médicament retire le cortisol externe *avant* que le corps n'ait repris d'en fabriquer lui-même — laissant une fenêtre sans cortisol du tout. L'inflammation de rebond qui suit est souvent pire que la maladie initiale, et ce n'est pas un signe que le médicament a cessé de fonctionner ; c'est le retrait d'une hormone à laquelle on avait dit au corps de ne pas produire. C'est pourquoi les corticostéroïdes doivent être réduits progressivement, jamais arrêtés brutalement, et pourquoi la réduction peut être difficile même à des doses modestes si l'axe a été supprimé.

La règle clinique qui en découle est contre-intuitive et mérite d'être énoncée clairement : avec les corticostéroïdes, la dose qui aide est la plus petite qui restaure un déficit, et la dépasser au-delà de la fenêtre de remplacement n'ajoute aucun bénéfice — elle convertit le médicament en quelque chose qui met en danger le système qu'il soutenait. L'hypothèse « plus, c'est mieux » n'est pas seulement inefficace ici ; elle est le mécanisme précis par lequel un remplacement utile devient un suppresseur nuisible avec un piège de rebond à la sortie. En raison du potentiel réel de préjudice, tout usage de corticostéroïdes dans l'EM/SFC — à n'importe quelle dose, de remplacement ou supérieure — relève d'un encadrement médical, et la surprise décrite est une mise en garde sur le mécanisme, pas une recommandation d'essayer.
...
**La surprise de cette catégorie — le NAC.** Le NAC est le seul médicament de tout le catalogue dont la courbe va *à l'envers* de l'intuition, et c'est le médicament que les patients sont le plus susceptibles d'abandonner sur la foi d'un seul essai trompeur. Le NAC est un *précurseur* antioxydant : le corps s'en sert pour fabriquer le glutathion, le principal tampon redox de la cellule. L'erreur est de considérer le NAC lui-même comme l'antioxydant. Il ne l'est pas. C'est une matière première, et la première chose que le corps fait avec une charge de NAC est de la traiter — et cette étape de traitement produit elle-même une bouffée d'intermédiaires oxydants réactifs avant que le glutathion ne soit construit.

À 600 mg, cette bouffée de traitement peut épuiser le glutathion existant plus vite que le nouveau glutathion n'est fabriqué — la cellule est brièvement *plus* stressée oxydativement, pas moins. Chez environ un cinquième à un tiers des patients, cela se manifeste par une aggravation paradoxale : symptômes grippaux, malaise oxydatif, se sentir moins bien dans les heures suivant la pilule. La conclusion naturelle — « le NAC m'aggrave, il n'est pas pour moi » — est fausse d'une manière précise. L'aggravation n'est pas l'effet stable du médicament ; c'est un dépassement transitoire pendant la rampe de synthèse. À 1 200 mg, la voie de synthèse s'est saturée et le glutathion net monte, et bon nombre des mêmes patients qui se sentaient plus mal à 600 mg se sentent mieux à 1 200. La dose qui fait du mal est *plus basse* que celle qui aide.

C'est pourquoi un seul essai de NAC échoué à 600 mg n'est pas un verdict. Les gestes cliniques qui respectent la courbe sont de commencer assez bas pour éviter la bouffée et de construire au-delà (par exemple en divisant la dose, pour ne jamais demander au corps de traiter un gros bolus unique), ou de reconnaître qu'un patient qui s'aggrave à 600 mg mais s'améliore à 1 200 mg a une voie du glutathion intacte mais limitée en capacité — un résultat qui porte son propre sens, puisqu'il prédit que d'autres médicaments du groupe Nrf2 agissant via Keap1 (sulforaphane) ou GSK-3β (lithium) peuvent réussir là où une seule faible dose de NAC semblait échouer.
