...
Les chiffres rendent cela concret. La colonne d'occupation utilise l'équation de Hill standard $f = c^2/(1+c^2)$ (pharmacologie établie) ; la colonne de bénéfice utilise le modèle simple $B \propto f(1-f)^2$ proposé dans la partie B de cet article (une hypothèse) ; $K_d = 1$ mg est illustratif et non mesuré :
...
Lisez le tableau de bas en haut. Un nul à 4 mg établit que la dernière ligne est ≈ 0. Il ne dit rien des deux premières lignes, parce que ces lignes décrivent un état — le blocage partiel — qu'une dose de 4 mg ne produit jamais. Et 3 mg est encore une autre expérience : la fenêtre basse dose s'y est refermée aussi, mais d'autres mécanismes (le plateau d'endorphines, l'ouverture de la fenêtre TRPM3) sont à *leur* optimum — encore d'autres cibles. Chaque dose est une expérience différente, et l'échec de l'une ne condamne aucune des autres.
...
Un échec à 4 mg ne donne que la seconde : la combinaison de cibles engagée dans la bande des 4 mg — la restauration TRPM3, la désinhibition de l'orexine, et TLR4 dans son état *sur-bloqué* — n'est pas la voie qui limite les symptômes chez ce patient. Cela ne dit rien de l'état hormétique TLR4/Nrf2 ni du rebond d'endorphines, qui n'existent qu'à 1–3 mg — parce que ces états ne se sont *jamais produits* pendant un essai à 4 mg.
