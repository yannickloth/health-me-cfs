...
Sie haben LDN über einen längeren Zeitraum mit 4 mg ausprobiert. Kein Nutzen. Sie bringen dieses Ergebnis zu Ihrem Arzt und bitten darum, eine niedrigere Dosis zu testen — 1 mg, sagen wir. Er zuckt mit den Schultern: „Wenn 4 mg nichts bewirken, wird 1 mg auch nichts bewirken. Das Größere enthält das Kleinere."
...
Dieser Artikel erklärt, warum. Nicht, indem er dem Arzt widerspricht, sondern indem er zeigt, was seine Schlussfolgerung stillschweigend voraussetzt — und warum diese Annahme nicht hält, wenn ein Medikament mehrere Ziele bei unterschiedlichen Konzentrationen trifft.
...
Die Schlussfolgerung des Arztes vermischt zwei sehr verschiedene Aussagen:
...
## Der Grenzfall, in dem der Arzt recht hat

Um fair zu sein: Die Obermengen-Inferenz **ist** in einem präzisen Fall gültig. Wenn ein Medikament ein einzelnes Ziel mit einer einzigen Affinität und einer monotonen Dosis-Wirkungs-Kurve trifft (mehr Dosis = mehr Besetzung = mehr Wirkung, keine Umkehrung), dann ja: Ein Hochdosis-Fehlversuch genügt, und niedrigere Dosen sind redundant. Dies ist ein allgemeines Pharmakologie-Prinzip — die Annahme hinter der Standard-Dosisfindung für viele Single-Target- und monotone Wirkstoffe — keine Aussage spezifisch zu LDN und nicht aus der LDN-Analyse des Papiers gezogen.
