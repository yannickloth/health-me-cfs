...
Die Zahlen machen das konkret. Die Besetzungsspalte nutzt die Standard-Hill-Gleichung $f = c^2/(1+c^2)$ (etablierte Pharmakologie); die Nutzenspalte nutzt das einfache Modell $B \propto f(1-f)^2$, das in Teil B dieses Artikels vorgeschlagen wird (eine Hypothese); $K_d = 1$ mg ist illustrativ und ungemessen:
...
Lesen Sie die Tabelle von unten nach oben. Ein Nulleffekt bei 4 mg stellt fest, dass die letzte Zeile ≈ 0 ist. Über die ersten zwei Zeilen sagt er nichts, denn diese Zeilen beschreiben einen Zustand — partielle Blockade —, den eine 4-mg-Dosis nie erzeugt. Und 3 mg ist wieder ein anderes Experiment: Das Niedrigdosis-Fenster hat sich auch dort geschlossen, aber andere Mechanismen (das Endorphin-Plateau, das sich öffnende TRPM3-Fenster) sind an *ihrem* Optimum — wieder andere Ziele. Jede Dosis ist ein anderes Experiment, und das Scheitern der einen verurteilt keine der anderen.
...
Ein Fehlversuch bei 4 mg liefert nur die zweite: die Zielkombination, die in der 4-mg-Bande aktiv ist — TRPM3-Restauration, Orexin-Desinhibition und TLR4 in seinem *überblockierten* Zustand — ist nicht der Weg, der die Symptome bei diesem Patienten limitiert. Er sagt nichts über den hormetischen TLR4/Nrf2-Zustand oder den Endorphin-Rebound, die nur bei 1–3 mg existieren — weil diese Zustände während eines 4-mg-Versuchs *nie eingetreten sind*.
