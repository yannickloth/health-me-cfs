...
Der Rückblick der letzten Woche behandelte Genetik, Zelltyp-Anreicherung und skelettale Asymmetrie. Es ist schwer, den Umfang dessen zu vermitteln, was seither geschehen ist, daher gliedere ich das Ganze nach Themen statt nach Zeitverlauf. Die Kurzfassung: Die Arbeit enthält jetzt ein umfassendes pharmakodiagnostisches Framework, das 102 Medikamente umfasst, ein Hormesis-Modell mit 17 Medikamenten, das in vier mechanistisch unterschiedliche Kategorien zerlegt ist, sechs neue Kapitel ([Vergleichende Nosologie](../../../../../part2-pathophysiology/ch19-causal-hierarchy/01-causal-hierarchy-root-causes-amplifiers-and-consequences.qmd), [Forschungsmethoden](../../../../../part4-research/ch39-epidemiology-outcomes/01-epidemiological-and-outcomes-research.qmd), [Globale Perspektiven](../../../../../part4-research/ch43-translational-findings/01-translational-findings-implications-for-related-conditions.qmd), [Wirtschaftliche Auswirkungen](../../../../../part4-research/ch39-epidemiology-outcomes/04-quality-of-life-and-disability-studies.qmd)), 924 [Glossareinträge](../../../../../z-appendices/appendix-a-terminology/01-glossary-of-medical-and-scientific-terms.qmd) mit Live-Tooltips in der Webversion sowie die erste formale [pharmakodiagnostische Matrix](../../../../../part3-treatment/ch33-medication-response-reference/08-pharmacodiagnostic-matrix-constraint-satisfaction-inference.qmd), die Wirkungsmuster mit wahrscheinlichen zugrunde liegenden Mechanismen verknüpft. Das Repository verzeichnete über sieben Tage hinweg rund 213 Commits.
...
**[Kapitel 33: Mechanistisches Kaskaden-Tracing](../../../../../part3-treatment/ch34-mechanistic-cascade-tracing/01-mechanistic-cascade-tracing-from-hypothesis-to-clinical-probe.qmd)** enthält jetzt [102 Einträge zu Medikamenten, Nahrungsergänzungsmitteln und Behandlungen](../../../../../part3-treatment/ch33-medication-response-reference/08-pharmacodiagnostic-matrix-constraint-satisfaction-inference.qmd) — jeweils mit einer schrittweisen Kaskadenverfolgung durch die Mechanismen, die ein Wirkstoff anspricht, den Reaktionsmustern, die die Wirkungen und [Nebenwirkungen](../../../../../part3-treatment/ch34-mechanistic-cascade-tracing/10-side-effects-as-diagnostic-probes.qmd) des Wirkstoffs offenbaren, und dem, was Nicht-Reaktion oder paradoxe Verschlechterung darüber aussagt, welche Pfade nicht der Engpass sind. Das Kapitel enthält eine Taxonomie der Verschlimmerung über 11 Mechanismen für Wirkstoffe, die PEM oder eine anhaltende Verschlechterung auslösen können, eine formale [pharmakodiagnostische Matrix](../../../../../part3-treatment/ch33-medication-response-reference/08-pharmacodiagnostic-matrix-constraint-satisfaction-inference.qmd), die alle 102 Wirkstoffe gegen 28 Hypothesen-Domänen kreuzverweist, sowie Dissoziationsmuster — Wirkstoffpaare, die ein Ziel teilen, sich aber bei einem anderen unterscheiden, sodass die differenzielle Reaktion die Läsion lokalisiert.

Ein neuer Abschnitt über [negative Kontrollklassen von Medikamenten](../../../../../part3-treatment/ch34-mechanistic-cascade-tracing/10-side-effects-as-diagnostic-probes.qmd) definiert eine formale Taxonomie: Rituximab als kanonische Negativkontrolle, Immunglobulinadsorption als Grenzfall und die Unterscheidung zwischen „Null-Leiter" und „Negativkontroll-Leiter", die verhindert, dass man von „Null-Ergebnis" auf „Null-Behauptung" abrutscht. Das ist sowohl eine methodologische Absicherung — jede Hypothese in der Arbeit muss angeben, welches Ergebnis aus welcher Klasse von Negativkontrolle sie widerlegen würde — als auch ein diagnostisches Instrument: Das Medikament, das *nicht* wirkt, ist eine Information über den Mechanismus, der nicht vorhanden ist.

**Pulstherapie** und **zeitabhängige Hormesis** sind jetzt als allgemeiner Behandlungsrahmen integriert. Einige Medikamente haben ein therapeutisches Fenster, das zeitabhängig und nicht nur dosisabhängig ist — intermittierende Dosierung erhält die Selektivität über Ziele hinweg mit unterschiedlichen Off-Raten (Rapamycin, mTORC1 vs. mTORC2), verhindert die Rezeptor-Desensibilisierung, die hormetische Kompensation löscht, und nutzt die Erholungsphase, in der die adaptive Reaktion über dem Ausgangswert liegt. Eine ergänzende Spekulation — **[interozeptive Dosisfindung](../../../../../part3-treatment/ch34-mechanistic-cascade-tracing/08-integrative-models.qmd)** — fasst die absichtliche intermittierende Dosierung als rationales N-of-1-Experiment neu auf: Die Patientin titriert in Richtung der Dosis, die ein internes Nutzensignal erzeugt, und das Titrationsmuster selbst wird diagnostisch.

**Die TRPV1-Temperaturachse** ist jetzt als autonomer Belastungstest im Abschnitt [integrative Spekulationen](../../../../../part2-pathophysiology/ch18-symptom-producing-mechanisms/02-sickness-behavior-as-overarching-integrative-framework.qmd) von Kapitel 15 integriert. Thermische Belastungen — Kälteexposition, heißes Bad, Sauna — belasten auf unterschiedliche Weise TRPV1-vermittelte vasomotorische, sudomotorische und baroreflektorische Pfade. Reaktionsmuster auf diese Belastungen (übertriebene Vasokonstriktion, ausbleibendes Schwitzen, verzögerte Herzfrequenzerholung) lokalisieren das autonome Versagen auf bestimmte Rezeptor-Kanal-Komplexe und sagen voraus, welche pharmakologischen Sonden (Capsaicin, Menthol, TRPV1-Antagonisten) am ehesten eine Pathologie aufdecken. Eine [eigens vorgeschlagene Studie](../../../../../part4-research/ch47-proposed-studies/32-thermoregulatory-research-protocols.qmd) legt nun das Design fest.

---

## Das 17-Medikamente-Hormesis-Framework und seine vier Kategorien

Das Hormesis-Framework wurde von 5 auf 17 Medikamente erweitert, gestützt durch 11 neue Zitationen und einen 5. mechanistischen Cluster (D2-Partialagonisten, die Aripiprazol/LDA vom Nrf2-Cluster trennen), und ist jetzt in das Kapitel **[Integrative Modelle](../../../../../part2-pathophysiology/ch18-symptom-producing-mechanisms/01-symptom-producing-mechanisms-in-me-cfs.qmd)** integriert. Die vier Kategorien — und ihre diagnostischen Implikationen — sind:
...
Darüber hinaus integriert **[Kapitel 8](../../../../../part2-pathophysiology/ch08-immune-dysfunction/01-immune-system-dysfunction.qmd)** jetzt eine [HSV-Latenz-und-Reaktivierungs-Sonde](../../../../../part2-pathophysiology/ch08-immune-dysfunction/06-viral-reactivation-and-persistence.qmd): sichtbare Herpesvirus-Reaktivierung (Lippenherpes) als patientenberichterbarer, PEM-bezogener Biomarker endogener Reaktivierung, der den HSV-1/2-Latenzzyklus als Fenster in die breitere Herpesvirus-Reaktivierungsdynamik nutzt, die bei ME/CFS-Symptomschüben eine Rolle spielt.

Die begleitende Blog-Serie — [Warum mehr nicht besser ist](../../treatment/more-isnt-better-ldn-lda/), [Das Inverse-U ist nicht eine Sache](../../treatment/inverted-u-not-one-thing/), [Ihre LDN-Dosis ist ein Diagnostikum](../../treatment/dose-is-diagnostic-ldn/) und [Die Pharmakopöe — jeder Dosisbereich für jedes Medikament und was er bedeutet](../../treatment/pharmacopoeia-dose-meaning/) — ist das patientenzentrierte Äquivalent der konsolidierten Referenztabelle.
...
**[Kapitel 39: Gesundheitssysteme und Politik](../../../../../part4-research/ch42-controversies/10-research-funding-disparities.qmd)** — 17 Behandlungsumgebungen, 10 Publikationen und ein 4-Fehler-Modell (diagnostisches Versagen, therapeutisches Versagen, systemisches Versagen, Versagen der Wissensproduktion), das erklärt, warum ME/CFS-Ergebnisse über Gesundheitssysteme mit grundlegend unterschiedlichen Designs hinweg schlecht sind. Strukturelles Versagen ist eine Folge des Kategorienfehlers, nicht der Ressourcenzuteilung.

**[Kapitel 45: Patientengeneriertes Wissen und Citizen Science](../../../../../part4-research/ch45-research-infrastructure/01-research-infrastructure-proposals.qmd)** — dokumentiert das parallele Ökosystem der Wissensproduktion, das Patientinnen außerhalb formaler Institutionen aufgebaut haben: Protokollaustausch, Crowdsourcing-Behandlungsregister, Verfolgung unerwünschter Ereignisse und das informelle diagnostische Fachwissen, das erfahrene Patientinnen ansammeln.

Zusätzliche Stubs für 8 weitere Kapitel wurden erstellt, um strukturelle Lücken zu schließen. Die gesamte Kapitelnummerierung wurde neu organisiert (1–55 fortlaufend), um die strukturelle Erweiterung aufzunehmen. Das bestehende [Kapitel zur Geschichte von ME/CFS](../../../../../part1-clinical/ch01-introduction/02-historical-context.qmd) (ch02) wurde mit einer vollständigen chronologischen Erzählung von 1934 bis 2025 bestückt und mit überlappenden Inhalten in ch01 abgeglichen. [Regenerations-Umgebungen von Satellitenzellen](https://github.com/yannickloth/health-me-cfs/tree/main/ops), die bei einer früheren Umstrukturierung von Kapitel 7 verloren gingen, wurden wiederhergestellt und erhielten Korrekturen aus der adversariellen Überprüfung — eine mechanische Reparatur, die den Nutzen des Skills zur propagierenden Strategierahmung in Phase 10b belegte. Ein [Serotonin-Engpass-Integrationsplan und Suchprotokoll](https://github.com/yannickloth/health-me-cfs/tree/main/ops) wurde für eine spätere Integration vorgemerkt, zusammen mit formalen Dokumenten zu [Themen-Integrationsprioritäten](https://github.com/yannickloth/health-me-cfs/tree/main/ops) und [kreativen Integrationsprioritäten](https://github.com/yannickloth/health-me-cfs/tree/main/ops), die die verbleibenden offenen Themen nach geschätzter Wirkung und Schwierigkeit einordnen.
