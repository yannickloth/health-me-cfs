...
(() => {
  ...
  const CATEGORY_LABEL_SETS = {
    en: {
      ...
      cell: 'Cell', cell_type: 'Cell Type', immune: 'Immune', biomarker: 'Biomarker', measurement: 'Measurement',
    ...
    fr: {
      ...
      cell: 'Cellule', cell_type: 'Type de cellule', immune: 'Système immunitaire', biomarker: 'Biomarqueur', measurement: 'Mesure',
    ...
    de: {
      ...
      cell: 'Zelle', cell_type: 'Zelltyp', immune: 'Immun', biomarker: 'Biomarker', measurement: 'Messung',
