...
\author{%
  \begin{minipage}[t]{0.95\textwidth}
    \centering
    Olivier Croce\textsuperscript{1}, Yannick Loth\textsuperscript{2},
    Patrick Lomonte\textsuperscript{3}, Genevi\`{e}ve Fourel\textsuperscript{4*}\\[4pt]
    \small
...
These conditions often follow a viral illness and many patients
experience reactivation of dormant herpesviruses (HSV-1,
cold-sore virus; HCMV, cytomegalovirus; HHV-6).
...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item \textbf{Therapeutic response.}  If the hypothesis is
    correct, methyl donors---compounds supplying DNA methylation
    material (SAMe [S-adenosylmethionine], methylfolate,
    betaine)---will reduce EV HSAT2 more than placebo.  This
    prediction awaits testing and is not a treatment recommendation;
    demethylating agents (HDAC inhibitors, 5-azacitidine) should not
    be administered on the basis of this model alone.
\end{enumerate}
...
\textbf{Limitations.}  Each step is documented: herpesviruses
induce HSAT2 \cite{Nogalski2019HSATII}, HSAT2 RNA is packaged into
EVs in cancer \cite{Ruzanov2024ETSsatelliteEV}, and HSAT2 is
detectable in serum \cite{Kishikawa2016SATII,Seimiya2023HSATII}.
However, the chain linking all three---viral centromere disruption
to circulating EV HSAT2 in a non-cancer context---has not been
demonstrated.  This is a framework for testing, not established
fact.
