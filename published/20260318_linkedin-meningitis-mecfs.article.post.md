...
The article below covers the biology — NK cell dysfunction, T cell exhaustion, complement consumption, BBB permeability — and the data on vaccination safety for this population, including two Norwegian population-level studies that are both reassuring.

#MECFS #MyalgicEncephalomyelitis #Meningitis #MeningitisB #Vaccination #PublicHealth #LongCovid #MillionsMissing
