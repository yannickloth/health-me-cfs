...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \textbf{Intolérance à la station debout (depuis $\sim$30 ans):} Le patient rapporte avoir toujours trouvé la station debout extrêmement inconfortable, aussi loin qu'il se souvienne (au moins depuis le milieu des années 1990). Ce n'est pas lié à la fatigue musculaire ou à la douleur, mais à un inconfort intrinsèque et profond en position debout prolongée. Ce symptôme précède de plusieurs décennies le diagnostic d'EM/SFC et peut représenter un marqueur précoce de vulnérabilité autonome/orthostatique
