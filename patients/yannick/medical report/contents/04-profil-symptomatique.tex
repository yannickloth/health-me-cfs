\subsection{Personal Symptom Profile}

This section documents a detailed personal symptom profile for use in clinical reasoning, treatment planning, and understanding symptom interconnections. The symptoms described here illustrate how ME/CFS manifests in an individual case, with pathophysiological explanations based on current research.
...
\subsubsection{Primary Symptoms}
\label{sec:personal-primary}

\paragraph{Constant Fatigue and Exertion Intolerance}
...
\paragraph{Cognitive Impairment: Complex Presentation}
...
\paragraph{Progressive Vision Impairment}
...
\paragraph{Progressive Hearing Loss}
...
\paragraph{Post-Exertional Malaise (PEM)}
...
\subsubsection{Musculoskeletal Symptoms}
\label{sec:personal-musculoskeletal}

\paragraph{Muscle Cramps (Crampes Musculaires)}
...
\paragraph{Early-Onset Tremor (Childhood/Adolescence).}
\begin{itemize}
...
\paragraph{Chronic Leg Exhaustion}
...
\paragraph{Lactic Acid Accumulation}
...
\paragraph{Neuralgias and Dorsalgias}
...
\subsubsection{Respiratory Symptoms}
\label{sec:personal-respiratory}

\paragraph{Historical Asthma (Childhood-Adolescence, Resolved)}
...
\paragraph{Progressive Air Hunger}
...
\subsubsection{Immune and Allergic Symptoms}
\label{sec:personal-immune}

\paragraph{Increased Food Allergies/Sensitivities}
...
\paragraph{Confirmed Nut Allergies.}
\begin{itemize}
...
\paragraph{Oral Allergy Syndrome (OAS) Pattern.}
\begin{itemize}
...
\subsubsection{Acute Illness Episodes}
...
\paragraph{Upper Respiratory Infection (January 2026)}
...
\paragraph{Generalized Weakness and Hypersomnia (February 2026)}
...
\paragraph{Persistent Fatigue (February 2026)}
...
\paragraph{Activity-Triggered PEM and Post-Stimulant Response (February 8--10, 2026)}
...
\paragraph{Saturday, February 8: Activity Despite Pain and Low Energy}
...
\paragraph{Sunday, February 9: Acute PEM Crash and Rapid Recovery}
...
\paragraph{Monday, February 10 Morning: Ritalin MR 30mg Resumption (30mg Dose) and Excellent Response}
...
\paragraph{Tuesday, February 10 Afternoon/Evening: Post-Stimulant Rebound---Weakness and Hypoglycemic-Like Tremors}
