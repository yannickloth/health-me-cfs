...
\begin{itemize}
\item \textit{Généraliste, pour petits trucs habituels}
\item \textit{Spécialiste en médecine interne générale, pour ME/CFS}
\end{itemize}
...
\begin{enumerate}
\item Polysomnographie avec surveillance autonome (FC, TA, VFC continus) est-elle indiquée pour évaluer dysrégulation autonome dépendante du stade de sommeil?
...
\item Le tremblement des mains (présent depuis l'âge de 16 ans) avec tremblements autonomes récents -- sont-ils les mêmes ou différents phénomènes?
