...
\midrule
Depuis $\sim$30 ans & Station debout toujours vécue comme extrêmement inconfortable & Possible marqueur précoce de vulnérabilité orthostatique/autonome \\
\midrule
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \begin{tcolorbox}[breakable,colback=yellow!10!white,colframe=orange!75!black,title=Facteur rétrospectif spéculatif]
        ...
        \item \textbf{Intolérance à la station debout (depuis $\sim$30 ans):} Le patient rapporte avoir toujours trouvé la station debout extrêmement inconfortable, aussi loin qu'il se souvienne (au moins depuis le milieu des années 1990). L'attente debout en particulier a toujours été ressentie comme très inconfortable. Ce n'est pas lié à la fatigue musculaire ou à la douleur, mais à un inconfort intrinsèque et profond en position debout prolongée. Ce symptôme précède de plusieurs décennies le diagnostic d'EM/SFC et peut représenter un marqueur précoce de vulnérabilité autonome/orthostatique
        \item \textbf{Tendance au sommeil en position assise ou allongée (à vie):} Le patient rapporte une tendance de toujours à s'endormir dès qu'il s'assied ou s'allonge, aussi loin qu'il se souvienne. Ce schéma est distinct de la somnolence post-prandiale normale~; il se manifeste quelle que soit l'heure de la journée, le niveau de repos préalable ou le contexte. Durant l'adolescence, le patient attribuait cette somnolence à son volume d'entraînement sportif intense (16--20 heures par semaine), ce qui rendait impossible d'identifier ce symptôme comme un signe de défaillance de la production énergétique~; l'explication par le sport était trop plausible. Le symptôme a cependant persisté indépendamment du niveau d'activité physique. Cohérent avec le diagnostic d'hypersomnie idiopathique et possiblement lié à la vulnérabilité autonome sous-jacente (réduction du tonus sympathique en position assise/allongée facilitant la transition vers le sommeil)
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \textbf{Dominance sympathique}: La dysfonction autonome post-TCC se manifeste souvent comme un surdrive sympathique (FC élevée, VFC altérée, tachycardie orthostatique)
