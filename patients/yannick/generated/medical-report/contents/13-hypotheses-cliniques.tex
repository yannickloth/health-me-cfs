...
\begin{itemize}
    \item \textbf{Test}: Polysomnographie avec surveillance autonome (VFC, ECG continu, tendance PA); test de table basculante (Section~\ref{subsubsec:protocol-tilt})
    \item \textbf{Résultats attendus si l'hypothèse est vraie}:
    \begin{itemize}
        \item Variations exagérées de FC et PA pendant les transitions de stade de sommeil
        \item VFC atténuée pendant le sommeil (normalement élevée pendant le sommeil profond; basse avec insuffisance en mélatonine)
