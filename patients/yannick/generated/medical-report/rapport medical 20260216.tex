...
\input{contents/01-resume-executif}
\input{contents/02-historique-patient}
\input{contents/03-resultats-cliniques}
\input{contents/04-profil-symptomatique}
\input{contents/05-evenements-recents}
\input{contents/06-gestion-medicale}
\input{contents/07-recommandations-traitement}
\input{contents/08-recommandations-diagnostiques}
\input{contents/09-gestion-pem-rythme}
\input{contents/10-surveillance-interactions}
\input{contents/11-interventions-quotidiennes}
\input{contents/12-analyse-cas}
\input{contents/13-hypotheses-cliniques}
\input{contents/15-recommandations}
\input{contents/14-references}
