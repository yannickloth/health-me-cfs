...
\newtcolorbox{hypothesis}[1][]{
  ...
  title={\textbf{Hypothese: #1}}, fonttitle=\bfseries, sharp corners, boxrule=1pt
}
...
\newtcolorbox{caution}[1][]{
  ...
  title={\textbf{Vorsicht: #1}}, fonttitle=\bfseries, sharp corners, boxrule=1pt
}

\newtcolorbox{currentbox}[1][]{
  colback=currentbg, colframe=currentborder,
  title={\textbf{#1}}, fonttitle=\bfseries, sharp corners, boxrule=2pt
}
...
\begin{itemize}[noitemsep]
    ...
    \item MCAS fraglich (Mastzellaktivierungssyndrom)
\end{itemize}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Krankheitsdauer:} 12 Jahre
    \item \textbf{Vermuteter Trigger:} EBV-Infektion (Patientin: ``vermutlich EBV'')
    \item \textbf{Diagnoseweg:} Frühere Fehldiagnosen (u.a. Fibromyalgie), ME/CFS-Diagnose erst 2022
    \item \textbf{Schweregrad-Verlauf:}
    \begin{itemize}[noitemsep]
        \item 12 Jahre: Moderat
        \item Herbst 2024: COVID-Infektion $\rightarrow$ Myokarditis
        \item Seit COVID 2024: Severe (größtenteils bettlägerig)
    \end{itemize}
...
\begin{tcolorbox}[colback=red!10, colframe=red!70!black, title={\textbf{CRASH-MANAGEMENT}}, fonttitle=\bfseries\large, sharp corners, boxrule=2pt]

\textbf{Ziel:} Aus dem Crash herauskommen. Keine neuen Interventionen während der Crash-Phase.

\subsection*{Priorität 1: Strikte Ruhe}
\begin{itemize}[noitemsep]
...
\subsection*{Priorität 2: Hydratation und Elektrolyte}
\begin{itemize}[noitemsep]
...
\subsection*{Priorität 3: Crash-spezifische Supplementanpassungen}
\begin{itemize}[noitemsep]
...
\subsection*{Priorität 4: Schlaf und Schmerz}
\begin{itemize}[noitemsep]
...
\subsection*{Priorität 5: Frauenspezifische Faktoren}
\begin{itemize}[noitemsep]
...
\begin{enumerate}[noitemsep,start=2]
    ...
    \item \textbf{Mestinon einführen:} Start 20~mg, Ziel 60--90~mg/Tag
